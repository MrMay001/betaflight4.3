# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
# 59 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
...
# 53 "./src/main/vcp_hal/usbd_conf.h"
...
# 153 "./src/main/platform.h" 2
# 54 "./src/main/vcp_hal/usbd_conf.h" 2
...
# 55 "./src/main/vcp_hal/usbd_conf.h" 2
...
# 60 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c" 2
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ctlreq.h" 1
# 61 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c" 2
# 103 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
...
# 155 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
...
# 160 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c" 3 4
 ((void *)0)
# 160 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
     ,
  USBD_CDC_EP0_RxReady,
  USBD_CDC_DataIn,
  USBD_CDC_DataOut,
  
# 164 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c" 3 4
 ((void *)0)
# 164 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
     ,
  
# 165 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c" 3 4
 ((void *)0)
# 165 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
     ,
  
# 166 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c" 3 4
 ((void *)0)
# 166 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
     ,
 ...
 uint8_t USBD_CDC_CfgHSDesc[67U] __attribute__ ((aligned (4))) =
{
  ...
  0x01U,
  0x02,
  ((uint8_t)(512U & 0x00FFU)),
  ((uint8_t)((512U & 0xFF00U) >> 8U)),
  0x00,
 ...
 uint8_t USBD_CDC_CfgFSDesc[67U] __attribute__ ((aligned (4))) =
{
 ...
 uint8_t USBD_CDC_OtherSpeedCfgDesc[67U] __attribute__ ((aligned (4))) =
{
  0x09,
  0x07U,
  67U,
...
# 471 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
static uint8_t USBD_CDC_Init (USBD_HandleTypeDef *pdev, uint8_t cfgidx)
{
  ...
  if(pdev->dev_speed == USBD_SPEED_HIGH)
  {
    ...
    USBD_LL_OpenEP(pdev, 0x81U, 0x02U,
                   512U);

    pdev->ep_in[0x81U & 0xFU].is_used = 1U;


    USBD_LL_OpenEP(pdev, 0x01U, 0x02U,
                   512U);
  ...
  USBD_LL_OpenEP(pdev, 0x82U, 0x03U, 8U);
  pdev->ep_in[0x82U & 0xFU].is_used = 1U;

  pdev->pCDC_ClassData = malloc(sizeof (USBD_CDC_HandleTypeDef));

  if(pdev->pCDC_ClassData == 
# 513 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c" 3 4
                            ((void *)0)
# 513 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
                                )
  {
    ret = 1U;
  }
  else
  {
    ...
    if(pdev->dev_speed == USBD_SPEED_HIGH)
    {
      ...
      USBD_LL_PrepareReceive(pdev, 0x01U, hcdc->RxBuffer,
                             512U);
    }
    else
    {
...
# 551 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
static uint8_t USBD_CDC_DeInit (USBD_HandleTypeDef *pdev, uint8_t cfgidx)
{
  ...
  if(pdev->pCDC_ClassData != 
# 570 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c" 3 4
                            ((void *)0)
# 570 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
                                )
  {
    ((USBD_CDC_ItfTypeDef *)pdev->pCDC_UserData)->DeInit();
    free(pdev->pCDC_ClassData);
    pdev->pCDC_ClassData = 
# 574 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c" 3 4
                          ((void *)0)
# 574 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
                              ;
  }

  return ret;
}
# 587 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
static uint8_t USBD_CDC_Setup (USBD_HandleTypeDef *pdev,
                                USBD_SetupReqTypedef *req)
{
...
# 681 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
static uint8_t USBD_CDC_DataIn (USBD_HandleTypeDef *pdev, uint8_t epnum)
{
  ...
  if(pdev->pCDC_ClassData != 
# 686 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c" 3 4
                            ((void *)0)
# 686 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
                                )
  {
    if((pdev->ep_in[epnum].total_length > 0U) && ((pdev->ep_in[epnum].total_length % hpcd->IN_ep[epnum].maxpacket) == 0U))
    {
      ...
      USBD_LL_Transmit (pdev, epnum, 
# 694 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c" 3 4
                                    ((void *)0)
# 694 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
                                        , 0U);
    }
    else
    {
...
# 715 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
static uint8_t USBD_CDC_DataOut (USBD_HandleTypeDef *pdev, uint8_t epnum)
{
  ...
  if(pdev->pCDC_ClassData != 
# 724 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c" 3 4
                            ((void *)0)
# 724 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
                                )
  {
...
static uint8_t USBD_CDC_EP0_RxReady (USBD_HandleTypeDef *pdev)
{
  ...
  if((pdev->pCDC_UserData != 
# 746 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c" 3 4
                            ((void *)0)
# 746 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
...
# 764 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
static uint8_t *USBD_CDC_GetFSCfgDesc (uint16_t *length)
{
  *length = sizeof (USBD_CDC_CfgFSDesc);
  return USBD_CDC_CfgFSDesc;
}
# 777 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
static uint8_t *USBD_CDC_GetHSCfgDesc (uint16_t *length)
{
  *length = sizeof (USBD_CDC_CfgHSDesc);
  return USBD_CDC_CfgHSDesc;
}
# 790 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
static uint8_t *USBD_CDC_GetOtherSpeedCfgDesc (uint16_t *length)
{
                                      ...
                                      USBD_CDC_ItfTypeDef *fops)
{
  ...
  if(fops != 
# 819 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c" 3 4
            ((void *)0)
# 819 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
                )
  {
...
# 853 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
uint8_t USBD_CDC_SetRxBuffer (USBD_HandleTypeDef *pdev,
                                   uint8_t *pbuff)
{
  USBD_CDC_HandleTypeDef *hcdc = (USBD_CDC_HandleTypeDef*) pdev->pCDC_ClassData;
...
uint8_t USBD_CDC_TransmitPacket(USBD_HandleTypeDef *pdev)
{
  ...
  if(pdev->pCDC_ClassData != 
# 873 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c" 3 4
                            ((void *)0)
# 873 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
                                )
  {
    if(hcdc->TxState == 0U)
    {
      ...
      pdev->ep_in[0x81U & 0xFU].total_length = hcdc->TxLength;


      USBD_LL_Transmit(pdev, 0x81U, hcdc->TxBuffer,
...
# 907 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
uint8_t USBD_CDC_ReceivePacket(USBD_HandleTypeDef *pdev)
{
  USBD_CDC_HandleTypeDef *hcdc = (USBD_CDC_HandleTypeDef*) pdev->pCDC_ClassData;
  ...
  if(pdev->pCDC_ClassData != 
# 912 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c" 3 4
                            ((void *)0)
# 912 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Src/usbd_cdc.c"
                                )
  {
    if(pdev->dev_speed == USBD_SPEED_HIGH )
    {
