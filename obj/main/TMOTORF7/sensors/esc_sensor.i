...
# 51 "./src/main/sensors/esc_sensor.c" 2
...
# 53 "./src/main/sensors/esc_sensor.c" 2
...
# 55 "./src/main/sensors/esc_sensor.c" 2
# 75 "./src/main/sensors/esc_sensor.c"
extern const escSensorConfig_t pgResetTemplate_escSensorConfig; escSensorConfig_t escSensorConfig_System; escSensorConfig_t escSensorConfig_Copy; uint32_t escSensorConfig_fnv_hash; extern const pgRegistry_t escSensorConfig_Registry; const pgRegistry_t escSensorConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 517 | (0 << 12), .length = 1, .size = sizeof(escSensorConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&escSensorConfig_System, .fnv_hash = &escSensorConfig_fnv_hash, .copy = (uint8_t*)&escSensorConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_escSensorConfig}, };

const escSensorConfig_t pgResetTemplate_escSensorConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .halfDuplex = 0 }

 ;
# 89 "./src/main/sensors/esc_sensor.c"
enum {
...
static 
# 128 "./src/main/sensors/esc_sensor.c" 3 4
      _Bool 
# 128 "./src/main/sensors/esc_sensor.c"
...
static 
# 145 "./src/main/sensors/esc_sensor.c" 3 4
      _Bool 
# 145 "./src/main/sensors/esc_sensor.c"
...
# 150 "./src/main/sensors/esc_sensor.c" 3 4
_Bool 
# 150 "./src/main/sensors/esc_sensor.c"
...
escSensorData_t *getEscSensorData(uint8_t motorNumber)
{
    if (!featureIsEnabled(FEATURE_ESC_SENSOR)) {
        return 
# 158 "./src/main/sensors/esc_sensor.c" 3 4
              ((void *)0)
# 158 "./src/main/sensors/esc_sensor.c"
                  ;
    }
    ...
    if (motorNumber < getMotorCount()) {
        ...
        if (combinedDataNeedsUpdate) {
            ...
            combinedDataNeedsUpdate = 
# 184 "./src/main/sensors/esc_sensor.c" 3 4
                                     0
# 184 "./src/main/sensors/esc_sensor.c"
                                          ;

            do { if (debugMode == (DEBUG_ESC_SENSOR)) { debug[(DEBUG_ESC_DATA_AGE)] = (combinedEscSensorData.dataAge); } } while (0);
        }

        return &combinedEscSensorData;
    } else {
        return 
# 191 "./src/main/sensors/esc_sensor.c" 3 4
              ((void *)0)
...
# 210 "./src/main/sensors/esc_sensor.c" 3 4
_Bool 
# 210 "./src/main/sensors/esc_sensor.c"
    escSensorInit(void)
{
...
# 220 "./src/main/sensors/esc_sensor.c"
    ...
    return escSensorPort != 
# 226 "./src/main/sensors/esc_sensor.c" 3 4
                           ((void *)0)
# 226 "./src/main/sensors/esc_sensor.c"
                               ;
}
...
static uint8_t decodeEscFrame(void)
{
    ...
    if (chksum == tlmsum) {
        ...
        combinedDataNeedsUpdate = 
# 269 "./src/main/sensors/esc_sensor.c" 3 4
                                 1
# 269 "./src/main/sensors/esc_sensor.c"
                                     ;

        frameStatus = ESC_SENSOR_FRAME_COMPLETE;

        if (escSensorMotor < 4) {
            do { if (debugMode == (DEBUG_ESC_SENSOR_RPM)) { debug[(escSensorMotor)] = (calcEscRpm(escSensorData[escSensorMotor].rpm) / 10); } } while (0);
            do { if (debugMode == (DEBUG_ESC_SENSOR_TMP)) { debug[(escSensorMotor)] = (escSensorData[escSensorMotor].temperature); } } while (0);
        }
    } else {
...
static void increaseDataAge(void)
{
    if (escSensorData[escSensorMotor].dataAge < 255) {
        ...
        combinedDataNeedsUpdate = 
# 289 "./src/main/sensors/esc_sensor.c" 3 4
                                 1
# 289 "./src/main/sensors/esc_sensor.c"
                                     ;
    }
}
...
# 324 "./src/main/sensors/esc_sensor.c" 3 4
                                                     1
# 324 "./src/main/sensors/esc_sensor.c"
                                                         ;
            escSensorTriggerState = ESC_SENSOR_TRIGGER_PENDING;

            do { if (debugMode == (DEBUG_ESC_SENSOR)) { debug[(DEBUG_ESC_MOTOR_INDEX)] = (escSensorMotor + 1); } } while (0);
            ...
            if (currentTimeMs < escTriggerTimestamp + 100) {
                ...
                switch (state) {
                    ...
                    case ESC_SENSOR_FRAME_FAILED:
                        ...
                        do { if (debugMode == (DEBUG_ESC_SENSOR)) { debug[(DEBUG_ESC_NUM_CRC_ERRORS)] = (++totalCrcErrorCount); } } while (0);
                        break;
                ...
                do { if (debugMode == (DEBUG_ESC_SENSOR)) { debug[(DEBUG_ESC_NUM_TIMEOUTS)] = (++totalTimeoutCount); } } while (0);
            }
