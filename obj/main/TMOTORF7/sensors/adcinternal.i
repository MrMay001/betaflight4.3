...
void adcInternalProcess(timeUs_t currentTimeUs)
{
    ...
    do { if (debugMode == (DEBUG_ADC_INTERNAL)) { debug[(0)] = (coreTemperature); } } while (0);
    do { if (debugMode == (DEBUG_ADC_INTERNAL)) { debug[(1)] = (vrefintSample); } } while (0);
    do { if (debugMode == (DEBUG_ADC_INTERNAL)) { debug[(2)] = (tempsensorSample); } } while (0);
    do { if (debugMode == (DEBUG_ADC_INTERNAL)) { debug[(3)] = (vrefMv); } } while (0);
