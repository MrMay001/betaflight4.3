...
# 55 "./src/main/sensors/rangefinder.c" 2
...
extern const rangefinderConfig_t pgResetTemplate_rangefinderConfig; rangefinderConfig_t rangefinderConfig_System; rangefinderConfig_t rangefinderConfig_Copy; uint32_t rangefinderConfig_fnv_hash; extern const pgRegistry_t rangefinderConfig_Registry; const pgRegistry_t rangefinderConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 527 | (0 << 12), .length = 1, .size = sizeof(rangefinderConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&rangefinderConfig_System, .fnv_hash = &rangefinderConfig_fnv_hash, .copy = (uint8_t*)&rangefinderConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_rangefinderConfig}, };
...
const rangefinderConfig_t pgResetTemplate_rangefinderConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .rangefinder_hardware = RANGEFINDER_NONE, }
 ...
 ;
# 90 "./src/main/sensors/rangefinder.c"
static 
# 90 "./src/main/sensors/rangefinder.c" 3 4
      _Bool 
# 90 "./src/main/sensors/rangefinder.c"
...
# 109 "./src/main/sensors/rangefinder.c"
            break;
    ...
    if (rangefinderHardware == RANGEFINDER_NONE) {
        ...
        return 
# 136 "./src/main/sensors/rangefinder.c" 3 4
              0
# 136 "./src/main/sensors/rangefinder.c"
                   ;
    }
    ...
    return 
# 141 "./src/main/sensors/rangefinder.c" 3 4
          1
# 141 "./src/main/sensors/rangefinder.c"
              ;
}
...
# 146 "./src/main/sensors/rangefinder.c" 3 4
                                     0
# 146 "./src/main/sensors/rangefinder.c"
                                          ;
    rangefinder.dynamicDistanceThreshold = 0;
}


# 150 "./src/main/sensors/rangefinder.c" 3 4
_Bool 
# 150 "./src/main/sensors/rangefinder.c"
    rangefinderInit(void)
{
    if (!rangefinderDetect(&rangefinder.dev, rangefinderConfig()->rangefinder_hardware)) {
        return 
# 153 "./src/main/sensors/rangefinder.c" 3 4
              0
# 153 "./src/main/sensors/rangefinder.c"
                   ;
    }
    ...
    return 
# 171 "./src/main/sensors/rangefinder.c" 3 4
          1
# 171 "./src/main/sensors/rangefinder.c"
              ;
}
...
static int32_t applyMedianFilter(int32_t newReading)
{
    ...
    static 
# 179 "./src/main/sensors/rangefinder.c" 3 4
          _Bool 
# 179 "./src/main/sensors/rangefinder.c"
               medianFilterReady = 
# 179 "./src/main/sensors/rangefinder.c" 3 4
                                   0
# 179 "./src/main/sensors/rangefinder.c"
    ...
    if (newReading > (-1)) {
        ...
        if (filterSampleIndex == 5) {
            filterSampleIndex = 0;
            medianFilterReady = 
# 186 "./src/main/sensors/rangefinder.c" 3 4
                               1
# 186 "./src/main/sensors/rangefinder.c"
                                   ;
        }
    }
...
static int16_t computePseudoSnr(int32_t newReading) {
    ...
    static 
# 197 "./src/main/sensors/rangefinder.c" 3 4
          _Bool 
# 197 "./src/main/sensors/rangefinder.c"
               snrReady = 
# 197 "./src/main/sensors/rangefinder.c" 3 4
                          0
# 197 "./src/main/sensors/rangefinder.c"
    ...
    if (snrSampleIndex == 5) {
        snrSampleIndex = 0;
        snrReady = 
# 205 "./src/main/sensors/rangefinder.c" 3 4
                  1
# 205 "./src/main/sensors/rangefinder.c"
                      ;
    }
...
# 232 "./src/main/sensors/rangefinder.c" 3 4
_Bool 
# 232 "./src/main/sensors/rangefinder.c"
    ...
    if (
        ...
        if (rangefinder.snrThresholdReached) {
            ...
            return 
# 251 "./src/main/sensors/rangefinder.c" 3 4
                  1
# 251 "./src/main/sensors/rangefinder.c"
                      ;
        }

    } else {
        return 
# 255 "./src/main/sensors/rangefinder.c" 3 4
              0
# 255 "./src/main/sensors/rangefinder.c"
                   ;
    }
...
# 263 "./src/main/sensors/rangefinder.c" 3 4
_Bool 
# 263 "./src/main/sensors/rangefinder.c"
    rangefinderProcess(float cosTiltAngle)
{
    if (rangefinder.dev.read) {
        ...
        if (distance == (-3)) {
            return 
# 270 "./src/main/sensors/rangefinder.c" 3 4
                  0
# 270 "./src/main/sensors/rangefinder.c"
                       ;
        }
        ...
        if (rangefinder.snrThresholdReached == 
# 287 "./src/main/sensors/rangefinder.c" 3 4
                                              0 
# 287 "./src/main/sensors/rangefinder.c"
                                                    && rangefinder.rawAltitude > 0) {
            ...
            if (rangefinder.snr >= 600) {
                rangefinder.snrThresholdReached = 
# 294 "./src/main/sensors/rangefinder.c" 3 4
                                                 1
# 294 "./src/main/sensors/rangefinder.c"
                                                     ;
            }

        }

        do { if (debugMode == (DEBUG_RANGEFINDER)) { debug[(3)] = (rangefinder.snr); } } while (0);

        do { if (debugMode == (DEBUG_RANGEFINDER_QUALITY)) { debug[(0)] = (rangefinder.rawAltitude); } } while (0);
        do { if (debugMode == (DEBUG_RANGEFINDER_QUALITY)) { debug[(1)] = (rangefinder.snrThresholdReached); } } while (0);
        do { if (debugMode == (DEBUG_RANGEFINDER_QUALITY)) { debug[(2)] = (rangefinder.dynamicDistanceThreshold); } } while (0);
        do { if (debugMode == (DEBUG_RANGEFINDER_QUALITY)) { debug[(3)] = (isSurfaceAltitudeValid()); } } while (0);
    ...
    do { if (debugMode == (DEBUG_RANGEFINDER)) { debug[(1)] = (rangefinder.rawAltitude); } } while (0);
    do { if (debugMode == (DEBUG_RANGEFINDER)) { debug[(2)] = (rangefinder.calculatedAltitude); } } while (0);

    return 
# 327 "./src/main/sensors/rangefinder.c" 3 4
          1
# 327 "./src/main/sensors/rangefinder.c"
              ;
}
...
# 343 "./src/main/sensors/rangefinder.c" 3 4
_Bool 
# 343 "./src/main/sensors/rangefinder.c"
    rangefinderIsHealthy(void)
{
