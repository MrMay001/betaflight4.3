# 1 "./src/main/startup/system_stm32f7xx.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/startup/system_stm32f7xx.c"
# 66 "./src/main/startup/system_stm32f7xx.c"
...
# 67 "./src/main/startup/system_stm32f7xx.c" 2
...
# 68 "./src/main/startup/system_stm32f7xx.c" 2
...
# 69 "./src/main/startup/system_stm32f7xx.c" 2
...
# 153 "./src/main/platform.h" 2
# 70 "./src/main/startup/system_stm32f7xx.c" 2
...
# 71 "./src/main/startup/system_stm32f7xx.c" 2
# 129 "./src/main/startup/system_stm32f7xx.c"
  uint32_t SystemCoreClock;
  uint32_t pll_p = ((uint32_t)0x00000002U), pll_n = 432, pll_q = 9;

  const uint8_t AHBPrescTable[16] = {0, 0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4, 6, 7, 8, 9};
  const uint8_t APBPrescTable[8] = {0, 0, 0, 0, 1, 2, 3, 4};
# 145 "./src/main/startup/system_stm32f7xx.c"
  void SystemClock_Config(void)
  {
      ...
      do { volatile uint32_t tmpreg; (((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1)) = ((((((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1))) & (~((0x3UL << (14U))))) | (((0x3UL << (14U))))))); tmpreg = ((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1) & ((0x3UL << (14U)))); ((void)(tmpreg)); } while(0);
# 169 "./src/main/startup/system_stm32f7xx.c"
      ...
      PeriphClkInitStruct.PeriphClockSelection = ((uint32_t)0x00200000U);
      PeriphClkInitStruct.Clk48ClockSelection = (0x1UL << (27U));
      PeriphClkInitStruct.PLLSAI.PLLSAIN = 384;
      PeriphClkInitStruct.PLLSAI.PLLSAIQ = 7;
      PeriphClkInitStruct.PLLSAI.PLLSAIP = ((uint32_t)0x00000003U);
      ...
      ret = HAL_RCC_ClockConfig(&RCC_ClkInitStruct, 0x00000007U);
      if (ret != HAL_OK) {
        while (1);
      }

      PeriphClkInitStruct.PeriphClockSelection = ((uint32_t)0x00000040U)|((uint32_t)0x00000080U)
                                  |((uint32_t)0x00000100U)|((uint32_t)0x00000800U)
                                  |((uint32_t)0x00000200U)|((uint32_t)0x00000400U)
                                  |((uint32_t)0x00001000U)|((uint32_t)0x00002000U)
                                  |((uint32_t)0x00004000U)|((uint32_t)0x00010000U)
                                  |((uint32_t)0x00008000U)|((uint32_t)0x00020000U);
      ...
      PeriphClkInitStruct.Uart4ClockSelection = ((uint32_t)0x00000000U);
      PeriphClkInitStruct.Uart5ClockSelection = ((uint32_t)0x00000000U);
      PeriphClkInitStruct.Usart6ClockSelection = ((uint32_t)0x00000000U);
      PeriphClkInitStruct.Uart7ClockSelection = ((uint32_t)0x00000000U);
      PeriphClkInitStruct.Uart8ClockSelection = ((uint32_t)0x00000000U);



      PeriphClkInitStruct.I2c1ClockSelection = ((uint32_t)0x00000000U);
      PeriphClkInitStruct.I2c2ClockSelection = ((uint32_t)0x00000000U);
      ...
      PeriphClkInitStruct.PeriphClockSelection = ((uint32_t)0x02000000U);
    ...
    do {((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->DCKCFGR1 &= ~((0x1UL << (24U))); ((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->DCKCFGR1 |= ((0x1UL << (24U))); }while(0);
...
static const pllConfig_t overclockLevels[] = {
  { 432, ((uint32_t)0x00000002U), 9 },
  { 480, ((uint32_t)0x00000002U), 10 },
};
...
# 314 "./src/main/startup/system_stm32f7xx.c"
void SystemInit(void)
{
    uint32_t bootloaderRequest = persistentObjectRead(PERSISTENT_OBJECT_RESET_REASON);

    if (bootloaderRequest == 2) {
    ...
    if (vtorOffset % 0x200 != 0) {

        while (1);
    }
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = vtorOffset;
...
# 425 "./src/main/startup/system_stm32f7xx.c"
void SystemCoreClockUpdate(void)
{
    ...
    case 0x08:
        ...
        if (pllsource != 0) {
            ...
            pllvco = (8000000 / pllm) * ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLCFGR & (0x1FFUL << (6U))) >> 6);
        } else {
