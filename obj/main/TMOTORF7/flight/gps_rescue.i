...
# 32 "./src/main/flight/gps_rescue.c" 2
...
# 211 "./src/main/io/gps.h"
                        state);
# 34 "./src/main/flight/gps_rescue.c" 2
...
void mwDisarm(void);
# 40 "./src/main/flight/gps_rescue.c" 2
...
# 45 "./src/main/flight/gps_rescue.c" 2


# 1 "./src/main/pg/pg_ids.h" 1
# 21 "./src/main/pg/pg_ids.h"
       
# 48 "./src/main/flight/gps_rescue.c" 2
...
# 50 "./src/main/flight/gps_rescue.c" 2
...
# 52 "./src/main/flight/gps_rescue.c" 2
...
# 54 "./src/main/flight/gps_rescue.c" 2
...
# 102 "./src/main/flight/gps_rescue.c" 3 4
   _Bool 
# 102 "./src/main/flight/gps_rescue.c"
        healthy;
} rescueSensorData_s;

typedef struct {
    
# 106 "./src/main/flight/gps_rescue.c" 3 4
   _Bool 
# 106 "./src/main/flight/gps_rescue.c"
        bumpDetection;
    
# 107 "./src/main/flight/gps_rescue.c" 3 4
   _Bool 
# 107 "./src/main/flight/gps_rescue.c"
...
# 115 "./src/main/flight/gps_rescue.c" 3 4
   _Bool 
# 115 "./src/main/flight/gps_rescue.c"
        isFailsafe;
    
# 116 "./src/main/flight/gps_rescue.c" 3 4
   _Bool 
# 116 "./src/main/flight/gps_rescue.c"
        isAvailable;
} rescueState_s;
...
# 153 "./src/main/flight/gps_rescue.c"
extern const gpsRescueConfig_t pgResetTemplate_gpsRescueConfig; gpsRescueConfig_t gpsRescueConfig_System; gpsRescueConfig_t gpsRescueConfig_Copy; uint32_t gpsRescueConfig_fnv_hash; extern const pgRegistry_t gpsRescueConfig_Registry; const pgRegistry_t gpsRescueConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 55 | (1 << 12), .length = 1, .size = sizeof(gpsRescueConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&gpsRescueConfig_System, .fnv_hash = &gpsRescueConfig_fnv_hash, .copy = (uint8_t*)&gpsRescueConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_gpsRescueConfig}, };

const gpsRescueConfig_t pgResetTemplate_gpsRescueConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .angle = 32, .initialAltitudeM = 50, .descentDistanceM = 200, .rescueGroundspeed = 2000, .throttleP = 150, .throttleI = 20, .throttleD = 50, .velP = 80, .velI = 20, .velD = 15, .yawP = 40, .throttleMin = 1100, .throttleMax = 1600, .throttleHover = 1280, .sanityChecks = RESCUE_SANITY_ON, .minSats = 8, .minRescueDth = 100, .allowArmingWithoutFix = 
# 155 "./src/main/flight/gps_rescue.c" 3 4
0
# 155 "./src/main/flight/gps_rescue.c"
, .useMag = 
# 155 "./src/main/flight/gps_rescue.c" 3 4
1
# 155 "./src/main/flight/gps_rescue.c"
, .targetLandingAltitudeM = 5, .targetLandingDistanceM = 10, .altitudeMode = MAX_ALT, .ascendRate = 500, .descendRate = 150, .rescueAltitudeBufferM = 15, }
# 181 "./src/main/flight/gps_rescue.c"
 ;
...
# 191 "./src/main/flight/gps_rescue.c" 3 4
_Bool 
# 191 "./src/main/flight/gps_rescue.c"
             magForceDisable = 
# 191 "./src/main/flight/gps_rescue.c" 3 4
                               0
# 191 "./src/main/flight/gps_rescue.c"
...
static 
# 193 "./src/main/flight/gps_rescue.c" 3 4
      _Bool 
# 193 "./src/main/flight/gps_rescue.c"
           newGPSData = 
# 193 "./src/main/flight/gps_rescue.c" 3 4
                        0
# 193 "./src/main/flight/gps_rescue.c"
...
{
    newGPSData = 
# 204 "./src/main/flight/gps_rescue.c" 3 4
                1
# 204 "./src/main/flight/gps_rescue.c"
                    ;
}
...
static void idleTasks()
{
    ...
    rescueState.sensor.maxAltitudeCm = __extension__ ({ __typeof__ (rescueState.sensor.currentAltitudeCm) _a = (rescueState.sensor.currentAltitudeCm); __typeof__ (rescueState.sensor.maxAltitudeCm) _b = (rescueState.sensor.maxAltitudeCm); _a > _b ? _a : _b; });

    rescueState.sensor.maxDistanceToHomeM = __extension__ ({ __typeof__ (rescueState.sensor.distanceToHomeM) _a = (rescueState.sensor.distanceToHomeM); __typeof__ (rescueState.sensor.maxDistanceToHomeM) _b = (rescueState.sensor.maxDistanceToHomeM); _a > _b ? _a : _b; });
...
static void setBearing(int16_t desiredHeading)
{
    ...
    rescueYaw = -constrainf(errorAngle / 45 * 180, -180, 180);
}
...
static void rescueAttainPosition()
{
    ...
    do { if (debugMode == (DEBUG_RTH)) { debug[(3)] = (rescueState.failure); } } while (0);
    ...
    const float ct = cosf(((gpsRescueAngle[AI_PITCH] / 10) / 10.0f * 0.0174532925f));
    ...
    float scalingRate;
    if (__extension__ ({ __typeof__ (altitudeError) _x = (altitudeError); _x > 0 ? _x : -_x; }) > 0 && __extension__ ({ __typeof__ (altitudeError) _x = (altitudeError); _x > 0 ? _x : -_x; }) < 300) {
        scalingRate = (float)altitudeError / 300;
    } else {
        scalingRate = 1;
    }
    ...
    if (altitudeError > 0) {
        ...
        if (rescueState.sensor.currentAltitudeCm <= 500) {
            const int16_t rescueLandingDescendVel = __extension__ ({ __typeof__ (80 * rescueState.sensor.currentAltitudeCm / 500) _a = (80 * rescueState.sensor.currentAltitudeCm / 500); __typeof__ (50) _b = (50); _a > _b ? _a : _b; });
    ...
    if (__extension__ ({ __typeof__ (zVelocityError) _x = (zVelocityError); _x > 0 ? _x : -_x; }) < 100) {
        zVelocityIntegral = constrainf(zVelocityIntegral + zVelocityError / 100.0f, -250.0f, 250.0f);
    } else {
        zVelocityIntegral = 0;
    }
    ...
    do { if (debugMode == (DEBUG_RTH)) { debug[(0)] = (rescueThrottle); } } while (0);
    do { if (debugMode == (DEBUG_RTH)) { debug[(1)] = (gpsRescueAngle[AI_PITCH]); } } while (0);
    do { if (debugMode == (DEBUG_RTH)) { debug[(2)] = (altitudeAdjustment); } } while (0);

    do { if (debugMode == (DEBUG_GPS_RESCUE_THROTTLE_PID)) { debug[(0)] = (throttle.Kp * zVelocityError); } } while (0);
    do { if (debugMode == (DEBUG_GPS_RESCUE_THROTTLE_PID)) { debug[(1)] = (throttle.Ki * zVelocityIntegral); } } while (0);
    do { if (debugMode == (DEBUG_GPS_RESCUE_THROTTLE_PID)) { debug[(2)] = (throttle.Kd * zVelocityDerivative); } } while (0);
    do { if (debugMode == (DEBUG_GPS_RESCUE_THROTTLE_PID)) { debug[(3)] = (rescueState.sensor.zVelocity); } } while (0);
}

static void performSanityChecks()
{
    static uint32_t previousTimeUs = 0;
    static int8_t secondsStalled = 0;
    static uint16_t lastDistanceToHomeM = 0;
...
# 407 "./src/main/flight/gps_rescue.c" 3 4
                                                                                                     1
# 407 "./src/main/flight/gps_rescue.c"
                                                                                                         )) {
    ...
    if (rescueState.phase == RESCUE_CROSSTRACK) {
        ...
        if (secondsFlyingAway == 10) {
            ...
            if (sensors(SENSOR_MAG) && gpsRescueConfig()->useMag && !magForceDisable) {
                ...
                magForceDisable = 
# 446 "./src/main/flight/gps_rescue.c" 3 4
                                 1
# 446 "./src/main/flight/gps_rescue.c"
                                     ;
                secondsFlyingAway = 0;
            } else
...
static void sensorUpdate()
{
    ...
    if (newGPSData) {
        ...
        rescueState.sensor.accMagnitude = (float) sqrtf(((acc.accADC[Z])*(acc.accADC[Z])) + ((acc.accADC[X])*(acc.accADC[X])) + ((acc.accADC[Y])*(acc.accADC[Y]))) * acc.dev.acc_1G_rec;
...
static 
# 498 "./src/main/flight/gps_rescue.c" 3 4
      _Bool 
# 498 "./src/main/flight/gps_rescue.c"
           checkGPSRescueIsAvailable(void)
{
    static uint32_t previousTimeUs = 0;
    const uint32_t currentTimeUs = micros();
    static int8_t secondsLowSats = 0;
    static 
# 503 "./src/main/flight/gps_rescue.c" 3 4
          _Bool 
# 503 "./src/main/flight/gps_rescue.c"
               lowsats = 
# 503 "./src/main/flight/gps_rescue.c" 3 4
                         0
# 503 "./src/main/flight/gps_rescue.c"
                              ;
    static 
# 504 "./src/main/flight/gps_rescue.c" 3 4
          _Bool 
# 504 "./src/main/flight/gps_rescue.c"
               noGPSfix = 
# 504 "./src/main/flight/gps_rescue.c" 3 4
                          0
# 504 "./src/main/flight/gps_rescue.c"
...
# 505 "./src/main/flight/gps_rescue.c" 3 4
   _Bool 
# 505 "./src/main/flight/gps_rescue.c"
        result = 
# 505 "./src/main/flight/gps_rescue.c" 3 4
                 1
# 505 "./src/main/flight/gps_rescue.c"
    ...
    if (!gpsIsHealthy() || !(stateFlags & (GPS_FIX_HOME))) {
        return 
# 508 "./src/main/flight/gps_rescue.c" 3 4
              0
# 508 "./src/main/flight/gps_rescue.c"
                   ;
    }
    ...
    if (dTime < 1000000) {
        if (noGPSfix || lowsats) {
            result = 
# 515 "./src/main/flight/gps_rescue.c" 3 4
                    0
# 515 "./src/main/flight/gps_rescue.c"
                         ;
        }
        return result;
    }
    ...
    if (!(stateFlags & (GPS_FIX))) {
        result = 
# 523 "./src/main/flight/gps_rescue.c" 3 4
                0
# 523 "./src/main/flight/gps_rescue.c"
                     ;
        noGPSfix = 
# 524 "./src/main/flight/gps_rescue.c" 3 4
                  1
# 524 "./src/main/flight/gps_rescue.c"
                      ;
    } else {
        noGPSfix = 
# 526 "./src/main/flight/gps_rescue.c" 3 4
                  0
# 526 "./src/main/flight/gps_rescue.c"
                       ;
    }
    ...
    if (secondsLowSats == 2) {
        lowsats = 
# 531 "./src/main/flight/gps_rescue.c" 3 4
                 1
# 531 "./src/main/flight/gps_rescue.c"
                     ;
        result = 
# 532 "./src/main/flight/gps_rescue.c" 3 4
                0
# 532 "./src/main/flight/gps_rescue.c"
                     ;
    } else {
        lowsats = 
# 534 "./src/main/flight/gps_rescue.c" 3 4
                 0
# 534 "./src/main/flight/gps_rescue.c"
                      ;
    }
...
void updateGPSRescueState(void)
{
    ...
    case RESCUE_INITIALIZE:
        ...
        throttle.Kp = gpsRescueConfig()->throttleP * 0.0003125f;
        throttle.Ki = gpsRescueConfig()->throttleI * 0.1f;
        throttle.Kd = gpsRescueConfig()->throttleD * 0.0003125f;
        ...
        if (rescueState.sensor.distanceToHomeM < gpsRescueConfig()->descentDistanceM) {
            newDescentDistanceM = __extension__ ({ __typeof__ (rescueState.sensor.distanceToHomeM - 5) _a = (rescueState.sensor.distanceToHomeM - 5); __typeof__ (30) _b = (30); _a > _b ? _a : _b; });
        } else {
        ...
        switch (gpsRescueConfig()->altitudeMode) {
            ...
            case MAX_ALT:
            default:
                newAltitude = __extension__ ({ __typeof__ (gpsRescueConfig()->initialAltitudeM * 100) _a = (gpsRescueConfig()->initialAltitudeM * 100); __typeof__ (rescueState.sensor.maxAltitudeCm + gpsRescueConfig()->rescueAltitudeBufferM * 100) _b = (rescueState.sensor.maxAltitudeCm + gpsRescueConfig()->rescueAltitudeBufferM * 100); _a > _b ? _a : _b; });
                break;
        }
    ...
    case RESCUE_ATTAIN_ALT:
        ...
        if (__extension__ ({ __typeof__ (rescueState.intent.targetAltitudeCm - rescueState.sensor.currentAltitudeCm) _x = (rescueState.intent.targetAltitudeCm - rescueState.sensor.currentAltitudeCm); _x > 0 ? _x : -_x; }) < 1000) {
...
# 632 "./src/main/flight/gps_rescue.c" 3 4
                                       1
# 632 "./src/main/flight/gps_rescue.c"
                                           ;
    ...
    case RESCUE_CROSSTRACK:
        ...
        rescueState.intent.targetAltitudeCm = newAltitude;
        rescueState.intent.crosstrack = 
# 645 "./src/main/flight/gps_rescue.c" 3 4
                                       1
# 645 "./src/main/flight/gps_rescue.c"
                                           ;
    ...
    case RESCUE_LANDING_APPROACH:
        ...
        const int32_t newAlt = __extension__ ({ __typeof__ ((lineSlope * rescueState.sensor.distanceToHomeM + lineOffsetM) * 100) _a = ((lineSlope * rescueState.sensor.distanceToHomeM + lineOffsetM) * 100); __typeof__ (0) _b = (0); _a > _b ? _a : _b; });


        if (rescueState.sensor.distanceToHomeM <= 200) {
            newSpeed = gpsRescueConfig()->rescueGroundspeed * rescueState.sensor.distanceToHomeM / 200;
        }
        ...
        rescueState.intent.crosstrack = 
# 665 "./src/main/flight/gps_rescue.c" 3 4
                                       1
# 665 "./src/main/flight/gps_rescue.c"
                                           ;
        rescueState.intent.minAngleDeg = 10;
        rescueState.intent.maxAngleDeg = gpsRescueConfig()->angle;
        break;
    case RESCUE_LANDING:
        ...
        if (rescueState.sensor.currentAltitudeCm < 100) {
        ...
        rescueState.intent.crosstrack = 
# 687 "./src/main/flight/gps_rescue.c" 3 4
                                       1
# 687 "./src/main/flight/gps_rescue.c"
                                           ;
    ...
    newGPSData = 
# 709 "./src/main/flight/gps_rescue.c" 3 4
                0
# 709 "./src/main/flight/gps_rescue.c"
                     ;
}
...
# 728 "./src/main/flight/gps_rescue.c" 3 4
_Bool 
# 728 "./src/main/flight/gps_rescue.c"
    gpsRescueIsConfigured(void)
{
...
# 733 "./src/main/flight/gps_rescue.c" 3 4
_Bool 
# 733 "./src/main/flight/gps_rescue.c"
    gpsRescueIsAvailable(void)
{
...
# 738 "./src/main/flight/gps_rescue.c" 3 4
_Bool 
# 738 "./src/main/flight/gps_rescue.c"
    gpsRescueIsDisabled(void)
{
    return (!(stateFlags & (GPS_FIX_HOME)));
}



# 744 "./src/main/flight/gps_rescue.c" 3 4
_Bool 
# 744 "./src/main/flight/gps_rescue.c"
    gpsRescueDisableMag(void)
{
