# 1 "./src/main/flight/rpm_filter.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/flight/rpm_filter.c"
# 22 "./src/main/flight/rpm_filter.c"
...
# 23 "./src/main/flight/rpm_filter.c" 2
...
# 24 "./src/main/flight/rpm_filter.c" 2
...
# 153 "./src/main/platform.h" 2
# 26 "./src/main/flight/rpm_filter.c" 2
...
# 30 "./src/main/flight/rpm_filter.c" 2
...
# 32 "./src/main/flight/rpm_filter.c" 2
...
# 33 "./src/main/flight/rpm_filter.c" 2
...
# 34 "./src/main/flight/rpm_filter.c" 2
...
# 36 "./src/main/flight/rpm_filter.c" 2
...
# 38 "./src/main/flight/rpm_filter.c" 2
...
# 39 "./src/main/flight/rpm_filter.c" 2
...
# 43 "./src/main/flight/rpm_filter.c" 2
...
# 45 "./src/main/flight/rpm_filter.c" 2
...
# 47 "./src/main/flight/rpm_filter.c" 2
...
static pt1Filter_t rpmFilters[8];
...
typedef struct rpmNotchFilter_s {
    ...
    biquadFilter_t notch[3][8][3];

} rpmNotchFilter_t;

__attribute__ ((section(".fastram_bss"), aligned(4))) static float erpmToHz;
__attribute__ ((section(".fastram_bss"), aligned(4))) static float filteredMotorErpm[8];
__attribute__ ((section(".fastram_bss"), aligned(4))) static float motorFrequency[8];
__attribute__ ((section(".fastram_bss"), aligned(4))) static float minMotorFrequency;
__attribute__ ((section(".fastram_bss"), aligned(4))) static uint8_t numberFilters;
__attribute__ ((section(".fastram_bss"), aligned(4))) static uint8_t numberRpmNotchFilters;
__attribute__ ((section(".fastram_bss"), aligned(4))) static uint8_t filterUpdatesPerIteration;
__attribute__ ((section(".fastram_bss"), aligned(4))) static float pidLooptime;
__attribute__ ((section(".fastram_bss"), aligned(4))) static rpmNotchFilter_t filters[2];
__attribute__ ((section(".fastram_bss"), aligned(4))) static rpmNotchFilter_t *gyroFilter;

__attribute__ ((section(".fastram_bss"), aligned(4))) static uint8_t currentMotor;
__attribute__ ((section(".fastram_bss"), aligned(4))) static uint8_t currentHarmonic;
__attribute__ ((section(".fastram_bss"), aligned(4))) static uint8_t currentFilterNumber;
__attribute__ ((section(".fastram_data"), aligned(4))) static rpmNotchFilter_t *currentFilter = &filters[0];



extern void pgResetFn_rpmFilterConfig(rpmFilterConfig_t *); rpmFilterConfig_t rpmFilterConfig_System; rpmFilterConfig_t rpmFilterConfig_Copy; uint32_t rpmFilterConfig_fnv_hash; extern const pgRegistry_t rpmFilterConfig_Registry; const pgRegistry_t rpmFilterConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 544 | (5 << 12), .length = 1, .size = sizeof(rpmFilterConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&rpmFilterConfig_System, .fnv_hash = &rpmFilterConfig_fnv_hash, .copy = (uint8_t*)&rpmFilterConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_rpmFilterConfig }, };
...
static void rpmNotchFilterInit(rpmNotchFilter_t *filter, const rpmFilterConfig_t *config, const timeUs_t looptimeUs)
{
    ...
    filter->maxHz = 0.48f * 1e6f / looptimeUs;
...
void rpmFilterInit(const rpmFilterConfig_t *config)
{
    ...
    if (!motorConfig()->dev.useDshotTelemetry) {
        gyroFilter = 
# 125 "./src/main/flight/rpm_filter.c" 3 4
                    ((void *)0)
# 125 "./src/main/flight/rpm_filter.c"
                        ;
        return;
    }
    ...
    if (config->rpm_filter_harmonics) {
        ...
        gyroFilter = 
# 134 "./src/main/flight/rpm_filter.c" 3 4
                    ((void *)0)
# 134 "./src/main/flight/rpm_filter.c"
                        ;
    }
    ...
    erpmToHz = 100.0f / 60.0f / (motorConfig()->motorPoleCount / 2.0f);

    const float loopIterationsPerUpdate = 0.001f / (pidLooptime * 1e-6f);
...
{
    if (filter == 
# 151 "./src/main/flight/rpm_filter.c" 3 4
                 ((void *)0)
# 151 "./src/main/flight/rpm_filter.c"
                     ) {
        return value;
    }
    for (int motor = 0; motor < getMotorCount(); motor++) {
...
__attribute__((noinline)) void rpmFilterUpdate(void)
{
    for (int motor = 0; motor < getMotorCount(); motor++) {
        filteredMotorErpm[motor] = pt1FilterApply(&rpmFilters[motor], getDshotTelemetry(motor));
        if (motor < 4) {
            do { if (debugMode == (DEBUG_RPM_FILTER)) { debug[(motor)] = (motorFrequency[motor]); } } while (0);
        }
        motorFrequency[motor] = erpmToHz * filteredMotorErpm[motor];
    }

    if (gyroFilter == 
# 177 "./src/main/flight/rpm_filter.c" 3 4
                     ((void *)0)
# 177 "./src/main/flight/rpm_filter.c"
                         ) {
...
# 226 "./src/main/flight/rpm_filter.c" 3 4
_Bool 
# 226 "./src/main/flight/rpm_filter.c"
    isRpmFilterEnabled(void)
{
