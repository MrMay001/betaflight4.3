# 1 "./src/main/flight/dyn_notch_filter.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/flight/dyn_notch_filter.c"
# 31 "./src/main/flight/dyn_notch_filter.c"
...
# 32 "./src/main/flight/dyn_notch_filter.c" 2
...
# 33 "./src/main/flight/dyn_notch_filter.c" 2
...
# 153 "./src/main/platform.h" 2
# 35 "./src/main/flight/dyn_notch_filter.c" 2
...
# 38 "./src/main/flight/dyn_notch_filter.c" 2
...
# 40 "./src/main/flight/dyn_notch_filter.c" 2
...
# 41 "./src/main/flight/dyn_notch_filter.c" 2
...
# 42 "./src/main/flight/dyn_notch_filter.c" 2
# 1 "./src/main/common/sdft.h" 1
# 24 "./src/main/common/sdft.h"
       


# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/arm-none-eabi/include/complex.h" 1 3
# 17 "/opt/gcc-arm-none-eabi-9-2020-q2-update/arm-none-eabi/include/complex.h" 3





# 21 "/opt/gcc-arm-none-eabi-9-2020-q2-update/arm-none-eabi/include/complex.h" 3
...
# 89 "/opt/gcc-arm-none-eabi-9-2020-q2-update/arm-none-eabi/include/complex.h" 3
...
# 151 "/opt/gcc-arm-none-eabi-9-2020-q2-update/arm-none-eabi/include/complex.h" 3

# 28 "./src/main/common/sdft.h" 2


# 29 "./src/main/common/sdft.h"
typedef float 
# 29 "./src/main/common/sdft.h" 3
             _Complex 
# 29 "./src/main/common/sdft.h"
                     complex_t;
...
# 43 "./src/main/flight/dyn_notch_filter.c" 2
...
# 46 "./src/main/flight/dyn_notch_filter.c" 2
...
# 48 "./src/main/flight/dyn_notch_filter.c" 2
...
# 50 "./src/main/flight/dyn_notch_filter.c" 2
...
# 52 "./src/main/flight/dyn_notch_filter.c" 2
# 91 "./src/main/flight/dyn_notch_filter.c"
typedef enum {
...
typedef struct dynNotch_s {
    ...
    int maxCenterFreq;
    float centerFreq[3][5];

    timeUs_t looptimeUs;
    biquadFilter_t notch[3][5];

} dynNotch_t;


static __attribute__ ((section(".fastram_bss"), aligned(4))) dynNotch_t dynNotch;


static __attribute__ ((section(".fastram_bss"), aligned(4))) int sampleIndex;
static __attribute__ ((section(".fastram_bss"), aligned(4))) int sampleCount;
static __attribute__ ((section(".fastram_bss"), aligned(4))) float sampleCountRcp;
static __attribute__ ((section(".fastram_bss"), aligned(4))) float sampleAccumulator[3];


static __attribute__ ((section(".fastram_bss"), aligned(4))) float sampleAvg[3];


static __attribute__ ((section(".fastram_bss"), aligned(4))) state_t state;
static __attribute__ ((section(".fastram_bss"), aligned(4))) sdft_t sdft[3];
static __attribute__ ((section(".fastram_bss"), aligned(4))) peak_t peaks[5];
static __attribute__ ((section(".fastram_bss"), aligned(4))) float sdftData[(72 / 2)];
static __attribute__ ((section(".fastram_bss"), aligned(4))) float sdftSampleRateHz;
static __attribute__ ((section(".fastram_bss"), aligned(4))) float sdftResolutionHz;
static __attribute__ ((section(".fastram_bss"), aligned(4))) int sdftStartBin;
static __attribute__ ((section(".fastram_bss"), aligned(4))) int sdftEndBin;
static __attribute__ ((section(".fastram_bss"), aligned(4))) float sdftNoiseThreshold;
static __attribute__ ((section(".fastram_bss"), aligned(4))) float pt1LooptimeS;
...
void dynNotchInit(const dynNotchConfig_t *config, const timeUs_t targetLooptimeUs)
{
    ...
    dynNotch.maxHz = __extension__ ({ __typeof__ (2 * dynNotch.minHz) _a = (2 * dynNotch.minHz); __typeof__ (config->dyn_notch_max_hz) _b = (config->dyn_notch_max_hz); _a > _b ? _a : _b; });
    ...
    sampleCount = __extension__ ({ __typeof__ (1) _a = (1); __typeof__ (looprateHz / (2 * dynNotch.maxHz)) _b = (looprateHz / (2 * dynNotch.maxHz)); _a > _b ? _a : _b; });
    ...
    sdftResolutionHz = sdftSampleRateHz / 72;
    sdftStartBin = __extension__ ({ __typeof__ (2) _a = (2); __typeof__ (dynNotch.minHz / sdftResolutionHz + 0.5f) _b = (dynNotch.minHz / sdftResolutionHz + 0.5f); _a > _b ? _a : _b; });
    sdftEndBin = __extension__ ({ __typeof__ ((72 / 2) - 1) _a = ((72 / 2) - 1); __typeof__ (dynNotch.maxHz / sdftResolutionHz + 0.5f) _b = (dynNotch.maxHz / sdftResolutionHz + 0.5f); _a < _b ? _a : _b; });
    pt1LooptimeS = (3 * STEP_COUNT) / looprateHz;
...
__attribute__((section(".tcm_code"))) __attribute__((optimize("-O2"))) void dynNotchPush(const int axis, const float sample)
{
...
__attribute__((section(".tcm_code"))) __attribute__((optimize("-O2"))) void dynNotchUpdate(void)
{
    ...
    if (sampleIndex == sampleCount) {
        ...
        for (int axis = 0; axis < 3; axis++) {
            ...
            if (axis == gyro.gyroDebugAxis) {
                do { if (debugMode == (DEBUG_FFT)) { debug[(2)] = (lrintf(sampleAvg[axis])); } } while (0);
            }
        }
...
static __attribute__((noinline)) void dynNotchProcess(void)
{
    ...
    do { if (debugMode == (DEBUG_FFT_TIME)) { debug[(0)] = (state.step); } } while (0);
    ...
    switch (state.step) {
        ...
        case STEP_WINDOW:
        {
            ...
            for (int bin = (sdftStartBin + 1); bin < sdftEndBin; bin++) {
                sdftNoiseThreshold += sdftData[bin];
            }

            do { if (debugMode == (DEBUG_FFT_TIME)) { debug[(1)] = (micros() - startTime); } } while (0);
        ...
        case STEP_CALC_FREQUENCIES:
        {
            ...
            for (int p = 0; p < dynNotch.count; p++) {
                ...
                if (peaks[p].bin != 0 && peaks[p].value > sdftNoiseThreshold) {
                    ...
                    const float gain = pt1FilterGain(4 * cutoffMult, pt1LooptimeS);
            ...
            if(calculateThrottlePercentAbs() > 20) {
                for (int p = 0; p < dynNotch.count; p++) {
                    dynNotch.maxCenterFreq = __extension__ ({ __typeof__ (dynNotch.maxCenterFreq) _a = (dynNotch.maxCenterFreq); __typeof__ (dynNotch.centerFreq[state.axis][p]) _b = (dynNotch.centerFreq[state.axis][p]); _a > _b ? _a : _b; });
                }
            }

            if (state.axis == gyro.gyroDebugAxis) {
                for (int p = 0; p < dynNotch.count && p < 3; p++) {
                    do { if (debugMode == (DEBUG_FFT_FREQ)) { debug[(p)] = (lrintf(dynNotch.centerFreq[state.axis][p])); } } while (0);
                }
                do { if (debugMode == (DEBUG_DYN_LPF)) { debug[(1)] = (lrintf(dynNotch.centerFreq[state.axis][0])); } } while (0);
            }
...
__attribute__((section(".tcm_code"))) __attribute__((optimize("-O2"))) float dynNotchFilter(const int axis, float value)
{
    for (int p = 0; p < dynNotch.count; p++) {
...
# 412 "./src/main/flight/dyn_notch_filter.c" 3 4
_Bool 
# 412 "./src/main/flight/dyn_notch_filter.c"
    isDynNotchActive(void)
{
