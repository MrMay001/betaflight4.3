# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash.c"
# 85 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash.c"
...
# 86 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash.c" 2
# 114 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash.c"
FLASH_ProcessTypeDef pFlash;
# 124 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash.c"
...
HAL_StatusTypeDef FLASH_WaitForLastOperation(uint32_t Timeout);
# 164 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash.c"
HAL_StatusTypeDef HAL_FLASH_Program(uint32_t TypeProgram, uint32_t Address, uint64_t Data)
{
...
# 233 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash.c"
HAL_StatusTypeDef HAL_FLASH_Program_IT(uint32_t TypeProgram, uint32_t Address, uint64_t Data)
{
...
void HAL_FLASH_IRQHandler(void)
{
  ...
  ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR &= (~(0x1UL << (1U)));
  ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR &= ((uint32_t)0xFFFFFF07U);
  ...
  if(pFlash.ProcedureOnGoing == FLASH_PROC_NONE)
  {
    ...
    (((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR &= ~(uint32_t)(((uint32_t)0x02000000U)));
...
# 430 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash.c"
...
# 448 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash.c"
...
# 480 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash.c"
HAL_StatusTypeDef HAL_FLASH_Unlock(void)
{
  HAL_StatusTypeDef status = HAL_OK;
  ...
  if(((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR) & ((0x1UL << (31U)))) != RESET)
  {
    ...
    ((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->KEYR) = (((uint32_t)0x45670123U)));
    ((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->KEYR) = (((uint32_t)0xCDEF89ABU)));
...
HAL_StatusTypeDef HAL_FLASH_OB_Unlock(void)
{
  if((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR & (0x1UL << (0U))) != RESET)
  {
    ...
    ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTKEYR = ((uint32_t)0x08192A3BU);
    ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTKEYR = ((uint32_t)0x4C5D6E7FU);
  }
  else
  {
    return HAL_ERROR;
...
HAL_StatusTypeDef HAL_FLASH_OB_Launch(void)
{
  ...
  ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR |= (0x1UL << (1U));


  return(FLASH_WaitForLastOperation((uint32_t)((uint32_t)50000U)));
}
# 584 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash.c"
uint32_t HAL_FLASH_GetError(void)
{
   return pFlash.ErrorCode;
}
# 598 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash.c"
HAL_StatusTypeDef FLASH_WaitForLastOperation(uint32_t Timeout)
{
...
# 653 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash.c"
static void FLASH_Program_DoubleWord(uint32_t Address, uint64_t Data)
{
  ...
  ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR |= ((uint32_t)(0x3UL << (8U)));
  ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR |= (0x1UL << (0U));
...
# 685 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash.c"
static void FLASH_Program_Word(uint32_t Address, uint32_t Data)
{
  ...
  ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR &= ((uint32_t)0xFFFFFCFFU);
  ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR |= ((uint32_t)(0x2UL << (8U)));
  ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR |= (0x1UL << (0U));
...
# 714 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash.c"
static void FLASH_Program_HalfWord(uint32_t Address, uint16_t Data)
{
  ...
  ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR &= ((uint32_t)0xFFFFFCFFU);
  ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR |= ((uint32_t)(0x1UL << (8U)));
  ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR |= (0x1UL << (0U));
...
# 744 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash.c"
static void FLASH_Program_Byte(uint32_t Address, uint8_t Data)
{
  ...
  ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR &= ((uint32_t)0xFFFFFCFFU);
  ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR |= ((uint32_t)0x00000000U);
  ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR |= (0x1UL << (0U));
...
static void FLASH_SetErrorCode(void)
{
  ...
  {
   pFlash.ErrorCode |= ((uint32_t)0x00000040U);
  }



  (((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->SR = (((0x1UL << (1U)) | (0x1UL << (4U)) | (0x1UL << (5U)) | (0x1UL << (6U)) | (0x1UL << (7U)) | (0x1UL << (8U)))));
}
