# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c"
# 58 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c"
...
# 59 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c" 2
# 91 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c"
static HAL_StatusTypeDef PCD_WriteEmptyTxFifo(PCD_HandleTypeDef *hpcd, uint32_t epnum);
static HAL_StatusTypeDef PCD_EP_OutXfrComplete_int(PCD_HandleTypeDef *hpcd, uint32_t epnum);
static HAL_StatusTypeDef PCD_EP_OutSetupPacket_int(PCD_HandleTypeDef *hpcd, uint32_t epnum);
# 123 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_Init(PCD_HandleTypeDef *hpcd)
{
  uint8_t i;
  ...
  if (hpcd == 
# 128 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c" 3 4
             ((void *)0)
# 128 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c"
                 )
  {
    return HAL_ERROR;
  }
...
# 163 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c"
...
HAL_StatusTypeDef HAL_PCD_DeInit(PCD_HandleTypeDef *hpcd)
{
  ...
  if (hpcd == 
# 236 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c" 3 4
             ((void *)0)
# 236 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c"
                 )
  {
    return HAL_ERROR;
  }
...
# 256 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c"
...
# 906 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_Start(PCD_HandleTypeDef *hpcd)
{
...
void HAL_PCD_IRQHandler(PCD_HandleTypeDef *hpcd)
{
  ...
  if (USB_GetMode(hpcd->Instance) == 0U)
  {
    ...
    if (((USB_ReadInterrupts((hpcd)->Instance) & ((0x1UL << (19U)))) == ((0x1UL << (19U)))))
    {
      ...
      while (ep_intr != 0U)
      {
        if ((ep_intr & 0x1U) != 0U)
        {
          ...
          {
            (((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPINT = ((0x1UL << (0U))));
          ...
          if ((epint & (0x1UL << (3U))) == (0x1UL << (3U)))
          {
            ...
            (((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPINT = ((0x1UL << (3U))));
          }

          if ((epint & (0x1UL << (4U))) == (0x1UL << (4U)))
          {
            (((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPINT = ((0x1UL << (4U))));
          }
          ...
          if ((epint & (0x1UL << (5U))) == (0x1UL << (5U)))
          {
            ...
            (((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPINT = ((0x1UL << (5U))));
          }


          if ((epint & (0x1UL << (13U))) == (0x1UL << (13U)))
          {
            (((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPINT = ((0x1UL << (13U))));
          }
        }
        epnum++;
        ep_intr >>= 1U;
      ...
      while (ep_intr != 0U)
      {
        if ((ep_intr & 0x1U) != 0U)
        {
          ...
          if ((epint & (0x1UL << (0U))) == (0x1UL << (0U)))
          {
            ...
            ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DIEPEMPMSK &= ~fifoemptymsk;

            (((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPINT = ((0x1UL << (0U))));
          ...
          if ((epint & (0x1UL << (3U))) == (0x1UL << (3U)))
          {
            (((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPINT = ((0x1UL << (3U))));
          }
          if ((epint & (0x1UL << (4U))) == (0x1UL << (4U)))
          {
            (((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPINT = ((0x1UL << (4U))));
          }
          if ((epint & (0x1UL << (6U))) == (0x1UL << (6U)))
          {
            (((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPINT = ((0x1UL << (6U))));
          }
          if ((epint & (0x1UL << (1U))) == (0x1UL << (1U)))
          {
            (((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPINT = ((0x1UL << (1U))));
          }
    ...
    if (((USB_ReadInterrupts((hpcd)->Instance) & ((0x1UL << (27U)))) == ((0x1UL << (27U)))))
    {
      (((hpcd)->Instance->GINTSTS) &= ((0x1UL << (27U))));

      if (hpcd->LPM_State == LPM_L0)
      {
        hpcd->LPM_State = LPM_L1;
        hpcd->BESL = (hpcd->Instance->GLPMCFG & (0xFUL << (2U))) >> 2U;
    ...
    if (((USB_ReadInterrupts((hpcd)->Instance) & ((0x1UL << (12U)))) == ((0x1UL << (12U)))))
    {
      ...
      for (i = 0U; i < hpcd->Init.dev_endpoints; i++)
      {
        ...
        ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((i) * 0x0020UL)))->DIEPCTL &= ~(0x1UL << (21U));
        ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((i) * 0x0020UL)))->DOEPINT = 0xFB7FU;
        ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((i) * 0x0020UL)))->DOEPCTL &= ~(0x1UL << (21U));
      }
      ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DAINTMSK |= 0x10001U;

      if (hpcd->Init.use_dedicated_ep1 != 0U)
      {
        ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DOUTEP1MSK |= (0x1UL << (3U)) |
                                   (0x1UL << (0U)) |
                                   (0x1UL << (1U));

        ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DINEP1MSK |= (0x1UL << (3U)) |
                                  (0x1UL << (0U)) |
                                  (0x1UL << (1U));
      }
      else
      {
        ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DOEPMSK |= (0x1UL << (3U)) |
                                (0x1UL << (0U)) |
                                (0x1UL << (1U)) |
                                (0x1UL << (5U)) |
                                (0x1UL << (13U));

        ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DIEPMSK |= (0x1UL << (3U)) |
                                (0x1UL << (0U)) |
                                (0x1UL << (1U));
      }
...
# 1334 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c"
...
# 1524 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_DevConnect(PCD_HandleTypeDef *hpcd)
{
  do{ if((hpcd)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hpcd)->Lock = HAL_LOCKED; } }while (0U);
  (void)USB_DevConnect(hpcd->Instance);
...
# 1567 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_EP_Open(PCD_HandleTypeDef *hpcd, uint8_t ep_addr, uint16_t ep_mps, uint8_t ep_type)
{
...
# 1642 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_EP_Receive(PCD_HandleTypeDef *hpcd, uint8_t ep_addr, uint8_t *pBuf, uint32_t len)
{
  PCD_EPTypeDef *ep;
...
# 1690 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_EP_Transmit(PCD_HandleTypeDef *hpcd, uint8_t ep_addr, uint8_t *pBuf, uint32_t len)
{
  PCD_EPTypeDef *ep;
...
# 1865 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c"
PCD_StateTypeDef HAL_PCD_GetState(PCD_HandleTypeDef *hpcd)
{
  return hpcd->State;
}
# 1889 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c"
static HAL_StatusTypeDef PCD_WriteEmptyTxFifo(PCD_HandleTypeDef *hpcd, uint32_t epnum)
{
  USB_OTG_GlobalTypeDef *USBx = hpcd->Instance;
  uint32_t USBx_BASE = (uint32_t)USBx;
  ...
  while (((((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DTXFSTS & (0xFFFFUL << (0U))) >= len32b) &&
...
# 1949 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c"
static HAL_StatusTypeDef PCD_EP_OutXfrComplete_int(PCD_HandleTypeDef *hpcd, uint32_t epnum)
{
  USB_OTG_GlobalTypeDef *USBx = hpcd->Instance;
  uint32_t USBx_BASE = (uint32_t)USBx;
  uint32_t gSNPSiD = *(volatile uint32_t *)(&USBx->CID + 0x1U);
  uint32_t DoepintReg = ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPINT;
  ...
  if (hpcd->Init.dma_enable == 1U)
  {
    if ((DoepintReg & (0x1UL << (3U))) == (0x1UL << (3U)))
    {
      ...
      {
        (((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPINT = ((0x1UL << (15U))));
      }
...
# 2059 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pcd.c"
static HAL_StatusTypeDef PCD_EP_OutSetupPacket_int(PCD_HandleTypeDef *hpcd, uint32_t epnum)
{
  USB_OTG_GlobalTypeDef *USBx = hpcd->Instance;
  uint32_t USBx_BASE = (uint32_t)USBx;
