# 1 "./src/main/vcp_hal/usbd_desc.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/vcp_hal/usbd_desc.c"
# 49 "./src/main/vcp_hal/usbd_desc.c"
...
# 50 "./src/main/vcp_hal/usbd_desc.c" 2
...
# 51 "./src/main/vcp_hal/usbd_desc.c" 2
# 1 "./src/main/vcp_hal/usbd_conf.h" 1
# 52 "./src/main/vcp_hal/usbd_desc.c" 2
...
# 56 "./src/main/vcp_hal/usbd_desc.c" 2
...
# 57 "./src/main/vcp_hal/usbd_desc.c" 2
...
# 59 "./src/main/vcp_hal/usbd_desc.c" 2
# 83 "./src/main/vcp_hal/usbd_desc.c"
...
USBD_DescriptorsTypeDef VCP_Desc = {
 ...
 uint8_t USBD_DeviceDesc[0x12U] __attribute__ ((aligned (4))) = {
  0x12,
  0x01U,
  0x00,
  0x02,
  ...
  0x00,
  64U,
  ((uint8_t)(0x0483 & 0x00FFU)),
  ((uint8_t)((0x0483 & 0xFF00U) >> 8U)),
  ((uint8_t)(0x5740 & 0x00FFU)),
  ((uint8_t)((0x5740 & 0xFF00U) >> 8U)),
  0x00,
  0x02,
  0x01U,
  0x02U,
...
extern uint8_t USBD_HID_CDC_DeviceDescriptor[0x12U];
 ...
 uint8_t USBD_MSC_DeviceDesc[0x12U] __attribute__ ((aligned (4))) =
{
  0x12,
  0x01U,
  0x00,
  ...
  ((uint8_t)(0x0483 & 0x00FFU)),
  ((uint8_t)((0x0483 & 0xFF00U) >> 8U)),
  ((uint8_t)(22314 & 0x00FFU)),
  ((uint8_t)((22314 & 0xFF00U) >> 8U)),
  0x00,
  0x02,
  0x01U,
  0x02U,
 ...
 uint8_t USBD_LangIDDesc[0x04U] __attribute__ ((aligned (4))) = {
  0x04U,
  0x03U,
  ((uint8_t)(0x409 & 0x00FFU)),
  ((uint8_t)((0x409 & 0xFF00U) >> 8U)),
};
...
uint8_t USBD_StringSerial[0x1A] =
{
 ...
 uint8_t USBD_StrDesc[0x100] __attribute__ ((aligned (4)));
...
uint8_t *USBD_VCP_ProductStrDescriptor(USBD_SpeedTypeDef speed, uint16_t *length)
{
  ...
  {
    USBD_GetString((uint8_t *)"TMOTORF7", USBD_StrDesc, length);
  }
  else
  {
    USBD_GetString((uint8_t *)"TMOTORF7", USBD_StrDesc, length);
...
static void Get_SerialNum(void)
{
  ...
  deviceserial0 = (*(uint32_t*)0x1FF07A10UL);
  deviceserial1 = (*(uint32_t*)(0x1FF07A10UL + 4));
  deviceserial2 = (*(uint32_t*)(0x1FF07A10UL + 8));
...
# 341 "./src/main/vcp_hal/usbd_desc.c"
static void IntToUnicode (uint32_t value , uint8_t *pbuf , uint8_t len)
{
  uint8_t idx = 0;
