# 1 "./src/main/vcp_hal/usbd_cdc_interface.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/vcp_hal/usbd_cdc_interface.c"
# 50 "./src/main/vcp_hal/usbd_cdc_interface.c"
...
# 153 "./src/main/platform.h" 2
# 51 "./src/main/vcp_hal/usbd_cdc_interface.c" 2
...
# 53 "./src/main/vcp_hal/usbd_cdc_interface.c" 2
...
# 55 "./src/main/vcp_hal/usbd_cdc_interface.c" 2
...
# 56 "./src/main/vcp_hal/usbd_cdc_interface.c" 2
...
# 57 "./src/main/vcp_hal/usbd_cdc_interface.c" 2
...
# 58 "./src/main/vcp_hal/usbd_cdc_interface.c" 2
...
# 63 "./src/main/vcp_hal/usbd_cdc_interface.c" 2
...
# 64 "./src/main/vcp_hal/usbd_cdc_interface.c" 2
# 74 "./src/main/vcp_hal/usbd_cdc_interface.c"
...
volatile uint8_t UserRxBuffer[2048];
volatile uint8_t UserTxBuffer[2048];
uint32_t BuffLength;
...
uint8_t* rxBuffPtr = 
# 91 "./src/main/vcp_hal/usbd_cdc_interface.c" 3 4
                    ((void *)0)
# 91 "./src/main/vcp_hal/usbd_cdc_interface.c"
                        ;
...
# 114 "./src/main/vcp_hal/usbd_cdc_interface.c"
...
# 142 "./src/main/vcp_hal/usbd_cdc_interface.c"
static int8_t CDC_Itf_Init(void)
{
  ...
  ctrlLineStateCb = 
# 159 "./src/main/vcp_hal/usbd_cdc_interface.c" 3 4
                   ((void *)0)
# 159 "./src/main/vcp_hal/usbd_cdc_interface.c"
                       ;
  baudRateCb = 
# 160 "./src/main/vcp_hal/usbd_cdc_interface.c" 3 4
              ((void *)0)
# 160 "./src/main/vcp_hal/usbd_cdc_interface.c"
                  ;
...
# 185 "./src/main/vcp_hal/usbd_cdc_interface.c"
static int8_t CDC_Itf_Control (uint8_t cmd, uint8_t* pbuf, uint16_t length)
{
...
# 274 "./src/main/vcp_hal/usbd_cdc_interface.c" 3 4
           _Bool 
# 274 "./src/main/vcp_hal/usbd_cdc_interface.c"
                needZeroLengthPacket = lastBuffsize % 64 == 0;
...
# 315 "./src/main/vcp_hal/usbd_cdc_interface.c"
...
# 344 "./src/main/vcp_hal/usbd_cdc_interface.c"
static void TIM_Config(void)
{

  TimHandle.Instance = ((TIM_TypeDef *) (0x40000000UL + 0x1400UL));
  ...
  TimHandle.Init.Period = (5*1000) - 1;
...
uint32_t CDC_Receive_DATA(uint8_t* recvBuf, uint32_t len)
{
    uint32_t count = 0;
    if ( (rxBuffPtr != 
# 389 "./src/main/vcp_hal/usbd_cdc_interface.c" 3 4
                      ((void *)0)
# 389 "./src/main/vcp_hal/usbd_cdc_interface.c"
                          ))
    {
...
uint32_t CDC_Send_FreeBytes(void)
{
    ...
    for ( uint8_t __basepri_save __attribute__ ((__cleanup__ (__basepriRestoreMem), __unused__)) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((6)<<(4-(7-(((uint32_t)0x00000005U)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005U))))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
        freeBytes = ((UserTxBufPtrOut - UserTxBufPtrIn) + (-((int)(UserTxBufPtrOut <= UserTxBufPtrIn)) & 2048)) - 1;
    }

    return freeBytes;
}
# 435 "./src/main/vcp_hal/usbd_cdc_interface.c"
uint32_t CDC_Send_DATA(const uint8_t *ptrBuffer, uint32_t sendLength)
{
    for (uint32_t i = 0; i < sendLength; i++) {
        ...
        for ( uint8_t __basepri_save __attribute__ ((__cleanup__ (__basepriRestoreMem), __unused__)) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((6)<<(4-(7-(((uint32_t)0x00000005U)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005U))))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
            ...
            UserTxBufPtrIn = (UserTxBufPtrIn + 1) % 2048;
        }
    }
    return sendLength;
}
# 458 "./src/main/vcp_hal/usbd_cdc_interface.c"
uint8_t usbIsConfigured(void)
{
    return (USBD_Device.dev_state == 0x03U);
}
# 470 "./src/main/vcp_hal/usbd_cdc_interface.c"
uint8_t usbIsConnected(void)
{
    return (USBD_Device.dev_state != 0x01U);
}
# 482 "./src/main/vcp_hal/usbd_cdc_interface.c"
uint32_t CDC_BaudRate(void)
{
    return LineCoding.bitrate;
}
# 494 "./src/main/vcp_hal/usbd_cdc_interface.c"
void CDC_SetBaudRateCb(void (*cb)(void *context, uint32_t baud), void *context)
{
    baudRateCbContext = context;
    baudRateCb = cb;
}
# 507 "./src/main/vcp_hal/usbd_cdc_interface.c"
void CDC_SetCtrlLineStateCb(void (*cb)(void *context, uint16_t ctrlLineState), void *context)
{
