# 1 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c"
# 49 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c"
...
# 50 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c" 2
...
# 52 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c" 2
...
# 53 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c" 2
...
# 54 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c" 2
...
# 55 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c" 2
# 1 "./src/main/vcp_hal/usbd_conf.h" 1
# 56 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c" 2
...
# 57 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c" 2
...
# 60 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c" 2
...
# 61 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c" 2
...
# 64 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c" 2
...
# 80 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c"
...
void HAL_PCD_MspInit(PCD_HandleTypeDef *hpcd)
{
  ...
  if (hpcd->Instance == ((USB_OTG_GlobalTypeDef *) 0x50000000UL))
  {
    ...
    GPIO_InitStruct.Pin = (((uint16_t)0x0800U) | ((uint16_t)0x1000U));
...
# 127 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c"
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2ENR) |= ((0x1UL << (7U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2ENR) & ((0x1UL << (7U)))); ((void)(tmpreg)); do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR) |= ((0x1UL << (14U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR) & ((0x1UL << (14U)))); ((void)(tmpreg)); } while(0); } while(0);
  ...
  else if (hpcd->Instance == ((USB_OTG_GlobalTypeDef *) 0x40040000UL))
  {
# 159 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c"
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) |= ((0x1UL << (0U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) & ((0x1UL << (0U)))); ((void)(tmpreg)); } while(0);
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) |= ((0x1UL << (1U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) & ((0x1UL << (1U)))); ((void)(tmpreg)); } while(0);
    ...
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) |= ((0x1UL << (7U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) & ((0x1UL << (7U)))); ((void)(tmpreg)); } while(0);
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) |= ((0x1UL << (8U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) & ((0x1UL << (8U)))); ((void)(tmpreg)); } while(0);
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x0001U) | ((uint16_t)0x0002U) | ((uint16_t)0x0020U) |
      ((uint16_t)0x0400U) | ((uint16_t)0x0800U) | ((uint16_t)0x1000U) | ((uint16_t)0x2000U);
    GPIO_InitStruct.Mode = ((uint32_t)0x00000002U);
    GPIO_InitStruct.Pull = ((uint32_t)0x00000000U);
    GPIO_InitStruct.Alternate = ((uint8_t)0xAU);
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x0001U);
    GPIO_InitStruct.Mode = ((uint32_t)0x00000002U);
    GPIO_InitStruct.Pull = ((uint32_t)0x00000000U);
    GPIO_InitStruct.Alternate = ((uint8_t)0xAU);
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x0010U);
    GPIO_InitStruct.Mode = ((uint32_t)0x00000002U);
    GPIO_InitStruct.Pull = ((uint32_t)0x00000000U);
    GPIO_InitStruct.Alternate = ((uint8_t)0xAU);
    ...
    GPIO_InitStruct.Pull = ((uint32_t)0x00000000U);
    GPIO_InitStruct.Alternate = ((uint8_t)0xAU);
    HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x2000UL)), &GPIO_InitStruct);
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) |= ((0x1UL << (30U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) & ((0x1UL << (30U)))); ((void)(tmpreg)); } while(0);


    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) |= ((0x1UL << (29U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) & ((0x1UL << (29U)))); ((void)(tmpreg)); } while(0);
...
# 252 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c"
void HAL_PCD_SetupStageCallback(PCD_HandleTypeDef *hpcd)
{
...
# 392 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c"
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{


  hpcd.Instance = ((USB_OTG_GlobalTypeDef *) 0x50000000UL);
  hpcd.Init.dev_endpoints = 4;
  hpcd.Init.use_dedicated_ep1 = 0;
  hpcd.Init.ep0_mps = 0x40;
  hpcd.Init.dma_enable = 0;
  hpcd.Init.low_power_enable = 0;
  hpcd.Init.phy_itface = 2U;
...
# 474 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c"
  return USBD_OK;
}
...
# 518 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c"
USBD_StatusTypeDef USBD_LL_OpenEP(USBD_HandleTypeDef *pdev,
                                  uint8_t ep_addr,
                                  uint8_t ep_type,
                                  uint16_t ep_mps)
...
# 619 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c"
USBD_StatusTypeDef USBD_LL_Transmit(USBD_HandleTypeDef *pdev,
                                    uint8_t ep_addr,
                                    uint8_t *pbuf,
                                    uint16_t size)
...
# 636 "./src/main/vcp_hal/usbd_conf_stm32f7xx.c"
USBD_StatusTypeDef USBD_LL_PrepareReceive(USBD_HandleTypeDef *pdev,
                                          uint8_t ep_addr,
                                          uint8_t *pbuf,
                                          uint16_t size)
