# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr.c"
# 26 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr.c"
...
# 27 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr.c" 2
# 100 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr.c"
void HAL_PWR_DeInit(void)
{
  (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1RSTR |= ((0x1UL << (28U))));
  (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1RSTR &= ~((0x1UL << (28U))));
}
# 113 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr.c"
void HAL_PWR_EnableBkUpAccess(void)
{

  ((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1) |= ((0x1UL << (8U))));
}
# 126 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr.c"
void HAL_PWR_DisableBkUpAccess(void)
{

 ((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1) &= ~((0x1UL << (8U))));
}
# 260 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr.c"
void HAL_PWR_ConfigPVD(PWR_PVDTypeDef *sConfigPVD)
{
  ...
  (((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1)) = ((((((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1))) & (~((0x7UL << (5U))))) | (sConfigPVD->PVDLevel))));
...
# 336 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr.c"
void HAL_PWR_EnableWakeUpPin(uint32_t WakeUpPinPolarity)
{
  ((void)0U);


  ((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CSR2) |= ((((uint32_t)0x00003F00) & WakeUpPinPolarity)));



  (((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR2)) = ((((((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR2))) & (~((((uint32_t)0x00003F00) & WakeUpPinPolarity)))) | ((WakeUpPinPolarity >> 0x06)))));
}
# 360 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr.c"
void HAL_PWR_DisableWakeUpPin(uint32_t WakeUpPinx)
{
  ((void)0U);

  ((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CSR2) &= ~(WakeUpPinx));
}
# 387 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr.c"
void HAL_PWR_EnterSLEEPMode(uint32_t Regulator, uint8_t SLEEPEntry)
{
  ((void)(Regulator));
...
# 436 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr.c"
void HAL_PWR_EnterSTOPMode(uint32_t Regulator, uint8_t STOPEntry)
{
  uint32_t tmpreg = 0;
  ...
  tmpreg = ((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1;

  tmpreg &= (uint32_t)~((0x1UL << (1U)) | (0x1UL << (0U)));


  tmpreg |= Regulator;


  ((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1 = tmpreg;
...
# 489 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr.c"
void HAL_PWR_EnterSTANDBYMode(void)
{

  ((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1 |= (0x1UL << (1U));
...
# 542 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr.c"
void HAL_PWR_EnableSleepOnExit(void)
{
