# 1 "./src/main/io/displayport_hott.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/io/displayport_hott.c"
# 21 "./src/main/io/displayport_hott.c"
# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include/stdbool.h" 1 3 4
# 22 "./src/main/io/displayport_hott.c" 2
...
# 23 "./src/main/io/displayport_hott.c" 2
...
# 24 "./src/main/io/displayport_hott.c" 2
...
# 153 "./src/main/platform.h" 2
# 26 "./src/main/io/displayport_hott.c" 2
...
# 30 "./src/main/io/displayport_hott.c" 2
...
# 31 "./src/main/io/displayport_hott.c" 2

displayPort_t hottDisplayPort;

static 
# 34 "./src/main/io/displayport_hott.c" 3 4
      _Bool 
# 34 "./src/main/io/displayport_hott.c"
           hottDrawScreen(displayPort_t *displayPort)
{
    ((void)(displayPort));
    return 0;
}
...
static 
# 76 "./src/main/io/displayport_hott.c" 3 4
      _Bool 
# 76 "./src/main/io/displayport_hott.c"
           hottIsTransferInProgress(const displayPort_t *displayPort)
{
    ((void)(displayPort));
    return 
# 79 "./src/main/io/displayport_hott.c" 3 4
          0
# 79 "./src/main/io/displayport_hott.c"
               ;
}
...
static int hottHeartbeat(displayPort_t *displayPort)
{
    if (!hottTextmodeIsAlive()) {
        cmsMenuExit(displayPort, (void*)(1));
    }
...
static uint32_t hottTxBytesFree(const displayPort_t *displayPort)
{
    ((void)(displayPort));
    return 
# 99 "./src/main/io/displayport_hott.c" 3 4
          (0xffffffffUL)
# 99 "./src/main/io/displayport_hott.c"
                    ;
}
...
static const displayPortVTable_t hottVTable = {
    ...
    .layerSupported = 
# 128 "./src/main/io/displayport_hott.c" 3 4
                     ((void *)0)
# 128 "./src/main/io/displayport_hott.c"
                         ,
    .layerSelect = 
# 129 "./src/main/io/displayport_hott.c" 3 4
                  ((void *)0)
# 129 "./src/main/io/displayport_hott.c"
                      ,
    .layerCopy = 
# 130 "./src/main/io/displayport_hott.c" 3 4
                ((void *)0)
# 130 "./src/main/io/displayport_hott.c"
                    ,
};

static displayPort_t *displayPortHottInit()
{
    hottDisplayPort.device = 
# 135 "./src/main/io/displayport_hott.c" 3 4
                            ((void *)0)
# 135 "./src/main/io/displayport_hott.c"
                                ;
    displayInit(&hottDisplayPort, &hottVTable, DISPLAYPORT_DEVICE_TYPE_HOTT);
    hottDisplayPort.useFullscreen = 
# 137 "./src/main/io/displayport_hott.c" 3 4
                                   1
# 137 "./src/main/io/displayport_hott.c"
                                       ;
    hottDisplayPort.rows = 8;
    hottDisplayPort.cols = 21;
...
# 156 "./src/main/io/displayport_hott.c" 3 4
                                   _Bool 
# 156 "./src/main/io/displayport_hott.c"
                                        keepCmsOpen)
{
    switch (hottKey) {
        case 0xB:
        ...
        case 0x9:
            if (cmsInMenu) {
                cmsMenuExit(pCurrentDisplay, (void*)(1));
            }
