...
# 62 "./src/main/io/beeper.c" 2
# 86 "./src/main/io/beeper.c"
static timeUs_t lastDshotBeaconCommandTimeUs;
# 99 "./src/main/io/beeper.c"
...
# 187 "./src/main/io/beeper.c"
static 
# 187 "./src/main/io/beeper.c" 3 4
      _Bool 
# 187 "./src/main/io/beeper.c"
           beeperIsOn = 
# 187 "./src/main/io/beeper.c" 3 4
...
static const beeperTableEntry_t beeperTable[] = {
    ...
    { BEEPER_ARMING_GPS_FIX,5,beep_armingGpsFix,"ARMING_GPS_FIX" },
    { BEEPER_ARMING_GPS_NO_FIX,6,beep_armingGpsNoFix,"ARMING_GPS_NO_FIX" },
    ...
    { BEEPER_ACC_CALIBRATION,11,beep_2shortBeeps,"ACC_CALIBRATION" },
    { BEEPER_ACC_CALIBRATION_FAIL,12,beep_2longerBeeps,"ACC_CALIBRATION_FAIL" },
...
# 226 "./src/main/io/beeper.c" 3 4
     ((void *)0)
# 226 "./src/main/io/beeper.c"
     ,"SYSTEM_INIT" },
    { BEEPER_USB,18,
# 227 "./src/main/io/beeper.c" 3 4
     ((void *)0)
# 227 "./src/main/io/beeper.c"
     ,"ON_USB" },
    { BEEPER_BLACKBOX_ERASE,19,beep_2shortBeeps,"BLACKBOX_ERASE" },
    { BEEPER_CRASH_FLIP_MODE,20,beep_2longerBeeps,"CRASH_FLIP" },
    { BEEPER_CAM_CONNECTION_OPEN,21,beep_camOpenBeep,"CAM_CONNECTION_OPEN" },
    { BEEPER_CAM_CONNECTION_CLOSE,22,beep_camCloseBeep,"CAM_CONNECTION_CLOSE" },
    { BEEPER_RC_SMOOTHING_INIT_FAIL,23,beep_rcSmoothingInitFail,"RC_SMOOTHING_INIT_FAIL" },
    { BEEPER_ALL,24,
# 233 "./src/main/io/beeper.c" 3 4
     ((void *)0)
# 233 "./src/main/io/beeper.c"
     ,"ALL" },
};

static const beeperTableEntry_t *currentBeeperEntry = 
# 236 "./src/main/io/beeper.c" 3 4
                                                     ((void *)0)
# 236 "./src/main/io/beeper.c"
                                                         ;
...
void beeper(beeperMode_e mode)
{
    if (
        mode == BEEPER_SILENCE || (
            (beeperConfig()->beeper_off_flags & (1 << (BEEPER_USB - 1)))
...
# 256 "./src/main/io/beeper.c" 3 4
                                                 ((void *)0)
# 256 "./src/main/io/beeper.c"
                                                     ;
...
{
    systemBeep(
# 287 "./src/main/io/beeper.c" 3 4
   0
# 287 "./src/main/io/beeper.c"
   );
    beeperIsOn = 
# 288 "./src/main/io/beeper.c" 3 4
                0
# 288 "./src/main/io/beeper.c"
                     ;
    ...
    currentBeeperEntry = 
# 296 "./src/main/io/beeper.c" 3 4
                        ((void *)0)
# 296 "./src/main/io/beeper.c"
                            ;
}
...
void beeperUpdate(timeUs_t currentTimeUs)
{
    ...
    if (currentBeeperEntry == 
# 394 "./src/main/io/beeper.c" 3 4
                             ((void *)0)
# 394 "./src/main/io/beeper.c"
                                 ) {
        return;
    }
...
# 419 "./src/main/io/beeper.c"
        ...
        if (currentBeeperEntry->sequence[beeperPos] != 0) {
            systemBeep(
# 434 "./src/main/io/beeper.c" 3 4
           0
# 434 "./src/main/io/beeper.c"
           );
            beeperIsOn = 
# 435 "./src/main/io/beeper.c" 3 4
                        0
# 435 "./src/main/io/beeper.c"
                             ;
    ...
    static 
# 443 "./src/main/io/beeper.c" 3 4
          _Bool 
# 443 "./src/main/io/beeper.c"
               beeperWasOn = 
# 443 "./src/main/io/beeper.c" 3 4
                             0
# 443 "./src/main/io/beeper.c"
...
# 445 "./src/main/io/beeper.c" 3 4
                               1
# 445 "./src/main/io/beeper.c"
                                   );
    }
...
# 504 "./src/main/io/beeper.c" 3 4
                                                                                      ((void *)0)
# 504 "./src/main/io/beeper.c"
                                                                                          ;
}
...
# 518 "./src/main/io/beeper.c" 3 4
_Bool 
# 518 "./src/main/io/beeper.c"
    isBeeperOn(void)
{
    return beeperIsOn;
}
# 541 "./src/main/io/beeper.c"
timeUs_t getLastDshotBeaconCommandTimeUs(void)
{
