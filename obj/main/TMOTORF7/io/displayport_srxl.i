...
# 30 "./src/main/io/displayport_srxl.c" 2
...
# 36 "./src/main/io/displayport_srxl.c" 2
...
# 38 "./src/main/io/displayport_srxl.c" 2

displayPort_t srxlDisplayPort;

static 
# 41 "./src/main/io/displayport_srxl.c" 3 4
      _Bool 
# 41 "./src/main/io/displayport_srxl.c"
           srxlDrawScreen(displayPort_t *displayPort)
{
    ((void)(displayPort));
    return 0;
}
...
static int srxlClearScreen(displayPort_t *displayPort, displayClearOption_e options)
{
    ...
    if (displayPort->grabCount == 0) {
        srxlWriteString(displayPort, 0, 2, DISPLAYPORT_ATTR_NONE, "MENU:THR MID");
        srxlWriteString(displayPort, 2, 3, DISPLAYPORT_ATTR_NONE, "+ YAW LEFT");
        srxlWriteString(displayPort, 2, 4, DISPLAYPORT_ATTR_NONE, "+ PITCH UP");
    }
    return 0;
}

static 
# 87 "./src/main/io/displayport_srxl.c" 3 4
      _Bool 
# 87 "./src/main/io/displayport_srxl.c"
           srxlIsTransferInProgress(const displayPort_t *displayPort)
{
    ((void)(displayPort));
    return 
# 90 "./src/main/io/displayport_srxl.c" 3 4
          0
# 90 "./src/main/io/displayport_srxl.c"
               ;
}

static 
# 93 "./src/main/io/displayport_srxl.c" 3 4
      _Bool 
# 93 "./src/main/io/displayport_srxl.c"
           srxlIsSynced(const displayPort_t *displayPort)
{
    ((void)(displayPort));
    return 
# 96 "./src/main/io/displayport_srxl.c" 3 4
          1
# 96 "./src/main/io/displayport_srxl.c"
              ;
}
...
static uint32_t srxlTxBytesFree(const displayPort_t *displayPort)
{
    ((void)(displayPort));
    return 
# 113 "./src/main/io/displayport_srxl.c" 3 4
          (0xffffffffUL)
# 113 "./src/main/io/displayport_srxl.c"
                    ;
}
...
static const displayPortVTable_t srxlVTable = {
    ...
    .layerSupported = 
# 141 "./src/main/io/displayport_srxl.c" 3 4
                     ((void *)0)
# 141 "./src/main/io/displayport_srxl.c"
                         ,
    .layerSelect = 
# 142 "./src/main/io/displayport_srxl.c" 3 4
                  ((void *)0)
# 142 "./src/main/io/displayport_srxl.c"
                      ,
    .layerCopy = 
# 143 "./src/main/io/displayport_srxl.c" 3 4
                ((void *)0)
# 143 "./src/main/io/displayport_srxl.c"
                    ,
};
...
# 148 "./src/main/io/displayport_srxl.c" 3 4
                            ((void *)0)
# 148 "./src/main/io/displayport_srxl.c"
                                ;
