...
# 24 "./src/main/io/vtx_control.c" 2
...
# 32 "./src/main/io/vtx_control.c" 2
...
void mwDisarm(void);
# 40 "./src/main/io/vtx_control.c" 2
...
# 46 "./src/main/io/vtx_control.c" 2


# 1 "./src/main/pg/pg_ids.h" 1
# 21 "./src/main/pg/pg_ids.h"
       
# 49 "./src/main/io/vtx_control.c" 2


extern const vtxConfig_t pgResetTemplate_vtxConfig; vtxConfig_t vtxConfig_System; vtxConfig_t vtxConfig_Copy; uint32_t vtxConfig_fnv_hash; extern const pgRegistry_t vtxConfig_Registry; const pgRegistry_t vtxConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 515 | (1 << 12), .length = 1, .size = sizeof(vtxConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&vtxConfig_System, .fnv_hash = &vtxConfig_fnv_hash, .copy = (uint8_t*)&vtxConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_vtxConfig}, };

const vtxConfig_t pgResetTemplate_vtxConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .halfDuplex = 
# 53 "./src/main/io/vtx_control.c" 3 4
1 
# 53 "./src/main/io/vtx_control.c"
}
...
void vtxCycleBandOrChannel(const uint8_t bandStep, const uint8_t channelStep)
{
    ...
    if (vtxDevice) {
        ...
        const 
# 147 "./src/main/io/vtx_control.c" 3 4
             _Bool 
# 147 "./src/main/io/vtx_control.c"
                  haveAllNeededInfo = vtxCommonGetBandAndChannel(vtxDevice, &band, &channel);
...
void vtxCyclePower(const uint8_t powerStep)
{
    ...
    if (vtxDevice) {
        uint8_t power = 0;
        const 
# 176 "./src/main/io/vtx_control.c" 3 4
             _Bool 
# 176 "./src/main/io/vtx_control.c"
                  haveAllNeededInfo = vtxCommonGetPowerIndex(vtxDevice, &power);
        if (!haveAllNeededInfo) {
            return;
        }
...
# 208 "./src/main/io/vtx_control.c"
void handleVTXControlButton(void)
{
# 281 "./src/main/io/vtx_control.c"
}
