...
# 48 "./src/main/io/vtx.c" 2


extern void pgResetFn_vtxSettingsConfig(vtxSettingsConfig_t *); vtxSettingsConfig_t vtxSettingsConfig_System; vtxSettingsConfig_t vtxSettingsConfig_Copy; uint32_t vtxSettingsConfig_fnv_hash; extern const pgRegistry_t vtxSettingsConfig_Registry; const pgRegistry_t vtxSettingsConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 259 | (1 << 12), .length = 1, .size = sizeof(vtxSettingsConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&vtxSettingsConfig_System, .fnv_hash = &vtxSettingsConfig_fnv_hash, .copy = (uint8_t*)&vtxSettingsConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_vtxSettingsConfig }, };
...
void pgResetFn_vtxSettingsConfig(vtxSettingsConfig_t *vtxSettingsConfig)
{
    ...
    vtxSettingsConfig->pitModeFreq = 0;
...
# 80 "./src/main/io/vtx.c" 3 4
   _Bool 
# 80 "./src/main/io/vtx.c"
        settingsUpdated = 
# 80 "./src/main/io/vtx.c" 3 4
                          0
# 80 "./src/main/io/vtx.c"
    ...
    if (vtxSettingsConfig()->band && freq != vtxSettingsConfig()->freq) {
        ...
        settingsUpdated = 
# 94 "./src/main/io/vtx.c" 3 4
                         1
# 94 "./src/main/io/vtx.c"
                             ;
    }
    ...
    if (vtxSettingsConfig()->pitModeFreq) {
        ...
        if (constrainedPitModeFreq != vtxSettingsConfig()->pitModeFreq) {
            ...
            settingsUpdated = 
# 103 "./src/main/io/vtx.c" 3 4
                             1
# 103 "./src/main/io/vtx.c"
                                 ;
        }
    }
...
static 
# 158 "./src/main/io/vtx.c" 3 4
      _Bool 
# 158 "./src/main/io/vtx.c"
           ...
           vtxProcessPower(vtxDevice_t *vtxDevice)
{
    ...
    if (vtxCommonGetPowerIndex(vtxDevice, &vtxPower)) {
        ...
        if (vtxPower != settings.power) {
            ...
            return 
# 181 "./src/main/io/vtx.c" 3 4
                  1
# 181 "./src/main/io/vtx.c"
                      ;
        }
    }
    return 
# 184 "./src/main/io/vtx.c" 3 4
          0
# 184 "./src/main/io/vtx.c"
               ;
}

static 
# 187 "./src/main/io/vtx.c" 3 4
      _Bool 
# 187 "./src/main/io/vtx.c"
...
# 189 "./src/main/io/vtx.c"
    ...
    unsigned vtxStatus;
    if (!(armingFlags & (ARMED)) && vtxCommonGetStatus(vtxDevice, &vtxStatus)) {
        
# 193 "./src/main/io/vtx.c" 3 4
       _Bool 
# 193 "./src/main/io/vtx.c"
        ...
        if (currPmSwitchState != prevPmSwitchState) {
            ...
            if (currPmSwitchState) {
                ...
                if (vtxSettingsConfig()->pitModeFreq) {
                    return 
# 201 "./src/main/io/vtx.c" 3 4
                          0
# 201 "./src/main/io/vtx.c"
                               ;
                }
...
# 205 "./src/main/io/vtx.c"
                    ...
                    return 
# 207 "./src/main/io/vtx.c" 3 4
                          1
# 207 "./src/main/io/vtx.c"
                              ;
                }
            } else {
                if (vtxStatus & VTX_STATUS_PIT_MODE) {
...
# 211 "./src/main/io/vtx.c"
                    ...
                    return 
# 213 "./src/main/io/vtx.c" 3 4
                          1
# 213 "./src/main/io/vtx.c"
                              ;
                }
            }
        }
    ...
    return 
# 219 "./src/main/io/vtx.c" 3 4
          0
# 219 "./src/main/io/vtx.c"
               ;
}

static 
# 222 "./src/main/io/vtx.c" 3 4
      _Bool 
# 222 "./src/main/io/vtx.c"
           vtxProcessStateUpdate(vtxDevice_t *vtxDevice)
{
    ...
    return (
# 237 "./src/main/io/vtx.c" 3 4
           _Bool
# 237 "./src/main/io/vtx.c"
...
# 254 "./src/main/io/vtx.c" 3 4
       _Bool 
# 254 "./src/main/io/vtx.c"
            vtxUpdatePending = 
# 254 "./src/main/io/vtx.c" 3 4
                               0
# 254 "./src/main/io/vtx.c"
