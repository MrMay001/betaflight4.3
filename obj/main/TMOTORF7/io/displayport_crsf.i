...
# 32 "./src/main/io/displayport_crsf.c" 2
...
# 36 "./src/main/io/displayport_crsf.c" 2
...
# 38 "./src/main/io/displayport_crsf.c" 2
...
static int crsfClearScreen(displayPort_t *displayPort, displayClearOption_e options)
{
    ...
    crsfScreen.updated = 
# 57 "./src/main/io/displayport_crsf.c" 3 4
                        0
# 57 "./src/main/io/displayport_crsf.c"
                             ;
    crsfScreen.reset = 
# 58 "./src/main/io/displayport_crsf.c" 3 4
                      1
# 58 "./src/main/io/displayport_crsf.c"
                          ;
...
static 
# 69 "./src/main/io/displayport_crsf.c" 3 4
      _Bool 
# 69 "./src/main/io/displayport_crsf.c"
           crsfDrawScreen(displayPort_t *displayPort)
{
    ((void)(displayPort));
    return 0;
}
...
static 
# 104 "./src/main/io/displayport_crsf.c" 3 4
      _Bool 
# 104 "./src/main/io/displayport_crsf.c"
           crsfIsTransferInProgress(const displayPort_t *displayPort)
{
    ((void)(displayPort));
    return 
# 107 "./src/main/io/displayport_crsf.c" 3 4
          0
# 107 "./src/main/io/displayport_crsf.c"
               ;
}

static 
# 110 "./src/main/io/displayport_crsf.c" 3 4
      _Bool 
# 110 "./src/main/io/displayport_crsf.c"
           crsfIsSynced(const displayPort_t *displayPort)
{
    ((void)(displayPort));
    return 
# 113 "./src/main/io/displayport_crsf.c" 3 4
          1
# 113 "./src/main/io/displayport_crsf.c"
              ;
}
...
static uint32_t crsfTxBytesFree(const displayPort_t *displayPort)
{
    ((void)(displayPort));
    return 
# 131 "./src/main/io/displayport_crsf.c" 3 4
          (0xffffffffUL)
# 131 "./src/main/io/displayport_crsf.c"
                    ;
}
...
static const displayPortVTable_t crsfDisplayPortVTable = {
    ...
    .layerSupported = 
# 147 "./src/main/io/displayport_crsf.c" 3 4
                     ((void *)0)
# 147 "./src/main/io/displayport_crsf.c"
                         ,
    .layerSelect = 
# 148 "./src/main/io/displayport_crsf.c" 3 4
                  ((void *)0)
# 148 "./src/main/io/displayport_crsf.c"
                      ,
    .layerCopy = 
# 149 "./src/main/io/displayport_crsf.c" 3 4
                ((void *)0)
# 149 "./src/main/io/displayport_crsf.c"
                    ,
};
...
void crsfDisplayPortRefresh(void)
{
    ...
    crsfScreen.updated = 
# 190 "./src/main/io/displayport_crsf.c" 3 4
                        1
# 190 "./src/main/io/displayport_crsf.c"
                            ;
    crsfScreen.reset = 
# 191 "./src/main/io/displayport_crsf.c" 3 4
                      1
# 191 "./src/main/io/displayport_crsf.c"
                          ;
    delayTransportUntilMs = millis() + 45;
}


# 195 "./src/main/io/displayport_crsf.c" 3 4
_Bool 
# 195 "./src/main/io/displayport_crsf.c"
    crsfDisplayPortIsReady(void)
{
    const timeMs_t currentTimeMs = millis();
    const 
# 198 "./src/main/io/displayport_crsf.c" 3 4
         _Bool 
# 198 "./src/main/io/displayport_crsf.c"
              delayExpired = (currentTimeMs > delayTransportUntilMs);
    const 
# 199 "./src/main/io/displayport_crsf.c" 3 4
         _Bool 
# 199 "./src/main/io/displayport_crsf.c"
              cmsReady = (cmsInMenu && (pCurrentDisplay == &crsfDisplayPort));
    return (
# 200 "./src/main/io/displayport_crsf.c" 3 4
           _Bool
# 200 "./src/main/io/displayport_crsf.c"
               )(delayExpired && cmsReady);
}
