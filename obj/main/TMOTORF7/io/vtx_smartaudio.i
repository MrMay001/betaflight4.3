...
int toupper (int __c);
int isblank (int __c);
# 28 "./src/main/io/vtx_smartaudio.c" 2
...
# 50 "./src/main/io/vtx_smartaudio.c" 2
# 62 "./src/main/io/vtx_smartaudio.c"
static serialPort_t *smartAudioSerialPort = 
# 62 "./src/main/io/vtx_smartaudio.c" 3 4
                                           ((void *)0)
# 62 "./src/main/io/vtx_smartaudio.c"
                                               ;
...
# 102 "./src/main/io/vtx_smartaudio.c"
...
smartAudioDevice_t saDevice = {
    ...
    .orfreq = 0,
    .willBootIntoPitMode = 
# 121 "./src/main/io/vtx_smartaudio.c" 3 4
                          0
# 121 "./src/main/io/vtx_smartaudio.c"
                               ,
};
...
# 138 "./src/main/io/vtx_smartaudio.c"
static uint8_t saSupportedNumPowerLevels = 8;
static uint16_t saSupportedPowerValues[8];



# 142 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 142 "./src/main/io/vtx_smartaudio.c"
    saDeferred = 
# 142 "./src/main/io/vtx_smartaudio.c" 3 4
                 1
# 142 "./src/main/io/vtx_smartaudio.c"
...
# 202 "./src/main/io/vtx_smartaudio.c"
...
# 296 "./src/main/io/vtx_smartaudio.c" 3 4
           _Bool 
# 296 "./src/main/io/vtx_smartaudio.c"
                newBootMode = (saDevice.mode & 4) || (saDevice.mode & 8);
        ...
        if (saDevice.version == 3) {
            ...
            saSupportedNumPowerLevels = constrain((int8_t)buf[8], 0, 8);
# 325 "./src/main/io/vtx_smartaudio.c"
            for ( int8_t i = 0; i < saSupportedNumPowerLevels; i++ ) {
                saSupportedPowerValues[i] = buf[9 + i + 1];
            }
        ...
        do { if (debugMode == (DEBUG_SMARTAUDIO)) { debug[(0)] = (saDevice.version * 100 + saDevice.mode); } } while (0);
        do { if (debugMode == (DEBUG_SMARTAUDIO)) { debug[(1)] = (saDevice.channel); } } while (0);
        do { if (debugMode == (DEBUG_SMARTAUDIO)) { debug[(2)] = (saDevice.freq); } } while (0);
        do { if (debugMode == (DEBUG_SMARTAUDIO)) { debug[(3)] = (saDevice.power); } } while (0);
        break;
...
static 
# 573 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 573 "./src/main/io/vtx_smartaudio.c"
           saQueueEmpty(void)
{
...
static 
# 578 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 578 "./src/main/io/vtx_smartaudio.c"
           saQueueFull(void)
{
...
static 
# 614 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 614 "./src/main/io/vtx_smartaudio.c"
...
void saSetMode(int mode)
{
    ...
    if (saDevice.version >= 3 && (mode & 4) &&
        ((mode & 1) || (mode & 2))) {
        saDevice.willBootIntoPitMode = 
# 674 "./src/main/io/vtx_smartaudio.c" 3 4
                                      1
# 674 "./src/main/io/vtx_smartaudio.c"
                                          ;
...
# 686 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 686 "./src/main/io/vtx_smartaudio.c"
    vtxSmartAudioInit(void)
{
# 705 "./src/main/io/vtx_smartaudio.c"
...
# 714 "./src/main/io/vtx_smartaudio.c" 3 4
                                                                                              ((void *)0)
# 714 "./src/main/io/vtx_smartaudio.c"
                                                                                                  , 
# 714 "./src/main/io/vtx_smartaudio.c" 3 4
                                                                                                    ((void *)0)
# 714 "./src/main/io/vtx_smartaudio.c"
    ...
    if (!smartAudioSerialPort) {
        return 
# 718 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 718 "./src/main/io/vtx_smartaudio.c"
                   ;
    }
    ...
    return 
# 736 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 736 "./src/main/io/vtx_smartaudio.c"
              ;
}
...
static void vtxSAProcess(vtxDevice_t *vtxDevice, timeUs_t currentTimeUs)
{
    ...
    if (smartAudioSerialPort == 
# 751 "./src/main/io/vtx_smartaudio.c" 3 4
                               ((void *)0)
# 751 "./src/main/io/vtx_smartaudio.c"
                                   ) {
        return;
    }
...
# 812 "./src/main/io/vtx_smartaudio.c"
            if (saDevice.version >= 2 ) {

                saDevice.willBootIntoPitMode = (saDevice.mode & 2) ? 
# 814 "./src/main/io/vtx_smartaudio.c" 3 4
                                                                                      1 
# 814 "./src/main/io/vtx_smartaudio.c"
                                                                                           : 
# 814 "./src/main/io/vtx_smartaudio.c" 3 4
                                                                                             0
# 814 "./src/main/io/vtx_smartaudio.c"
    ...
    if ((sa_outstanding != SA_CMD_NONE) && (nowMs - sa_lastTransmissionMs > 120)) {
        ...
        saSendQueue();
        lastCommandSentMs = nowMs;
    } else if ((nowMs - lastCommandSentMs < 1000)
               && (nowMs - sa_lastTransmissionMs >= 150)) {
        ;
        saGetSettings();
        saSendQueue();
    }
...
static 
# 862 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 862 "./src/main/io/vtx_smartaudio.c"
...
static 
# 879 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 879 "./src/main/io/vtx_smartaudio.c"
           saValidateBandAndChannel(uint8_t band, uint8_t channel)
{
    return (band >= 1 && band <= vtxTableBandCount &&
            channel >= 1 && channel <= vtxTableChannelCount);
}
...
static void vtxSASetBandAndChannel(vtxDevice_t *vtxDevice, uint8_t band, uint8_t channel)
{
    ...
    if (saValidateBandAndChannel(band, channel)) {
        ...
        buf[4] = ((band - 1) * (uint8_t)vtxTableChannelCount + (channel - 1));
        buf[5] = CRC8(buf, 5);
        ;
...
static void vtxSASetPitMode(vtxDevice_t *vtxDevice, uint8_t onoff)
{
    ...
    uint8_t newMode = onoff ? 0 : 4;

    if (saDevice.mode & 8) {
        newMode |= 2;
    }

    if ((saDevice.mode & 4) || (onoff && newMode == 0)) {
...
static 
# 982 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 982 "./src/main/io/vtx_smartaudio.c"
           vtxSAGetBandAndChannel(const vtxDevice_t *vtxDevice, uint8_t *pBand, uint8_t *pChannel)
{
    if (!vtxSAIsReady(vtxDevice)) {
        return 
# 985 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 985 "./src/main/io/vtx_smartaudio.c"
                   ;
    }
    ...
    if (saDevice.mode & 1) {
        ...
        *pChannel = 0;
        return 
# 991 "./src/main/io/vtx_smartaudio.c" 3 4
              1
# 991 "./src/main/io/vtx_smartaudio.c"
                  ;
    } else {
        *pBand = ((saDevice.channel) / (uint8_t)vtxTableChannelCount) + 1;
        *pChannel = ((saDevice.channel) % (uint8_t)vtxTableChannelCount) + 1;
        return 
# 995 "./src/main/io/vtx_smartaudio.c" 3 4
              1
# 995 "./src/main/io/vtx_smartaudio.c"
                  ;
    }
}

static 
# 999 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 999 "./src/main/io/vtx_smartaudio.c"
           vtxSAGetPowerIndex(const vtxDevice_t *vtxDevice, uint8_t *pIndex)
{
    if (!vtxSAIsReady(vtxDevice)) {
        return 
# 1002 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 1002 "./src/main/io/vtx_smartaudio.c"
                   ;
    }

    *pIndex = saDevice.power;
    return 
# 1006 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 1006 "./src/main/io/vtx_smartaudio.c"
              ;
}

static 
# 1009 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 1009 "./src/main/io/vtx_smartaudio.c"
           vtxSAGetFreq(const vtxDevice_t *vtxDevice, uint16_t *pFreq)
{
    if (!vtxSAIsReady(vtxDevice)) {
        return 
# 1012 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 1012 "./src/main/io/vtx_smartaudio.c"
                   ;
    }
    ...
    *pFreq = (saDevice.mode & 1) ? saDevice.freq :
             vtxCommonLookupFrequency(&vtxSmartAudio,
                                      ((saDevice.channel) / (uint8_t)vtxTableChannelCount) + 1,
                                      ((saDevice.channel) % (uint8_t)vtxTableChannelCount) + 1);
    return 
# 1020 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 1020 "./src/main/io/vtx_smartaudio.c"
              ;
}

static 
# 1023 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 1023 "./src/main/io/vtx_smartaudio.c"
           vtxSAGetStatus(const vtxDevice_t *vtxDevice, unsigned *status)
{
    if (!vtxSAIsReady(vtxDevice) || saDevice.version < 2) {
        return 
# 1026 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 1026 "./src/main/io/vtx_smartaudio.c"
                   ;
    }

    *status = (saDevice.mode & 2) ? VTX_STATUS_PIT_MODE : 0;

    return 
# 1031 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 1031 "./src/main/io/vtx_smartaudio.c"
              ;
}
...
static void vtxSASerializeCustomDeviceStatus(const vtxDevice_t *vtxDevice, sbuf_t *dst)
{
    ...
    sbufWriteU16(dst, saDevice.orfreq);
