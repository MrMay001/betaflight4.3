...
# 77 "./src/main/io/vtx_tramp.c" 3 4
                                      ((void *)0)
# 77 "./src/main/io/vtx_tramp.c"
                                          ;
...
static uint16_t trampCurConfPower = 0;
static uint16_t trampCurActPower = 0;
...
static uint8_t trampRetryCount = (20);
...
# 155 "./src/main/io/vtx_tramp.c"
           trampVtxRaceLockEnabled(void)
{
    return trampCurControlMode & (0x01);
}
    ...
    case 'v':
        {
            ...
            if (freq != 0) {
                ...
                trampCurControlMode = trampRespBuffer[6];
...
# 329 "./src/main/io/vtx_tramp.c" 3 4
   _Bool 
# 329 "./src/main/io/vtx_tramp.c"
    ...
    case TRAMP_STATUS_OFFLINE:
        {
            ...
            } else if (cmp32(currentTimeUs, trampLastTimeUs) >= (200 * 1000)) {
    ...
    case TRAMP_STATUS_ONLINE_MONITOR_FREQPWRPIT:
        {
            ...
            if (trampRetryCount > 0 && (cmp32(currentTimeUs, trampLastTimeUs) >= (200 * 1000))) {
                ...
                if (!trampVtxRaceLockEnabled() && (trampConfFreq != trampCurFreq)) {
                    ...
                    configUpdateRequired = 
# 378 "./src/main/io/vtx_tramp.c" 3 4
                                          1
# 378 "./src/main/io/vtx_tramp.c"
                                              ;
                    ...
                    configUpdateRequired = 
# 384 "./src/main/io/vtx_tramp.c" 3 4
                                          1
# 384 "./src/main/io/vtx_tramp.c"
                                              ;
                    ...
                    configUpdateRequired = 
# 390 "./src/main/io/vtx_tramp.c" 3 4
                                          1
# 390 "./src/main/io/vtx_tramp.c"
                                              ;
                }
            ...
            if (!configUpdateRequired) {
                ...
                if (cmp32(currentTimeUs, trampLastTimeUs) >= (1000 * 1000)) {
    ...
    case TRAMP_STATUS_ONLINE_CONFIG:
        {
            ...
            if (cmp32(currentTimeUs, trampLastTimeUs) >= (200 * 1000)) {
    ...
    do { if (debugMode == (DEBUG_VTX_TRAMP)) { debug[(2)] = (((trampConfPitMode << 14) & 0xC000) | ((trampCurPitMode << 12) & 0x3000) | ((trampConfPower << 8) & 0x0F00) | ((trampCurConfPower << 4) & 0x00F0) | ((trampConfFreq != trampCurFreq) ? 0x0008 : 0x0000) | ((trampConfPower != trampCurConfPower) ? 0x0004 : 0x0000) | ((trampConfPitMode != trampCurPitMode) ? 0x0002 : 0x0000) | (configUpdateRequired ? 0x0001 : 0x0000)); } } while (0)
                                                                                            ...
                                                                                            ;
    do { if (debugMode == (DEBUG_VTX_TRAMP)) { debug[(3)] = (trampRetryCount); } } while (0);
...
static 
# 493 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 493 "./src/main/io/vtx_tramp.c"
           vtxTrampIsReady(const vtxDevice_t *vtxDevice)
{
    return vtxDevice != 
# 495 "./src/main/io/vtx_tramp.c" 3 4
                       ((void *)0) 
# 495 "./src/main/io/vtx_tramp.c"
                            && trampStatus >= TRAMP_STATUS_ONLINE_MONITOR_FREQPWRPIT;
}
...
static 
# 559 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 559 "./src/main/io/vtx_tramp.c"
           vtxTrampGetBandAndChannel(const vtxDevice_t *vtxDevice, uint8_t *pBand, uint8_t *pChannel)
{
    if (!vtxTrampIsReady(vtxDevice)) {
        return 
# 562 "./src/main/io/vtx_tramp.c" 3 4
              0
# 562 "./src/main/io/vtx_tramp.c"
                   ;
    }
...
# 574 "./src/main/io/vtx_tramp.c"
    ...
    if (trampConfPower == 0) {
        *pIndex = 0;
        return 
# 580 "./src/main/io/vtx_tramp.c" 3 4
              1
# 580 "./src/main/io/vtx_tramp.c"
                  ;
    }
    ...
    for (uint8_t i = 0; i < vtxTablePowerLevels; i++) {
        ...
        if (trampConfPower == vtxTablePowerValues[i]) {
            ...
            *pIndex = i + 1;
            return 
# 589 "./src/main/io/vtx_tramp.c" 3 4
                  1
# 589 "./src/main/io/vtx_tramp.c"
                      ;
        }
    }
...
static 
# 597 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 597 "./src/main/io/vtx_tramp.c"
...
static 
# 607 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 607 "./src/main/io/vtx_tramp.c"
           vtxTrampGetStatus(const vtxDevice_t *vtxDevice, unsigned *status)
{
    if (!vtxTrampIsReady(vtxDevice)) {
        return 
...
# 610 "./src/main/io/vtx_tramp.c"
    ...
    *status |= ((trampCurControlMode & (0x01)) ? VTX_STATUS_LOCKED : 0);

    return 
# 621 "./src/main/io/vtx_tramp.c" 3 4
          1
# 621 "./src/main/io/vtx_tramp.c"
              ;
}
...
# 646 "./src/main/io/vtx_tramp.c" 3 4
                                  ((void *)0)
# 646 "./src/main/io/vtx_tramp.c"
                                      ,
};



# 650 "./src/main/io/vtx_tramp.c" 3 4
_Bool 
# 650 "./src/main/io/vtx_tramp.c"
    vtxTrampInit(void)
{
...
# 662 "./src/main/io/vtx_tramp.c" 3 4
                                                                                    ((void *)0)
# 662 "./src/main/io/vtx_tramp.c"
                                                                                        , 
# 662 "./src/main/io/vtx_tramp.c" 3 4
                                                                                          ((void *)0)
# 662 "./src/main/io/vtx_tramp.c"
    ...
    if (!trampSerialPort) {
        return 
# 666 "./src/main/io/vtx_tramp.c" 3 4
              0
# 666 "./src/main/io/vtx_tramp.c"
                   ;
    }
...
# 686 "./src/main/io/vtx_tramp.c"
    vtxInit();

    return 
# 688 "./src/main/io/vtx_tramp.c" 3 4
          1
# 688 "./src/main/io/vtx_tramp.c"
              ;
}
