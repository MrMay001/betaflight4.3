...
static 
# 43 "./src/main/io/spektrum_rssi.c" 3 4
      _Bool 
# 43 "./src/main/io/spektrum_rssi.c"
           spektrumSatInternal = 
# 43 "./src/main/io/spektrum_rssi.c" 3 4
                                 1
# 43 "./src/main/io/spektrum_rssi.c"
...
static const dbm_table_t dbmTable[] = {
    ...
    {-76, 63},
    {-77, 60},
# 90 "./src/main/io/spektrum_rssi.c"
    {(-92), 0}};
...
void spektrumHandleRSSI(volatile uint8_t spekFrame[]) {
    ...
    if (srxlEnabled) {
        ...
        if (rssi <= (-100) ) {
# 132 "./src/main/io/spektrum_rssi.c"
            spek_fade_count++;
            if (spek_fade_count < 5) {
...

    {
        ...
        if (spektrumSatInternal) {
            ...
            if ( !( (system == 0x01) |
                    ...
                    (system == 0xb2) ) ){
                spektrumSatInternal =
# 185 "./src/main/io/spektrum_rssi.c" 3 4
                                    0
# 185 "./src/main/io/spektrum_rssi.c"
                                         ;
            }
        } else {
