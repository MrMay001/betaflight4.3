...
{
    IOConfigGPIO(escHardware[selEsc].io, ((((uint32_t)0x00000000U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000001U)) << 5)));
}

inline void setEscOutput(uint8_t selEsc)
{
    IOConfigGPIO(escHardware[selEsc].io, ((((uint32_t)0x00000001U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000000U)) << 5)));
}
...
void esc4wayRelease(void)
{
    while (escCount > 0) {
        escCount--;
        IOConfigGPIO(escHardware[escCount].io, ((((uint32_t)0x00000002U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000000U)) << 5)));
        setEscLo(escCount);
    }
    motorEnable();
}
# 317 "./src/main/io/serial_4way.c"
...
# 365 "./src/main/io/serial_4way.c"
        if (BL_ConnectEx(pDeviceInfo)) {
            if ((pDeviceInfo->words[0] > 0xE800) && (pDeviceInfo->words[0] < 0xF900)) {
                ...
                return 1;
            } else if ((pDeviceInfo->bytes[1] > 0x00) && (pDeviceInfo->bytes[1] < 0x90) && (pDeviceInfo->bytes[0] == 0x06)) {
...
# 511 "./src/main/io/serial_4way.c"
                ...
                case 0x33:
                {
                    ...
                    O_PARAM_LEN = 2;
                    Dummy.bytes[0] = (uint8_t) ((uint16_t) ((20 * 1000) + ((uint8_t) 0 * 100) + (uint8_t) 06) / 100);
                    Dummy.bytes[1] = (uint8_t) ((uint16_t) ((20 * 1000) + ((uint8_t) 0 * 100) + (uint8_t) 06) % 100);
                    break;
                }
                case 0x34:
                {
...
# 545 "./src/main/io/serial_4way.c"
                ...
                case 0x3F:
                {
                    ...
                    if (((ParamBuf[0] <= 2)||(ParamBuf[0] == 4)) && (ParamBuf[0] >= 1)) {
...
# 566 "./src/main/io/serial_4way.c" 3 4
                   _Bool 
# 566 "./src/main/io/serial_4way.c"
                        rebootEsc = 
# 566 "./src/main/io/serial_4way.c" 3 4
                                    0
# 566 "./src/main/io/serial_4way.c"
                    ...
                    if (ParamBuf[0] < escCount) {
                        ...
                        if (ioMem.D_FLASH_ADDR_L == 1) {
                            rebootEsc = 
# 571 "./src/main/io/serial_4way.c" 3 4
                                       1
# 571 "./src/main/io/serial_4way.c"
                                           ;
                        }
                    }
                    else {
...
# 830 "./src/main/io/serial_4way.c"
        ...
        ledSet(0, 
# 880 "./src/main/io/serial_4way.c" 3 4
       0
# 880 "./src/main/io/serial_4way.c"
       );
        ...
        ledSet(0, 
# 903 "./src/main/io/serial_4way.c" 3 4
       0
# 903 "./src/main/io/serial_4way.c"
       );
        if (isExitScheduled) {
            esc4wayRelease();
            return;
