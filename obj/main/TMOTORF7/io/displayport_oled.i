...
_Bool 
# 42 "./src/main/drivers/display_ug2864hsweg01.h"
    ug2864hsweg01InitI2C(const extDevice_t *dev);
...
static 
# 53 "./src/main/io/displayport_oled.c" 3 4
      _Bool 
# 53 "./src/main/io/displayport_oled.c"
           oledDrawScreen(displayPort_t *displayPort)
{
    ((void)(displayPort));
    return 0;
}
...
static 
# 88 "./src/main/io/displayport_oled.c" 3 4
      _Bool 
# 88 "./src/main/io/displayport_oled.c"
           oledIsSynced(const displayPort_t *displayPort)
{
    ((void)(displayPort));
    return 
# 91 "./src/main/io/displayport_oled.c" 3 4
          1
# 91 "./src/main/io/displayport_oled.c"
              ;
}
...
static uint32_t oledTxBytesFree(const displayPort_t *displayPort)
{
    ((void)(displayPort));
    return 
# 108 "./src/main/io/displayport_oled.c" 3 4
          (0xffffffffUL)
# 108 "./src/main/io/displayport_oled.c"
                    ;
}
...
static const displayPortVTable_t oledVTable = {
    ...
    .layerSupported = 
# 124 "./src/main/io/displayport_oled.c" 3 4
                     ((void *)0)
# 124 "./src/main/io/displayport_oled.c"
                         ,
    .layerSelect = 
# 125 "./src/main/io/displayport_oled.c" 3 4
                  ((void *)0)
# 125 "./src/main/io/displayport_oled.c"
                      ,
    .layerCopy = 
# 126 "./src/main/io/displayport_oled.c" 3 4
                ((void *)0)
# 126 "./src/main/io/displayport_oled.c"
                    ,
};
