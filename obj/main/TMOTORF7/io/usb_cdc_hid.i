...
# 153 "./src/main/platform.h" 2
# 25 "./src/main/io/usb_cdc_hid.c" 2
...
# 29 "./src/main/io/usb_cdc_hid.c" 2
...
# 31 "./src/main/io/usb_cdc_hid.c" 2
...
# 33 "./src/main/io/usb_cdc_hid.c" 2
...
# 35 "./src/main/io/usb_cdc_hid.c" 2
...
# 37 "./src/main/io/usb_cdc_hid.c" 2
...
# 44 "./src/main/io/usb_cdc_hid.c" 2
...
# 45 "./src/main/io/usb_cdc_hid.c" 2
...
# 46 "./src/main/io/usb_cdc_hid.c" 2
# 56 "./src/main/io/usb_cdc_hid.c"
...
void sendRcDataToHid(void)
{
    ...
    report[8] = 0;
    for (unsigned i = 0; i < 8; i++) {
        const uint8_t channel = hidChannelMapping[i + 8];
        if (scaleRange(constrain(rcData[channel], 1000, 2000), 1000, 2000, -127, 127) > 0) {
            report[8] |= (1 << i);
        }
    }
...
# 106 "./src/main/io/usb_cdc_hid.c" 3 4
_Bool 
# 106 "./src/main/io/usb_cdc_hid.c"
