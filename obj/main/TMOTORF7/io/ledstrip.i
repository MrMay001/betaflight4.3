...
# 81 "./src/main/io/ledstrip.c" 2



static 
# 84 "./src/main/io/ledstrip.c" 3 4
      _Bool 
# 84 "./src/main/io/ledstrip.c"
           ledStripEnabled = 
# 84 "./src/main/io/ledstrip.c" 3 4
                             0
# 84 "./src/main/io/ledstrip.c"
                                  ;
static uint8_t previousProfileColorIndex = 255;
# 98 "./src/main/io/ledstrip.c"
...
extern void pgResetFn_ledStripConfig(ledStripConfig_t *); ledStripConfig_t ledStripConfig_System; ledStripConfig_t ledStripConfig_Copy; uint32_t ledStripConfig_fnv_hash; extern const pgRegistry_t ledStripConfig_Registry; const pgRegistry_t ledStripConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 27 | (2 << 12), .length = 1, .size = sizeof(ledStripConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&ledStripConfig_System, .fnv_hash = &ledStripConfig_fnv_hash, .copy = (uint8_t*)&ledStripConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_ledStripConfig }, };
...
void pgResetFn_ledStripConfig(ledStripConfig_t *ledStripConfig)
{
    ...
    ledStripConfig->ledstrip_beacon_period_ms = 500;
    ledStripConfig->ledstrip_beacon_percent = 50;
    ledStripConfig->ledstrip_beacon_armed_only = 
# 132 "./src/main/io/ledstrip.c" 3 4
                                                0
# 132 "./src/main/io/ledstrip.c"
                                                     ;
    ledStripConfig->ledstrip_visual_beeper_color = COLOR_WHITE;
...
extern void pgResetFn_ledStripStatusModeConfig(ledStripStatusModeConfig_t *); ledStripStatusModeConfig_t ledStripStatusModeConfig_System; ledStripStatusModeConfig_t ledStripStatusModeConfig_Copy; uint32_t ledStripStatusModeConfig_fnv_hash; extern const pgRegistry_t ledStripStatusModeConfig_Registry; const pgRegistry_t ledStripStatusModeConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 545 | (0 << 12), .length = 1, .size = sizeof(ledStripStatusModeConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&ledStripStatusModeConfig_System, .fnv_hash = &ledStripStatusModeConfig_fnv_hash, .copy = (uint8_t*)&ledStripStatusModeConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_ledStripStatusModeConfig }, };

void pgResetFn_ledStripStatusModeConfig(ledStripStatusModeConfig_t *ledStripStatusModeConfig)
{
    memset(ledStripStatusModeConfig->ledConfigs, 0, 32 * sizeof(ledConfig_t));

    memset(ledStripStatusModeConfig->colors, 0, (sizeof(hsv) / sizeof((hsv)[0])) * sizeof(hsvColor_t));
    _Static_assert((16 >= (sizeof(hsv) / sizeof((hsv)[0]))), "LED_CONFIGURABLE_COLOR_COUNT_invalid");
...
# 297 "./src/main/io/ledstrip.c" 3 4
_Bool 
# 297 "./src/main/io/ledstrip.c"
    parseLedStripConfig(int ledIndex, const char *config)
{
    if (ledIndex >= 32)
        return 
# 300 "./src/main/io/ledstrip.c" 3 4
              0
# 300 "./src/main/io/ledstrip.c"
                   ;
    ...
    for (enum parseState_e parseState = 0; parseState < PARSE_STATE_COUNT; parseState++) {
        char chunk[11];
        {
            ...
            if (*config != chunkSeparator) {
                return 
# 330 "./src/main/io/ledstrip.c" 3 4
                      0
# 330 "./src/main/io/ledstrip.c"
                           ;
            }
            config++;
        }
    ...
    *ledConfig = (((((((x) & 0x0F) << 4) | (((y) & 0x0F) << 0))) << 0) | ((color) << 18) | ((direction_flags) << 22) | ((baseFunction) << 8) | ((overlay_flags) << 12) | ((0) << 28));
    ...
    return 
# 381 "./src/main/io/ledstrip.c" 3 4
          1
# 381 "./src/main/io/ledstrip.c"
              ;
}
...
static const hsvColor_t* getDirectionalModeColor(const int ledIndex, const modeColorIndexes_t *modeColors)
{
    ...
    return 
# 452 "./src/main/io/ledstrip.c" 3 4
          ((void *)0)
# 452 "./src/main/io/ledstrip.c"
              ;
}
...
static void applyLedFixedLayers(void)
{
    for (int ledIndex = 0; ledIndex < ledCounts.count; ledIndex++) {
        ...
        case LED_FUNCTION_COLOR:
            ...
            hsvColor_t nextColor = ledStripStatusModeConfig()->colors[(ledGetColor(ledConfig) + 1 + 16) % 16];
            hsvColor_t previousColor = ledStripStatusModeConfig()->colors[(ledGetColor(ledConfig) - 1 + 16) % 16];
        ...
        case LED_FUNCTION_BATTERY:
            color = (hsv[COLOR_RED]);
            hOffset += __extension__ ({ __typeof__ (scaleRange(calculateBatteryPercentageRemaining(), 0, 100, -30, 120)) _a = (scaleRange(calculateBatteryPercentageRemaining(), 0, 100, -30, 120)); __typeof__ (0) _b = (0); _a > _b ? _a : _b; });
            break;

        case LED_FUNCTION_RSSI:
            color = (hsv[COLOR_RED]);
            hOffset += __extension__ ({ __typeof__ (scaleRange(getRssiPercent(), 0, 100, -30, 120)) _a = (scaleRange(getRssiPercent(), 0, 100, -30, 120)); __typeof__ (0) _b = (0); _a > _b ? _a : _b; });
            break;
...
# 558 "./src/main/io/ledstrip.c" 3 4
                                _Bool 
# 558 "./src/main/io/ledstrip.c"
...
# 586 "./src/main/io/ledstrip.c" 3 4
                                    ((void *)0)
# 586 "./src/main/io/ledstrip.c"
                                        ;
        ...
        if (warningFlags & (1 << warningId)) {
            switch (warningId) {
                ...
                case WARNING_CRASH_FLIP_ACTIVE:
                    warningColor = colorOn ? &(hsv[COLOR_MAGENTA]) : &(hsv[COLOR_BLACK]);
                    break;
...
# 625 "./src/main/io/ledstrip.c" 3 4
                                 0
# 625 "./src/main/io/ledstrip.c"
                                      ;
    static uint16_t lastCheck = 0;
    static 
# 627 "./src/main/io/ledstrip.c" 3 4
          _Bool 
# 627 "./src/main/io/ledstrip.c"
               blink = 
# 627 "./src/main/io/ledstrip.c" 3 4
                       0
# 627 "./src/main/io/ledstrip.c"
...
# 713 "./src/main/io/ledstrip.c" 3 4
                                _Bool 
# 713 "./src/main/io/ledstrip.c"
                                     updateNow, timeUs_t *timer)
{
    static 
# 715 "./src/main/io/ledstrip.c" 3 4
          _Bool 
# 715 "./src/main/io/ledstrip.c"
               flash = 
# 715 "./src/main/io/ledstrip.c" 3 4
                       0
# 715 "./src/main/io/ledstrip.c"
    ...
    if (updateNow) {
        ...
        switch (getBatteryState()) {
            case BATTERY_OK:
                flash = 
# 723 "./src/main/io/ledstrip.c" 3 4
                       1
# 723 "./src/main/io/ledstrip.c"
                           ;
...
# 748 "./src/main/io/ledstrip.c" 3 4
                             _Bool 
# 748 "./src/main/io/ledstrip.c"
                                  updateNow, timeUs_t *timer)
{
    static 
# 750 "./src/main/io/ledstrip.c" 3 4
          _Bool 
# 750 "./src/main/io/ledstrip.c"
               flash = 
# 750 "./src/main/io/ledstrip.c" 3 4
                       0
# 750 "./src/main/io/ledstrip.c"
    ...
    if (updateNow) {
        ...
        if (state > 50) {
            flash = 
# 758 "./src/main/io/ledstrip.c" 3 4
                   1
# 758 "./src/main/io/ledstrip.c"
                       ;
...
# 778 "./src/main/io/ledstrip.c" 3 4
                            _Bool 
# 778 "./src/main/io/ledstrip.c"
                                 updateNow, timeUs_t *timer)
{
...
# 803 "./src/main/io/ledstrip.c" 3 4
       _Bool 
# 803 "./src/main/io/ledstrip.c"
...
# 817 "./src/main/io/ledstrip.c" 3 4
                                  _Bool 
# 817 "./src/main/io/ledstrip.c"
                                       updateNow, timeUs_t *timer)
{
    static 
# 819 "./src/main/io/ledstrip.c" 3 4
          _Bool 
# 819 "./src/main/io/ledstrip.c"
               flash = 0;

    if (updateNow) {
        if (rxIsReceivingSignal()) {

            int scale = __extension__ ({ __typeof__ (fabsf(rcCommand[ROLL])) _a = (fabsf(rcCommand[ROLL])); __typeof__ (fabsf(rcCommand[PITCH])) _b = (fabsf(rcCommand[PITCH])); _a > _b ? _a : _b; });
            scale = scale - 25;
...
# 860 "./src/main/io/ledstrip.c" 3 4
                                   _Bool 
# 860 "./src/main/io/ledstrip.c"
                                        updateNow, timeUs_t *timer)
{
    ...
    if (updateNow) {
        ...
        const int scaledThrottle = (armingFlags & (ARMED)) ? scaleRange(rcData[THROTTLE], 1000, 2000, 0, 100) : 0;
...
# 876 "./src/main/io/ledstrip.c" 3 4
           _Bool 
...
# 956 "./src/main/io/ledstrip.c" 3 4
                              _Bool 
# 956 "./src/main/io/ledstrip.c"
                                   updateNow, timeUs_t *timer)
{
...
# 969 "./src/main/io/ledstrip.c" 3 4
   _Bool 
# 969 "./src/main/io/ledstrip.c"
        ledOn = (blinkMask & 1);
    if (!ledOn) {
...
_Static_assert((timTimerCount <= sizeof(disabledTimerMask) * 8), "disabledTimerMask_too_small");
...
# 1009 "./src/main/io/ledstrip.c" 3 4
                               _Bool 
# 1009 "./src/main/io/ledstrip.c"
                                    updateNow, timeUs_t *timer);
    ...
    isOverlayTypeUsed(ledOverlayId_e overlayType)
{
    for (int ledIndex = 0; ledIndex < ledCounts.count; ledIndex++) {
        ...
        if (ledGetOverlayBit(ledConfig, overlayType)) {
            return 
# 1032 "./src/main/io/ledstrip.c" 3 4
                  1
# 1032 "./src/main/io/ledstrip.c"
                      ;
        }
    }
    return 
# 1035 "./src/main/io/ledstrip.c" 3 4
          0
# 1035 "./src/main/io/ledstrip.c"
               ;
}
...
# 1084 "./src/main/io/ledstrip.c" 3 4
_Bool 
# 1084 "./src/main/io/ledstrip.c"
    parseColor(int index, const char *colorConfig)
{
...
# 1090 "./src/main/io/ledstrip.c" 3 4
   _Bool 
# 1090 "./src/main/io/ledstrip.c"
        result = 
# 1090 "./src/main/io/ledstrip.c" 3 4
                 1
# 1090 "./src/main/io/ledstrip.c"
    ...
    for (int componentIndex = 0; result && componentIndex < (HSV_VALUE + 1); componentIndex++) {
        ...
        if (val > hsv_limit[componentIndex]) {
            result = 
# 1099 "./src/main/io/ledstrip.c" 3 4
                    0
# 1099 "./src/main/io/ledstrip.c"
                         ;
            break;
        }
        ...
        if (remainingCharacters) {
            ...
            if (componentIndex < (HSV_VALUE + 1) - 1) {
                result = 
# 1118 "./src/main/io/ledstrip.c" 3 4
                        0
# 1118 "./src/main/io/ledstrip.c"
                             ;
            }
        }
    }
...
# 1144 "./src/main/io/ledstrip.c"
        ...
        if (modeColorIndex < 0 || modeColorIndex >= 1)
            return 
# 1148 "./src/main/io/ledstrip.c" 3 4
                  0
# 1148 "./src/main/io/ledstrip.c"
                       ;
...
# 1151 "./src/main/io/ledstrip.c"
    ...
    return 
# 1153 "./src/main/io/ledstrip.c" 3 4
          1
# 1153 "./src/main/io/ledstrip.c"
              ;
}
...
void ledStripEnable(void)
{
    ...
    ledStripEnabled = 
# 1161 "./src/main/io/ledstrip.c" 3 4
                     1
# 1161 "./src/main/io/ledstrip.c"
                         ;
}
...
{
    ledStripEnabled = 
# 1166 "./src/main/io/ledstrip.c" 3 4
                     0
# 1166 "./src/main/io/ledstrip.c"
                          ;
    previousProfileColorIndex = 255;
...
# 1199 "./src/main/io/ledstrip.c" 3 4
   _Bool 
# 1199 "./src/main/io/ledstrip.c"
        blinkLed = 
# 1199 "./src/main/io/ledstrip.c" 3 4
                   0
# 1199 "./src/main/io/ledstrip.c"
...
# 1200 "./src/main/io/ledstrip.c" 3 4
   _Bool 
# 1200 "./src/main/io/ledstrip.c"
...
# 1200 "./src/main/io/ledstrip.c"
    ...
    if (IS_RC_MODE_ACTIVE(BOXBEEPERON) || failsafeIsActive()) {
        ...
        blinkLed = 
# 1206 "./src/main/io/ledstrip.c" 3 4
                  1
# 1206 "./src/main/io/ledstrip.c"
                      ;
        visualBeeperOverride = 
# 1207 "./src/main/io/ledstrip.c" 3 4
                              0
# 1207 "./src/main/io/ledstrip.c"
                                   ;
        flashPeriod = 250;
        onPercent = 50;
        ...
        switch (ledStripConfig()->ledstrip_profile) {
            ...
            case LED_PROFILE_BEACON: {
                if (!ledStripConfig()->ledstrip_beacon_armed_only || (armingFlags & (ARMED))) {
                    ...
                    blinkLed = 
# 1222 "./src/main/io/ledstrip.c" 3 4
                              1
# 1222 "./src/main/io/ledstrip.c"
                                  ;
                }
                break;
            }
    ...
    if (blinkLed) {
        ...
        const 
# 1234 "./src/main/io/ledstrip.c" 3 4
             _Bool 
# 1234 "./src/main/io/ledstrip.c"
                  beaconState = (millis() % flashPeriod) < onPeriod;
    ...
    if ((colorIndex != previousProfileColorIndex) || (currentTimeUs >= colorUpdateTimeUs)) {
        ...
        colorUpdateTimeUs = currentTimeUs + 1e6;
    }
}
