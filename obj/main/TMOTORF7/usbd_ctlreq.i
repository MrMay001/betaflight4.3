# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
# 21 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
...
# 22 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c" 2
...
# 23 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c" 2
# 71 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
...
# 111 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
USBD_StatusTypeDef USBD_StdDevReq (USBD_HandleTypeDef *pdev , USBD_SetupReqTypedef *req)
{
...
# 177 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
USBD_StatusTypeDef USBD_StdItfReq (USBD_HandleTypeDef *pdev , USBD_SetupReqTypedef *req)
{
  USBD_StatusTypeDef ret = USBD_OK;
  ...
  case 0x00U:
    ...
    case 0x03U:
      ...
      if (((uint8_t)(req->wIndex & 0x00FFU)) <= 3)
      {
...
# 228 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
USBD_StatusTypeDef USBD_StdEPReq (USBD_HandleTypeDef *pdev , USBD_SetupReqTypedef *req)
{
                               ...
                               USBD_SetupReqTypedef *req)
{
  ...
  if((len != 0U) && (req->wLength != 0U))
  {
    ...
    len = __extension__ ({ __typeof__ (len) _a = (len); __typeof__ (req->wLength) _b = (req->wLength); _a < _b ? _a : _b; });
...
# 523 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
static void USBD_SetAddress(USBD_HandleTypeDef *pdev ,
                            USBD_SetupReqTypedef *req)
{
  uint8_t dev_addr;
...
# 565 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
...
# 640 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
...
# 674 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
...
# 715 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
static void USBD_SetFeature(USBD_HandleTypeDef *pdev ,
                            USBD_SetupReqTypedef *req)
{
...
# 735 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
static void USBD_ClrFeature(USBD_HandleTypeDef *pdev ,
                            USBD_SetupReqTypedef *req)
{
  switch (pdev->dev_state)
...
# 764 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
void USBD_ParseSetupRequest(USBD_SetupReqTypedef *req, uint8_t *pdata)
{
  req->bmRequest = *(uint8_t *) (pdata);
  req->bRequest = *(uint8_t *) (pdata + 1);
  req->wValue = (((uint16_t)(*((uint8_t *)(pdata + 2)))) + (((uint16_t)(*(((uint8_t *)(pdata + 2)) + 1U))) << 8U));
  req->wIndex = (((uint16_t)(*((uint8_t *)(pdata + 4)))) + (((uint16_t)(*(((uint8_t *)(pdata + 4)) + 1U))) << 8U));
  req->wLength = (((uint16_t)(*((uint8_t *)(pdata + 6)))) + (((uint16_t)(*(((uint8_t *)(pdata + 6)) + 1U))) << 8U));

}
# 782 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
...
# 800 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
void USBD_GetString(uint8_t *desc, uint8_t *unicode, uint16_t *len)
{
  uint8_t idx = 0U;

  if (desc != 
# 804 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c" 3 4
             ((void *)0)
# 804 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
                 )
  {
