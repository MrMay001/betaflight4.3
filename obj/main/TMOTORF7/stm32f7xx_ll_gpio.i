# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_gpio.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_gpio.c"
# 22 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_gpio.c"
# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Inc/stm32f7xx_ll_gpio.h" 1
# 29 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Inc/stm32f7xx_ll_gpio.h"
...
# 30 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Inc/stm32f7xx_ll_gpio.h" 2
...
# 23 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_gpio.c" 2
...
# 24 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_gpio.c" 2
# 104 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_gpio.c"
ErrorStatus LL_GPIO_DeInit(GPIO_TypeDef *GPIOx)
{
  ...
  if (GPIOx == ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)))
  {
    LL_AHB1_GRP1_ForceReset((0x1UL << (0U)));
    LL_AHB1_GRP1_ReleaseReset((0x1UL << (0U)));
  }
  else if (GPIOx == ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)))
  {
    LL_AHB1_GRP1_ForceReset((0x1UL << (1U)));
    LL_AHB1_GRP1_ReleaseReset((0x1UL << (1U)));
  }
  else if (GPIOx == ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)))
  {
    LL_AHB1_GRP1_ForceReset((0x1UL << (2U)));
    LL_AHB1_GRP1_ReleaseReset((0x1UL << (2U)));
  }

  else if (GPIOx == ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)))
  {
  ...
  else if (GPIOx == ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)))
  {
  ...
  else if (GPIOx == ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1400UL)))
  {
    LL_AHB1_GRP1_ForceReset((0x1UL << (5U)));
    LL_AHB1_GRP1_ReleaseReset((0x1UL << (5U)));
  }


  else if (GPIOx == ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1800UL)))
  {
    LL_AHB1_GRP1_ForceReset((0x1UL << (6U)));
    LL_AHB1_GRP1_ReleaseReset((0x1UL << (6U)));
  }


  else if (GPIOx == ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1C00UL)))
  {
    LL_AHB1_GRP1_ForceReset((0x1UL << (7U)));
    LL_AHB1_GRP1_ReleaseReset((0x1UL << (7U)));
  }


  else if (GPIOx == ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x2000UL)))
  {
    LL_AHB1_GRP1_ForceReset((0x1UL << (8U)));
    LL_AHB1_GRP1_ReleaseReset((0x1UL << (8U)));
  }
# 183 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_gpio.c"
  else
  {
    status = ERROR;
  }
...
# 200 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_gpio.c"
ErrorStatus LL_GPIO_Init(GPIO_TypeDef *GPIOx, LL_GPIO_InitTypeDef *GPIO_InitStruct)
{
  ...
  pinpos = ((uint8_t)__builtin_clz(__RBIT(GPIO_InitStruct->Pin)));
  ...
  while (((GPIO_InitStruct->Pin) >> pinpos) != 0x00000000U)
  {
    ...
    if (currentpin)
    {
      ...
      if (GPIO_InitStruct->Mode == (0x2UL << (0U)))
      {
        ...
        if (((uint8_t)__builtin_clz(__RBIT(currentpin))) < 0x00000008U)
        {
...
# 276 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_gpio.c"
void LL_GPIO_StructInit(LL_GPIO_InitTypeDef *GPIO_InitStruct)
{
