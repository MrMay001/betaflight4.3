# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
# 41 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
...
# 42 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c" 2
# 56 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
static HAL_StatusTypeDef USB_CoreReset(USB_OTG_GlobalTypeDef *USBx);
# 86 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
HAL_StatusTypeDef USB_CoreInit(USB_OTG_GlobalTypeDef *USBx, USB_OTG_CfgTypeDef cfg)
{
...
# 135 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
  else
  {
...
# 163 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
...
# 274 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
HAL_StatusTypeDef USB_SetCurrentMode(USB_OTG_GlobalTypeDef *USBx, USB_OTG_ModeTypeDef mode)
{
...
# 303 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
HAL_StatusTypeDef USB_DevInit(USB_OTG_GlobalTypeDef *USBx, USB_OTG_CfgTypeDef cfg)
{
  ...
  if (cfg.vbus_sensing_enable == 0U)
  {
    ...
    USBx->GOTGCTL |= (0x1UL << (6U));
    USBx->GOTGCTL |= (0x1UL << (7U));
  }
  else
  {
  ...
  *(volatile uint32_t *)((uint32_t)USBx_BASE + 0x0E00UL) = 0U;


  ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DCFG |= 0U;
  ...
  ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DIEPMSK = 0U;
  ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DOEPMSK = 0U;
  ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DAINTMSK = 0U;

  for (i = 0U; i < cfg.dev_endpoints; i++)
  {
    if ((((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((i) * 0x0020UL)))->DIEPCTL & (0x1UL << (31U))) == (0x1UL << (31U)))
    {
      if (i == 0U)
      {
        ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((i) * 0x0020UL)))->DIEPCTL = (0x1UL << (27U));
      }
      else
      {
        ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((i) * 0x0020UL)))->DIEPCTL = (0x1UL << (30U)) | (0x1UL << (27U));
      }
    }
    else
    {
      ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((i) * 0x0020UL)))->DIEPCTL = 0U;
    }

    ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((i) * 0x0020UL)))->DIEPTSIZ = 0U;
    ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((i) * 0x0020UL)))->DIEPINT = 0xFB7FU;
  }

  for (i = 0U; i < cfg.dev_endpoints; i++)
  {
    if ((((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((i) * 0x0020UL)))->DOEPCTL & (0x1UL << (31U))) == (0x1UL << (31U)))
    {
      if (i == 0U)
      {
        ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((i) * 0x0020UL)))->DOEPCTL = (0x1UL << (27U));
      }
      else
      {
        ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((i) * 0x0020UL)))->DOEPCTL = (0x1UL << (30U)) | (0x1UL << (27U));
      }
    }
    else
    {
      ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((i) * 0x0020UL)))->DOEPCTL = 0U;
    }

    ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((i) * 0x0020UL)))->DOEPTSIZ = 0U;
    ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((i) * 0x0020UL)))->DOEPINT = 0xFB7FU;
  }

  ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DIEPMSK &= ~((0x1UL << (8U)));

  if (cfg.dma_enable == 1U)
  {

    ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DTHRCTL = (0x040UL << (2U)) |
                           (0x040UL << (17U));

    ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DTHRCTL |= (0x1UL << (16U)) |
                            (0x1UL << (1U)) |
                            (0x1UL << (0U));
  }
...
# 480 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
HAL_StatusTypeDef USB_FlushTxFifo(USB_OTG_GlobalTypeDef *USBx, uint32_t num)
{
  uint32_t count = 0U;
...
# 532 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
HAL_StatusTypeDef USB_SetDevSpeed(USB_OTG_GlobalTypeDef *USBx, uint8_t speed)
{
  uint32_t USBx_BASE = (uint32_t)USBx;

  ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DCFG |= speed;
  return HAL_OK;
}
# 548 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
uint8_t USB_GetDevSpeed(USB_OTG_GlobalTypeDef *USBx)
{
  uint32_t USBx_BASE = (uint32_t)USBx;
  uint8_t speed;
  uint32_t DevEnumSpeed = ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DSTS & (0x3UL << (1U));
...
HAL_StatusTypeDef USB_ActivateEndpoint(USB_OTG_GlobalTypeDef *USBx, USB_OTG_EPTypeDef *ep)
{
  ...
  if (ep->is_in == 1U)
  {
    ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DAINTMSK |= (0xFFFFUL << (0U)) & (uint32_t)(1UL << (ep->num & 0xFU));

    if ((((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPCTL & (0x1UL << (15U))) == 0U)
    {
      ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPCTL |= (ep->maxpacket & (0x7FFUL << (0U))) |
  ...
  {
    ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DAINTMSK |= (0xFFFFUL << (16U)) & ((uint32_t)(1UL << (ep->num & 0xFU)) << 16);

    if (((((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPCTL) & (0x1UL << (15U))) == 0U)
    {
      ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPCTL |= (ep->maxpacket & (0x7FFUL << (0U))) |
                                    ((uint32_t)ep->type << 18) |
                                    (0x1UL << (28U)) |
                                    (0x1UL << (15U));
    }
...
HAL_StatusTypeDef USB_ActivateDedicatedEndpoint(USB_OTG_GlobalTypeDef *USBx, USB_OTG_EPTypeDef *ep)
{
  ...
  if (ep->is_in == 1U)
  {
    ...
    ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DEACHMSK |= (0xFFFFUL << (0U)) & (uint32_t)(1UL << (ep->num & 0xFU));
  }
  else
  {
    if (((((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPCTL) & (0x1UL << (15U))) == 0U)
    ...
    ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DEACHMSK |= (0xFFFFUL << (16U)) & ((uint32_t)(1UL << (ep->num & 0xFU)) << 16);
  }
...
HAL_StatusTypeDef USB_DeactivateEndpoint(USB_OTG_GlobalTypeDef *USBx, USB_OTG_EPTypeDef *ep)
{
  ...
  if (ep->is_in == 1U)
  {
    ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DEACHMSK &= ~((0xFFFFUL << (0U)) & (uint32_t)(1UL << (ep->num & 0xFU)));
    ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DAINTMSK &= ~((0xFFFFUL << (0U)) & (uint32_t)(1UL << (ep->num & 0xFU)));
    ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPCTL &= ~((0x1UL << (15U)) |
                                   (0x7FFUL << (0U)) |
                                   (0xFUL << (22U)) |
                                   (0x1UL << (28U)) |
                                   (0x3UL << (18U)));
  ...
  else
  {
    ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DEACHMSK &= ~((0xFFFFUL << (16U)) & ((uint32_t)(1UL << (ep->num & 0xFU)) << 16));
    ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DAINTMSK &= ~((0xFFFFUL << (16U)) & ((uint32_t)(1UL << (ep->num & 0xFU)) << 16));
    ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPCTL &= ~((0x1UL << (15U)) |
                                    (0x7FFUL << (0U)) |
                                    (0x1UL << (28U)) |
                                    (0x3UL << (18U)));
  }
...
# 719 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
HAL_StatusTypeDef USB_EPStartXfer(USB_OTG_GlobalTypeDef *USBx, USB_OTG_EPTypeDef *ep, uint8_t dma)
{
  uint32_t USBx_BASE = (uint32_t)USBx;
  uint32_t epnum = (uint32_t)ep->num;
  ...
  if (ep->is_in == 1U)
  {
    ...
    if (ep->xfer_len == 0U)
    {
      ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPTSIZ &= ~((0x3FFUL << (19U)));
      ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPTSIZ |= ((0x3FFUL << (19U)) & (1U << 19));
      ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPTSIZ &= ~((0x7FFFFUL << (0U)));
    }
    else
    {
      ...
      ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPTSIZ &= ~((0x7FFFFUL << (0U)));
      ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPTSIZ &= ~((0x3FFUL << (19U)));
      ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPTSIZ |= ((0x3FFUL << (19U)) & (((ep->xfer_len + ep->maxpacket - 1U) / ep->maxpacket) << 19));
      ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPTSIZ |= ((0x7FFFFUL << (0U)) & ep->xfer_len);

      if (ep->type == 1U)
      {
        ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPTSIZ &= ~((0x3UL << (29U)));
        ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPTSIZ |= ((0x3UL << (29U)) & (1U << 29));
      }
    }
    ...
    if (dma == 1U)
    {
      ...
      {
        ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPDMA = (uint32_t)(ep->dma_addr);
      }
    }
    else
    {
      if (ep->type != 1U)
      {
        ...
        if (ep->xfer_len > 0U)
        {
          ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DIEPEMPMSK |= 1UL << (ep->num & 0xFU);
        }
      }
    }
    ...
    if (ep->type == 1U)
    {
      if ((((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DSTS & (1U << 8)) == 0U)
      {
        ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPCTL |= (0x1UL << (29U));
      }
      else
      {
        ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPCTL |= (0x1UL << (28U));
      }
    }


    ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPCTL |= ((0x1UL << (26U)) | (0x1UL << (31U)));
  ...
  else
  {
    ...
    ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPTSIZ &= ~((0x7FFFFUL << (0U)));
    ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPTSIZ &= ~((0x3FFUL << (19U)));

    if (ep->xfer_len == 0U)
    {
      ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPTSIZ |= ((0x7FFFFUL << (0U)) & ep->maxpacket);
      ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPTSIZ |= ((0x3FFUL << (19U)) & (1U << 19));
    }
    else
    {
      pktcnt = (uint16_t)((ep->xfer_len + ep->maxpacket - 1U) / ep->maxpacket);
      ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPTSIZ |= (0x3FFUL << (19U)) & ((uint32_t)pktcnt << 19);
      ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPTSIZ |= (0x7FFFFUL << (0U)) & (ep->maxpacket * pktcnt);
    }
    ...
    if (dma == 1U)
    {
      ...
      {
        ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPDMA = (uint32_t)(ep->xfer_buff);
      }
    }
    ...
    if (ep->type == 1U)
    {
      if ((((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DSTS & (1U << 8)) == 0U)
      {
        ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPCTL |= (0x1UL << (29U));
      }
      else
      {
        ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPCTL |= (0x1UL << (28U));
      }
    }

    ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPCTL |= ((0x1UL << (26U)) | (0x1UL << (31U)));
  }

  return HAL_OK;
}
# 850 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
HAL_StatusTypeDef USB_EP0StartXfer(USB_OTG_GlobalTypeDef *USBx, USB_OTG_EPTypeDef *ep, uint8_t dma)
{
  uint32_t USBx_BASE = (uint32_t)USBx;
  uint32_t epnum = (uint32_t)ep->num;
...
# 947 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
HAL_StatusTypeDef USB_WritePacket(USB_OTG_GlobalTypeDef *USBx, uint8_t *src, uint8_t ch_ep_num, uint16_t len, uint8_t dma)
{
  uint32_t USBx_BASE = (uint32_t)USBx;
  ...
  if (dma == 0U)
  {
    ...
    {
      *(volatile uint32_t *)(USBx_BASE + 0x1000UL + (((uint32_t)ch_ep_num) * 0x1000UL)) = *((uint32_t *)pSrc);
      pSrc++;
    }
  }
...
# 978 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
void *USB_ReadPacket(USB_OTG_GlobalTypeDef *USBx, uint8_t *dest, uint16_t len)
{
  uint32_t USBx_BASE = (uint32_t)USBx;
  ...
  for (i = 0U; i < count32b; i++)
  {
    *(uint32_t *)pDest = *(volatile uint32_t *)(USBx_BASE + 0x1000UL + ((0U) * 0x1000UL));
    pDest++;
  }
...
HAL_StatusTypeDef USB_EPSetStall(USB_OTG_GlobalTypeDef *USBx, USB_OTG_EPTypeDef *ep)
{
  ...
  if (ep->is_in == 1U)
  {
    if (((((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPCTL & (0x1UL << (31U))) == 0U) && (epnum != 0U))
    {
      ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPCTL &= ~((0x1UL << (30U)));
    }
    ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((epnum) * 0x0020UL)))->DIEPCTL |= (0x1UL << (21U));
  }
  else
  {
    if (((((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPCTL & (0x1UL << (31U))) == 0U) && (epnum != 0U))
    {
      ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPCTL &= ~((0x1UL << (30U)));
    }
    ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((epnum) * 0x0020UL)))->DOEPCTL |= (0x1UL << (21U));
  }
...
# 1101 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
HAL_StatusTypeDef USB_SetDevAddress(USB_OTG_GlobalTypeDef *USBx, uint8_t address)
{
  uint32_t USBx_BASE = (uint32_t)USBx;

  ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DCFG &= ~((0x7FUL << (4U)));
  ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DCFG |= ((uint32_t)address << 4) & (0x7FUL << (4U));
...
HAL_StatusTypeDef USB_DevConnect(USB_OTG_GlobalTypeDef *USBx)
{
  ...
  ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DCTL &= ~(0x1UL << (1U));
  HAL_Delay(3U);
...
uint32_t USB_ReadDevAllOutEpInterrupt(USB_OTG_GlobalTypeDef *USBx)
{
  ...
  tmpreg = ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DAINT;
  tmpreg &= ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DAINTMSK;
...
# 1195 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
uint32_t USB_ReadDevOutEPInterrupt(USB_OTG_GlobalTypeDef *USBx, uint8_t epnum)
{
  uint32_t USBx_BASE = (uint32_t)USBx;
  uint32_t tmpreg;

  tmpreg = ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + (((uint32_t)epnum) * 0x0020UL)))->DOEPINT;
  tmpreg &= ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DOEPMSK;

  return tmpreg;
}
# 1213 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
uint32_t USB_ReadDevInEPInterrupt(USB_OTG_GlobalTypeDef *USBx, uint8_t epnum)
{
  uint32_t USBx_BASE = (uint32_t)USBx;
  uint32_t tmpreg, msk, emp;

  msk = ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DIEPMSK;
  emp = ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DIEPEMPMSK;
  msk |= ((emp >> (epnum & 0xFU)) & 0x1U) << 7;
  tmpreg = ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + (((uint32_t)epnum) * 0x0020UL)))->DIEPINT & msk;
...
# 1245 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
uint32_t USB_GetMode(USB_OTG_GlobalTypeDef *USBx)
{
...
HAL_StatusTypeDef USB_ActivateSetup(USB_OTG_GlobalTypeDef *USBx)
{
  ...
  ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((0U) * 0x0020UL)))->DIEPCTL &= ~(0x7FFUL << (0U));

  if ((((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DSTS & (0x3UL << (1U))) == (2U << 1))
  {
    ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x0900UL + ((0U) * 0x0020UL)))->DIEPCTL |= 3U;
  }
  ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DCTL |= (0x1UL << (8U));

  return HAL_OK;
}
# 1281 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
HAL_StatusTypeDef USB_EP0_OutStart(USB_OTG_GlobalTypeDef *USBx, uint8_t dma, uint8_t *psetup)
{
  uint32_t USBx_BASE = (uint32_t)USBx;
  ...
  {
    if ((((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((0U) * 0x0020UL)))->DOEPCTL & (0x1UL << (31U))) == (0x1UL << (31U)))
    {
      return HAL_OK;
    }
  }

  ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((0U) * 0x0020UL)))->DOEPTSIZ = 0U;
  ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((0U) * 0x0020UL)))->DOEPTSIZ |= ((0x3FFUL << (19U)) & (1U << 19));
  ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((0U) * 0x0020UL)))->DOEPTSIZ |= (3U * 8U);
  ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((0U) * 0x0020UL)))->DOEPTSIZ |= (0x3UL << (29U));

  if (dma == 1U)
  {
    ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((0U) * 0x0020UL)))->DOEPDMA = (uint32_t)psetup;

    ((USB_OTG_OUTEndpointTypeDef *)(USBx_BASE + 0x0B00UL + ((0U) * 0x0020UL)))->DOEPCTL |= (0x1UL << (31U)) | (0x1UL << (15U));
  }
...
# 1419 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
HAL_StatusTypeDef USB_HostInit(USB_OTG_GlobalTypeDef *USBx, USB_OTG_CfgTypeDef cfg)
{
  uint32_t USBx_BASE = (uint32_t)USBx;
  uint32_t i;
  ...
  *(volatile uint32_t *)((uint32_t)USBx_BASE + 0x0E00UL) = 0U;
  ...
  if ((USBx->CID & (0x1U << 8)) != 0U)
  {
    if (cfg.speed == 3U)
    {
      ...
      ((USB_OTG_HostTypeDef *)(USBx_BASE + 0x0400UL))->HCFG |= (0x1UL << (2U));
    }
    else
    {
  ...
  {
    ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((i) * 0x0020UL)))->HCINT = 0xFFFFFFFFU;
    ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((i) * 0x0020UL)))->HCINTMSK = 0U;
  }
...
# 1510 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
HAL_StatusTypeDef USB_InitFSLSPClkSel(USB_OTG_GlobalTypeDef *USBx, uint8_t freq)
{
  uint32_t USBx_BASE = (uint32_t)USBx;

  ((USB_OTG_HostTypeDef *)(USBx_BASE + 0x0400UL))->HCFG &= ~((0x3UL << (0U)));
  ((USB_OTG_HostTypeDef *)(USBx_BASE + 0x0400UL))->HCFG |= (uint32_t)freq & (0x3UL << (0U));

  if (freq == 1U)
  {
    ((USB_OTG_HostTypeDef *)(USBx_BASE + 0x0400UL))->HFIR = 48000U;
  }
  else if (freq == 2U)
  {
    ((USB_OTG_HostTypeDef *)(USBx_BASE + 0x0400UL))->HFIR = 6000U;
  }
  else
  {
...
# 1540 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
HAL_StatusTypeDef USB_ResetPort(USB_OTG_GlobalTypeDef *USBx)
{
  uint32_t USBx_BASE = (uint32_t)USBx;
  ...
  hprt0 = *(volatile uint32_t *)((uint32_t)USBx_BASE + 0x0440UL);

  hprt0 &= ~((0x1UL << (2U)) | (0x1UL << (1U)) |
             (0x1UL << (3U)) | (0x1UL << (5U)));

  *(volatile uint32_t *)((uint32_t)USBx_BASE + 0x0440UL) = ((0x1UL << (8U)) | hprt0);
  HAL_Delay(100U);
  *(volatile uint32_t *)((uint32_t)USBx_BASE + 0x0440UL) = ((~(0x1UL << (8U))) & hprt0);
  HAL_Delay(10U);
...
# 1567 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
HAL_StatusTypeDef USB_DriveVbus(USB_OTG_GlobalTypeDef *USBx, uint8_t state)
{
  uint32_t USBx_BASE = (uint32_t)USBx;
  volatile uint32_t hprt0 = 0U;
  ...
  {
    *(volatile uint32_t *)((uint32_t)USBx_BASE + 0x0440UL) = ((0x1UL << (12U)) | hprt0);
  }
...
# 1597 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
uint32_t USB_GetHostSpeed(USB_OTG_GlobalTypeDef *USBx)
{
  uint32_t USBx_BASE = (uint32_t)USBx;
  volatile uint32_t hprt0 = 0U;
...
uint32_t USB_GetCurrentFrame(USB_OTG_GlobalTypeDef *USBx)
{
  ...
  return (((USB_OTG_HostTypeDef *)(USBx_BASE + 0x0400UL))->HFNUM & (0xFFFFUL << (0U)));
}
# 1642 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
HAL_StatusTypeDef USB_HC_Init(USB_OTG_GlobalTypeDef *USBx,
                              uint8_t ch_num,
                              uint8_t epnum,
                              uint8_t dev_address,
                              ...
                              uint16_t mps)
{
  ...
  ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + (((uint32_t)ch_num) * 0x0020UL)))->HCINT = 0xFFFFFFFFU;
  ...
  switch (ep_type)
  {
    case 0U:
    case 2U:
      ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + (((uint32_t)ch_num) * 0x0020UL)))->HCINTMSK = (0x1UL << (0U)) |
                                            (0x1UL << (3U)) |
                                            (0x1UL << (7U)) |
                                            (0x1UL << (10U)) |
                                            (0x1UL << (2U)) |
      ...
      {
        ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + (((uint32_t)ch_num) * 0x0020UL)))->HCINTMSK |= (0x1UL << (8U));
      }
      else
      {
        if ((USBx->CID & (0x1U << 8)) != 0U)
        {
          ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + (((uint32_t)ch_num) * 0x0020UL)))->HCINTMSK |= ((0x1UL << (6U)) | (0x1UL << (5U)));
        }
      }
      break;
    ...
    case 1U:
      ...
      if ((epnum & 0x80U) == 0x80U)
      {
        ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + (((uint32_t)ch_num) * 0x0020UL)))->HCINTMSK |= ((0x1UL << (7U)) | (0x1UL << (8U)));
      }
      break;
  ...
  ((USB_OTG_HostTypeDef *)(USBx_BASE + 0x0400UL))->HAINTMSK |= 1UL << (ch_num & 0xFU);
  ...
  ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + (((uint32_t)ch_num) * 0x0020UL)))->HCCHAR = (((uint32_t)dev_address << 22) & (0x7FUL << (22U))) |
  ...
  if (ep_type == 3U)
  {
    ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + (((uint32_t)ch_num) * 0x0020UL)))->HCCHAR |= (0x1UL << (29U)) ;
  }

  return ret;
}
# 1763 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
HAL_StatusTypeDef USB_HC_StartXfer(USB_OTG_GlobalTypeDef *USBx, USB_OTG_HCTypeDef *hc, uint8_t dma)
{
  uint32_t USBx_BASE = (uint32_t)USBx;
  ...
  if (((USBx->CID & (0x1U << 8)) != 0U) && (hc->speed == 0U))
  {
    ...
    {
      ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((ch_num) * 0x0020UL)))->HCINTMSK &= ~((0x1UL << (6U)) | (0x1UL << (5U)));
      hc->do_ping = 0U;
    }
    else
    {
  ...
  ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((ch_num) * 0x0020UL)))->HCTSIZ = (hc->xfer_len & (0x7FFFFUL << (0U))) |
  ...
  if (dma != 0U)
  {
    ...
    ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((ch_num) * 0x0020UL)))->HCDMA = (uint32_t)hc->xfer_buff;
  }

  is_oddframe = (((uint32_t)((USB_OTG_HostTypeDef *)(USBx_BASE + 0x0400UL))->HFNUM & 0x01U) != 0U) ? 0U : 1U;
  ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((ch_num) * 0x0020UL)))->HCCHAR &= ~(0x1UL << (29U));
  ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((ch_num) * 0x0020UL)))->HCCHAR |= (uint32_t)is_oddframe << 29;


  tmpreg = ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((ch_num) * 0x0020UL)))->HCCHAR;
  tmpreg &= ~(0x1UL << (30U));
  ...
  tmpreg |= (0x1UL << (31U));
  ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((ch_num) * 0x0020UL)))->HCCHAR = tmpreg;
    ...
    if ((hc->ep_is_in == 0U) && (hc->xfer_len > 0U))
    {
      switch (hc->ep_type)
      {
        ...
        case 1U:
          ...
          if (len_words > (((USB_OTG_HostTypeDef *)(USBx_BASE + 0x0400UL))->HPTXSTS & 0xFFFFU))
          {
...
uint32_t USB_HC_ReadInterrupt(USB_OTG_GlobalTypeDef *USBx)
{
  ...
  return ((((USB_OTG_HostTypeDef *)(USBx_BASE + 0x0400UL))->HAINT) & 0xFFFFU);
}
# 1905 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
HAL_StatusTypeDef USB_HC_Halt(USB_OTG_GlobalTypeDef *USBx, uint8_t hc_num)
{
  uint32_t USBx_BASE = (uint32_t)USBx;
  uint32_t hcnum = (uint32_t)hc_num;
  uint32_t count = 0U;
  uint32_t HcEpType = (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((hcnum) * 0x0020UL)))->HCCHAR & (0x3UL << (18U))) >> 18;


  if ((HcEpType == 0U) || (HcEpType == 2U))
  {
    ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((hcnum) * 0x0020UL)))->HCCHAR |= (0x1UL << (30U));

    if ((USBx->HNPTXSTS & (0xFFU << 16)) == 0U)
    {
      ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((hcnum) * 0x0020UL)))->HCCHAR &= ~(0x1UL << (31U));
      ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((hcnum) * 0x0020UL)))->HCCHAR |= (0x1UL << (31U));
      ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((hcnum) * 0x0020UL)))->HCCHAR &= ~(0x1UL << (15U));
      do
      {
        if (++count > 1000U)
        {
      ...
      while ((((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((hcnum) * 0x0020UL)))->HCCHAR & (0x1UL << (31U))) == (0x1UL << (31U)));
    }
    else
    {
      ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((hcnum) * 0x0020UL)))->HCCHAR |= (0x1UL << (31U));
  ...
  else
  {
    ...
    if ((((USB_OTG_HostTypeDef *)(USBx_BASE + 0x0400UL))->HPTXSTS & (0xFFU << 16)) == 0U)
    {
      ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((hcnum) * 0x0020UL)))->HCCHAR &= ~(0x1UL << (31U));
      ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((hcnum) * 0x0020UL)))->HCCHAR |= (0x1UL << (31U));
      ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((hcnum) * 0x0020UL)))->HCCHAR &= ~(0x1UL << (15U));
...
# 1970 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_ll_usb.c"
HAL_StatusTypeDef USB_DoPing(USB_OTG_GlobalTypeDef *USBx, uint8_t ch_num)
{
  uint32_t USBx_BASE = (uint32_t)USBx;
  ...
  ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((chnum) * 0x0020UL)))->HCTSIZ = ((num_packets << 19) & (0x3FFUL << (19U))) |
                           (0x1UL << (31U));


  tmpreg = ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((chnum) * 0x0020UL)))->HCCHAR;
  tmpreg &= ~(0x1UL << (30U));
  tmpreg |= (0x1UL << (31U));
  ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((chnum) * 0x0020UL)))->HCCHAR = tmpreg;
...
HAL_StatusTypeDef USB_StopHost(USB_OTG_GlobalTypeDef *USBx)
{
  ...
  for (i = 0U; i <= 15U; i++)
  {
    value = ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((i) * 0x0020UL)))->HCCHAR;
    value |= (0x1UL << (30U));
    value &= ~(0x1UL << (31U));
    value &= ~(0x1UL << (15U));
    ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((i) * 0x0020UL)))->HCCHAR = value;
  }
  ...
  for (i = 0U; i <= 15U; i++)
  {
    ...
    while ((((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x0500UL + ((i) * 0x0020UL)))->HCCHAR & (0x1UL << (31U))) == (0x1UL << (31U)));
  }


  ((USB_OTG_HostTypeDef *)(USBx_BASE + 0x0400UL))->HAINT = 0xFFFFFFFFU;
  USBx->GINTSTS = 0xFFFFFFFFU;
...
HAL_StatusTypeDef USB_ActivateRemoteWakeup(USB_OTG_GlobalTypeDef *USBx)
{
  ...
  if ((((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DSTS & (0x1UL << (0U))) == (0x1UL << (0U)))
  {

    ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x0800UL))->DCTL |= (0x1UL << (0U));
  }
