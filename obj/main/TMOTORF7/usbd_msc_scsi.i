# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
# 27 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
...
void MSC_BOT_CplClrFeature (USBD_HandleTypeDef *pdev,
                             uint8_t epnum);
# 28 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c" 2
...
void SCSI_SenseCode(USBD_HandleTypeDef *pdev, uint8_t lun, uint8_t sKey,
                    uint8_t ASC);
# 29 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c" 2
...
# 30 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c" 2
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_data.h" 1
# 73 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_data.h"
extern const uint8_t MSC_Page00_Inquiry_Data[];
extern const uint8_t MSC_Mode_Sense6_data[];
extern const uint8_t MSC_Mode_Sense10_data[] ;
# 31 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c" 2
# 81 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
...
# 115 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
int8_t SCSI_ProcessCmd(USBD_HandleTypeDef *pdev, uint8_t lun, uint8_t *cmd)
{
  switch (cmd[0])
  {
  ...
  default:
    SCSI_SenseCode(pdev, lun, 5U, 0x20U);
    return -1;
  }
  return 0;
}
# 181 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
static int8_t SCSI_TestUnitReady(USBD_HandleTypeDef *pdev, uint8_t lun, uint8_t *params)
{
  ((void)(params));
  ...
  {
    SCSI_SenseCode(pdev, hmsc->cbw.bLUN, 5U, 0x20U);
  ...
  {
    SCSI_SenseCode(pdev, lun, 2U, 0x3AU);
    hmsc->bot_state = 5U;
...
# 214 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
static int8_t SCSI_Inquiry(USBD_HandleTypeDef *pdev, uint8_t lun, uint8_t *params)
{
  uint8_t* pPage;
  uint16_t len;
  ...
  {
    pPage = (uint8_t *)(void *)&((USBD_StorageTypeDef *)pdev->pMSC_UserData)->pInquiry[lun * 0x24U];
...
# 259 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
static int8_t SCSI_ReadCapacity10(USBD_HandleTypeDef *pdev, uint8_t lun, uint8_t *params)
{
  ((void)(params));
...
# 368 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
static int8_t SCSI_ModeSense10 (USBD_HandleTypeDef *pdev, uint8_t lun, uint8_t *params)
{
  ((void)(lun));
  ((void)(params));
...
# 400 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
static int8_t SCSI_RequestSense (USBD_HandleTypeDef *pdev, uint8_t lun, uint8_t *params)
{
  ((void)(lun));
  ...
  if((hmsc->scsi_sense_head != hmsc->scsi_sense_tail)) {
    ...
    if (hmsc->scsi_sense_head == 4U)
    {
      hmsc->scsi_sense_head = 0U;
    }
  }
  hmsc->bot_data_length = 0x12U;
...
# 445 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
...
# 482 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
static int8_t SCSI_Read10(USBD_HandleTypeDef *pdev, uint8_t lun, uint8_t *params)
{
  USBD_MSC_BOT_HandleTypeDef *hmsc = (USBD_MSC_BOT_HandleTypeDef*) pdev->pMSC_ClassData;

  if(hmsc->bot_state == 0U)
  {
  ...
  hmsc->bot_data_length = 512U;

  return SCSI_ProcessRead(pdev, lun);
}
# 536 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
static int8_t SCSI_Write10 (USBD_HandleTypeDef *pdev, uint8_t lun , uint8_t *params)
{
  USBD_MSC_BOT_HandleTypeDef *hmsc = (USBD_MSC_BOT_HandleTypeDef*) pdev->pMSC_ClassData;
  uint32_t len;
  ...
  if (hmsc->bot_state == 0U)
  {
    ...
    if(((USBD_StorageTypeDef *)pdev->pMSC_UserData)->IsWriteProtected(lun) != 0)
    {
      SCSI_SenseCode(pdev, lun, 2U, 0x27U);
      return -1;
    }
    ...
    len = __extension__ ({ __typeof__ (len) _a = (len); __typeof__ (512U) _b = (512U); _a < _b ? _a : _b; });


    hmsc->bot_state = 1U;
    USBD_LL_PrepareReceive (pdev, 0x01U, hmsc->bot_data, len);
  }
  else
  {
...
# 610 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
static int8_t SCSI_Verify10(USBD_HandleTypeDef *pdev, uint8_t lun , uint8_t *params)
{
  USBD_MSC_BOT_HandleTypeDef *hmsc = (USBD_MSC_BOT_HandleTypeDef*) pdev->pMSC_ClassData;
  ...
  {
    SCSI_SenseCode(pdev, lun, 5U, 0x24U);
    return -1;
  }
...
# 637 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
static int8_t SCSI_CheckAddressRange (USBD_HandleTypeDef *pdev, uint8_t lun,
                                      uint32_t blk_offset, uint32_t blk_nbr)
{
  USBD_MSC_BOT_HandleTypeDef *hmsc = (USBD_MSC_BOT_HandleTypeDef*) pdev->pMSC_ClassData;
  ...
  {
    SCSI_SenseCode(pdev, lun, 5U, 0x21U);
    return -1;
  }
  return 0;
}
...
static int8_t SCSI_ProcessRead (USBD_HandleTypeDef *pdev, uint8_t lun)
{
  ...
  {
    SCSI_SenseCode(pdev, lun, 4U, 0x11U);
    return -1;
  }

  USBD_LL_Transmit (pdev, 0x81U, hmsc->bot_data, len);
...
# 694 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
static int8_t SCSI_ProcessWrite (USBD_HandleTypeDef *pdev, uint8_t lun)
{
  USBD_MSC_BOT_HandleTypeDef *hmsc = (USBD_MSC_BOT_HandleTypeDef*) pdev->pMSC_ClassData;
  uint32_t len = hmsc->scsi_blk_len * hmsc->scsi_blk_size;
  ...
  if(((USBD_StorageTypeDef *)pdev->pMSC_UserData)->Write(lun, hmsc->bot_data,
                             ...
                             (len / hmsc->scsi_blk_size)) < 0)
  {
    SCSI_SenseCode(pdev, lun, 4U, 0x03U);
  ...
  if (hmsc->scsi_blk_len == 0U)
  {
    MSC_BOT_SendCSW (pdev, 0x00U);
  }
  else
  {
    len = __extension__ ({ __typeof__ ((hmsc->scsi_blk_len * hmsc->scsi_blk_size)) _a = ((hmsc->scsi_blk_len * hmsc->scsi_blk_size)); __typeof__ (512U) _b = (512U); _a < _b ? _a : _b; });
