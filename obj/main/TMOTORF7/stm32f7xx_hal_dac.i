# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c"
# 212 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c"
...
# 213 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c" 2
# 233 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c"
static void DAC_DMAConvCpltCh1(DMA_HandleTypeDef *hdma);
static void DAC_DMAErrorCh1(DMA_HandleTypeDef *hdma);
static void DAC_DMAHalfConvCpltCh1(DMA_HandleTypeDef *hdma);
# 267 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c"
HAL_StatusTypeDef HAL_DAC_Init(DAC_HandleTypeDef* hdac)
{

  if(hdac == 
# 270 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c" 3 4
            ((void *)0)
# 270 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c"
                )
  {
     return HAL_ERROR;
  }
  ...
  {
# 297 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c"
...
HAL_StatusTypeDef HAL_DAC_DeInit(DAC_HandleTypeDef* hdac)
{
  ...
  if(hdac == 
# 329 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c" 3 4
            ((void *)0)
# 329 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c"
                )
  {
     return HAL_ERROR;
  }
  ...
  hdac->State = HAL_DAC_STATE_BUSY;
# 349 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c"
  ...
  do{ (hdac)->Lock = HAL_UNLOCKED; }while (0U);
...
# 429 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c"
HAL_StatusTypeDef HAL_DAC_Start(DAC_HandleTypeDef* hdac, uint32_t Channel)
{
  ...
  do{ if((hdac)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hdac)->Lock = HAL_LOCKED; } }while (0U);


  hdac->State = HAL_DAC_STATE_BUSY;


  ((hdac)->Instance->CR |= ((0x1UL << (0U)) << (Channel)));

  if(Channel == ((uint32_t)0x00000000U))
  {
    tmp1 = hdac->Instance->CR & (0x1UL << (2U));
    tmp2 = hdac->Instance->CR & (0x7UL << (3U));

    if((tmp1 == (0x1UL << (2U))) && (tmp2 == (0x7UL << (3U))))
    {

      hdac->Instance->SWTRIGR |= (uint32_t)(0x1UL << (0U));
    }
  }
  else
  {
    tmp1 = hdac->Instance->CR & (0x1UL << (18U));
    tmp2 = hdac->Instance->CR & (0x7UL << (19U));

    if((tmp1 == (0x1UL << (18U))) && (tmp2 == (0x7UL << (19U))))
    {

      hdac->Instance->SWTRIGR |= (uint32_t)(0x1UL << (1U));
    }
  }
...
# 488 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c"
HAL_StatusTypeDef HAL_DAC_Stop(DAC_HandleTypeDef* hdac, uint32_t Channel)
{
...
# 520 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c"
HAL_StatusTypeDef HAL_DAC_Start_DMA(DAC_HandleTypeDef* hdac, uint32_t Channel, uint32_t* pData, uint32_t Length, uint32_t Alignment)
{
  uint32_t tmpreg = 0;
  ...
  if(Channel == ((uint32_t)0x00000000U))
  {
    ...
    (((hdac)->Instance->CR) |= (((uint32_t)(0x1UL << (13U)))));
  ...
  else
  {
    ...
    (((hdac)->Instance->CR) |= (((uint32_t)(0x1UL << (29U)))));
...
# 639 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c"
HAL_StatusTypeDef HAL_DAC_Stop_DMA(DAC_HandleTypeDef* hdac, uint32_t Channel)
{
  ...
  ((void)0U);
   ...
   hdac->Instance->CR &= ~((0x1UL << (12U)) << Channel);
...
# 689 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c"
uint32_t HAL_DAC_GetValue(DAC_HandleTypeDef* hdac, uint32_t Channel)
{
...
void HAL_DAC_IRQHandler(DAC_HandleTypeDef* hdac)
{
  ...
  if(((((hdac)->Instance->SR) & (((uint32_t)(0x1UL << (13U))))) == (((uint32_t)(0x1UL << (13U))))))
  {

    hdac->State = HAL_DAC_STATE_ERROR;


    hdac->ErrorCode |= 0x01U;


    (((hdac)->Instance->SR) = (((uint32_t)(0x1UL << (13U)))));
  ...
  if(((((hdac)->Instance->SR) & (((uint32_t)(0x1UL << (29U))))) == (((uint32_t)(0x1UL << (29U))))))
  {

    hdac->State = HAL_DAC_STATE_ERROR;


    hdac->ErrorCode |= 0x02U;


    (((hdac)->Instance->SR) = (((uint32_t)(0x1UL << (29U)))));
...
# 853 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c"
HAL_StatusTypeDef HAL_DAC_ConfigChannel(DAC_HandleTypeDef* hdac, DAC_ChannelConfTypeDef* sConfig, uint32_t Channel)
{
  ...
  tmpreg1 &= ~(((uint32_t)((0xFUL << (8U)) | (0x3UL << (6U)) | (0x7UL << (3U)) | (0x1UL << (2U)) | (0x1UL << (1U)))) << Channel);
  ...
  hdac->Instance->CR &= ~((0x3UL << (6U)) << Channel);
...
# 909 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c"
HAL_StatusTypeDef HAL_DAC_SetValue(DAC_HandleTypeDef* hdac, uint32_t Channel, uint32_t Alignment, uint32_t Data)
{
  ...
  if(Channel == ((uint32_t)0x00000000U))
  {
    tmp += (((uint32_t)0x00000008U) + (Alignment));
  }
  else
  {
    tmp += (((uint32_t)0x00000014U) + (Alignment));
  }
...
# 961 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c"
HAL_DAC_StateTypeDef HAL_DAC_GetState(DAC_HandleTypeDef* hdac)
{

  return hdac->State;
}
# 974 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c"
uint32_t HAL_DAC_GetError(DAC_HandleTypeDef *hdac)
{
  return hdac->ErrorCode;
}
# 1233 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_dac.c"
static void DAC_DMAConvCpltCh1(DMA_HandleTypeDef *hdma)
{
