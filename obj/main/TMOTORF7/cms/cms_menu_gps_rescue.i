# 1 "./src/main/cms/cms_menu_gps_rescue.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/cms/cms_menu_gps_rescue.c"
# 21 "./src/main/cms/cms_menu_gps_rescue.c"
# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include/stdbool.h" 1 3 4
# 22 "./src/main/cms/cms_menu_gps_rescue.c" 2
...
# 23 "./src/main/cms/cms_menu_gps_rescue.c" 2
...
# 24 "./src/main/cms/cms_menu_gps_rescue.c" 2
...
int toupper (int __c);
int isblank (int __c);
# 25 "./src/main/cms/cms_menu_gps_rescue.c" 2
...
# 153 "./src/main/platform.h" 2
# 27 "./src/main/cms/cms_menu_gps_rescue.c" 2
...
# 31 "./src/main/cms/cms_menu_gps_rescue.c" 2
...
# 33 "./src/main/cms/cms_menu_gps_rescue.c" 2

# 1 "./src/main/cms/cms_menu_gps_rescue.h" 1
# 21 "./src/main/cms/cms_menu_gps_rescue.h"
       

extern CMS_Menu cmsx_menuGpsRescue;
# 35 "./src/main/cms/cms_menu_gps_rescue.c" 2
...
# 37 "./src/main/cms/cms_menu_gps_rescue.c" 2
...
# 39 "./src/main/cms/cms_menu_gps_rescue.c" 2
...
# 41 "./src/main/cms/cms_menu_gps_rescue.c" 2


static uint16_t gpsRescueConfig_angle;
static uint16_t gpsRescueConfig_initialAltitudeM;
static uint16_t gpsRescueConfig_descentDistanceM;
static uint16_t gpsRescueConfig_rescueGroundspeed;
...
static uint16_t gpsRescueConfig_minRescueDth;
...
static const void *cms_menuGpsRescuePidOnEnter(displayPort_t *pDisp)
{
    ...
    return 
# 76 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
          ((void *)0)
# 76 "./src/main/cms/cms_menu_gps_rescue.c"
              ;
}
...
static const void *cms_menuGpsRescuePidOnExit(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    return 
# 94 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
          ((void *)0)
# 94 "./src/main/cms/cms_menu_gps_rescue.c"
              ;
}

const OSD_Entry cms_menuGpsRescuePidEntries[] =
{
    {"--- GPS RESCUE PID---", OME_Label, 
# 99 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                        ((void *)0)
# 99 "./src/main/cms/cms_menu_gps_rescue.c"
                                            , 
# 99 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                              ((void *)0)
# 99 "./src/main/cms/cms_menu_gps_rescue.c"
    ...
    { "THROTTLE P", OME_UINT16 | 0x0200, 
# 101 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                        ((void *)0)
# 101 "./src/main/cms/cms_menu_gps_rescue.c"
                                                            , &(OSD_UINT16_t){ &gpsRescueConfig_throttleP, 0, 500, 1 } },
    { "THROTTLE I", OME_UINT16 | 0x0200, 
# 102 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                        ((void *)0)
# 102 "./src/main/cms/cms_menu_gps_rescue.c"
                                                            , &(OSD_UINT16_t){ &gpsRescueConfig_throttleI, 0, 500, 1 } },
    { "THROTTLE D", OME_UINT16 | 0x0200, 
# 103 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                        ((void *)0)
# 103 "./src/main/cms/cms_menu_gps_rescue.c"
                                                            , &(OSD_UINT16_t){ &gpsRescueConfig_throttleD, 0, 500, 1 } },

    { "YAW P", OME_UINT16 | 0x0200, 
# 105 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                        ((void *)0)
# 105 "./src/main/cms/cms_menu_gps_rescue.c"
                                                            , &(OSD_UINT16_t){ &gpsRescueConfig_yawP, 0, 500, 1 } },

    { "VELOCITY P", OME_UINT16 | 0x0200, 
# 107 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                        ((void *)0)
# 107 "./src/main/cms/cms_menu_gps_rescue.c"
                                                            , &(OSD_UINT16_t){ &gpsRescueConfig_velP, 0, 500, 1 } },
    { "VELOCITY I", OME_UINT16 | 0x0200, 
# 108 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                        ((void *)0)
# 108 "./src/main/cms/cms_menu_gps_rescue.c"
                                                            , &(OSD_UINT16_t){ &gpsRescueConfig_velI, 0, 500, 1 } },
    { "VELOCITY D", OME_UINT16 | 0x0200, 
# 109 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                        ((void *)0)
# 109 "./src/main/cms/cms_menu_gps_rescue.c"
                                                            , &(OSD_UINT16_t){ &gpsRescueConfig_velD, 0, 500, 1 } },

    {"BACK", OME_Back, 
# 111 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                      ((void *)0)
# 111 "./src/main/cms/cms_menu_gps_rescue.c"
                          , 
# 111 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                            ((void *)0)
# 111 "./src/main/cms/cms_menu_gps_rescue.c"
    ...
    {
# 112 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
    ((void *)0)
# 112 "./src/main/cms/cms_menu_gps_rescue.c"
        , OME_END, 
# 112 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                   ((void *)0)
# 112 "./src/main/cms/cms_menu_gps_rescue.c"
...
CMS_Menu cms_menuGpsRescuePid = {
    ...
    .onDisplayUpdate = 
# 122 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                      ((void *)0)
# 122 "./src/main/cms/cms_menu_gps_rescue.c"
                          ,
...
static const void *cmsx_menuGpsRescueOnEnter(displayPort_t *pDisp)
{
    ...
    return 
# 146 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
          ((void *)0)
# 146 "./src/main/cms/cms_menu_gps_rescue.c"
              ;
}
...
static const void *cmsx_menuGpsRescueOnExit(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    return 
# 170 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
          ((void *)0)
# 170 "./src/main/cms/cms_menu_gps_rescue.c"
              ;
}

const OSD_Entry cmsx_menuGpsRescueEntries[] =
{
    {"--- GPS RESCUE ---", OME_Label, 
# 175 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                     ((void *)0)
# 175 "./src/main/cms/cms_menu_gps_rescue.c"
                                         , 
# 175 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                           ((void *)0)
# 175 "./src/main/cms/cms_menu_gps_rescue.c"
    ...
    { "ANGLE", OME_UINT16 | 0x0200, 
# 177 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                        ((void *)0)
# 177 "./src/main/cms/cms_menu_gps_rescue.c"
                                                            , &(OSD_UINT16_t){ &gpsRescueConfig_angle, 0, 200 ,1 } },
    { "MIN DIST HOME   M", OME_UINT16 | 0x0200, 
# 178 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                        ((void *)0)
# 178 "./src/main/cms/cms_menu_gps_rescue.c"
                                                            , &(OSD_UINT16_t){ &gpsRescueConfig_minRescueDth, 50, 1000 ,1 } },
    { "INITAL ALT      M", OME_UINT16 | 0x0200, 
# 179 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                        ((void *)0)
# 179 "./src/main/cms/cms_menu_gps_rescue.c"
                                                            , &(OSD_UINT16_t){ &gpsRescueConfig_initialAltitudeM, 20, 100, 1 } },
    { "ALTITUDE MODE" , OME_TAB | 0x0200, 
# 180 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                     ((void *)0)
# 180 "./src/main/cms/cms_menu_gps_rescue.c"
                                                         , &(OSD_TAB_t) { &gpsRescueConfig_altitudeMode, 2, lookupTableRescueAltitudeMode} },
    { "DESCENT DIST    M", OME_UINT16 | 0x0200, 
# 181 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                        ((void *)0)
# 181 "./src/main/cms/cms_menu_gps_rescue.c"
                                                            , &(OSD_UINT16_t){ &gpsRescueConfig_descentDistanceM, 30, 500, 1 } },
    { "LANDING ALT     M", OME_UINT16 | 0x0200, 
# 182 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                        ((void *)0)
# 182 "./src/main/cms/cms_menu_gps_rescue.c"
                                                            , &(OSD_UINT16_t){ &gpsRescueConfig_targetLandingAltitudeM, 3, 10, 1 } },
    { "LANDING DIST    M", OME_UINT16 | 0x0200, 
# 183 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                        ((void *)0)
# 183 "./src/main/cms/cms_menu_gps_rescue.c"
                                                            , &(OSD_UINT16_t){ &gpsRescueConfig_targetLandingDistanceM, 5, 15, 1 } },
    { "GROUND SPEED CM/S", OME_UINT16 | 0x0200, 
# 184 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                        ((void *)0)
# 184 "./src/main/cms/cms_menu_gps_rescue.c"
                                                            , &(OSD_UINT16_t){ &gpsRescueConfig_rescueGroundspeed, 30, 3000, 1 } },
    { "THROTTLE MIN", OME_UINT16 | 0x0200, 
# 185 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                        ((void *)0)
# 185 "./src/main/cms/cms_menu_gps_rescue.c"
                                                            , &(OSD_UINT16_t){ &gpsRescueConfig_throttleMin, 1000, 2000, 1 } },
    { "THROTTLE MAX", OME_UINT16 | 0x0200, 
# 186 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                        ((void *)0)
# 186 "./src/main/cms/cms_menu_gps_rescue.c"
                                                            , &(OSD_UINT16_t){ &gpsRescueConfig_throttleMax, 1000, 2000, 1 } },
    { "THROTTLE HOV", OME_UINT16 | 0x0200, 
# 187 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                        ((void *)0)
# 187 "./src/main/cms/cms_menu_gps_rescue.c"
                                                            , &(OSD_UINT16_t){ &gpsRescueConfig_throttleHover, 1000, 2000, 1 } },
    { "ASCEND RATE", OME_UINT16 | 0x0200, 
# 188 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                        ((void *)0)
# 188 "./src/main/cms/cms_menu_gps_rescue.c"
                                                            , &(OSD_UINT16_t){ &gpsRescueConfig_ascendRate, 100, 2500, 1 } },
    { "DESCEND RATE", OME_UINT16 | 0x0200, 
# 189 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                        ((void *)0)
# 189 "./src/main/cms/cms_menu_gps_rescue.c"
                                                            , &(OSD_UINT16_t){ &gpsRescueConfig_descendRate, 100, 500, 1 } },
    { "ARM WITHOUT FIX", OME_Bool | 0x0200, 
# 190 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                       ((void *)0)
# 190 "./src/main/cms/cms_menu_gps_rescue.c"
                                                           , &gpsRescueConfig_allowArmingWithoutFix },
    { "MIN SATELITES", OME_UINT8 | 0x0200, 
# 191 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                                       ((void *)0)
# 191 "./src/main/cms/cms_menu_gps_rescue.c"
                                                           , &(OSD_UINT8_t){ &gpsRescueConfig_minSats, 5, 50, 1 } },
    { "GPS RESCUE PID", OME_Submenu, cmsMenuChange, &cms_menuGpsRescuePid},

    {"BACK", OME_Back, 
# 194 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                      ((void *)0)
# 194 "./src/main/cms/cms_menu_gps_rescue.c"
                          , 
# 194 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                            ((void *)0)
# 194 "./src/main/cms/cms_menu_gps_rescue.c"
    ...
    {
# 195 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
    ((void *)0)
# 195 "./src/main/cms/cms_menu_gps_rescue.c"
        , OME_END, 
# 195 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                   ((void *)0)
# 195 "./src/main/cms/cms_menu_gps_rescue.c"
...
CMS_Menu cmsx_menuGpsRescue = {
    ...
    .onDisplayUpdate = 
# 205 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                      ((void *)0)
# 205 "./src/main/cms/cms_menu_gps_rescue.c"
                          ,
