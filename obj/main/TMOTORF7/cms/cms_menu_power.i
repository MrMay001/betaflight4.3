...
static const void *cmsx_Power_onEnter(displayPort_t *pDisp)
{
    ...
    return 
# 80 "./src/main/cms/cms_menu_power.c" 3 4
          ((void *)0)
# 80 "./src/main/cms/cms_menu_power.c"
              ;
}
...
static const void *cmsx_Power_onExit(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    return 
# 105 "./src/main/cms/cms_menu_power.c" 3 4
          ((void *)0)
# 105 "./src/main/cms/cms_menu_power.c"
              ;
}
...
# 110 "./src/main/cms/cms_menu_power.c"
    ...
    { "V METER", OME_TAB | 0x0200, 
# 112 "./src/main/cms/cms_menu_power.c" 3 4
                                           ((void *)0)
# 112 "./src/main/cms/cms_menu_power.c"
                                               , &(OSD_TAB_t){ &batteryConfig_voltageMeterSource, VOLTAGE_METER_COUNT - 1, voltageMeterSourceNames } },
    { "I METER", OME_TAB | 0x0200, 
# 113 "./src/main/cms/cms_menu_power.c" 3 4
                                           ((void *)0)
# 113 "./src/main/cms/cms_menu_power.c"
                                               , &(OSD_TAB_t){ &batteryConfig_currentMeterSource, CURRENT_METER_COUNT - 1, currentMeterSourceNames } },

    { "VBAT CLMIN", OME_UINT16, 
# 115 "./src/main/cms/cms_menu_power.c" 3 4
                               ((void *)0)
# 115 "./src/main/cms/cms_menu_power.c"
                                   , &(OSD_UINT16_t) { &batteryConfig_vbatmincellvoltage, 100, 500, 1 } },
    { "VBAT CLMAX", OME_UINT16, 
# 116 "./src/main/cms/cms_menu_power.c" 3 4
                               ((void *)0)
# 116 "./src/main/cms/cms_menu_power.c"
                                   , &(OSD_UINT16_t) { &batteryConfig_vbatmaxcellvoltage, 100, 500, 1 } },
    { "VBAT CLWARN", OME_UINT16, 
# 117 "./src/main/cms/cms_menu_power.c" 3 4
                                ((void *)0)
# 117 "./src/main/cms/cms_menu_power.c"
                                    , &(OSD_UINT16_t) { &batteryConfig_vbatwarningcellvoltage, 100, 500, 1 } },

    { "VBAT SCALE", OME_UINT8, 
# 119 "./src/main/cms/cms_menu_power.c" 3 4
                              ((void *)0)
# 119 "./src/main/cms/cms_menu_power.c"
                                  , &(OSD_UINT8_t){ &voltageSensorADCConfig_vbatscale, 0, 255, 1 } },

    { "IBAT SCALE", OME_INT16, 
# 121 "./src/main/cms/cms_menu_power.c" 3 4
                              ((void *)0)
# 121 "./src/main/cms/cms_menu_power.c"
                                  , &(OSD_INT16_t){ &currentSensorADCConfig_scale, -16000, 16000, 5 } },
    { "IBAT OFFSET", OME_INT16, 
# 122 "./src/main/cms/cms_menu_power.c" 3 4
                               ((void *)0)
# 122 "./src/main/cms/cms_menu_power.c"
                                   , &(OSD_INT16_t){ &currentSensorADCConfig_offset, -32000, 32000, 5 } },


    { "IBAT VIRT SCALE", OME_INT16, 
# 125 "./src/main/cms/cms_menu_power.c" 3 4
                                   ((void *)0)
# 125 "./src/main/cms/cms_menu_power.c"
                                       , &(OSD_INT16_t){ &currentSensorVirtualConfig_scale, -16000, 16000, 5 } },
    { "IBAT VIRT OFFSET", OME_UINT16, 
# 126 "./src/main/cms/cms_menu_power.c" 3 4
                                     ((void *)0)
# 126 "./src/main/cms/cms_menu_power.c"
                                         , &(OSD_UINT16_t){ &currentSensorVirtualConfig_offset, 0, 16000, 5 } },


    { "BACK", OME_Back, 
# 129 "./src/main/cms/cms_menu_power.c" 3 4
                       ((void *)0)
# 129 "./src/main/cms/cms_menu_power.c"
                           , 
# 129 "./src/main/cms/cms_menu_power.c" 3 4
                             ((void *)0) 
# 129 "./src/main/cms/cms_menu_power.c"
    ...
    { 
# 130 "./src/main/cms/cms_menu_power.c" 3 4
     ((void *)0)
# 130 "./src/main/cms/cms_menu_power.c"
         , OME_END, 
# 130 "./src/main/cms/cms_menu_power.c" 3 4
                    ((void *)0)
# 130 "./src/main/cms/cms_menu_power.c"
...
CMS_Menu cmsx_menuPower = {
    ...
    .onDisplayUpdate = 
# 140 "./src/main/cms/cms_menu_power.c" 3 4
                      ((void *)0)
# 140 "./src/main/cms/cms_menu_power.c"
                          ,
