...
# 86 "./src/main/cms/cms_menu_main.c" 3 4
                                      ((void *)0)
# 86 "./src/main/cms/cms_menu_main.c"
                                          },
...
# 133 "./src/main/cms/cms_menu_main.c"
    ...
    if (sensors(SENSOR_ACC) && (getArmingDisableFlags() & ARMING_DISABLED_ACC_CALIBRATION)) {
        cmsAddMenuEntry(&setupPopupMenuEntries[++menuIndex], "CALIBRATE ACC", OME_Funcall | 0x0080, cmsCalibrateAccMenu, accCalibrationStatus);
    }


    cmsAddMenuEntry(&setupPopupMenuEntries[++menuIndex], "EXIT", OME_Back | 0x0080, 
