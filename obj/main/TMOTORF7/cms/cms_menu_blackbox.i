...
# 58 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 62 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 94 "./src/main/cms/cms_menu_blackbox.c" 3 4
   _Bool 
# 94 "./src/main/cms/cms_menu_blackbox.c"
...
# 94 "./src/main/cms/cms_menu_blackbox.c"
    ...
    {
# 135 "./src/main/cms/cms_menu_blackbox.c"
    case BLACKBOX_DEVICE_FLASH:
        ...
        if (storageDeviceIsWorking) {
            ...
            storageFree = (((flashPartition->endSector + 1 - flashPartition->startSector) * flashGeometry->sectorSize) / 1024) - storageUsed;
        } else {
...
static const void *cmsx_EraseFlash(displayPort_t *pDisplay, const void *ptr)
{
    ...
    if (!flashfsIsSupported()) {
        return 
# 169 "./src/main/cms/cms_menu_blackbox.c" 3 4
              ((void *)0)
# 169 "./src/main/cms/cms_menu_blackbox.c"
                  ;
    }
...
static const void *cmsx_Blackbox_onExit(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    return 
# 223 "./src/main/cms/cms_menu_blackbox.c" 3 4
          ((void *)0)
# 223 "./src/main/cms/cms_menu_blackbox.c"
              ;
}
...
static const OSD_Entry menuEraseFlashCheckEntries[] = {
    { "CONFIRM ERASE", OME_Label, 
# 229 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                 ((void *)0)
# 229 "./src/main/cms/cms_menu_blackbox.c"
                                     , 
# 229 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                       ((void *)0)
# 229 "./src/main/cms/cms_menu_blackbox.c"
                                           },
    { "YES", OME_Funcall, cmsx_EraseFlash, 
# 230 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                                    ((void *)0) 
# 230 "./src/main/cms/cms_menu_blackbox.c"
                                                         },

    { "NO", OME_Back, 
# 232 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                ((void *)0)
# 232 "./src/main/cms/cms_menu_blackbox.c"
                                    , 
# 232 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                      ((void *)0) 
# 232 "./src/main/cms/cms_menu_blackbox.c"
    ...
    { 
# 233 "./src/main/cms/cms_menu_blackbox.c" 3 4
     ((void *)0)
# 233 "./src/main/cms/cms_menu_blackbox.c"
         , OME_END, 
# 233 "./src/main/cms/cms_menu_blackbox.c" 3 4
                               ((void *)0)
# 233 "./src/main/cms/cms_menu_blackbox.c"
...
static CMS_Menu cmsx_menuEraseFlashCheck = {
    ...
    .onEnter = 
# 241 "./src/main/cms/cms_menu_blackbox.c" 3 4
              ((void *)0)
# 241 "./src/main/cms/cms_menu_blackbox.c"
                  ,
    .onExit = 
# 242 "./src/main/cms/cms_menu_blackbox.c" 3 4
             ((void *)0)
# 242 "./src/main/cms/cms_menu_blackbox.c"
                 ,
    .onDisplayUpdate = 
# 243 "./src/main/cms/cms_menu_blackbox.c" 3 4
                      ((void *)0)
# 243 "./src/main/cms/cms_menu_blackbox.c"
                          ,
...
{
    { "-- BLACKBOX --", OME_Label, 
# 250 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                  ((void *)0)
# 250 "./src/main/cms/cms_menu_blackbox.c"
                                      , 
# 250 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                        ((void *)0)
# 250 "./src/main/cms/cms_menu_blackbox.c"
    ...
    { "(PID FREQ)", OME_String, 
# 251 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                 ((void *)0)
# 251 "./src/main/cms/cms_menu_blackbox.c"
                                     , &cmsx_pidFreq },
    { "SAMPLERATE", OME_TAB | 0x0200, 
# 252 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                                   ((void *)0)
# 252 "./src/main/cms/cms_menu_blackbox.c"
                                                       , &cmsx_BlackboxRateTable },
    { "DEVICE", OME_TAB | 0x0200, 
# 253 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                                   ((void *)0)
# 253 "./src/main/cms/cms_menu_blackbox.c"
                                                       , &cmsx_BlackboxDeviceTable },
    { "(STATUS)", OME_String, 
# 254 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                 ((void *)0)
# 254 "./src/main/cms/cms_menu_blackbox.c"
                                     , &cmsx_BlackboxStatus },
    { "(USED)", OME_String, 
# 255 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                 ((void *)0)
# 255 "./src/main/cms/cms_menu_blackbox.c"
                                     , &cmsx_BlackboxDeviceStorageUsed },
    { "(FREE)", OME_String, 
# 256 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                 ((void *)0)
# 256 "./src/main/cms/cms_menu_blackbox.c"
                                     , &cmsx_BlackboxDeviceStorageFree },
    { "DEBUG MODE", OME_TAB | 0x0200, 
# 257 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                                   ((void *)0)
# 257 "./src/main/cms/cms_menu_blackbox.c"
                                                       , &(OSD_TAB_t) { &systemConfig_debug_mode, DEBUG_COUNT - 1, debugModeNames } },
    ...
    { "BACK", OME_Back, 
# 263 "./src/main/cms/cms_menu_blackbox.c" 3 4
                       ((void *)0)
# 263 "./src/main/cms/cms_menu_blackbox.c"
                           , 
# 263 "./src/main/cms/cms_menu_blackbox.c" 3 4
                             ((void *)0) 
# 263 "./src/main/cms/cms_menu_blackbox.c"
    ...
    { 
# 264 "./src/main/cms/cms_menu_blackbox.c" 3 4
     ((void *)0)
# 264 "./src/main/cms/cms_menu_blackbox.c"
         , OME_END, 
# 264 "./src/main/cms/cms_menu_blackbox.c" 3 4
                    ((void *)0)
# 264 "./src/main/cms/cms_menu_blackbox.c"
...
CMS_Menu cmsx_menuBlackbox = {
    ...
    .onDisplayUpdate = 
# 274 "./src/main/cms/cms_menu_blackbox.c" 3 4
                      ((void *)0)
# 274 "./src/main/cms/cms_menu_blackbox.c"
                          ,
