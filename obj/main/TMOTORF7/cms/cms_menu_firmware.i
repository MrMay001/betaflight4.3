...
# 29 "./src/main/cms/cms_menu_firmware.c" 2
...
# 153 "./src/main/platform.h" 2
# 31 "./src/main/cms/cms_menu_firmware.c" 2
...
# 37 "./src/main/cms/cms_menu_firmware.c" 2
...
# 40 "./src/main/cms/cms_menu_firmware.c" 2
...
# 42 "./src/main/cms/cms_menu_firmware.c" 2
...
# 44 "./src/main/cms/cms_menu_firmware.c" 2
...
void mwDisarm(void);
# 47 "./src/main/cms/cms_menu_firmware.c" 2
...
# 49 "./src/main/cms/cms_menu_firmware.c" 2
...
# 53 "./src/main/cms/cms_menu_firmware.c" 2
...
# 55 "./src/main/cms/cms_menu_firmware.c" 2
# 66 "./src/main/cms/cms_menu_firmware.c"
static char gyroCalibrationStatus[6];

static char accCalibrationStatus[6];


static char baroCalibrationStatus[6];
...
static const void *cmsx_CalibrationOnDisplayUpdate(displayPort_t *pDisp, const OSD_Entry *selected)
{
    ...
    tfp_sprintf(baroCalibrationStatus, sensors(SENSOR_BARO) ? baroIsCalibrationComplete() ? "  OK " : "WAIT ": " --- ");


    return 
# 87 "./src/main/cms/cms_menu_firmware.c" 3 4
          ((void *)0)
# 87 "./src/main/cms/cms_menu_firmware.c"
              ;
}
...
# 96 "./src/main/cms/cms_menu_firmware.c" 3 4
                            0
# 96 "./src/main/cms/cms_menu_firmware.c"
                                 );
    }

    return 
# 99 "./src/main/cms/cms_menu_firmware.c" 3 4
          ((void *)0)
# 99 "./src/main/cms/cms_menu_firmware.c"
              ;
}
...
static const void *cmsCalibrateBaro(displayPort_t *pDisp, const void *self)
{
    ...
    return 
# 126 "./src/main/cms/cms_menu_firmware.c" 3 4
          ((void *)0)
# 126 "./src/main/cms/cms_menu_firmware.c"
              ;
}
...
# 137 "./src/main/cms/cms_menu_firmware.c"
    ...
    { 
# 138 "./src/main/cms/cms_menu_firmware.c" 3 4
     ((void *)0)
# 138 "./src/main/cms/cms_menu_firmware.c"
         , OME_END, 
# 138 "./src/main/cms/cms_menu_firmware.c" 3 4
                    ((void *)0)
# 138 "./src/main/cms/cms_menu_firmware.c"
...
# 147 "./src/main/cms/cms_menu_firmware.c"
                 ,
    .onDisplayUpdate = 
# 148 "./src/main/cms/cms_menu_firmware.c" 3 4
                      ((void *)0)
# 148 "./src/main/cms/cms_menu_firmware.c"
                          ,
...
const void *cmsCalibrateAccMenu(displayPort_t *pDisp, const void *self)
{
    ...
    return 
# 160 "./src/main/cms/cms_menu_firmware.c" 3 4
          ((void *)0)
# 160 "./src/main/cms/cms_menu_firmware.c"
              ;
}
...
static const OSD_Entry menuCalibrationEntries[] = {
    { "--- CALIBRATE ---", OME_Label, 
# 166 "./src/main/cms/cms_menu_firmware.c" 3 4
                                     ((void *)0)
# 166 "./src/main/cms/cms_menu_firmware.c"
                                         , 
# 166 "./src/main/cms/cms_menu_firmware.c" 3 4
                                           ((void *)0) 
# 166 "./src/main/cms/cms_menu_firmware.c"
                                                },
    { "GYRO", OME_Funcall | 0x0080, cmsCalibrateGyro, gyroCalibrationStatus },

    { "ACC", OME_Funcall | 0x0080, cmsCalibrateAccMenu, accCalibrationStatus },


    { "BARO", OME_Funcall | 0x0080, cmsCalibrateBaro, baroCalibrationStatus },
...
# 174 "./src/main/cms/cms_menu_firmware.c"
    ...
    { 
# 175 "./src/main/cms/cms_menu_firmware.c" 3 4
     ((void *)0)
# 175 "./src/main/cms/cms_menu_firmware.c"
         , OME_END, 
# 175 "./src/main/cms/cms_menu_firmware.c" 3 4
                    ((void *)0)
# 175 "./src/main/cms/cms_menu_firmware.c"
...
# 183 "./src/main/cms/cms_menu_firmware.c"
                  ,
    .onExit = 
# 184 "./src/main/cms/cms_menu_firmware.c" 3 4
             ((void *)0)
# 184 "./src/main/cms/cms_menu_firmware.c"
                 ,
...
static const void *cmsx_FirmwareInit(displayPort_t *pDisp)
{
    ...
    return 
# 202 "./src/main/cms/cms_menu_firmware.c" 3 4
          ((void *)0)
# 202 "./src/main/cms/cms_menu_firmware.c"
              ;
}
...
# 210 "./src/main/cms/cms_menu_firmware.c"
                               , "9f75ec6" },
    { "TARGET", OME_String, 
# 211 "./src/main/cms/cms_menu_firmware.c" 3 4
                           ((void *)0)
# 211 "./src/main/cms/cms_menu_firmware.c"
                               , "TMOTORF7" },
...
# 213 "./src/main/cms/cms_menu_firmware.c"
                            , manufacturerId },
    { "BOARD", OME_String, 
# 214 "./src/main/cms/cms_menu_firmware.c" 3 4
                          ((void *)0)
# 214 "./src/main/cms/cms_menu_firmware.c"
                              , boardName },

    { "--- SETUP ---", OME_Label, 
# 216 "./src/main/cms/cms_menu_firmware.c" 3 4
                                 ((void *)0)
# 216 "./src/main/cms/cms_menu_firmware.c"
                                     , 
# 216 "./src/main/cms/cms_menu_firmware.c" 3 4
                                       ((void *)0) 
# 216 "./src/main/cms/cms_menu_firmware.c"
...
# 218 "./src/main/cms/cms_menu_firmware.c"
    ...
    { 
# 219 "./src/main/cms/cms_menu_firmware.c" 3 4
     ((void *)0)
# 219 "./src/main/cms/cms_menu_firmware.c"
         , OME_END, 
# 219 "./src/main/cms/cms_menu_firmware.c" 3 4
                    ((void *)0)
# 219 "./src/main/cms/cms_menu_firmware.c"
...
# 232 "./src/main/cms/cms_menu_firmware.c"
                 ,
    .onDisplayUpdate = 
# 233 "./src/main/cms/cms_menu_firmware.c" 3 4
                      ((void *)0)
# 233 "./src/main/cms/cms_menu_firmware.c"
                          ,
