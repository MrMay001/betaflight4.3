# 1 "./src/main/cms/cms_menu_failsafe.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/cms/cms_menu_failsafe.c"
# 21 "./src/main/cms/cms_menu_failsafe.c"
# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include/stdbool.h" 1 3 4
# 22 "./src/main/cms/cms_menu_failsafe.c" 2
...
# 23 "./src/main/cms/cms_menu_failsafe.c" 2
...
# 24 "./src/main/cms/cms_menu_failsafe.c" 2
...
int toupper (int __c);
int isblank (int __c);
# 25 "./src/main/cms/cms_menu_failsafe.c" 2
...
# 36 "./src/main/cms/cms_menu_failsafe.c" 2
...
# 78 "./src/main/cms/cms_menu_failsafe.c"
    ...
    { "PROCEDURE", OME_TAB | 0x0200, 
# 80 "./src/main/cms/cms_menu_failsafe.c" 3 4
                                                       ((void *)0)
# 80 "./src/main/cms/cms_menu_failsafe.c"
                                                           , &(OSD_TAB_t) { &failsafeConfig_failsafe_procedure, FAILSAFE_PROCEDURE_COUNT - 1, failsafeProcedureNames } },
    { "GUARD TIME", OME_FLOAT | 0x0200, 
# 81 "./src/main/cms/cms_menu_failsafe.c" 3 4
                                                       ((void *)0)
# 81 "./src/main/cms/cms_menu_failsafe.c"
                                                           , &(OSD_FLOAT_t) { &failsafeConfig_failsafe_delay, 200 / 100, 200, 1, 100 } },
    { "STAGE 2 DELAY", OME_FLOAT | 0x0200, 
# 82 "./src/main/cms/cms_menu_failsafe.c" 3 4
                                                       ((void *)0)
# 82 "./src/main/cms/cms_menu_failsafe.c"
                                                           , &(OSD_FLOAT_t) { &failsafeConfig_failsafe_off_delay, 0, 200, 1, 100 } },
    { "STAGE 2 THROTTLE", OME_UINT16 | 0x0200, 
# 83 "./src/main/cms/cms_menu_failsafe.c" 3 4
                                                       ((void *)0)
# 83 "./src/main/cms/cms_menu_failsafe.c"
                                                           , &(OSD_UINT16_t) { &failsafeConfig_failsafe_throttle, 750, 2250, 1 } },
