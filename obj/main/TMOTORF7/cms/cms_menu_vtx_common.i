# 1 "./src/main/cms/cms_menu_vtx_common.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/cms/cms_menu_vtx_common.c"
# 21 "./src/main/cms/cms_menu_vtx_common.c"
# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include/stdbool.h" 1 3 4
# 22 "./src/main/cms/cms_menu_vtx_common.c" 2
...
# 23 "./src/main/cms/cms_menu_vtx_common.c" 2
...
int toupper (int __c);
int isblank (int __c);
# 24 "./src/main/cms/cms_menu_vtx_common.c" 2
...
# 153 "./src/main/platform.h" 2
# 26 "./src/main/cms/cms_menu_vtx_common.c" 2
...
# 30 "./src/main/cms/cms_menu_vtx_common.c" 2
...
# 32 "./src/main/cms/cms_menu_vtx_common.c" 2
...
# 33 "./src/main/cms/cms_menu_vtx_common.c" 2
...
# 34 "./src/main/cms/cms_menu_vtx_common.c" 2
...
# 35 "./src/main/cms/cms_menu_vtx_common.c" 2
...
# 38 "./src/main/cms/cms_menu_vtx_common.c" 2
...
# 40 "./src/main/cms/cms_menu_vtx_common.c" 2



static char statusLine1[21] = "";
static char statusLine2[21] = "";
...
static const void *setStatusMessage(displayPort_t *pDisp)
{
    ...
    return 
# 66 "./src/main/cms/cms_menu_vtx_common.c" 3 4
          ((void *)0)
# 66 "./src/main/cms/cms_menu_vtx_common.c"
              ;
}
...
{
    { "", OME_Label | 0x0080, 
# 71 "./src/main/cms/cms_menu_vtx_common.c" 3 4
                                  ((void *)0)
# 71 "./src/main/cms/cms_menu_vtx_common.c"
                                      , statusLine1 },
    { "", OME_Label | 0x0080, 
# 72 "./src/main/cms/cms_menu_vtx_common.c" 3 4
                                  ((void *)0)
# 72 "./src/main/cms/cms_menu_vtx_common.c"
                                      , statusLine2 },
    { "", OME_Label, 
# 73 "./src/main/cms/cms_menu_vtx_common.c" 3 4
                        ((void *)0)
# 73 "./src/main/cms/cms_menu_vtx_common.c"
                            , 
# 73 "./src/main/cms/cms_menu_vtx_common.c" 3 4
                              ((void *)0) 
# 73 "./src/main/cms/cms_menu_vtx_common.c"
    ...
    { "BACK", OME_Back, 
# 74 "./src/main/cms/cms_menu_vtx_common.c" 3 4
                        ((void *)0)
# 74 "./src/main/cms/cms_menu_vtx_common.c"
                            , 
# 74 "./src/main/cms/cms_menu_vtx_common.c" 3 4
                              ((void *)0) 
# 74 "./src/main/cms/cms_menu_vtx_common.c"
    ...
    { 
# 75 "./src/main/cms/cms_menu_vtx_common.c" 3 4
     ((void *)0)
# 75 "./src/main/cms/cms_menu_vtx_common.c"
         , OME_END, 
# 75 "./src/main/cms/cms_menu_vtx_common.c" 3 4
                        ((void *)0)
# 75 "./src/main/cms/cms_menu_vtx_common.c"
...
static CMS_Menu cmsx_menuVtxError = {
    ...
    .onExit = 
# 84 "./src/main/cms/cms_menu_vtx_common.c" 3 4
             ((void *)0)
# 84 "./src/main/cms/cms_menu_vtx_common.c"
                 ,
    .onDisplayUpdate = 
# 85 "./src/main/cms/cms_menu_vtx_common.c" 3 4
                      ((void *)0)
# 85 "./src/main/cms/cms_menu_vtx_common.c"
                          ,
...
const void *cmsSelectVtx(displayPort_t *pDisplay, const void *ptr)
{
    ...
    if (device) {
        ...
        switch (vtxType) {
# 110 "./src/main/cms/cms_menu_vtx_common.c"
    ...
    return 
# 131 "./src/main/cms/cms_menu_vtx_common.c" 3 4
          ((void *)0)
# 131 "./src/main/cms/cms_menu_vtx_common.c"
              ;
}
