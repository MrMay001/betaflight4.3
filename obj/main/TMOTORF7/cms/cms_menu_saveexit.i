# 1 "./src/main/cms/cms_menu_saveexit.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/cms/cms_menu_saveexit.c"
# 21 "./src/main/cms/cms_menu_saveexit.c"
# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include/stdbool.h" 1 3 4
# 22 "./src/main/cms/cms_menu_saveexit.c" 2
...
# 23 "./src/main/cms/cms_menu_saveexit.c" 2
...
# 24 "./src/main/cms/cms_menu_saveexit.c" 2
...
int toupper (int __c);
int isblank (int __c);
# 25 "./src/main/cms/cms_menu_saveexit.c" 2
...
# 153 "./src/main/platform.h" 2
# 27 "./src/main/cms/cms_menu_saveexit.c" 2
...
# 30 "./src/main/cms/cms_menu_saveexit.c" 2
...
# 32 "./src/main/cms/cms_menu_saveexit.c" 2
...
# 34 "./src/main/cms/cms_menu_saveexit.c" 2
...
# 36 "./src/main/cms/cms_menu_saveexit.c" 2

static const OSD_Entry cmsx_menuSaveExitEntries[] =
{
    { "-- SAVE/EXIT --", OME_Label, 
# 39 "./src/main/cms/cms_menu_saveexit.c" 3 4
                                   ((void *)0)
# 39 "./src/main/cms/cms_menu_saveexit.c"
                                       , 
# 39 "./src/main/cms/cms_menu_saveexit.c" 3 4
                                         ((void *)0)
# 39 "./src/main/cms/cms_menu_saveexit.c"
    ...
    { "SAVE&EXIT", OME_OSD_Exit, cmsMenuExit, (void *)(3)},
    { "SAVE&REBOOT", OME_OSD_Exit, cmsMenuExit, (void *)(4)},
    { "BACK", OME_Back, 
# 43 "./src/main/cms/cms_menu_saveexit.c" 3 4
                       ((void *)0)
# 43 "./src/main/cms/cms_menu_saveexit.c"
                           , 
# 43 "./src/main/cms/cms_menu_saveexit.c" 3 4
                             ((void *)0) 
# 43 "./src/main/cms/cms_menu_saveexit.c"
    ...
    { 
# 44 "./src/main/cms/cms_menu_saveexit.c" 3 4
     ((void *)0)
# 44 "./src/main/cms/cms_menu_saveexit.c"
         , OME_END, 
# 44 "./src/main/cms/cms_menu_saveexit.c" 3 4
                    ((void *)0)
# 44 "./src/main/cms/cms_menu_saveexit.c"
...
static CMS_Menu cmsx_menuSaveExit = {
    ...
    .onEnter = 
# 52 "./src/main/cms/cms_menu_saveexit.c" 3 4
              ((void *)0)
# 52 "./src/main/cms/cms_menu_saveexit.c"
                  ,
    .onExit = 
# 53 "./src/main/cms/cms_menu_saveexit.c" 3 4
             ((void *)0)
# 53 "./src/main/cms/cms_menu_saveexit.c"
                 ,
    .onDisplayUpdate = 
# 54 "./src/main/cms/cms_menu_saveexit.c" 3 4
                      ((void *)0)
# 54 "./src/main/cms/cms_menu_saveexit.c"
                          ,
...
{
    { "-- SAVE/EXIT (REBOOT REQD)", OME_Label, 
# 60 "./src/main/cms/cms_menu_saveexit.c" 3 4
                                              ((void *)0)
# 60 "./src/main/cms/cms_menu_saveexit.c"
                                                  , 
# 60 "./src/main/cms/cms_menu_saveexit.c" 3 4
                                                    ((void *)0)
# 60 "./src/main/cms/cms_menu_saveexit.c"
                                                        },
    { "EXIT&REBOOT", OME_OSD_Exit, cmsMenuExit, (void *)(5)},
    { "SAVE&REBOOT", OME_OSD_Exit, cmsMenuExit, (void *)(4)},
    { "BACK", OME_Back, 
# 63 "./src/main/cms/cms_menu_saveexit.c" 3 4
                       ((void *)0)
# 63 "./src/main/cms/cms_menu_saveexit.c"
                           , 
# 63 "./src/main/cms/cms_menu_saveexit.c" 3 4
                             ((void *)0) 
# 63 "./src/main/cms/cms_menu_saveexit.c"
    ...
    { 
# 64 "./src/main/cms/cms_menu_saveexit.c" 3 4
     ((void *)0)
# 64 "./src/main/cms/cms_menu_saveexit.c"
         , OME_END, 
# 64 "./src/main/cms/cms_menu_saveexit.c" 3 4
                    ((void *)0)
# 64 "./src/main/cms/cms_menu_saveexit.c"
...
static CMS_Menu cmsx_menuSaveExitReboot = {
    ...
    .onEnter = 
# 72 "./src/main/cms/cms_menu_saveexit.c" 3 4
              ((void *)0)
# 72 "./src/main/cms/cms_menu_saveexit.c"
                  ,
    .onExit = 
# 73 "./src/main/cms/cms_menu_saveexit.c" 3 4
             ((void *)0)
# 73 "./src/main/cms/cms_menu_saveexit.c"
                 ,
    .onDisplayUpdate = 
# 74 "./src/main/cms/cms_menu_saveexit.c" 3 4
                      ((void *)0)
# 74 "./src/main/cms/cms_menu_saveexit.c"
                          ,
