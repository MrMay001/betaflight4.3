...
static const void *trampCmsConfigBand(displayPort_t *pDisp, const void *self)
{
    ...
    return 
# 125 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
          ((void *)0)
# 125 "./src/main/cms/cms_menu_vtx_tramp.c"
              ;
}
...
static const void *trampCmsConfigChan(displayPort_t *pDisp, const void *self)
{
    ...
    return 
# 140 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
          ((void *)0)
# 140 "./src/main/cms/cms_menu_vtx_tramp.c"
              ;
}
...
static const void *trampCmsConfigPower(displayPort_t *pDisp, const void *self)
{
    ...
    return 
# 153 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
          ((void *)0)
# 153 "./src/main/cms/cms_menu_vtx_tramp.c"
              ;
}
...
static const void *trampCmsSetPitMode(displayPort_t *pDisp, const void *self)
{
    ...
    if (trampCmsPitMode == (0)) {
        ...
        vtxCommonSetPitMode(vtxCommonDevice(),
                            (trampCmsPitMode == (1)) ? 0 : 1);
    }

    return 
# 179 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
          ((void *)0)
# 179 "./src/main/cms/cms_menu_vtx_tramp.c"
              ;
}
...
static 
# 202 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
      _Bool 
# 202 "./src/main/cms/cms_menu_vtx_tramp.c"
           trampCmsInitSettings(void)
{
    vtxDevice_t *device = vtxCommonDevice();
    unsigned vtxStatus;
    ...
    if (!device) {
        return 
# 208 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
              0
# 208 "./src/main/cms/cms_menu_vtx_tramp.c"
                   ;
    }
    ...
    if (vtxCommonGetStatus(device, &vtxStatus)) {
        trampCmsPitMode = (vtxStatus & VTX_STATUS_PIT_MODE) ? (2) : (1);
    } else {
        trampCmsPitMode = (0);
    }
    ...
    return 
# 236 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
          1
# 236 "./src/main/cms/cms_menu_vtx_tramp.c"
              ;
}
...
static const void *trampCmsOnEnter(displayPort_t *pDisp)
{
    ...
    return 
# 247 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
          ((void *)0)
# 247 "./src/main/cms/cms_menu_vtx_tramp.c"
              ;
}

static const OSD_Entry trampCmsMenuCommenceEntries[] = {
    { "CONFIRM", OME_Label, 
# 251 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                             ((void *)0)
# 251 "./src/main/cms/cms_menu_vtx_tramp.c"
                                 , 
# 251 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                                            ((void *)0) 
# 251 "./src/main/cms/cms_menu_vtx_tramp.c"
...
# 253 "./src/main/cms/cms_menu_vtx_tramp.c"
    ...
    { 
# 254 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
     ((void *)0)
# 254 "./src/main/cms/cms_menu_vtx_tramp.c"
         , OME_END, 
# 254 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                         ((void *)0)
# 254 "./src/main/cms/cms_menu_vtx_tramp.c"
...
static CMS_Menu trampCmsMenuCommence = {
    ...
    .onEnter = 
# 262 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
              ((void *)0)
# 262 "./src/main/cms/cms_menu_vtx_tramp.c"
                  ,
    .onExit = 
# 263 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
             ((void *)0)
# 263 "./src/main/cms/cms_menu_vtx_tramp.c"
                 ,
    .onDisplayUpdate = 
# 264 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                      ((void *)0)
# 264 "./src/main/cms/cms_menu_vtx_tramp.c"
                          ,
...
{
    { "- TRAMP -", OME_Label, 
# 270 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                             ((void *)0)
# 270 "./src/main/cms/cms_menu_vtx_tramp.c"
                                 , 
# 270 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                                   ((void *)0) 
# 270 "./src/main/cms/cms_menu_vtx_tramp.c"
    ...
    { "", OME_Label | 0x0080, 
# 272 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                                      ((void *)0)
# 272 "./src/main/cms/cms_menu_vtx_tramp.c"
...
# 276 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                                      ((void *)0)
# 276 "./src/main/cms/cms_menu_vtx_tramp.c"
                                          , &trampCmsEntFreqRef },
    { "POWER", OME_TAB, trampCmsConfigPower, &trampCmsEntPower },
    { "T(C)", OME_INT16 | 0x0080, 
# 278 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                                      ((void *)0)
# 278 "./src/main/cms/cms_menu_vtx_tramp.c"
                                          , &trampCmsEntTemp },
    { "SAVE", OME_Submenu, cmsMenuChange, &trampCmsMenuCommence },

    { "BACK", OME_Back, 
# 281 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                         ((void *)0)
# 281 "./src/main/cms/cms_menu_vtx_tramp.c"
                             , 
# 281 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                               ((void *)0) 
# 281 "./src/main/cms/cms_menu_vtx_tramp.c"
    ...
    { 
# 282 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
     ((void *)0)
# 282 "./src/main/cms/cms_menu_vtx_tramp.c"
         , OME_END, 
# 282 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                        ((void *)0)
# 282 "./src/main/cms/cms_menu_vtx_tramp.c"
...
CMS_Menu cmsx_menuVtxTramp = {
    ...
    .onExit = 
# 291 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
             ((void *)0)
# 291 "./src/main/cms/cms_menu_vtx_tramp.c"
                 ,
    .onDisplayUpdate = 
# 292 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                      ((void *)0)
# 292 "./src/main/cms/cms_menu_vtx_tramp.c"
                          ,
