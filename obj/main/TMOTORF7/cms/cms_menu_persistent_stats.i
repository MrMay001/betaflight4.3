# 1 "./src/main/cms/cms_menu_persistent_stats.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/cms/cms_menu_persistent_stats.c"
# 21 "./src/main/cms/cms_menu_persistent_stats.c"
# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include/stdbool.h" 1 3 4
# 22 "./src/main/cms/cms_menu_persistent_stats.c" 2
...
# 23 "./src/main/cms/cms_menu_persistent_stats.c" 2
...
# 24 "./src/main/cms/cms_menu_persistent_stats.c" 2
...
int toupper (int __c);
int isblank (int __c);
# 25 "./src/main/cms/cms_menu_persistent_stats.c" 2
...
# 153 "./src/main/platform.h" 2
# 27 "./src/main/cms/cms_menu_persistent_stats.c" 2
...
# 32 "./src/main/cms/cms_menu_persistent_stats.c" 2
...
# 34 "./src/main/cms/cms_menu_persistent_stats.c" 2
...
# 36 "./src/main/cms/cms_menu_persistent_stats.c" 2
...
# 37 "./src/main/cms/cms_menu_persistent_stats.c" 2
...
static const void *cmsx_PersistentStats_onEnter(displayPort_t *pDisp)
{
    ...
    return 
# 52 "./src/main/cms/cms_menu_persistent_stats.c" 3 4
          ((void *)0)
# 52 "./src/main/cms/cms_menu_persistent_stats.c"
              ;
}
...
static const void *cmsx_PersistentStats_onExit(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    return 
# 65 "./src/main/cms/cms_menu_persistent_stats.c" 3 4
          ((void *)0)
# 65 "./src/main/cms/cms_menu_persistent_stats.c"
              ;
}
...
static const void *cmsx_ResetStats(displayPort_t *pDisplay, const void *ptr)
{
    ...
    return 
# 79 "./src/main/cms/cms_menu_persistent_stats.c" 3 4
          ((void *)0)
# 79 "./src/main/cms/cms_menu_persistent_stats.c"
              ;
}

static const OSD_Entry cmsx_menuPersistentStatsEntries[] =
{
    {"-- PERSISTENT STATS --", OME_Label, 
# 84 "./src/main/cms/cms_menu_persistent_stats.c" 3 4
                                         ((void *)0)
# 84 "./src/main/cms/cms_menu_persistent_stats.c"
                                             , 
# 84 "./src/main/cms/cms_menu_persistent_stats.c" 3 4
                                               ((void *)0)
# 84 "./src/main/cms/cms_menu_persistent_stats.c"
    ...
    {"FLIGHTS", OME_UINT32, 
# 85 "./src/main/cms/cms_menu_persistent_stats.c" 3 4
                           ((void *)0)
# 85 "./src/main/cms/cms_menu_persistent_stats.c"
                               , &(OSD_UINT32_t){ &stats_total_flights, 0, 
# 85 "./src/main/cms/cms_menu_persistent_stats.c" 3 4
                                                                           (0xffffffffUL)
# 85 "./src/main/cms/cms_menu_persistent_stats.c"
                                                                                     , 1}},
    {"TIME(sec)", OME_UINT32, 
# 86 "./src/main/cms/cms_menu_persistent_stats.c" 3 4
                             ((void *)0)
# 86 "./src/main/cms/cms_menu_persistent_stats.c"
                                 , &(OSD_UINT32_t){ &stats_total_time_s, 0, 
# 86 "./src/main/cms/cms_menu_persistent_stats.c" 3 4
                                                                            (0xffffffffUL)
# 86 "./src/main/cms/cms_menu_persistent_stats.c"
                                                                                      , 1}},
    {"DIST(m)", OME_UINT32, 
# 87 "./src/main/cms/cms_menu_persistent_stats.c" 3 4
                           ((void *)0)
# 87 "./src/main/cms/cms_menu_persistent_stats.c"
                               , &(OSD_UINT32_t){ &stats_total_dist_m, 0, 
# 87 "./src/main/cms/cms_menu_persistent_stats.c" 3 4
                                                                          (0xffffffffUL)
# 87 "./src/main/cms/cms_menu_persistent_stats.c"
                                                                                    , 1}},
    {"RESET STATS", OME_Funcall, cmsx_ResetStats, 
# 88 "./src/main/cms/cms_menu_persistent_stats.c" 3 4
                                                 ((void *)0)
# 88 "./src/main/cms/cms_menu_persistent_stats.c"
                                                     },
    {"--- SETTINGS ---", OME_Label, 
# 89 "./src/main/cms/cms_menu_persistent_stats.c" 3 4
                                   ((void *)0)
# 89 "./src/main/cms/cms_menu_persistent_stats.c"
                                       , 
# 89 "./src/main/cms/cms_menu_persistent_stats.c" 3 4
                                         ((void *)0)
# 89 "./src/main/cms/cms_menu_persistent_stats.c"
                                             },
    {"MIN ARMED TIME(sec)", OME_INT8, 
# 90 "./src/main/cms/cms_menu_persistent_stats.c" 3 4
                                     ((void *)0)
# 90 "./src/main/cms/cms_menu_persistent_stats.c"
                                         , &(OSD_INT8_t){ &stats_min_armed_time_s, -1, 
# 90 "./src/main/cms/cms_menu_persistent_stats.c" 3 4
                                                                                       (0x7f)
# 90 "./src/main/cms/cms_menu_persistent_stats.c"
                                                                                               , 1}},
    ...
    {"BACK", OME_Back, 
# 92 "./src/main/cms/cms_menu_persistent_stats.c" 3 4
                      ((void *)0)
# 92 "./src/main/cms/cms_menu_persistent_stats.c"
                          , 
# 92 "./src/main/cms/cms_menu_persistent_stats.c" 3 4
                            ((void *)0)
# 92 "./src/main/cms/cms_menu_persistent_stats.c"
    ...
    { 
# 93 "./src/main/cms/cms_menu_persistent_stats.c" 3 4
     ((void *)0)
# 93 "./src/main/cms/cms_menu_persistent_stats.c"
         , OME_END, 
# 93 "./src/main/cms/cms_menu_persistent_stats.c" 3 4
                    ((void *)0)
# 93 "./src/main/cms/cms_menu_persistent_stats.c"
...
CMS_Menu cmsx_menuPersistentStats = {
    ...
    .onDisplayUpdate = 
# 103 "./src/main/cms/cms_menu_persistent_stats.c" 3 4
                      ((void *)0)
# 103 "./src/main/cms/cms_menu_persistent_stats.c"
                          ,
