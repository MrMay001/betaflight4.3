...
# 97 "./src/main/cms/cms.c" 3 4
_Bool 
# 97 "./src/main/cms/cms.c"
    cmsDisplayPortRegister(displayPort_t *pDisplay)
{
    if (!pDisplay || cmsDeviceCount >= 4) {
        return 
# 100 "./src/main/cms/cms.c" 3 4
              0
# 100 "./src/main/cms/cms.c"
                   ;
    }
    ...
    return 
# 105 "./src/main/cms/cms.c" 3 4
          1
# 105 "./src/main/cms/cms.c"
              ;
}
...
static displayPort_t *cmsDisplayPortSelectCurrent(void)
{
    if (cmsDeviceCount == 0) {
        return 
# 111 "./src/main/cms/cms.c" 3 4
              ((void *)0)
# 111 "./src/main/cms/cms.c"
                  ;
    }
...
static displayPort_t *cmsDisplayPortSelectNext(void)
{
    if (cmsDeviceCount == 0) {
        return 
# 124 "./src/main/cms/cms.c" 3 4
              ((void *)0)
# 124 "./src/main/cms/cms.c"
                  ;
    }
...
# 132 "./src/main/cms/cms.c" 3 4
_Bool 
# 132 "./src/main/cms/cms.c"
    cmsDisplayPortSelect(displayPort_t *instance)
{
...
# 136 "./src/main/cms/cms.c"
    ...
    return 
# 139 "./src/main/cms/cms.c" 3 4
          0
# 139 "./src/main/cms/cms.c"
               ;
}
# 166 "./src/main/cms/cms.c"
static 
# 166 "./src/main/cms/cms.c" 3 4
      _Bool 
# 166 "./src/main/cms/cms.c"
              smallScreen;
...
static 
# 172 "./src/main/cms/cms.c" 3 4
      _Bool 
# 172 "./src/main/cms/cms.c"
           osdElementEditing = 
# 172 "./src/main/cms/cms.c" 3 4
                               0
# 172 "./src/main/cms/cms.c"
...
# 174 "./src/main/cms/cms.c" 3 4
_Bool 
# 174 "./src/main/cms/cms.c"
    cmsInMenu = 
# 174 "./src/main/cms/cms.c" 3 4
                0
# 174 "./src/main/cms/cms.c"
...
static 
# 191 "./src/main/cms/cms.c" 3 4
      _Bool 
# 191 "./src/main/cms/cms.c"
           saveMenuInhibited = 
# 191 "./src/main/cms/cms.c" 3 4
                               0
# 191 "./src/main/cms/cms.c"
                                    ;
# 222 "./src/main/cms/cms.c"
static void cmsUpdateMaxRow(displayPort_t *instance)
{
    ((void)(instance));
    pageMaxRow = 0;

    for (const OSD_Entry *ptr = pageTop; (ptr->flags & 0x001f) != OME_END; ptr++) {
        pageMaxRow++;
    }
...
uint8_t runtimeEntryFlags[16] = { 0 };
...
cmsTableTicker_t runtimeTableTicker[16];
...
static int cmsDrawMenuEntry(displayPort_t *pDisplay, const OSD_Entry *p, uint8_t row, 
# 395 "./src/main/cms/cms.c" 3 4
                                                                                     _Bool 
# 395 "./src/main/cms/cms.c"
                                                                                          selectedRow, uint8_t *flags, cmsTableTicker_t *ticker)
{
    ...
    case OME_Funcall:
        if (((*flags) & 0x0020)) {
            ...
            if ((p->flags & 0x001f) == OME_Submenu && p->func && *flags & 0x0100) {



                const char *str = p->func(pDisplay, p->data);
                strncpy(buff, str, 12);
            } else if ((p->flags & 0x001f) == OME_Funcall && p->data) {
                strncpy(buff, p->data, 12);
            }
            strncat(buff, ">", 12);
    ...
    case OME_TAB:
        if (((*flags) & 0x0020) || ((*flags) & 0x0400)) {
            
# 460 "./src/main/cms/cms.c" 3 4
           _Bool 
# 460 "./src/main/cms/cms.c"
                drawText = 
# 460 "./src/main/cms/cms.c" 3 4
                           0
# 460 "./src/main/cms/cms.c"
            ...
            const int labelLength = strlen(p->text) + 1;
            ...
            const int availableSpace = __extension__ ({ __typeof__ (12) _a = (12); __typeof__ (rightMenuColumn - labelLength - leftMenuColumn - 1) _b = (rightMenuColumn - labelLength - leftMenuColumn - 1); _a > _b ? _a : _b; });

            if (((*flags) & 0x0020)) {
                drawText = 
# 472 "./src/main/cms/cms.c" 3 4
                          1
# 472 "./src/main/cms/cms.c"
                              ;
                ticker->state = 0;
                ticker->loopCounter = 0;
                if (displayLength > availableSpace) {
                    do { (*flags) |= 0x0400; } while (0);
                } else {
                    do { (*flags) &= ~0x0400; } while (0);
                }
            } else if (((*flags) & 0x0400)) {
                ticker->loopCounter++;
                const uint8_t loopLimit = (ticker->state == 0 || ticker->state == (displayLength - availableSpace)) ? 20 : 3;
                if (ticker->loopCounter >= loopLimit) {
                    ticker->loopCounter = 0;
                    drawText = 
# 485 "./src/main/cms/cms.c" 3 4
                              1
# 485 "./src/main/cms/cms.c"
                                  ;
                    ticker->state++;
            ...
            if (drawText) {
                strncpy(tableBuff, (char *)(str + ticker->state), 30);
...
# 504 "./src/main/cms/cms.c" 3 4
           _Bool 
# 504 "./src/main/cms/cms.c"
...
static void cmsMenuCountPage(displayPort_t *pDisplay)
{
    ((void)(pDisplay));
    const OSD_Entry *p;
    for (p = currentCtx.menu->entries; (p->flags & 0x001f) != OME_END; p++);
    pageCount = (p - currentCtx.menu->entries - 1) / maxMenuItems + 1;
}

static const void *cmsMenuBack(displayPort_t *pDisplay)
{
    ...
    saveMenuInhibited = 
# 637 "./src/main/cms/cms.c" 3 4
                       0
# 637 "./src/main/cms/cms.c"
                            ;

    if (!menuStackIdx) {
        return 
# 640 "./src/main/cms/cms.c" 3 4
              ((void *)0)
# 640 "./src/main/cms/cms.c"
                  ;
    }
    ...
    return 
# 652 "./src/main/cms/cms.c" 3 4
          ((void *)0)
# 652 "./src/main/cms/cms.c"
              ;
}


static 
# 656 "./src/main/cms/cms.c" 3 4
      _Bool 
# 656 "./src/main/cms/cms.c"
           rowSliderOverride(const uint16_t flags)
{
...
# 663 "./src/main/cms/cms.c" 3 4
   _Bool 
# 663 "./src/main/cms/cms.c"
        slider_flags_mode_rpy = (simplified_pids_mode == PID_SIMPLIFIED_TUNING_RPY);
    
# 664 "./src/main/cms/cms.c" 3 4
   _Bool 
# 664 "./src/main/cms/cms.c"
        slider_flags_mode_rp = slider_flags_mode_rpy || (simplified_pids_mode == PID_SIMPLIFIED_TUNING_RP);

    
# 666 "./src/main/cms/cms.c" 3 4
   _Bool 
# 666 "./src/main/cms/cms.c"
        simplified_gyro_filter = gyroConfig()->simplified_gyro_filter;
    
# 667 "./src/main/cms/cms.c" 3 4
   _Bool 
# 667 "./src/main/cms/cms.c"
        simplified_dterm_filter = currentPidProfile->simplified_dterm_filter;

    if (((flags & 0x0800) && slider_flags_mode_rp) ||
        ((flags & 0x1000) && slider_flags_mode_rpy) ||
        ((flags & 0x2000) && simplified_gyro_filter) ||
        ((flags & 0x4000) && simplified_dterm_filter)) {
        return 
...
# 673 "./src/main/cms/cms.c"
    ...
    return 
# 677 "./src/main/cms/cms.c" 3 4
          0
# 677 "./src/main/cms/cms.c"
               ;
}


static 
# 681 "./src/main/cms/cms.c" 3 4
      _Bool 
# 681 "./src/main/cms/cms.c"
           rowIsSkippable(const OSD_Entry *row)
{
    OSD_MenuElement type = row->flags & 0x001f;

    if (type == OME_Label) {
        return 
# 686 "./src/main/cms/cms.c" 3 4
              1
# 686 "./src/main/cms/cms.c"
                  ;
    }

    if (type == OME_String) {
        return 
# 690 "./src/main/cms/cms.c" 3 4
              1
# 690 "./src/main/cms/cms.c"
                  ;
    }

    if ((type == OME_UINT8 || type == OME_INT8 ||
         type == OME_UINT16 || type == OME_INT16) &&
        ((row->flags == 0x0080) || rowSliderOverride(row->flags))) {
        return 
# 696 "./src/main/cms/cms.c" 3 4
              1
# 696 "./src/main/cms/cms.c"
                  ;
    }
    return 
# 698 "./src/main/cms/cms.c" 3 4
          0
# 698 "./src/main/cms/cms.c"
               ;
}
...
# 707 "./src/main/cms/cms.c"
              displayWasCleared = pDisplay->cleared;
    uint8_t i;
    const OSD_Entry *p;
    uint8_t top = smallScreen ? 1 : (pDisplay->rows - pageMaxRow)/2;

    pDisplay->cleared = 
# 712 "./src/main/cms/cms.c" 3 4
                       0
# 712 "./src/main/cms/cms.c"
                            ;
...
# 716 "./src/main/cms/cms.c"
    ...
    if (currentTimeUs > lastPolledUs + 100000) {
        drawPolled = 
# 720 "./src/main/cms/cms.c" 3 4
                    1
# 720 "./src/main/cms/cms.c"
                        ;
    ...
    if (displayWasCleared) {
        for (p = pageTop, i= 0; (p <= pageTop + pageMaxRow); p++, i++) {
            do { (runtimeEntryFlags[i]) |= 0x0040; } while (0);
            do { (runtimeEntryFlags[i]) |= 0x0020; } while (0);
        }
    } else if (drawPolled) {
        for (p = pageTop, i = 0; (p <= pageTop + pageMaxRow); p++, i++) {
            if (((p)->flags & 0x0080))
    ...
    for (i = 0, p = pageTop; (p <= pageTop + pageMaxRow); i++, p++) {
        if (((runtimeEntryFlags[i]) & 0x0040)) {
            uint8_t coloff = leftMenuColumn;
            coloff += ((p->flags & 0x001f) == OME_Label) ? 0 : 1;
        ...
        if (((runtimeEntryFlags[i]) & 0x0020) || ((runtimeEntryFlags[i]) & 0x0400)) {
            
# 798 "./src/main/cms/cms.c" 3 4
           _Bool 
# 798 "./src/main/cms/cms.c"
                selectedRow = i == currentCtx.cursorRow;
    ...
    if (displayWasCleared && leftMenuColumn > 0) {
        if (currentCtx.page > 0) {
            const uint8_t symbol = displaySupportsOsdSymbols(pDisplay) ? 0x68 : '^';
            displayWriteChar(pDisplay, leftMenuColumn - 1, top, DISPLAYPORT_ATTR_NONE, symbol);
        }
         if (currentCtx.page < pageCount - 1) {
            const uint8_t symbol = displaySupportsOsdSymbols(pDisplay) ? 0x60 : 'V';
...
const void *cmsMenuChange(displayPort_t *pDisplay, const void *ptr)
{
    ...
    if (!pMenu) {
        return 
# 828 "./src/main/cms/cms.c" 3 4
              ((void *)0)
# 828 "./src/main/cms/cms.c"
                  ;
    }
# 843 "./src/main/cms/cms.c"
    if (pMenu != currentCtx.menu) {
        saveMenuInhibited = 
# 844 "./src/main/cms/cms.c" 3 4
                           0
# 844 "./src/main/cms/cms.c"
                                ;

        if (currentCtx.menu) {


            if (menuStackIdx >= 10 - 1) {

                return 
# 851 "./src/main/cms/cms.c" 3 4
                      ((void *)0)
# 851 "./src/main/cms/cms.c"
                          ;
            }
    ...
    return 
# 882 "./src/main/cms/cms.c" 3 4
          ((void *)0)
# 882 "./src/main/cms/cms.c"
              ;
}
...
void cmsMenuOpen(void)
{
    ...
    if (!cmsInMenu) {
        ...
        cmsInMenu = 
# 894 "./src/main/cms/cms.c" 3 4
                   1
# 894 "./src/main/cms/cms.c"
                       ;
        currentCtx = (cmsCtx_t){ 
# 895 "./src/main/cms/cms.c" 3 4
                                ((void *)0)
# 895 "./src/main/cms/cms.c"
                                    , 0, 0 };
        ...
        if (osdConfig()->cms_background_type != DISPLAY_BACKGROUND_TRANSPARENT) {
            displaySetBackgroundType(pCurrentDisplay, (displayPortBackground_e)osdConfig()->cms_background_type);
        }
    } else {
        ...
        if (pNextDisplay != pCurrentDisplay) {
            ...
            displaySetBackgroundType(pCurrentDisplay, DISPLAY_BACKGROUND_TRANSPARENT);
    ...
    if ( pCurrentDisplay->cols < 18) {
      smallScreen = 
# 926 "./src/main/cms/cms.c" 3 4
                         1
# 926 "./src/main/cms/cms.c"
                             ;
      linesPerMenuItem = 2;
      leftMenuColumn = 0;
      ...
      smallScreen = 
# 932 "./src/main/cms/cms.c" 3 4
                         0
# 932 "./src/main/cms/cms.c"
                              ;
      linesPerMenuItem = 1;
      leftMenuColumn = 2;
...
{
    for (const OSD_Entry *p = pMenu->entries; (p->flags & 0x001f) != OME_END ; p++) {
        if ((p->flags & 0x001f) == OME_Submenu) {
...
const void *cmsMenuExit(displayPort_t *pDisplay, const void *ptr)
{
    ...
    case (4):
        ...
        if (currentCtx.menu->onExit) {
            currentCtx.menu->onExit(pDisplay, (OSD_Entry *)
# 974 "./src/main/cms/cms.c" 3 4
                                                          ((void *)0)
# 974 "./src/main/cms/cms.c"
                                                              );
        }

        if ((exitType == (3)) || (exitType == (4))) {

            for (int i = menuStackIdx - 1; i >= 0; i--) {
                if (menuStack[i].menu->onExit) {
                    menuStack[i].menu->onExit(pDisplay, (OSD_Entry *)
# 981 "./src/main/cms/cms.c" 3 4
                                                                    ((void *)0)
# 981 "./src/main/cms/cms.c"
                                                                        );
                }
            }
        }
    ...
    cmsInMenu = 
# 993 "./src/main/cms/cms.c" 3 4
               0
# 993 "./src/main/cms/cms.c"
                    ;
    ...
    currentCtx.menu = 
# 998 "./src/main/cms/cms.c" 3 4
                     ((void *)0)
# 998 "./src/main/cms/cms.c"
                         ;

    if ((exitType == (2)) || (exitType == (4)) || (exitType == (5))) {
    ...
    return 
# 1016 "./src/main/cms/cms.c" 3 4
          ((void *)0)
# 1016 "./src/main/cms/cms.c"
              ;
}
# 1028 "./src/main/cms/cms.c"
static uint16_t cmsHandleKey(displayPort_t *pDisplay, cms_key_e key)
{
    uint16_t res = 250;
    const OSD_Entry *p;
    ...
    if (key == CMS_KEY_ESC) {
        if (osdElementEditing) {
            osdElementEditing = 
# 1044 "./src/main/cms/cms.c" 3 4
                               0
# 1044 "./src/main/cms/cms.c"
                                    ;
        } else {
            cmsMenuBack(pDisplay);
        }
    ...
    if (key == CMS_KEY_SAVEMENU && !saveMenuInhibited) {
        osdElementEditing = 
# 1052 "./src/main/cms/cms.c" 3 4
                           0
# 1052 "./src/main/cms/cms.c"
                                ;
    ...
    if ((key == CMS_KEY_UP) && (!osdElementEditing)) {
        ...
        if (currentCtx.cursorRow == -1 || ((pageTop + currentCtx.cursorRow)->flags & 0x001f) == OME_Label) {
    ...
    switch (p->flags & 0x001f) {
        ...
        case OME_Back:
            ...
            res = 500;
            osdElementEditing = 
# 1119 "./src/main/cms/cms.c" 3 4
                               0
# 1119 "./src/main/cms/cms.c"
                                    ;
            break;
        ...
        case OME_Bool:
            if (p->data) {
                ...
                *val = (key == CMS_KEY_RIGHT) ? 1 : 0;
                do { (runtimeEntryFlags[currentCtx.cursorRow]) |= 0x0020; } while (0);
                if ((p->flags & 0x0200) && (*val != previousValue)) {
                    setRebootRequired();
                }
                if (p->func) {
                    p->func(pDisplay, p->data);
        ...
        case OME_VISIBLE:
            if (p->data) {
                ...
                if ((key == CMS_KEY_RIGHT) && (!osdElementEditing)) {
                    osdElementEditing = 
# 1143 "./src/main/cms/cms.c" 3 4
                                       1
# 1143 "./src/main/cms/cms.c"
                                           ;
                    osdProfileCursor = 1;
        ...
        case OME_FLOAT:
            if (p->data) {
                ...
                do { (runtimeEntryFlags[currentCtx.cursorRow]) |= 0x0020; } while (0);
                if ((p->flags & 0x0200) && (*ptr->val != previousValue)) {
                    setRebootRequired();
                }
                if (p->func) {
                    p->func(pDisplay, p);
...
static uint16_t cmsScanKeys(timeMs_t currentTimeMs, timeMs_t lastCalledMs, int16_t rcDelayMs)
{
    ...
    if (externKey != CMS_KEY_NONE) {
        ...
        if ((rcData[THROTTLE] > 1250 && rcData[THROTTLE] < 1750) && (rcData[YAW] < 1250) && (rcData[PITCH] > 1750) && !(armingFlags & (ARMED))) {
            ...
            key = CMS_KEY_RIGHT;
        } else if ((rcData[YAW] < 1250)) {
            key = CMS_KEY_ESC;
        } else if ((rcData[YAW] > 1750)) {
...
static void cmsUpdate(uint32_t currentTimeUs)
{
    ...
    if (!cmsInMenu) {
        ...
        if ((rcData[THROTTLE] > 1250 && rcData[THROTTLE] < 1750) && (rcData[YAW] < 1250) && (rcData[PITCH] > 1750) && !(armingFlags & (ARMED)) && !IS_RC_MODE_ACTIVE(BOXSTICKCOMMANDDISABLE)) {
            cmsMenuOpen();
            rcDelayMs = 500;
        }
    } else {
...
{
    saveMenuInhibited = 
# 1517 "./src/main/cms/cms.c" 3 4
                       1
# 1517 "./src/main/cms/cms.c"
                           ;
}
