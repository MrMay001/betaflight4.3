...
# 51 "./src/main/cms/cms_menu_imu.c" 2
...
# 54 "./src/main/cms/cms_menu_imu.c" 2
...
# 56 "./src/main/cms/cms_menu_imu.c" 2
...
# 60 "./src/main/cms/cms_menu_imu.c" 2
...
# 63 "./src/main/cms/cms_menu_imu.c" 2
...
static char pidProfileIndexString[8u + 5];
static uint8_t tempPid[3][3];
static uint16_t tempPidF[3];

static uint8_t tmpRateProfileIndex;
static uint8_t rateProfileIndex;
static char rateProfileIndexString[8u + 5];
...
static const void *cmsx_menuImu_onEnter(displayPort_t *pDisp)
{
    ...
    return 
# 121 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 121 "./src/main/cms/cms_menu_imu.c"
              ;
}
...
static const void *cmsx_menuImu_onExit(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    return 
# 132 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 132 "./src/main/cms/cms_menu_imu.c"
              ;
}
...
static const void *cmsx_PidOnEnter(displayPort_t *pDisp)
{
    ...
    return 
# 178 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 178 "./src/main/cms/cms_menu_imu.c"
              ;
}
...
{
    { "-- PID --", OME_Label, 
# 200 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0)
# 200 "./src/main/cms/cms_menu_imu.c"
                                 , pidProfileIndexString},

    { "ROLL  P", OME_UINT8 | 0x0800, 
# 202 "./src/main/cms/cms_menu_imu.c" 3 4
                                       ((void *)0)
# 202 "./src/main/cms/cms_menu_imu.c"
                                           , &(OSD_UINT8_t){ &tempPid[PID_ROLL][0], 0, 200, 1 }},
    { "ROLL  I", OME_UINT8 | 0x0800, 
# 203 "./src/main/cms/cms_menu_imu.c" 3 4
                                       ((void *)0)
# 203 "./src/main/cms/cms_menu_imu.c"
                                           , &(OSD_UINT8_t){ &tempPid[PID_ROLL][1], 0, 200, 1 }},
    { "ROLL  D", OME_UINT8 | 0x0800, 
# 204 "./src/main/cms/cms_menu_imu.c" 3 4
                                       ((void *)0)
# 204 "./src/main/cms/cms_menu_imu.c"
                                           , &(OSD_UINT8_t){ &tempPid[PID_ROLL][2], 0, 200, 1 }},
    { "ROLL  F", OME_UINT16 | 0x0800, 
# 205 "./src/main/cms/cms_menu_imu.c" 3 4
                                        ((void *)0)
# 205 "./src/main/cms/cms_menu_imu.c"
                                            , &(OSD_UINT16_t){ &tempPidF[PID_ROLL], 0, 2000, 1 }},

    { "PITCH P", OME_UINT8 | 0x0800, 
# 207 "./src/main/cms/cms_menu_imu.c" 3 4
                                       ((void *)0)
# 207 "./src/main/cms/cms_menu_imu.c"
                                           , &(OSD_UINT8_t){ &tempPid[PID_PITCH][0], 0, 200, 1 }},
    { "PITCH I", OME_UINT8 | 0x0800, 
# 208 "./src/main/cms/cms_menu_imu.c" 3 4
                                       ((void *)0)
# 208 "./src/main/cms/cms_menu_imu.c"
                                           , &(OSD_UINT8_t){ &tempPid[PID_PITCH][1], 0, 200, 1 }},
    { "PITCH D", OME_UINT8 | 0x0800, 
# 209 "./src/main/cms/cms_menu_imu.c" 3 4
                                       ((void *)0)
# 209 "./src/main/cms/cms_menu_imu.c"
                                           , &(OSD_UINT8_t){ &tempPid[PID_PITCH][2], 0, 200, 1 }},
    { "PITCH F", OME_UINT16 | 0x0800, 
# 210 "./src/main/cms/cms_menu_imu.c" 3 4
                                        ((void *)0)
# 210 "./src/main/cms/cms_menu_imu.c"
                                            , &(OSD_UINT16_t){ &tempPidF[PID_PITCH], 0, 2000, 1 }},

    { "YAW   P", OME_UINT8 | 0x1000, 
# 212 "./src/main/cms/cms_menu_imu.c" 3 4
                                        ((void *)0)
# 212 "./src/main/cms/cms_menu_imu.c"
                                            , &(OSD_UINT8_t){ &tempPid[PID_YAW][0], 0, 200, 1 }},
    { "YAW   I", OME_UINT8 | 0x1000, 
# 213 "./src/main/cms/cms_menu_imu.c" 3 4
                                        ((void *)0)
# 213 "./src/main/cms/cms_menu_imu.c"
                                            , &(OSD_UINT8_t){ &tempPid[PID_YAW][1], 0, 200, 1 }},
    { "YAW   D", OME_UINT8 | 0x1000, 
# 214 "./src/main/cms/cms_menu_imu.c" 3 4
                                        ((void *)0)
# 214 "./src/main/cms/cms_menu_imu.c"
                                            , &(OSD_UINT8_t){ &tempPid[PID_YAW][2], 0, 200, 1 }},
    { "YAW   F", OME_UINT16 | 0x1000, 
# 215 "./src/main/cms/cms_menu_imu.c" 3 4
                                         ((void *)0)
# 215 "./src/main/cms/cms_menu_imu.c"
                                             , &(OSD_UINT16_t){ &tempPidF[PID_YAW], 0, 2000, 1 }},
...
# 283 "./src/main/cms/cms_menu_imu.c"
              anySettingChanged = pidProfile->simplified_pids_mode != cmsx_simplified_pids_mode
...
{
    { "-- SIMPLIFIED PID --", OME_Label, 
# 325 "./src/main/cms/cms_menu_imu.c" 3 4
                                        ((void *)0)
# 325 "./src/main/cms/cms_menu_imu.c"
                                            , 
# 325 "./src/main/cms/cms_menu_imu.c" 3 4
                                              ((void *)0)
# 325 "./src/main/cms/cms_menu_imu.c"
    ...
    { "PID TUNING", OME_TAB, 
# 326 "./src/main/cms/cms_menu_imu.c" 3 4
                                     ((void *)0)
# 326 "./src/main/cms/cms_menu_imu.c"
                                         , &(OSD_TAB_t) { &cmsx_simplified_pids_mode, PID_SIMPLIFIED_TUNING_MODE_COUNT - 1, lookupTableSimplifiedTuningPidsMode } },

    { "-- BASIC --", OME_Label, 
# 328 "./src/main/cms/cms_menu_imu.c" 3 4
                                     ((void *)0)
# 328 "./src/main/cms/cms_menu_imu.c"
                                         , 
# 328 "./src/main/cms/cms_menu_imu.c" 3 4
                                           ((void *)0)
# 328 "./src/main/cms/cms_menu_imu.c"
...
# 329 "./src/main/cms/cms_menu_imu.c"
                                         , &(OSD_FLOAT_t) { &cmsx_simplified_d_gain, 0, 200, 5, 10 } },
    { "P&I GAINS", OME_FLOAT, 
# 330 "./src/main/cms/cms_menu_imu.c" 3 4
                                     ((void *)0)
# 330 "./src/main/cms/cms_menu_imu.c"
                                         , &(OSD_FLOAT_t) { &cmsx_simplified_pi_gain, 0, 200, 5, 10 } },
    { "FF GAINS", OME_FLOAT, 
# 331 "./src/main/cms/cms_menu_imu.c" 3 4
                                     ((void *)0)
# 331 "./src/main/cms/cms_menu_imu.c"
                                         , &(OSD_FLOAT_t) { &cmsx_simplified_feedforward_gain, 0, 200, 5, 10 } },

    { "-- EXPERT --", OME_Label, 
# 333 "./src/main/cms/cms_menu_imu.c" 3 4
                                     ((void *)0)
# 333 "./src/main/cms/cms_menu_imu.c"
                                         , 
# 333 "./src/main/cms/cms_menu_imu.c" 3 4
                                           ((void *)0)
# 333 "./src/main/cms/cms_menu_imu.c"
    ...
    { "D MAX", OME_FLOAT, 
# 335 "./src/main/cms/cms_menu_imu.c" 3 4
                                     ((void *)0)
# 335 "./src/main/cms/cms_menu_imu.c"
                                         , &(OSD_FLOAT_t) { &cmsx_simplified_dmin_ratio, 0, 200, 5, 10 } },

    { "I GAINS", OME_FLOAT, 
# 337 "./src/main/cms/cms_menu_imu.c" 3 4
                                     ((void *)0)
# 337 "./src/main/cms/cms_menu_imu.c"
                                         , &(OSD_FLOAT_t) { &cmsx_simplified_i_gain, 0, 200, 5, 10 } },

    { "PITCH:ROLL D", OME_FLOAT, 
# 339 "./src/main/cms/cms_menu_imu.c" 3 4
                                     ((void *)0)
# 339 "./src/main/cms/cms_menu_imu.c"
                                         , &(OSD_FLOAT_t) { &cmsx_simplified_roll_pitch_ratio, 0, 200, 5, 10 } },
    { "PITCH:ROLL P,I&FF", OME_FLOAT, 
# 340 "./src/main/cms/cms_menu_imu.c" 3 4
                                     ((void *)0)
# 340 "./src/main/cms/cms_menu_imu.c"
                                         , &(OSD_FLOAT_t) { &cmsx_simplified_pitch_pi_gain, 0, 200, 5, 10 } },
    { "MASTER MULT", OME_FLOAT, 
# 341 "./src/main/cms/cms_menu_imu.c" 3 4
                                     ((void *)0)
# 341 "./src/main/cms/cms_menu_imu.c"
                                         , &(OSD_FLOAT_t) { &cmsx_simplified_master_multiplier, 0, 200, 5, 10 } },

    { "-- SIMPLIFIED FILTER --", OME_Label, 
...
# 344 "./src/main/cms/cms_menu_imu.c"
                                         , &(OSD_TAB_t) { &cmsx_simplified_gyro_filter, 1, lookupTableOffOn } },
    { "GYRO MULT", OME_FLOAT, 
# 345 "./src/main/cms/cms_menu_imu.c" 3 4
                                     ((void *)0)
# 345 "./src/main/cms/cms_menu_imu.c"
                                         , &(OSD_FLOAT_t) { &cmsx_simplified_gyro_filter_multiplier, 10, 200, 5, 10 } },
    { "DTERM TUNING", OME_TAB, 
# 346 "./src/main/cms/cms_menu_imu.c" 3 4
                                     ((void *)0)
# 346 "./src/main/cms/cms_menu_imu.c"
                                         , &(OSD_TAB_t) { &cmsx_simplified_dterm_filter, 1, lookupTableOffOn } },
    { "DTERM MULT", OME_FLOAT, 
# 347 "./src/main/cms/cms_menu_imu.c" 3 4
                                     ((void *)0)
# 347 "./src/main/cms/cms_menu_imu.c"
                                         , &(OSD_FLOAT_t) { &cmsx_simplified_dterm_filter_multiplier, 10, 200, 5, 10 } },

    { "BACK", OME_Back, 
# 349 "./src/main/cms/cms_menu_imu.c" 3 4
                       ((void *)0)
# 349 "./src/main/cms/cms_menu_imu.c"
                           , 
# 349 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0) 
# 349 "./src/main/cms/cms_menu_imu.c"
    ...
    { 
# 350 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 350 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 350 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 350 "./src/main/cms/cms_menu_imu.c"
...
static const void *cmsx_RateProfileRead(void)
{
    ...
    return 
# 372 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 372 "./src/main/cms/cms_menu_imu.c"
              ;
}
...
static const void *cmsx_RateProfileWriteback(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    return 
# 382 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 382 "./src/main/cms/cms_menu_imu.c"
              ;
}
...
# 399 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rcRates[FD_ROLL], 1, 255, 1, 10 } },
    { "RC P RATE", OME_FLOAT, 
# 400 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 400 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rcRates[FD_PITCH], 1, 255, 1, 10 } },
    { "RC Y RATE", OME_FLOAT, 
# 401 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 401 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rcRates[FD_YAW], 1, 255, 1, 10 } },

    { "ROLL SUPER", OME_FLOAT, 
# 403 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 403 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rates[FD_ROLL], 0, 255, 1, 10 } },
    { "PITCH SUPER", OME_FLOAT, 
# 404 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 404 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rates[FD_PITCH], 0, 255, 1, 10 } },
    { "YAW SUPER", OME_FLOAT, 
# 405 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 405 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rates[FD_YAW], 0, 255, 1, 10 } },

    { "RC R EXPO", OME_FLOAT, 
# 407 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 407 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rcExpo[FD_ROLL], 0, 100, 1, 10 } },
    { "RC P EXPO", OME_FLOAT, 
# 408 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 408 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rcExpo[FD_PITCH], 0, 100, 1, 10 } },
    { "RC Y EXPO", OME_FLOAT, 
# 409 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 409 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rcExpo[FD_YAW], 0, 100, 1, 10 } },

    { "THR MID", OME_UINT8, 
# 411 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 411 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &rateProfile.thrMid8, 0, 100, 1} },
    { "THR EXPO", OME_UINT8, 
# 412 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 412 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &rateProfile.thrExpo8, 0, 100, 1} },
    { "THRPID ATT", OME_FLOAT, 
# 413 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 413 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.tpa_rate, 0, 100, 1, 10} },
    { "TPA BRKPT", OME_UINT16, 
# 414 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 414 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT16_t){ &rateProfile.tpa_breakpoint, 1000, 2000, 10} },

    { "THR LIM TYPE",OME_TAB, 
# 416 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 416 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_TAB_t) { &rateProfile.throttle_limit_type, THROTTLE_LIMIT_TYPE_COUNT - 1, osdTableThrottleLimitType} },
    { "THR LIM %", OME_UINT8, 
# 417 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 417 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &rateProfile.throttle_limit_percent, 25, 100, 1} },

    { "ROLL LVL EXPO", OME_FLOAT, 
# 419 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 419 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_FLOAT_t) { &rateProfile.levelExpo[FD_ROLL], 0, 100, 1, 10 } },
    { "PITCH LVL EXPO", OME_FLOAT, 
# 420 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 420 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_FLOAT_t) { &rateProfile.levelExpo[FD_PITCH], 0, 100, 1, 10 } },
...
static CMS_Menu cmsx_menuRateProfile = {
    ...
    .onDisplayUpdate = 
# 433 "./src/main/cms/cms_menu_imu.c" 3 4
                      ((void *)0)
# 433 "./src/main/cms/cms_menu_imu.c"
                          ,
...
static const void *cmsx_launchControlOnEnter(displayPort_t *pDisp)
{
    ...
    return 
# 456 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 456 "./src/main/cms/cms_menu_imu.c"
              ;
}
...
static const void *cmsx_launchControlOnExit(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    return 
# 472 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 472 "./src/main/cms/cms_menu_imu.c"
              ;
}

static const OSD_Entry cmsx_menuLaunchControlEntries[] = {
    { "-- LAUNCH CONTROL --", OME_Label, 
# 476 "./src/main/cms/cms_menu_imu.c" 3 4
                                        ((void *)0)
# 476 "./src/main/cms/cms_menu_imu.c"
                                            , pidProfileIndexString },

    { "MODE", OME_TAB, 
# 478 "./src/main/cms/cms_menu_imu.c" 3 4
                                    ((void *)0)
# 478 "./src/main/cms/cms_menu_imu.c"
                                        , &(OSD_TAB_t) { &cmsx_launchControlMode, LAUNCH_CONTROL_MODE_COUNT - 1, osdLaunchControlModeNames} },
    { "ALLOW RESET", OME_Bool, 
# 479 "./src/main/cms/cms_menu_imu.c" 3 4
                                    ((void *)0)
# 479 "./src/main/cms/cms_menu_imu.c"
                                        , &cmsx_launchControlAllowTriggerReset },
    { "TRIGGER THROTTLE", OME_UINT8, 
# 480 "./src/main/cms/cms_menu_imu.c" 3 4
                                    ((void *)0)
# 480 "./src/main/cms/cms_menu_imu.c"
                                        , &(OSD_UINT8_t) { &cmsx_launchControlThrottlePercent, 0, 90, 1 } },
    { "ANGLE LIMIT", OME_UINT8, 
# 481 "./src/main/cms/cms_menu_imu.c" 3 4
                                    ((void *)0)
# 481 "./src/main/cms/cms_menu_imu.c"
                                        , &(OSD_UINT8_t) { &cmsx_launchControlAngleLimit, 0, 80, 1 } },
    { "ITERM GAIN", OME_UINT8, 
# 482 "./src/main/cms/cms_menu_imu.c" 3 4
                                    ((void *)0)
# 482 "./src/main/cms/cms_menu_imu.c"
                                        , &(OSD_UINT8_t) { &cmsx_launchControlGain, 0, 200, 1 } },

    { "BACK", OME_Back, 
# 484 "./src/main/cms/cms_menu_imu.c" 3 4
                       ((void *)0)
# 484 "./src/main/cms/cms_menu_imu.c"
                           , 
# 484 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0) 
# 484 "./src/main/cms/cms_menu_imu.c"
    ...
    { 
# 485 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 485 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 485 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 485 "./src/main/cms/cms_menu_imu.c"
...
static CMS_Menu cmsx_menuLaunchControl = {
    ...
    .onDisplayUpdate = 
# 495 "./src/main/cms/cms_menu_imu.c" 3 4
                      ((void *)0)
# 495 "./src/main/cms/cms_menu_imu.c"
                          ,
...
static const void *cmsx_profileOtherOnEnter(displayPort_t *pDisp)
{
    ...
    return 
# 579 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 579 "./src/main/cms/cms_menu_imu.c"
              ;
}
...
static const void *cmsx_profileOtherOnExit(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    initEscEndpoints();
    return 
# 629 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 629 "./src/main/cms/cms_menu_imu.c"
              ;
}

static const OSD_Entry cmsx_menuProfileOtherEntries[] = {
    { "-- OTHER PP --", OME_Label, 
# 633 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 633 "./src/main/cms/cms_menu_imu.c"
                                      , pidProfileIndexString },


    { "FF TRANSITION", OME_FLOAT, 
# 636 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 636 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_FLOAT_t) { &cmsx_feedforward_transition, 0, 100, 1, 10 } },
    { "FF AVERAGING", OME_TAB, 
# 637 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 637 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_TAB_t) { &cmsx_feedforward_averaging, 4, lookupTableFeedforwardAveraging} },
    { "FF SMOOTHNESS", OME_UINT8, 
# 638 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 638 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_UINT8_t) { &cmsx_feedforward_smooth_factor, 0, 75, 1 } },
    { "FF JITTER", OME_UINT8, 
# 639 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 639 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_UINT8_t) { &cmsx_feedforward_jitter_factor, 0, 20, 1 } },
    { "FF BOOST", OME_UINT8, 
# 640 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 640 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_UINT8_t) { &cmsx_feedforward_boost, 0, 50, 1 } },

    { "ANGLE STR", OME_UINT8, 
# 642 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 642 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_angleStrength, 0, 200, 1 } },
    { "HORZN STR", OME_UINT8, 
# 643 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 643 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_horizonStrength, 0, 200, 1 } },
    { "HORZN TRS", OME_UINT8, 
# 644 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 644 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_horizonTransition, 0, 200, 1 } },
    { "AG GAIN", OME_UINT16, 
# 645 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 645 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT16_t) { &cmsx_itermAcceleratorGain, 0, 30000, 10 } },
    { "AG THR", OME_UINT16, 
# 646 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 646 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT16_t) { &cmsx_itermThrottleThreshold, 20, 1000, 1 } },

    { "THR BOOST", OME_UINT8, 
# 648 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 648 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_throttleBoost, 0, 100, 1 } },


    { "THR LINEAR", OME_UINT8, 
# 651 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 651 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_thrustLinearization, 0, 150, 1 } },


    { "I_RELAX", OME_TAB, 
# 654 "./src/main/cms/cms_menu_imu.c" 3 4
                                    ((void *)0)
# 654 "./src/main/cms/cms_menu_imu.c"
                                        , &(OSD_TAB_t) { &cmsx_iterm_relax, ITERM_RELAX_COUNT - 1, lookupTableItermRelax } },
    { "I_RELAX TYPE", OME_TAB, 
# 655 "./src/main/cms/cms_menu_imu.c" 3 4
                                    ((void *)0)
# 655 "./src/main/cms/cms_menu_imu.c"
                                        , &(OSD_TAB_t) { &cmsx_iterm_relax_type, ITERM_RELAX_TYPE_COUNT - 1, lookupTableItermRelaxType } },
    { "I_RELAX CUTOFF", OME_UINT8, 
# 656 "./src/main/cms/cms_menu_imu.c" 3 4
                                    ((void *)0)
# 656 "./src/main/cms/cms_menu_imu.c"
                                        , &(OSD_UINT8_t) { &cmsx_iterm_relax_cutoff, 1, 50, 1 } },


    {"LAUNCH CONTROL", OME_Submenu, cmsMenuChange, &cmsx_menuLaunchControl },

    { "MTR OUT LIM %",OME_UINT8, 
# 661 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 661 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_motorOutputLimit, 1, 100, 1} },

    { "AUTO CELL CNT", OME_INT8, 
# 663 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 663 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_INT8_t) { &cmsx_autoProfileCellCount, AUTO_PROFILE_CELL_COUNT_CHANGE, 8, 1} },


    { "D_MIN ROLL", OME_UINT8 | 0x0800, 
# 666 "./src/main/cms/cms_menu_imu.c" 3 4
                                            ((void *)0)
# 666 "./src/main/cms/cms_menu_imu.c"
                                                , &(OSD_UINT8_t) { &cmsx_d_min[FD_ROLL], 0, 100, 1 } },
    { "D_MIN PITCH", OME_UINT8 | 0x0800, 
# 667 "./src/main/cms/cms_menu_imu.c" 3 4
                                            ((void *)0)
# 667 "./src/main/cms/cms_menu_imu.c"
                                                , &(OSD_UINT8_t) { &cmsx_d_min[FD_PITCH], 0, 100, 1 } },
    { "D_MIN YAW", OME_UINT8 | 0x1000, 
# 668 "./src/main/cms/cms_menu_imu.c" 3 4
                                             ((void *)0)
# 668 "./src/main/cms/cms_menu_imu.c"
                                                 , &(OSD_UINT8_t) { &cmsx_d_min[FD_YAW], 0, 100, 1 } },
    { "D_MIN GAIN", OME_UINT8, 
# 669 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 669 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_d_min_gain, 0, 100, 1 } },
    { "D_MIN ADV", OME_UINT8, 
# 670 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 670 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_d_min_advance, 0, 200, 1 } },



    { "VBAT_SAG_COMP", OME_UINT8, 
# 674 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 674 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_UINT8_t) { &cmsx_vbat_sag_compensation, 0, 150, 1 } },


    { "BACK", OME_Back, 
# 677 "./src/main/cms/cms_menu_imu.c" 3 4
                       ((void *)0)
# 677 "./src/main/cms/cms_menu_imu.c"
                           , 
# 677 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0) 
# 677 "./src/main/cms/cms_menu_imu.c"
    ...
    { 
# 678 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 678 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 678 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 678 "./src/main/cms/cms_menu_imu.c"
...
static CMS_Menu cmsx_menuProfileOther = {
    ...
    .onDisplayUpdate = 
# 688 "./src/main/cms/cms_menu_imu.c" 3 4
                      ((void *)0)
# 688 "./src/main/cms/cms_menu_imu.c"
                          ,
...
static const void *cmsx_menuGyro_onEnter(displayPort_t *pDisp)
{
    ...
    return 
# 713 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 713 "./src/main/cms/cms_menu_imu.c"
              ;
}
...
static const void *cmsx_menuGyro_onExit(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    return 
# 729 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 729 "./src/main/cms/cms_menu_imu.c"
              ;
}
...
# 734 "./src/main/cms/cms_menu_imu.c" 3 4
                                     ((void *)0)
# 734 "./src/main/cms/cms_menu_imu.c"
                                         , 
# 734 "./src/main/cms/cms_menu_imu.c" 3 4
                                           ((void *)0) 
# 734 "./src/main/cms/cms_menu_imu.c"
    ...
    { "GYRO LPF1", OME_UINT16 | 0x2000, 
# 736 "./src/main/cms/cms_menu_imu.c" 3 4
                                             ((void *)0)
# 736 "./src/main/cms/cms_menu_imu.c"
                                                 , &(OSD_UINT16_t) { &gyroConfig_gyro_lpf1_static_hz, 0, 1000, 1 } },

    { "GYRO LPF2", OME_UINT16 | 0x2000, 
# 738 "./src/main/cms/cms_menu_imu.c" 3 4
                                             ((void *)0)
# 738 "./src/main/cms/cms_menu_imu.c"
                                                 , &(OSD_UINT16_t) { &gyroConfig_gyro_lpf2_static_hz, 0, 1000, 1 } },

    { "GYRO NF1", OME_UINT16, 
# 740 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 740 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t) { &gyroConfig_gyro_soft_notch_hz_1, 0, 500, 1 } },
    { "GYRO NF1C", OME_UINT16, 
# 741 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 741 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t) { &gyroConfig_gyro_soft_notch_cutoff_1, 0, 500, 1 } },
    { "GYRO NF2", OME_UINT16, 
# 742 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 742 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t) { &gyroConfig_gyro_soft_notch_hz_2, 0, 500, 1 } },
    { "GYRO NF2C", OME_UINT16, 
# 743 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 743 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t) { &gyroConfig_gyro_soft_notch_cutoff_2, 0, 500, 1 } },

    { "GYRO TO USE", OME_TAB | 0x0200, 
# 745 "./src/main/cms/cms_menu_imu.c" 3 4
                                                 ((void *)0)
# 745 "./src/main/cms/cms_menu_imu.c"
                                                     , &(OSD_TAB_t) { &gyroConfig_gyro_to_use, 2, osdTableGyroToUse} },


    { "BACK", OME_Back, 
# 748 "./src/main/cms/cms_menu_imu.c" 3 4
                       ((void *)0)
# 748 "./src/main/cms/cms_menu_imu.c"
                           , 
# 748 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0) 
# 748 "./src/main/cms/cms_menu_imu.c"
    ...
    { 
# 749 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 749 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 749 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 749 "./src/main/cms/cms_menu_imu.c"
...
static CMS_Menu cmsx_menuFilterGlobal = {
    ...
    .onDisplayUpdate = 
# 759 "./src/main/cms/cms_menu_imu.c" 3 4
                      ((void *)0)
# 759 "./src/main/cms/cms_menu_imu.c"
                          ,
...
static const void *cmsx_menuDynFilt_onEnter(displayPort_t *pDisp)
{
    ...
    return 
# 800 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 800 "./src/main/cms/cms_menu_imu.c"
              ;
}
...
static const void *cmsx_menuDynFilt_onExit(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    return 
# 824 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 824 "./src/main/cms/cms_menu_imu.c"
              ;
}
...
# 829 "./src/main/cms/cms_menu_imu.c"
    ...
    { "NOTCH COUNT", OME_UINT8, 
# 832 "./src/main/cms/cms_menu_imu.c" 3 4
                                   ((void *)0)
# 832 "./src/main/cms/cms_menu_imu.c"
                                       , &(OSD_UINT8_t) { &dynFiltNotchCount, 0, 5, 1 } },
    { "NOTCH Q", OME_UINT16, 
# 833 "./src/main/cms/cms_menu_imu.c" 3 4
                                   ((void *)0)
# 833 "./src/main/cms/cms_menu_imu.c"
                                       , &(OSD_UINT16_t) { &dynFiltNotchQ, 1, 1000, 1 } },
    { "NOTCH MIN HZ", OME_UINT16, 
# 834 "./src/main/cms/cms_menu_imu.c" 3 4
                                   ((void *)0)
# 834 "./src/main/cms/cms_menu_imu.c"
                                       , &(OSD_UINT16_t) { &dynFiltNotchMinHz, 60, 250, 1 } },
    { "NOTCH MAX HZ", OME_UINT16, 
# 835 "./src/main/cms/cms_menu_imu.c" 3 4
                                   ((void *)0)
# 835 "./src/main/cms/cms_menu_imu.c"
                                       , &(OSD_UINT16_t) { &dynFiltNotchMaxHz, 200, 1000, 1 } },



    { "GYRO DLPF MIN", OME_UINT16 | 0x2000, 
# 839 "./src/main/cms/cms_menu_imu.c" 3 4
                                                  ((void *)0)
# 839 "./src/main/cms/cms_menu_imu.c"
                                                      , &(OSD_UINT16_t) { &gyroLpfDynMin, 0, 1000, 1 } },
    { "GYRO DLPF MAX", OME_UINT16 | 0x2000, 
# 840 "./src/main/cms/cms_menu_imu.c" 3 4
                                                  ((void *)0)
# 840 "./src/main/cms/cms_menu_imu.c"
                                                      , &(OSD_UINT16_t) { &gyroLpfDynMax, 0, 1000, 1 } },
    { "GYRO DLPF EXPO", OME_UINT8, 
# 841 "./src/main/cms/cms_menu_imu.c" 3 4
                                   ((void *)0)
# 841 "./src/main/cms/cms_menu_imu.c"
                                       , &(OSD_UINT8_t) { &gyroLpfDynExpo, 0, 10, 1 } },
    { "DTERM DLPF MIN", OME_UINT16 | 0x4000, 
# 842 "./src/main/cms/cms_menu_imu.c" 3 4
                                                   ((void *)0)
# 842 "./src/main/cms/cms_menu_imu.c"
                                                       , &(OSD_UINT16_t) { &dtermLpfDynMin, 0, 1000, 1 } },
    { "DTERM DLPF MAX", OME_UINT16 | 0x4000, 
# 843 "./src/main/cms/cms_menu_imu.c" 3 4
                                                   ((void *)0)
# 843 "./src/main/cms/cms_menu_imu.c"
                                                       , &(OSD_UINT16_t) { &dtermLpfDynMax, 0, 1000, 1 } },
    { "DTERM DLPF EXPO", OME_UINT8, 
# 844 "./src/main/cms/cms_menu_imu.c" 3 4
                                   ((void *)0)
# 844 "./src/main/cms/cms_menu_imu.c"
                                       , &(OSD_UINT8_t) { &dtermLpfDynExpo, 0, 10, 1 } },


    { "BACK", OME_Back, 
# 847 "./src/main/cms/cms_menu_imu.c" 3 4
                       ((void *)0)
# 847 "./src/main/cms/cms_menu_imu.c"
                           , 
# 847 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0) 
# 847 "./src/main/cms/cms_menu_imu.c"
    ...
    { 
# 848 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 848 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 848 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 848 "./src/main/cms/cms_menu_imu.c"
...
static CMS_Menu cmsx_menuDynFilt = {
    ...
    .onDisplayUpdate = 
# 858 "./src/main/cms/cms_menu_imu.c" 3 4
                      ((void *)0)
# 858 "./src/main/cms/cms_menu_imu.c"
                          ,
...
static const void *cmsx_FilterPerProfileRead(displayPort_t *pDisp)
{
    ...
    return 
# 882 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 882 "./src/main/cms/cms_menu_imu.c"
              ;
}
...
static const void *cmsx_FilterPerProfileWriteback(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    return 
# 898 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 898 "./src/main/cms/cms_menu_imu.c"
              ;
}
...
{
    { "-- FILTER PP  --", OME_Label, 
# 903 "./src/main/cms/cms_menu_imu.c" 3 4
                                    ((void *)0)
# 903 "./src/main/cms/cms_menu_imu.c"
                                        , 
# 903 "./src/main/cms/cms_menu_imu.c" 3 4
                                          ((void *)0) 
# 903 "./src/main/cms/cms_menu_imu.c"
    ...
    { "DTERM LPF1", OME_UINT16 | 0x4000, 
# 905 "./src/main/cms/cms_menu_imu.c" 3 4
                                              ((void *)0)
# 905 "./src/main/cms/cms_menu_imu.c"
                                                  , &(OSD_UINT16_t){ &cmsx_dterm_lpf1_static_hz, 0, 1000, 1 } },
    { "DTERM LPF2", OME_UINT16 | 0x4000, 
# 906 "./src/main/cms/cms_menu_imu.c" 3 4
                                              ((void *)0)
# 906 "./src/main/cms/cms_menu_imu.c"
                                                  , &(OSD_UINT16_t){ &cmsx_dterm_lpf2_static_hz, 0, 1000, 1 } },
    { "DTERM NF", OME_UINT16, 
# 907 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 907 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t){ &cmsx_dterm_notch_hz, 0, 1000, 1 } },
    { "DTERM NFCO", OME_UINT16, 
# 908 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 908 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t){ &cmsx_dterm_notch_cutoff, 0, 1000, 1 } },
    { "YAW LPF", OME_UINT16, 
# 909 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 909 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t){ &cmsx_yaw_lowpass_hz, 0, 500, 1 } },

    { "BACK", OME_Back, 
# 911 "./src/main/cms/cms_menu_imu.c" 3 4
                       ((void *)0)
# 911 "./src/main/cms/cms_menu_imu.c"
                           , 
# 911 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0) 
# 911 "./src/main/cms/cms_menu_imu.c"
    ...
    { 
# 912 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 912 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 912 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 912 "./src/main/cms/cms_menu_imu.c"
...
static CMS_Menu cmsx_menuFilterPerProfile = {
    ...
    .onDisplayUpdate = 
# 922 "./src/main/cms/cms_menu_imu.c" 3 4
                      ((void *)0)
# 922 "./src/main/cms/cms_menu_imu.c"
                          ,
...
# 977 "./src/main/cms/cms_menu_imu.c" 3 4
                                      ((void *)0)
# 977 "./src/main/cms/cms_menu_imu.c"
                                          , 
# 977 "./src/main/cms/cms_menu_imu.c" 3 4
                                            ((void *)0)
# 977 "./src/main/cms/cms_menu_imu.c"
...
# 979 "./src/main/cms/cms_menu_imu.c" 3 4
                                        ((void *)0)
# 979 "./src/main/cms/cms_menu_imu.c"
                                            , &cmsx_PidProfileTable },
    { "COPY PP", OME_Funcall, cmsx_CopyPidProfile, 
# 980 "./src/main/cms/cms_menu_imu.c" 3 4
                                                                     ((void *)0) 
# 980 "./src/main/cms/cms_menu_imu.c"
                                                                          },
    { "CPY RATE PROF TO", OME_TAB, 
# 981 "./src/main/cms/cms_menu_imu.c" 3 4
                                        ((void *)0)
# 981 "./src/main/cms/cms_menu_imu.c"
...
# 982 "./src/main/cms/cms_menu_imu.c"
    ...
    { "BACK", OME_Back, 
# 984 "./src/main/cms/cms_menu_imu.c" 3 4
                       ((void *)0)
# 984 "./src/main/cms/cms_menu_imu.c"
                           , 
# 984 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0) 
# 984 "./src/main/cms/cms_menu_imu.c"
    ...
    { 
# 985 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 985 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 985 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 985 "./src/main/cms/cms_menu_imu.c"
...
CMS_Menu cmsx_menuCopyProfile = {
    ...
    .onExit = 
# 994 "./src/main/cms/cms_menu_imu.c" 3 4
             ((void *)0)
# 994 "./src/main/cms/cms_menu_imu.c"
                 ,
    .onDisplayUpdate = 
# 995 "./src/main/cms/cms_menu_imu.c" 3 4
                      ((void *)0)
# 995 "./src/main/cms/cms_menu_imu.c"
                          ,
...
{
    { "-- PROFILE --", OME_Label, 
# 1003 "./src/main/cms/cms_menu_imu.c" 3 4
                                 ((void *)0)
# 1003 "./src/main/cms/cms_menu_imu.c"
                                     , 
# 1003 "./src/main/cms/cms_menu_imu.c" 3 4
                                       ((void *)0)
# 1003 "./src/main/cms/cms_menu_imu.c"
    ...
    {"PID PROF", OME_UINT8, cmsx_profileIndexOnChange, &(OSD_UINT8_t){ &tmpPidProfileIndex, 1, 3, 1}},
    ...
    {"RATE PROF", OME_UINT8, cmsx_rateProfileIndexOnChange, &(OSD_UINT8_t){ &tmpRateProfileIndex, 1, 6, 1}},
    ...
    {"BACK", OME_Back, 
# 1025 "./src/main/cms/cms_menu_imu.c" 3 4
                      ((void *)0)
# 1025 "./src/main/cms/cms_menu_imu.c"
                          , 
# 1025 "./src/main/cms/cms_menu_imu.c" 3 4
                            ((void *)0)
# 1025 "./src/main/cms/cms_menu_imu.c"
    ...
    {
# 1026 "./src/main/cms/cms_menu_imu.c" 3 4
    ((void *)0)
# 1026 "./src/main/cms/cms_menu_imu.c"
        , OME_END, 
# 1026 "./src/main/cms/cms_menu_imu.c" 3 4
                   ((void *)0)
# 1026 "./src/main/cms/cms_menu_imu.c"
...
CMS_Menu cmsx_menuImu = {
    ...
    .onDisplayUpdate = 
# 1036 "./src/main/cms/cms_menu_imu.c" 3 4
                      ((void *)0)
# 1036 "./src/main/cms/cms_menu_imu.c"
                          ,
