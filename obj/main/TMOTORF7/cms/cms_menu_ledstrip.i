...
# 40 "./src/main/cms/cms_menu_ledstrip.c" 2
...
# 42 "./src/main/cms/cms_menu_ledstrip.c" 2


# 1 "./src/main/pg/pg_ids.h" 1
# 21 "./src/main/pg/pg_ids.h"
       
# 45 "./src/main/cms/cms_menu_ledstrip.c" 2
...
# 47 "./src/main/cms/cms_menu_ledstrip.c" 2
...
static const void *cmsx_Ledstrip_OnEnter(displayPort_t *pDisp)
{
    ...
    return 
# 82 "./src/main/cms/cms_menu_ledstrip.c" 3 4
          ((void *)0)
# 82 "./src/main/cms/cms_menu_ledstrip.c"
              ;
}
...
static const void *cmsx_Ledstrip_OnExit(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    return 
# 107 "./src/main/cms/cms_menu_ledstrip.c" 3 4
          ((void *)0)
# 107 "./src/main/cms/cms_menu_ledstrip.c"
              ;
}
...
{
    { "-- LED STRIP --", OME_Label, 
# 112 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                                    ((void *)0)
# 112 "./src/main/cms/cms_menu_ledstrip.c"
                                        , 
# 112 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                                          ((void *)0) 
# 112 "./src/main/cms/cms_menu_ledstrip.c"
    ...
    { "ENABLED", OME_Bool, 
# 113 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                                    ((void *)0)
# 113 "./src/main/cms/cms_menu_ledstrip.c"
                                        , &cmsx_FeatureLedstrip },
    { "PROFILE", OME_TAB, 
# 114 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                                    ((void *)0)
# 114 "./src/main/cms/cms_menu_ledstrip.c"
                                        , &(OSD_TAB_t){ &cmsx_ledProfile, LED_PROFILE_COUNT - 1, ledProfileNames } },
    { "RACE COLOR", OME_TAB, 
# 115 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                                    ((void *)0)
# 115 "./src/main/cms/cms_menu_ledstrip.c"
                                        , &(OSD_TAB_t){ &cmsx_ledRaceColor, COLOR_COUNT - 1, lookupTableLedstripColors } },
    { "BEACON COLOR", OME_TAB, 
# 116 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                                    ((void *)0)
# 116 "./src/main/cms/cms_menu_ledstrip.c"
                                        , &(OSD_TAB_t){ &cmsx_ledBeaconColor, COLOR_COUNT -1, lookupTableLedstripColors } },
    { "BEACON PERIOD", OME_UINT16,
# 117 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                                    ((void *)0)
# 117 "./src/main/cms/cms_menu_ledstrip.c"
                                        , &(OSD_UINT16_t){ &cmsx_ledBeaconPeriod, 50, 10000, 10 } },
    { "BEACON ON %", OME_UINT8, 
# 118 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                                    ((void *)0)
# 118 "./src/main/cms/cms_menu_ledstrip.c"
                                        , &(OSD_UINT8_t){ &cmsx_ledBeaconOnPercent, 0, 100, 1 } },
    { "BEACON ARMED ONLY",OME_Bool, 
# 119 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                                    ((void *)0)
# 119 "./src/main/cms/cms_menu_ledstrip.c"
                                        , &cmsx_ledBeaconArmedOnly },
    { "VISUAL BEEPER", OME_Bool, 
# 120 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                                    ((void *)0)
# 120 "./src/main/cms/cms_menu_ledstrip.c"
                                        , &cmsx_ledVisualBeeper },
    { "VISUAL COLOR", OME_TAB, 
# 121 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                                    ((void *)0)
# 121 "./src/main/cms/cms_menu_ledstrip.c"
                                        , &(OSD_TAB_t){ &cmsx_ledVisualBeeperColor, COLOR_COUNT - 1, lookupTableLedstripColors } },
    { "BACK", OME_Back, 
# 122 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                       ((void *)0)
# 122 "./src/main/cms/cms_menu_ledstrip.c"
                           , 
# 122 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                             ((void *)0) 
# 122 "./src/main/cms/cms_menu_ledstrip.c"
    ...
    { 
# 123 "./src/main/cms/cms_menu_ledstrip.c" 3 4
     ((void *)0)
# 123 "./src/main/cms/cms_menu_ledstrip.c"
         , OME_END, 
# 123 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                    ((void *)0)
# 123 "./src/main/cms/cms_menu_ledstrip.c"
...
CMS_Menu cmsx_menuLedstrip = {
    ...
    .onDisplayUpdate = 
# 133 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                      ((void *)0)
# 133 "./src/main/cms/cms_menu_ledstrip.c"
                          ,
