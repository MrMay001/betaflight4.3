...
# 56 "./src/main/cms/cms_menu_misc.c" 2
...
# 58 "./src/main/cms/cms_menu_misc.c" 2
...
static const void *cmsx_menuRcOnEnter(displayPort_t *pDisp)
{
    ...
    return 
# 69 "./src/main/cms/cms_menu_misc.c" 3 4
          ((void *)0)
# 69 "./src/main/cms/cms_menu_misc.c"
              ;
}
...
static const void *cmsx_menuRcConfirmBack(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    if (self && ((self->flags & 0x001f) == OME_Back)) {
        return 
...
static const void *cmsx_menuRcOnDisplayUpdate(displayPort_t *pDisp, const OSD_Entry *selected)
{
    ...
    return 
# 94 "./src/main/cms/cms_menu_misc.c" 3 4
          ((void *)0)
# 94 "./src/main/cms/cms_menu_misc.c"
              ;
}
...
{
    { "-- RC PREV --", OME_Label, 
# 102 "./src/main/cms/cms_menu_misc.c" 3 4
                                 ((void *)0)
# 102 "./src/main/cms/cms_menu_misc.c"
                                     , 
# 102 "./src/main/cms/cms_menu_misc.c" 3 4
                                       ((void *)0)
# 102 "./src/main/cms/cms_menu_misc.c"
    ...
    { "ROLL", OME_INT16 | 0x0080, 
# 104 "./src/main/cms/cms_menu_misc.c" 3 4
                                   ((void *)0)
# 104 "./src/main/cms/cms_menu_misc.c"
                                       , &(OSD_INT16_t){ &rcDataInt[ROLL], 1, 2500, 0 } },
    { "PITCH", OME_INT16 | 0x0080, 
# 105 "./src/main/cms/cms_menu_misc.c" 3 4
                                   ((void *)0)
# 105 "./src/main/cms/cms_menu_misc.c"
                                       , &(OSD_INT16_t){ &rcDataInt[PITCH], 1, 2500, 0 } },
    { "THR", OME_INT16 | 0x0080, 
# 106 "./src/main/cms/cms_menu_misc.c" 3 4
                                   ((void *)0)
# 106 "./src/main/cms/cms_menu_misc.c"
                                       , &(OSD_INT16_t){ &rcDataInt[THROTTLE], 1, 2500, 0 } },
    { "YAW", OME_INT16 | 0x0080, 
# 107 "./src/main/cms/cms_menu_misc.c" 3 4
                                   ((void *)0)
# 107 "./src/main/cms/cms_menu_misc.c"
                                       , &(OSD_INT16_t){ &rcDataInt[YAW], 1, 2500, 0 } },

    { "AUX1", OME_INT16 | 0x0080, 
# 109 "./src/main/cms/cms_menu_misc.c" 3 4
                                   ((void *)0)
# 109 "./src/main/cms/cms_menu_misc.c"
                                       , &(OSD_INT16_t){ &rcDataInt[AUX1], 1, 2500, 0 } },
    { "AUX2", OME_INT16 | 0x0080, 
# 110 "./src/main/cms/cms_menu_misc.c" 3 4
                                   ((void *)0)
# 110 "./src/main/cms/cms_menu_misc.c"
                                       , &(OSD_INT16_t){ &rcDataInt[AUX2], 1, 2500, 0 } },
    { "AUX3", OME_INT16 | 0x0080, 
# 111 "./src/main/cms/cms_menu_misc.c" 3 4
                                   ((void *)0)
# 111 "./src/main/cms/cms_menu_misc.c"
                                       , &(OSD_INT16_t){ &rcDataInt[AUX3], 1, 2500, 0 } },
    { "AUX4", OME_INT16 | 0x0080, 
# 112 "./src/main/cms/cms_menu_misc.c" 3 4
                                   ((void *)0)
# 112 "./src/main/cms/cms_menu_misc.c"
                                       , &(OSD_INT16_t){ &rcDataInt[AUX4], 1, 2500, 0 } },

    { "BACK", OME_Back, 
# 114 "./src/main/cms/cms_menu_misc.c" 3 4
                        ((void *)0)
# 114 "./src/main/cms/cms_menu_misc.c"
                            , 
# 114 "./src/main/cms/cms_menu_misc.c" 3 4
                              ((void *)0)
# 114 "./src/main/cms/cms_menu_misc.c"
    ...
    {
# 115 "./src/main/cms/cms_menu_misc.c" 3 4
    ((void *)0)
# 115 "./src/main/cms/cms_menu_misc.c"
        , OME_END, 
# 115 "./src/main/cms/cms_menu_misc.c" 3 4
                   ((void *)0)
# 115 "./src/main/cms/cms_menu_misc.c"
...
static const void *cmsx_menuMiscOnEnter(displayPort_t *pDisp)
{
    ...
    return 
# 141 "./src/main/cms/cms_menu_misc.c" 3 4
          ((void *)0)
# 141 "./src/main/cms/cms_menu_misc.c"
              ;
}
...
static const void *cmsx_menuMiscOnExit(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    return 
# 153 "./src/main/cms/cms_menu_misc.c" 3 4
          ((void *)0)
# 153 "./src/main/cms/cms_menu_misc.c"
              ;
}
...
{
    { "-- MISC --", OME_Label, 
# 158 "./src/main/cms/cms_menu_misc.c" 3 4
                              ((void *)0)
# 158 "./src/main/cms/cms_menu_misc.c"
                                  , 
# 158 "./src/main/cms/cms_menu_misc.c" 3 4
                                    ((void *)0) 
# 158 "./src/main/cms/cms_menu_misc.c"
    ...
    { "MIN THR", OME_UINT16 | 0x0200, 
# 160 "./src/main/cms/cms_menu_misc.c" 3 4
                                                     ((void *)0)
# 160 "./src/main/cms/cms_menu_misc.c"
                                                         , &(OSD_UINT16_t){ &motorConfig_minthrottle, 1000, 2000, 1 } },
    { "DIGITAL IDLE", OME_UINT8 | 0x0200, 
# 161 "./src/main/cms/cms_menu_misc.c" 3 4
                                                     ((void *)0)
# 161 "./src/main/cms/cms_menu_misc.c"
                                                         , &(OSD_UINT8_t) { &motorConfig_digitalIdleOffsetValue, 0, 200, 1 } },
    { "FPV CAM ANGLE", OME_UINT8, 
# 162 "./src/main/cms/cms_menu_misc.c" 3 4
                                   ((void *)0)
# 162 "./src/main/cms/cms_menu_misc.c"
                                       , &(OSD_UINT8_t) { &rxConfig_fpvCamAngleDegrees, 0, 90, 1 } },
    { "RC PREV", OME_Submenu, cmsMenuChange, &cmsx_menuRcPreview},

    { "BACK", OME_Back, 
# 165 "./src/main/cms/cms_menu_misc.c" 3 4
                       ((void *)0)
# 165 "./src/main/cms/cms_menu_misc.c"
                           , 
# 165 "./src/main/cms/cms_menu_misc.c" 3 4
                             ((void *)0)
# 165 "./src/main/cms/cms_menu_misc.c"
    ...
    { 
# 166 "./src/main/cms/cms_menu_misc.c" 3 4
     ((void *)0)
# 166 "./src/main/cms/cms_menu_misc.c"
         , OME_END, 
# 166 "./src/main/cms/cms_menu_misc.c" 3 4
                    ((void *)0)
# 166 "./src/main/cms/cms_menu_misc.c"
...
CMS_Menu cmsx_menuMisc = {
    ...
    .onDisplayUpdate = 
# 176 "./src/main/cms/cms_menu_misc.c" 3 4
                      ((void *)0)
# 176 "./src/main/cms/cms_menu_misc.c"
                          ,
