...
extern const beeperConfig_t pgResetTemplate_beeperConfig; beeperConfig_t beeperConfig_System; beeperConfig_t beeperConfig_Copy; uint32_t beeperConfig_fnv_hash; extern const pgRegistry_t beeperConfig_Registry; const pgRegistry_t beeperConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 502 | (2 << 12), .length = 1, .size = sizeof(beeperConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&beeperConfig_System, .fnv_hash = &beeperConfig_fnv_hash, .copy = (uint8_t*)&beeperConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_beeperConfig}, };
