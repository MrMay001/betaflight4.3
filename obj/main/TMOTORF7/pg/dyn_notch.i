# 1 "./src/main/pg/dyn_notch.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/pg/dyn_notch.c"
# 21 "./src/main/pg/dyn_notch.c"
...
# 26 "./src/main/pg/dyn_notch.c" 2
# 1 "./src/main/pg/pg_ids.h" 1
# 21 "./src/main/pg/pg_ids.h"
       
# 27 "./src/main/pg/dyn_notch.c" 2
...
# 29 "./src/main/pg/dyn_notch.c" 2

extern const dynNotchConfig_t pgResetTemplate_dynNotchConfig; dynNotchConfig_t dynNotchConfig_System; dynNotchConfig_t dynNotchConfig_Copy; uint32_t dynNotchConfig_fnv_hash; extern const pgRegistry_t dynNotchConfig_Registry; const pgRegistry_t dynNotchConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 554 | (0 << 12), .length = 1, .size = sizeof(dynNotchConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&dynNotchConfig_System, .fnv_hash = &dynNotchConfig_fnv_hash, .copy = (uint8_t*)&dynNotchConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_dynNotchConfig}, };

const dynNotchConfig_t pgResetTemplate_dynNotchConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .dyn_notch_min_hz = 150, .dyn_notch_max_hz = 600, .dyn_notch_q = 300, .dyn_notch_count = 3 }
