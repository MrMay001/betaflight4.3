...
# 30 "./src/main/pg/usb.c" 2

extern const usbDev_t pgResetTemplate_usbDevConfig; usbDev_t usbDevConfig_System; usbDev_t usbDevConfig_Copy; uint32_t usbDevConfig_fnv_hash; extern const pgRegistry_t usbDevConfig_Registry; const pgRegistry_t usbDevConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 531 | (0 << 12), .length = 1, .size = sizeof(usbDev_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&usbDevConfig_System, .fnv_hash = &usbDevConfig_fnv_hash, .copy = (uint8_t*)&usbDevConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_usbDevConfig}, };
...
# 33 "./src/main/pg/usb.c" 3 4
1
# 33 "./src/main/pg/usb.c"
, .detectPin = 0, }
