...
# 36 "./src/main/pg/flash.c" 2





extern void pgResetFn_flashConfig(flashConfig_t *); flashConfig_t flashConfig_System; flashConfig_t flashConfig_Copy; uint32_t flashConfig_fnv_hash; extern const pgRegistry_t flashConfig_Registry; const pgRegistry_t flashConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 506 | (0 << 12), .length = 1, .size = sizeof(flashConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&flashConfig_System, .fnv_hash = &flashConfig_fnv_hash, .copy = (uint8_t*)&flashConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_flashConfig }, };

void pgResetFn_flashConfig(flashConfig_t *flashConfig)
{
    flashConfig->csTag = ((ioTag_t)((((2) + 1) << 4) | (8)));

    flashConfig->spiDevice = ((spiDeviceByInstance(((SPI_TypeDef *) (0x40000000UL + 0x3C00UL)))) + 1);
