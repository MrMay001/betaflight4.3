...
extern void pgResetFn_max7456Config(max7456Config_t *); max7456Config_t max7456Config_System; max7456Config_t max7456Config_Copy; uint32_t max7456Config_fnv_hash; extern const pgRegistry_t max7456Config_Registry; const pgRegistry_t max7456Config_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 524 | (0 << 12), .length = 1, .size = sizeof(max7456Config_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&max7456Config_System, .fnv_hash = &max7456Config_fnv_hash, .copy = (uint8_t*)&max7456Config_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_max7456Config }, };

void pgResetFn_max7456Config(max7456Config_t *config)
{
    config->clockConfig = 1;
    config->csTag = ((ioTag_t)((((1) + 1) << 4) | (12)));
    config->spiDevice = ((spiDeviceByInstance(((SPI_TypeDef *) (0x40000000UL + 0x3800UL)))) + 1);
    config->preInitOPU = 
# 40 "./src/main/pg/max7456.c" 3 4
                        0
# 40 "./src/main/pg/max7456.c"
                             ;
}
