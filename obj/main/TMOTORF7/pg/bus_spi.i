...
# 26 "./src/main/drivers/dma_reqmap.h" 2
...
const spiDefaultConfig_t spiDefaultConfig[] = {
    ...
    { SPIDEV_1, ((ioTag_t)((((0) + 1) << 4) | (5))), ((ioTag_t)((((0) + 1) << 4) | (6))), ((ioTag_t)((((0) + 1) << 4) | (7))), ((-1)), ((-1)) },


    { SPIDEV_2, ((ioTag_t)((((1) + 1) << 4) | (13))), ((ioTag_t)((((1) + 1) << 4) | (14))), ((ioTag_t)((((1) + 1) << 4) | (15))), ((-1)), ((-1)) },


    { SPIDEV_3, ((ioTag_t)((((1) + 1) << 4) | (3))), ((ioTag_t)((((1) + 1) << 4) | (4))), ((ioTag_t)((((1) + 1) << 4) | (5))), ((-1)), ((-1)) },
# 62 "./src/main/pg/bus_spi.c"
};

extern void pgResetFn_spiPinConfig(spiPinConfig_t *); spiPinConfig_t spiPinConfig_SystemArray[4]; spiPinConfig_t spiPinConfig_CopyArray[4]; uint32_t spiPinConfig_fnv_hash; extern const pgRegistry_t spiPinConfig_Registry; const pgRegistry_t spiPinConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 520 | (1 << 12), .length = 4, .size = (sizeof(spiPinConfig_t) * 4) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&spiPinConfig_SystemArray, .fnv_hash = &spiPinConfig_fnv_hash, .copy = (uint8_t*)&spiPinConfig_CopyArray, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_spiPinConfig}, };
