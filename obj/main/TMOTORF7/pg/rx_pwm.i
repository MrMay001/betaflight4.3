...
extern void pgResetFn_pwmConfig(pwmConfig_t *); pwmConfig_t pwmConfig_System; pwmConfig_t pwmConfig_Copy; uint32_t pwmConfig_fnv_hash; extern const pgRegistry_t pwmConfig_Registry; const pgRegistry_t pwmConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 508 | (0 << 12), .length = 1, .size = sizeof(pwmConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&pwmConfig_System, .fnv_hash = &pwmConfig_fnv_hash, .copy = (uint8_t*)&pwmConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_pwmConfig }, };
...
extern void pgResetFn_ppmConfig(ppmConfig_t *); ppmConfig_t ppmConfig_System; ppmConfig_t ppmConfig_Copy; uint32_t ppmConfig_fnv_hash; extern const pgRegistry_t ppmConfig_Registry; const pgRegistry_t ppmConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 507 | (0 << 12), .length = 1, .size = sizeof(ppmConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&ppmConfig_System, .fnv_hash = &ppmConfig_fnv_hash, .copy = (uint8_t*)&ppmConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_ppmConfig }, };
