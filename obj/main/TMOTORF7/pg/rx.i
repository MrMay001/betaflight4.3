...
extern void pgResetFn_rxConfig(rxConfig_t *); rxConfig_t rxConfig_System; rxConfig_t rxConfig_Copy; uint32_t rxConfig_fnv_hash; extern const pgRegistry_t rxConfig_Registry; const pgRegistry_t rxConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 24 | (3 << 12), .length = 1, .size = sizeof(rxConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&rxConfig_System, .fnv_hash = &rxConfig_fnv_hash, .copy = (uint8_t*)&rxConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_rxConfig }, };
void pgResetFn_rxConfig(rxConfig_t *rxConfig)
{
    *(rxConfig) = (rxConfig_t) { .halfDuplex = 0, .serialrx_provider = SERIALRX_SBUS, .serialrx_inverted = 0, .spektrum_bind_pin_override_ioTag = 0, .spektrum_bind_plug_ioTag = 0, .spektrum_sat_bind = 0, .spektrum_sat_bind_autoreset = 1, .midrc = 1500, .mincheck = 1050, .maxcheck = 1900, .rx_min_usec = 885, .rx_max_usec = 2115, .rssi_src_frame_errors = 
# 40 "./src/main/pg/rx.c" 3 4
   0
# 40 "./src/main/pg/rx.c"
   , .rssi_channel = 0, .rssi_scale = 100, .rssi_offset = 0, .rssi_invert = 0, .rssi_src_frame_lpf_period = 30, .fpvCamAngleDegrees = 0, .airModeActivateThreshold = 25, .max_aux_channel = (18 - 4), .rc_smoothing_mode = 1, .rc_smoothing_setpoint_cutoff = 0, .rc_smoothing_feedforward_cutoff = 0, .rc_smoothing_throttle_cutoff = 0, .rc_smoothing_debug_axis = ROLL, .rc_smoothing_auto_factor_rpy = 30, .rc_smoothing_auto_factor_throttle = 30, .srxl2_unit_id = 1, .srxl2_baud_fast = 
# 40 "./src/main/pg/rx.c" 3 4
   1
# 40 "./src/main/pg/rx.c"
   , .sbus_baud_fast = 
...
# 40 "./src/main/pg/rx.c" 3 4
   0
# 40 "./src/main/pg/rx.c"
   , .msp_override_channels_mask = 0, .crsf_use_negotiated_baud = 
# 40 "./src/main/pg/rx.c" 3 4
   0
# 40 "./src/main/pg/rx.c"
   , };
