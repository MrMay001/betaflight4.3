...
extern const beeperDevConfig_t pgResetTemplate_beeperDevConfig; beeperDevConfig_t beeperDevConfig_System; beeperDevConfig_t beeperDevConfig_Copy; uint32_t beeperDevConfig_fnv_hash; extern const pgRegistry_t beeperDevConfig_Registry; const pgRegistry_t beeperDevConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 503 | (0 << 12), .length = 1, .size = sizeof(beeperDevConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&beeperDevConfig_System, .fnv_hash = &beeperDevConfig_fnv_hash, .copy = (uint8_t*)&beeperDevConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_beeperDevConfig}, };
...
1
# 49 "./src/main/pg/beeper_dev.c"
, .ioTag = ((ioTag_t)((((2) + 1) << 4) | (13))), .frequency = 0 }
