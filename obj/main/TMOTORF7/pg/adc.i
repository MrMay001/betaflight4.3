...
# 25 "./src/main/drivers/adc_impl.h" 2
...
# 27 "./src/main/drivers/adc_impl.h" 2
...
# 36 "./src/main/pg/adc.c" 2


extern void pgResetFn_adcConfig(adcConfig_t *); adcConfig_t adcConfig_System; adcConfig_t adcConfig_Copy; uint32_t adcConfig_fnv_hash; extern const pgRegistry_t adcConfig_Registry; const pgRegistry_t adcConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 510 | (0 << 12), .length = 1, .size = sizeof(adcConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&adcConfig_System, .fnv_hash = &adcConfig_fnv_hash, .copy = (uint8_t*)&adcConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_adcConfig }, };

void pgResetFn_adcConfig(adcConfig_t *adcConfig)
{
    adcConfig->device = ((adcDeviceByInstance(((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2000UL)))) + 1);
    adcConfig->dmaopt[ADCDEV_1] = 1;


    adcConfig->dmaopt[ADCDEV_2] = ((-1));


    adcConfig->dmaopt[ADCDEV_3] = ((-1));
...
# 59 "./src/main/pg/adc.c"
                                 ;
    adcConfig->vbat.ioTag = ((ioTag_t)((((2) + 1) << 4) | (1)));
# 83 "./src/main/pg/adc.c"
    adcConfig->current.enabled = 
# 83 "./src/main/pg/adc.c" 3 4
                                1
# 83 "./src/main/pg/adc.c"
                                    ;
    adcConfig->current.ioTag = ((ioTag_t)((((2) + 1) << 4) | (2)));
# 95 "./src/main/pg/adc.c"
    adcConfig->rssi.enabled = 
# 95 "./src/main/pg/adc.c" 3 4
                             1
# 95 "./src/main/pg/adc.c"
                                 ;
    adcConfig->rssi.ioTag = ((ioTag_t)((((2) + 1) << 4) | (3)));
# 106 "./src/main/pg/adc.c"
