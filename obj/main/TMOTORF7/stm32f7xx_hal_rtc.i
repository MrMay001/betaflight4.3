# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
# 178 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
...
# 179 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c" 2
# 242 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
HAL_StatusTypeDef HAL_RTC_Init(RTC_HandleTypeDef *hrtc)
{

  if(hrtc == 
# 245 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c" 3 4
            ((void *)0)
# 245 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
                )
  {
     return HAL_ERROR;
  }
  ...
  ((void)0U);
  ((void)0U);
# 286 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
  ...
  else
  {
    ...
    hrtc->Instance->OR &= (uint32_t)~(0x1UL << (3U));
...
# 347 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
HAL_StatusTypeDef HAL_RTC_DeInit(RTC_HandleTypeDef *hrtc)
{
  ...
  do{ (hrtc)->Instance->WPR = 0xFFU; } while(0U);
# 446 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
...
# 671 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
...
# 726 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
HAL_StatusTypeDef HAL_RTC_SetTime(RTC_HandleTypeDef *hrtc, RTC_TimeTypeDef *sTime, uint32_t Format)
{
  uint32_t tmpreg = 0;
...
# 860 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
HAL_StatusTypeDef HAL_RTC_GetTime(RTC_HandleTypeDef *hrtc, RTC_TimeTypeDef *sTime, uint32_t Format)
{
  uint32_t tmpreg = 0;
  ...
  sTime->Hours = (uint8_t)((tmpreg & ((0x3UL << (20U)) | (0xFUL << (16U)))) >> 16);
  sTime->Minutes = (uint8_t)((tmpreg & ((0x7UL << (12U)) | (0xFUL << (8U)))) >>8);
  sTime->Seconds = (uint8_t)(tmpreg & ((0x7UL << (4U)) | (0xFUL << (0U))));
  sTime->TimeFormat = (uint8_t)((tmpreg & ((0x1UL << (22U)))) >> 16);
...
# 905 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
HAL_StatusTypeDef HAL_RTC_SetDate(RTC_HandleTypeDef *hrtc, RTC_DateTypeDef *sDate, uint32_t Format)
{
...
# 1015 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
HAL_StatusTypeDef HAL_RTC_GetDate(RTC_HandleTypeDef *hrtc, RTC_DateTypeDef *sDate, uint32_t Format)
{
  uint32_t datetmpreg = 0;
  ...
  sDate->Year = (uint8_t)((datetmpreg & ((0xFUL << (20U)) | (0xFUL << (16U)))) >> 16);
  sDate->Month = (uint8_t)((datetmpreg & ((0x1UL << (12U)) | (0xFUL << (8U)))) >> 8);
  sDate->Date = (uint8_t)(datetmpreg & ((0x3UL << (4U)) | (0xFUL << (0U))));
  sDate->WeekDay = (uint8_t)((datetmpreg & ((0x7UL << (13U)))) >> 13);
...
# 1070 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
HAL_StatusTypeDef HAL_RTC_SetAlarm(RTC_HandleTypeDef *hrtc, RTC_AlarmTypeDef *sAlarm, uint32_t Format)
{
  uint32_t tickstart = 0;
  ...
  if(sAlarm->Alarm == (0x1UL << (8U)))
  {
    ...
    ((hrtc)->Instance->CR &= ~((0x1UL << (12U))));


    tickstart = HAL_GetTick();


    while((((((hrtc)->Instance->ISR) & ((0x1UL << (0U)))) != RESET)? SET : RESET) == RESET)
    {
      if((HAL_GetTick() - tickstart ) > 1000U)
      {
  ...
  else
  {
    ...
    ((hrtc)->Instance->CR &= ~((0x1UL << (13U))));


    tickstart = HAL_GetTick();


    while((((((hrtc)->Instance->ISR) & ((0x1UL << (1U)))) != RESET)? SET : RESET) == RESET)
    {
      if((HAL_GetTick() - tickstart ) > 1000U)
      {
...
# 1256 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
HAL_StatusTypeDef HAL_RTC_SetAlarm_IT(RTC_HandleTypeDef *hrtc, RTC_AlarmTypeDef *sAlarm, uint32_t Format)
{
  uint32_t tmpreg = 0U, subsecondtmpreg = 0U;
  volatile uint32_t count = 1000U * (SystemCoreClock / 32U / 1000U) ;
  ...
  if(sAlarm->Alarm == (0x1UL << (8U)))
  {
    ...
    ((hrtc)->Instance->ISR) = (~((((0x1UL << (8U))) | (0x1UL << (7U)))& 0x0000FFFFU)|((hrtc)->Instance->ISR & (0x1UL << (7U))));
  ...
  (((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->IMR |= (0x1UL << (17U)));

  ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->RTSR |= (0x1UL << (17U));
...
# 1439 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
HAL_StatusTypeDef HAL_RTC_DeactivateAlarm(RTC_HandleTypeDef *hrtc, uint32_t Alarm)
{
  uint32_t tickstart = 0;
...
# 1536 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
HAL_StatusTypeDef HAL_RTC_GetAlarm(RTC_HandleTypeDef *hrtc, RTC_AlarmTypeDef *sAlarm, uint32_t Alarm, uint32_t Format)
{
  uint32_t tmpreg = 0, subsecondtmpreg = 0;
  ...
  sAlarm->AlarmTime.Hours = (uint32_t)((tmpreg & ((0x3UL << (20U)) | (0xFUL << (16U)))) >> 16);
  sAlarm->AlarmTime.Minutes = (uint32_t)((tmpreg & ((0x7UL << (12U)) | (0xFUL << (8U)))) >> 8);
  sAlarm->AlarmTime.Seconds = (uint32_t)(tmpreg & ((0x7UL << (4U)) | (0xFUL << (0U))));
  sAlarm->AlarmTime.TimeFormat = (uint32_t)((tmpreg & (0x1UL << (22U))) >> 16);
  sAlarm->AlarmTime.SubSeconds = (uint32_t) subsecondtmpreg;
  sAlarm->AlarmDateWeekDay = (uint32_t)((tmpreg & ((0x3UL << (28U)) | (0xFUL << (24U)))) >> 24);
...
void HAL_RTC_AlarmIRQHandler(RTC_HandleTypeDef* hrtc)
{
  if(((((((hrtc)->Instance->ISR)& (((0x1UL << (12U)))>> 4U)) & 0x0000FFFFU) != RESET)? SET : RESET))
  {

    if((uint32_t)(hrtc->Instance->CR & (0x1UL << (12U))) != (uint32_t)RESET)
    {
  ...
  if(((((((hrtc)->Instance->ISR)& (((0x1UL << (13U)))>> 4U)) & 0x0000FFFFU) != RESET)? SET : RESET))
  {

    if((uint32_t)(hrtc->Instance->CR & (0x1UL << (13U))) != (uint32_t)RESET)
    {
  ...
  (((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->PR = (0x1UL << (17U)));
...
# 1653 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
HAL_StatusTypeDef HAL_RTC_PollForAlarmAEvent(RTC_HandleTypeDef *hrtc, uint32_t Timeout)
{
  uint32_t tickstart = 0;
  ...
  while((((((hrtc)->Instance->ISR) & ((0x1UL << (8U)))) != RESET)? SET : RESET) == RESET)
  {
...
# 1715 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
HAL_StatusTypeDef HAL_RTC_WaitForSynchro(RTC_HandleTypeDef* hrtc)
{
  uint32_t tickstart = 0;
...
# 1761 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
HAL_RTCStateTypeDef HAL_RTC_GetState(RTC_HandleTypeDef* hrtc)
{
  return hrtc->State;
}
# 1778 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc.c"
HAL_StatusTypeDef RTC_EnterInitMode(RTC_HandleTypeDef* hrtc)
{
  uint32_t tickstart = 0;
