# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
# 57 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
...
# 58 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c" 2
# 86 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
extern FLASH_ProcessTypeDef pFlash;
# 96 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
...
# 158 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
HAL_StatusTypeDef HAL_FLASHEx_Erase(FLASH_EraseInitTypeDef *pEraseInit, uint32_t *SectorError)
{
    ...
    *SectorError = 0xFFFFFFFFU;
    ...
    else
    {
      ...
      for(index = pEraseInit->Sector; index < (pEraseInit->NbSectors + pEraseInit->Sector); index++)
      {
        ...
        ((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR) &= ~(((0x1UL << (1U)) | (0xFUL << (3U)))));
...
# 231 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
HAL_StatusTypeDef HAL_FLASHEx_Erase_IT(FLASH_EraseInitTypeDef *pEraseInit)
{
...
# 287 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
HAL_StatusTypeDef HAL_FLASHEx_OBProgram(FLASH_OBProgramInitTypeDef *pOBInit)
{
  HAL_StatusTypeDef status = HAL_ERROR;
  ...
  {
# 332 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
  ...
  if((pOBInit->OptionType & ((uint32_t)0x40U)) == ((uint32_t)0x40U))
  {
    status = FLASH_OB_PCROP_Config(pOBInit->PCROPSector);
  }


  if((pOBInit->OptionType & ((uint32_t)0x80U)) == ((uint32_t)0x80U))
  {
...
# 386 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
void HAL_FLASHEx_OBGetConfig(FLASH_OBProgramInitTypeDef *pOBInit)
{
  pOBInit->OptionType = ((uint32_t)0x01U) | ((uint32_t)0x02U) | ((uint32_t)0x04U) |
                 ((uint32_t)0x08U) | ((uint32_t)0x10U) | ((uint32_t)0x20U);
...
# 641 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
static void FLASH_MassErase(uint8_t VoltageRange)
{
  ...
  ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR &= ((uint32_t)0xFFFFFCFFU);
  ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR |= (0x1UL << (2U));
  ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR |= (0x1UL << (16U)) | ((uint32_t)VoltageRange <<8);


  __DSB();
}
# 672 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
void FLASH_Erase_Sector(uint32_t Sector, uint8_t VoltageRange)
{
  ...
  {
    tmp_psize = ((uint32_t)(0x1UL << (8U)));
  }
  else if(VoltageRange == ((uint32_t)0x02U))
  {
    tmp_psize = ((uint32_t)(0x2UL << (8U)));
  }
  else
  {
    tmp_psize = ((uint32_t)(0x3UL << (8U)));
  }


  ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR &= ((uint32_t)0xFFFFFCFFU);
  ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR |= tmp_psize;
  ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR &= 0xFFFFFF07U;
...
static uint32_t FLASH_OB_GetWRP(void)
{
  ...
  return ((uint32_t)(((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR & 0x00FF0000));
}
# 747 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_UserConfig(uint32_t Wwdg, uint32_t Iwdg, uint32_t Stop, uint32_t Stdby, uint32_t Iwdgstop, uint32_t Iwdgstdby)
{
  ...
  if(status == HAL_OK)
  {
    useroptionmask = ((0x1UL << (4U)) | (0x1UL << (5U)) | (0x1UL << (6U)) |
                      (0x1UL << (7U)) | (0x1UL << (31U)) | (0x1UL << (30U)));

    useroptionvalue = (Iwdg | Wwdg | Stop | Stdby | Iwdgstop | Iwdgstdby);


    (((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR)) = ((((((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR))) & (~(useroptionmask))) | (useroptionvalue))));
  }
...
static uint32_t FLASH_OB_GetUser(void)
{
  ...
  return ((uint32_t)(((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR & 0xC00000F0U));
}
# 808 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_EnableWRP(uint32_t WRPSector)
{
  HAL_StatusTypeDef status = HAL_OK;
  ...
  if(status == HAL_OK)
  {
    ...
    ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR &= (~WRPSector);
  }

  return status;
}
# 844 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_DisableWRP(uint32_t WRPSector)
{
  HAL_StatusTypeDef status = HAL_OK;
...
# 875 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_RDP_LevelConfig(uint8_t Level)
{
  HAL_StatusTypeDef status = HAL_OK;
...
# 903 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_BOR_LevelConfig(uint8_t Level)
{
  ...
  (((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR)) = ((((((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR))) & (~((0x3UL << (2U))))) | (Level))));

  return HAL_OK;

}
# 934 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_BootAddressConfig(uint32_t BootOption, uint32_t Address)
{
  HAL_StatusTypeDef status = HAL_OK;
  ...
  if(status == HAL_OK)
  {
    ...
    {
      (((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR1)) = ((((((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR1))) & (~((0xFFFFUL << (0U))))) | (Address))));
    }
    else
    {
      (((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR1)) = ((((((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR1))) & (~((0xFFFFUL << (16U))))) | ((Address << 16)))));
    }
  }

  return status;
}
# 967 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
static uint8_t FLASH_OB_GetRDP(void)
{
...
# 995 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
static uint32_t FLASH_OB_GetBOR(void)
{

  return ((uint32_t)(((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR & 0x0C));
}
# 1018 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
static uint32_t FLASH_OB_GetBootAddress(uint32_t BootOption)
{
  uint32_t Address = 0;
  ...
  if(BootOption == ((uint32_t)0x10U))
  {
    Address = ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR1 & (0xFFFFUL << (0U));
 }
  else
 {
  Address = ((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR1 & (0xFFFFUL << (16U))) >> 16);
 }

  return Address;
}
# 1045 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_PCROP_Config(uint32_t PCROPSector)
{
  HAL_StatusTypeDef status = HAL_OK;
  ...
  if(status == HAL_OK)
  {
    (((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR2)) = ((((((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR2))) & (~((0xFFUL << (0U))))) | (PCROPSector))));
  }
...
static HAL_StatusTypeDef FLASH_OB_PCROP_RDP_Config(uint32_t Pcrop_Rdp)
{
  ...
  if(status == HAL_OK)
  {
    (((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR2)) = ((((((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR2))) & (~((0x1UL << (31U))))) | (Pcrop_Rdp))));
  }
...
static uint32_t FLASH_OB_GetPCROP(void)
{
  ...
  return ((uint32_t)(((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR2 & (0xFFUL << (0U))));
}
...
static uint32_t FLASH_OB_GetPCROPRDP(void)
{
  ...
  return ((uint32_t)(((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->OPTCR2 & (0x1UL << (31U))));
}
