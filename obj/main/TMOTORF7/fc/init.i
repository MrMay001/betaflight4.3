...
# 32 "./src/main/fc/init.c" 2
# 1 "./src/main/build/debug_pin.h" 1
# 21 "./src/main/build/debug_pin.h"
...
# 24 "./src/main/build/debug_pin.h" 2
...
# 48 "./src/main/fc/init.c" 2


# 1 "./src/main/drivers/bus_quadspi.h" 1
# 23 "./src/main/drivers/bus_quadspi.h"
...
# 30 "./src/main/drivers/bus_quadspi.h" 2
# 51 "./src/main/fc/init.c" 2
...
# 67 "./src/main/drivers/light_led.h"
                         state);
# 61 "./src/main/fc/init.c" 2
# 1 "./src/main/drivers/mco.h" 1
# 21 "./src/main/drivers/mco.h"
...
# 62 "./src/main/fc/init.c" 2
# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 63 "./src/main/fc/init.c" 2
# 1 "./src/main/drivers/persistent.h" 1
# 21 "./src/main/drivers/persistent.h"
...
typedef enum {
    ...
    PERSISTENT_OBJECT_SERIALRX_BAUD,
...
# 56 "./src/main/drivers/persistent.h"
void persistentObjectInit(void);
uint32_t persistentObjectRead(persistentObjectId_e id);
void persistentObjectWrite(persistentObjectId_e id, uint32_t value);
# 64 "./src/main/fc/init.c" 2
...
# 73 "./src/main/fc/init.c" 2
# 1 "./src/main/drivers/sdio.h" 1
# 24 "./src/main/drivers/sdio.h"
typedef enum {
    SDIOINVALID = -1,
    SDIODEV_1 = 0,
    SDIODEV_2,
} SDIODevice;
# 74 "./src/main/fc/init.c" 2
...
# 1 "./src/main/pg/vtx_io.h" 1
# 21 "./src/main/pg/vtx_io.h"
...
extern vtxIOConfig_t vtxIOConfig_System; extern vtxIOConfig_t vtxIOConfig_Copy; static inline const vtxIOConfig_t* vtxIOConfig(void) { return &vtxIOConfig_System; } static inline vtxIOConfig_t* vtxIOConfigMutable(void) { return &vtxIOConfig_System; } struct _dummy;
# 33 "./src/main/drivers/vtx_rtc6705.h" 2
# 41 "./src/main/drivers/vtx_rtc6705.h"

# 41 "./src/main/drivers/vtx_rtc6705.h" 3 4
_Bool 
# 41 "./src/main/drivers/vtx_rtc6705.h"
    rtc6705IOInit(const vtxIOConfig_t *vtxIOConfig);
...
# 89 "./src/main/fc/init.c" 2
# 1 "./src/main/fc/init.h" 1
# 21 "./src/main/fc/init.h"
...
# 93 "./src/main/fc/init.c" 2
# 1 "./src/main/fc/tasks.h" 1
# 21 "./src/main/fc/tasks.h"
...
# 29 "./src/main/fc/tasks.h" 3 4
_Bool 
# 29 "./src/main/fc/tasks.h"
    taskUpdateRxMainInProgress();
# 94 "./src/main/fc/init.c" 2
...
# 105 "./src/main/fc/init.c" 2
# 1 "./src/main/io/displayport_frsky_osd.h" 1
# 20 "./src/main/io/displayport_frsky_osd.h"
...
# 1 "./src/main/pg/displayport_profiles.h" 1
# 21 "./src/main/pg/displayport_profiles.h"
...
# 28 "./src/main/pg/displayport_profiles.h" 3 4
   _Bool 
# 28 "./src/main/pg/displayport_profiles.h"
        invert;
    ...
    uint8_t attrValues[4];
    uint8_t useDeviceBlink;
...
# 26 "./src/main/io/displayport_max7456.h" 2

struct vcdProfile_s;

# 28 "./src/main/io/displayport_max7456.h" 3 4
_Bool 
# 28 "./src/main/io/displayport_max7456.h"
    max7456DisplayPortInit(const struct vcdProfile_s *vcdProfile, displayPort_t **displayPort);
# 107 "./src/main/fc/init.c" 2
# 1 "./src/main/io/displayport_msp.h" 1
# 21 "./src/main/io/displayport_msp.h"
       
# 32 "./src/main/io/displayport_msp.h"
struct displayPort_s *displayPortMspInit(void);
# 108 "./src/main/fc/init.c" 2
...
# 117 "./src/main/io/rcdevice.h" 3 4
   _Bool 
# 117 "./src/main/io/rcdevice.h"
        isReady;
} runcamDevice_t;
...
typedef struct {
    ...
    uint8_t tailPos;
    uint8_t itemCount;
    rcdeviceResponseParseContext_t buffer[1];
...
# 165 "./src/main/io/rcdevice.h" 3 4
_Bool 
# 165 "./src/main/io/rcdevice.h"
...
# 116 "./src/main/fc/init.c" 2
# 1 "./src/main/io/servos.h" 1
# 21 "./src/main/io/servos.h"
       
# 117 "./src/main/fc/init.c" 2
...
# 71 "./src/main/io/vtx_smartaudio.h" 3 4
   _Bool 
# 71 "./src/main/io/vtx_smartaudio.h"
        willBootIntoPitMode;
} smartAudioDevice_t;
...
extern 
# 88 "./src/main/io/vtx_smartaudio.h" 3 4
      _Bool 
# 88 "./src/main/io/vtx_smartaudio.h"
           saDeferred;
...
# 122 "./src/main/fc/init.c" 2
# 1 "./src/main/io/vtx_tramp.h" 1
# 21 "./src/main/io/vtx_tramp.h"
       
# 30 "./src/main/io/vtx_tramp.h"

# 30 "./src/main/io/vtx_tramp.h" 3 4
_Bool 
# 30 "./src/main/io/vtx_tramp.h"
    vtxTrampInit(void);
...
# 125 "./src/main/fc/init.c" 2

# 1 "./src/main/msc/usbd_storage.h" 1
# 23 "./src/main/msc/usbd_storage.h"
       


# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc.h" 1
# 29 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc.h"
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_bot.h" 1
# 29 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_bot.h"
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_core.h" 1
# 29 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_core.h"
# 1 "./src/main/vcp_hal/usbd_conf.h" 1
# 73 "./src/main/vcp_hal/usbd_conf.h"
...
# 35 "/opt/gcc-arm-none-eabi-9-2020-q2-update/arm-none-eabi/include/stdlib.h" 3
typedef struct
{
  int quot;
  int rem;
...
# 74 "./src/main/vcp_hal/usbd_conf.h" 2
# 30 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_core.h" 2
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_def.h" 1
# 159 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_def.h"
...
# 31 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_core.h" 2
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ioreq.h" 1
# 30 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ioreq.h"
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_core.h" 1
# 31 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ioreq.h" 2
# 80 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ioreq.h"
...
# 32 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_core.h" 2
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ctlreq.h" 1
# 76 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ctlreq.h"
...
# 33 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_core.h" 2
# 85 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_core.h"
...
# 30 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_bot.h" 2
# 80 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_bot.h"
typedef struct
{
  uint32_t dSignature;
  uint32_t dTag;
...
# 119 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_bot.h"
...
void MSC_BOT_CplClrFeature (USBD_HandleTypeDef *pdev,
                             uint8_t epnum);
# 30 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc.h" 2
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_scsi.h" 1
# 29 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_scsi.h"
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_def.h" 1
# 30 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_scsi.h" 2
# 112 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_scsi.h"
...
# 129 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_scsi.h"
...
# 162 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_scsi.h"
int8_t SCSI_ProcessCmd(USBD_HandleTypeDef *pdev, uint8_t lun, uint8_t *cmd);

void SCSI_SenseCode(USBD_HandleTypeDef *pdev, uint8_t lun, uint8_t sKey,
                    uint8_t ASC);
# 31 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc.h" 2
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ioreq.h" 1
# 32 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc.h" 2
# 69 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc.h"
...
typedef struct
{
  ...
  uint8_t bot_data[512U];
  USBD_MSC_BOT_CBWTypeDef cbw;
  USBD_MSC_BOT_CSWTypeDef csw;

  USBD_SCSI_SenseTypeDef scsi_sense [4U];
...
# 35 "./src/main/msc/usbd_storage.h"
...
# 139 "./src/main/fc/init.c" 2
# 1 "./src/main/pg/bus_quadspi.h" 1
# 21 "./src/main/pg/bus_quadspi.h"
       
# 140 "./src/main/fc/init.c" 2
...
extern 
# 47 "./src/main/rx/spektrum.h" 3 4
      _Bool 
# 47 "./src/main/rx/spektrum.h"
           srxlEnabled;
...
# 52 "./src/main/rx/spektrum.h" 3 4
_Bool 
# 52 "./src/main/rx/spektrum.h"
    spektrumInit(const rxConfig_t *rxConfig, rxRuntimeState_t *rxRuntimeState);


# 54 "./src/main/rx/spektrum.h" 3 4
_Bool 
# 54 "./src/main/rx/spektrum.h"
...
# 24 "./src/main/sensors/gyro_init.h" 2
...
# 24 "./src/main/sensors/initialisation.h" 3 4
_Bool 
# 24 "./src/main/sensors/initialisation.h"
    sensorsAutodetect(void);
# 168 "./src/main/fc/init.c" 2
...
# 170 "./src/main/fc/init.c" 2
# 179 "./src/main/fc/init.c"
uint8_t systemState = SYSTEM_STATE_INITIALISING;
# 196 "./src/main/fc/init.c"
static void configureSPIAndQuadSPI(void)
{
    ...
    spiInit(SPIDEV_3);
# 234 "./src/main/fc/init.c"
}
# 244 "./src/main/fc/init.c"
static void swdPinsInit(void)
{
    IO_t io = IOGetByTag(((ioTag_t)((((0) + 1) << 4) | (13))));
    if (IOGetOwner(io) == OWNER_FREE) {
        IOInit(io, OWNER_SWD, 0);
    }
    io = IOGetByTag(((ioTag_t)((((0) + 1) << 4) | (14))));
    if (IOGetOwner(io) == OWNER_FREE) {
        IOInit(io, OWNER_SWD, 0);
    }
}
...
# 283 "./src/main/fc/init.c"
    ...
    uint8_t initFlags = 0;
# 388 "./src/main/fc/init.c"
    initEEPROM();

    ensureEEPROMStructureIsValid();

    
# 392 "./src/main/fc/init.c" 3 4
   _Bool 
# 392 "./src/main/fc/init.c"
    ...
    if (!readSuccess || !isEEPROMVersionValid() || strncasecmp(systemConfig()->boardIdentifier, "TMR7", sizeof("TMR7"))) {
        resetEEPROM(
# 399 "./src/main/fc/init.c" 3 4
                   0
# 399 "./src/main/fc/init.c"
                        );
    }
    ...
    ledSet(2, 
# 426 "./src/main/fc/init.c" 3 4
   1
# 426 "./src/main/fc/init.c"
   );


    EXTIInit();
# 478 "./src/main/fc/init.c"
...
# 653 "./src/main/fc/init.c"
    i2cInit(I2CDEV_2);
# 674 "./src/main/fc/init.c"
    cameraControlInit();
    ...
    if (!sensorsAutodetect()) {
        ...
        if (
# 685 "./src/main/fc/init.c" 3 4
           1



            
# 689 "./src/main/fc/init.c"
           ) {
    ...
    ledSet(1, 
# 738 "./src/main/fc/init.c" 3 4
   1
# 738 "./src/main/fc/init.c"
   );
    ledSet(0, 
# 739 "./src/main/fc/init.c" 3 4
   0
# 739 "./src/main/fc/init.c"
   );
    ledSet(2, 
# 740 "./src/main/fc/init.c" 3 4
   0
# 740 "./src/main/fc/init.c"
   );
    ...
    for (int i = 0; i < 10; i++) {
        ...
        if (!(beeperConfig()->beeper_off_flags & (1 << (BEEPER_SYSTEM_INIT - 1)))) {
            systemBeep(
# 748 "./src/main/fc/init.c" 3 4
           1
# 748 "./src/main/fc/init.c"
           );
        }
        delay(25);
        systemBeep(
# 751 "./src/main/fc/init.c" 3 4
       0
# 751 "./src/main/fc/init.c"
       );
    ...
    ledSet(0, 
# 756 "./src/main/fc/init.c" 3 4
   0
# 756 "./src/main/fc/init.c"
   );
    ledSet(1, 
# 757 "./src/main/fc/init.c" 3 4
   0
# 757 "./src/main/fc/init.c"
   );
...
# 826 "./src/main/fc/init.c" 3 4
                        0
# 826 "./src/main/fc/init.c"
                             );
...
# 886 "./src/main/fc/init.c" 3 4
                                   ((void *)0)
# 886 "./src/main/fc/init.c"
                                       ;
