...
# 13 "/opt/gcc-arm-none-eabi-9-2020-q2-update/arm-none-eabi/include/stdint.h" 3 4
...
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Inc/usbd_cdc.h" 1
# 29 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Inc/usbd_cdc.h"
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ioreq.h" 1
# 29 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ioreq.h"
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_def.h" 1
# 29 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_def.h"
# 1 "./src/main/vcp_hal/usbd_conf.h" 1
# 74 "./src/main/vcp_hal/usbd_conf.h"
...
# 46 "/opt/gcc-arm-none-eabi-9-2020-q2-update/arm-none-eabi/include/strings.h" 3
...
# 75 "./src/main/vcp_hal/usbd_conf.h" 2
# 30 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_def.h" 2
...
# 30 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ioreq.h" 2
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_core.h" 1
# 31 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_core.h"
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ioreq.h" 1
...
# 30 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Inc/usbd_cdc.h" 2
# 93 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Inc/usbd_cdc.h"
typedef struct
{
  uint32_t bitrate;
  uint8_t format;
...
# 140 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Inc/usbd_cdc.h"
extern USBD_ClassTypeDef USBD_CDC;
# 149 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Inc/usbd_cdc.h"
...
# 29 "./src/main/drivers/serial_usb_vcp.h" 2
...
# 45 "./src/main/drivers/serial_usb_vcp.h" 3 4
   _Bool 
# 45 "./src/main/drivers/serial_usb_vcp.h"
        buffering;
} vcpPort_t;
...
# 24 "./src/main/io/usb_cdc_hid.h" 3 4
_Bool 
# 24 "./src/main/io/usb_cdc_hid.h"
    cdcDeviceIsMayBeActive();
# 72 "./src/main/fc/tasks.c" 2
...
# 30 "./src/main/telemetry/crsf.h" 2
...
# 45 "./src/main/telemetry/crsf.h" 3 4
_Bool 
# 45 "./src/main/telemetry/crsf.h"
    bufferCrsfMspFrame(uint8_t *frameStart, int frameLength);

# 46 "./src/main/telemetry/crsf.h" 3 4
_Bool 
# 46 "./src/main/telemetry/crsf.h"
    handleCrsfMspFrameBuffer(mspResponseFnPtr responseFn);
...
# 51 "./src/main/telemetry/crsf.h" 3 4
_Bool 
# 51 "./src/main/telemetry/crsf.h"
    crsfBaudNegotiationInProgress(void);
uint32_t getCrsfCachedBaudrate(void);
# 98 "./src/main/fc/tasks.c" 2
# 109 "./src/main/fc/tasks.c"
# 1 "./src/main/vcp_hal/usbd_cdc_interface.h" 1
# 55 "./src/main/vcp_hal/usbd_cdc_interface.h"
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_core.h" 1
# 56 "./src/main/vcp_hal/usbd_cdc_interface.h" 2
# 1 "./src/main/vcp_hal/usbd_desc.h" 1
# 53 "./src/main/vcp_hal/usbd_desc.h"
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_def.h" 1
# 54 "./src/main/vcp_hal/usbd_desc.h" 2
...
# 57 "./src/main/vcp_hal/usbd_cdc_interface.h" 2
# 77 "./src/main/vcp_hal/usbd_cdc_interface.h"
typedef struct __attribute__ ((packed))
{
  uint32_t bitrate;
  uint8_t format;
...
# 110 "./src/main/fc/tasks.c" 2
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Inc/usbd_hid.h" 1
# 78 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Inc/usbd_hid.h"
typedef enum
{
  HID_IDLE = 0,
  HID_BUSY,
...
# 112 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Inc/usbd_hid.h"
extern USBD_ClassTypeDef USBD_HID;
# 121 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Inc/usbd_hid.h"
uint8_t USBD_HID_SendReport (USBD_HandleTypeDef *pdev,
                                 uint8_t *report,
                                 uint16_t len);

uint32_t USBD_HID_GetPollingInterval (USBD_HandleTypeDef *pdev);
# 111 "./src/main/fc/tasks.c" 2
...
static void taskHandleSerial(timeUs_t currentTimeUs)
{
    ...
    do { if (debugMode == (DEBUG_USB)) { debug[(0)] = (usbCableIsInserted()); } } while (0);
    do { if (debugMode == (DEBUG_USB)) { debug[(1)] = (usbVcpIsConnected()); } } while (0);
...
# 147 "./src/main/fc/tasks.c" 3 4
   _Bool 
# 147 "./src/main/fc/tasks.c"
...
# 177 "./src/main/fc/tasks.c" 3 4
_Bool 
# 177 "./src/main/fc/tasks.c"
    taskUpdateRxMainInProgress()
{
...
static void taskUpdateRxMain(timeUs_t currentTimeUs)
{
    ...
    if (!schedulerGetIgnoreTaskExecTime()) {
        executeTimeUs = micros() - currentTimeUs + 1;


        anticipatedExecutionTime = schedulerGetNextStateTime();
        if (anticipatedExecutionTime != (rxStateDurationFractionUs[oldRxState] >> 6)) {
            rxStateDurationFractionUs[oldRxState] = anticipatedExecutionTime << 6;
        }

        if (executeTimeUs > (rxStateDurationFractionUs[oldRxState] >> 6)) {
            rxStateDurationFractionUs[oldRxState] = executeTimeUs << 6;
        } else {
    ...
    if (debugMode == DEBUG_RX_STATE_TIME) {
        debug[oldRxState] = rxStateDurationFractionUs[oldRxState] >> 6;
    }

    schedulerSetNextStateTime(rxStateDurationFractionUs[rxState] >> 6);
}
...
task_attribute_t task_attributes[TASK_COUNT] = {
    [TASK_SYSTEM] = { .taskName = "SYSTEM", .subTaskName = "LOAD", .checkFunc = 
# 334 "./src/main/fc/tasks.c" 3 4
                   ((void *)0)
# 334 "./src/main/fc/tasks.c"
                   , .taskFunc = taskSystemLoad, .desiredPeriodUs = (1000000 / (10)), .staticPriority = TASK_PRIORITY_MEDIUM_HIGH },
    [TASK_MAIN] = { .taskName = "SYSTEM", .subTaskName = "UPDATE", .checkFunc = 
# 335 "./src/main/fc/tasks.c" 3 4
                 ((void *)0)
# 335 "./src/main/fc/tasks.c"
                 , .taskFunc = taskMain, .desiredPeriodUs = (1000000 / (1000)), .staticPriority = TASK_PRIORITY_MEDIUM_HIGH },
    [TASK_SERIAL] = { .taskName = "SERIAL", .subTaskName = 
# 336 "./src/main/fc/tasks.c" 3 4
                   ((void *)0)
# 336 "./src/main/fc/tasks.c"
                   , .checkFunc = 
# 336 "./src/main/fc/tasks.c" 3 4
                   ((void *)0)
# 336 "./src/main/fc/tasks.c"
                   , .taskFunc = taskHandleSerial, .desiredPeriodUs = (1000000 / (100)), .staticPriority = TASK_PRIORITY_LOW },
    [TASK_BATTERY_ALERTS] = { .taskName = "BATTERY_ALERTS", .subTaskName = 
# 337 "./src/main/fc/tasks.c" 3 4
                           ((void *)0)
# 337 "./src/main/fc/tasks.c"
                           , .checkFunc = 
# 337 "./src/main/fc/tasks.c" 3 4
                           ((void *)0)
# 337 "./src/main/fc/tasks.c"
                           , .taskFunc = taskBatteryAlerts, .desiredPeriodUs = (1000000 / (5)), .staticPriority = TASK_PRIORITY_MEDIUM },
    [TASK_BATTERY_VOLTAGE] = { .taskName = "BATTERY_VOLTAGE", .subTaskName = 
# 338 "./src/main/fc/tasks.c" 3 4
                            ((void *)0)
# 338 "./src/main/fc/tasks.c"
                            , .checkFunc = 
# 338 "./src/main/fc/tasks.c" 3 4
                            ((void *)0)
# 338 "./src/main/fc/tasks.c"
                            , .taskFunc = batteryUpdateVoltage, .desiredPeriodUs = (1000000 / (50)), .staticPriority = TASK_PRIORITY_MEDIUM },
    [TASK_BATTERY_CURRENT] = { .taskName = "BATTERY_CURRENT", .subTaskName = 
...
# 339 "./src/main/fc/tasks.c" 3 4
                            ((void *)0)
# 339 "./src/main/fc/tasks.c"
                            , .taskFunc = batteryUpdateCurrentMeter, .desiredPeriodUs = (1000000 / (50)), .staticPriority = TASK_PRIORITY_MEDIUM },
# 349 "./src/main/fc/tasks.c"
    [TASK_GYRO] = { .taskName = "GYRO", .subTaskName = 
# 349 "./src/main/fc/tasks.c" 3 4
                 ((void *)0)
# 349 "./src/main/fc/tasks.c"
                 , .checkFunc = 
# 349 "./src/main/fc/tasks.c" 3 4
                 ((void *)0)
# 349 "./src/main/fc/tasks.c"
                 , .taskFunc = taskGyroSample, .desiredPeriodUs = 125, .staticPriority = TASK_PRIORITY_REALTIME },
    [TASK_FILTER] = { .taskName = "FILTER", .subTaskName = 
# 350 "./src/main/fc/tasks.c" 3 4
                   ((void *)0)
# 350 "./src/main/fc/tasks.c"
                   , .checkFunc = 
# 350 "./src/main/fc/tasks.c" 3 4
                   ((void *)0)
# 350 "./src/main/fc/tasks.c"
                   , .taskFunc = taskFiltering, .desiredPeriodUs = 125, .staticPriority = TASK_PRIORITY_REALTIME },
    [TASK_PID] = { .taskName = "PID", .subTaskName = 
...
# 351 "./src/main/fc/tasks.c" 3 4
                ((void *)0)
# 351 "./src/main/fc/tasks.c"
                , .taskFunc = taskMainPidLoop, .desiredPeriodUs = 125, .staticPriority = TASK_PRIORITY_REALTIME },

    [TASK_ACCEL] = { .taskName = "ACC", .subTaskName = 
# 353 "./src/main/fc/tasks.c" 3 4
                  ((void *)0)
# 353 "./src/main/fc/tasks.c"
                  , .checkFunc = 
# 353 "./src/main/fc/tasks.c" 3 4
                  ((void *)0)
# 353 "./src/main/fc/tasks.c"
                  , .taskFunc = taskUpdateAccelerometer, .desiredPeriodUs = (1000000 / (1000)), .staticPriority = TASK_PRIORITY_MEDIUM },
    [TASK_ATTITUDE] = { .taskName = "ATTITUDE", .subTaskName = 
# 354 "./src/main/fc/tasks.c" 3 4
                     ((void *)0)
# 354 "./src/main/fc/tasks.c"
                     , .checkFunc = 
# 354 "./src/main/fc/tasks.c" 3 4
                     ((void *)0)
# 354 "./src/main/fc/tasks.c"
                     , .taskFunc = imuUpdateAttitude, .desiredPeriodUs = (1000000 / (100)), .staticPriority = TASK_PRIORITY_MEDIUM },

    [TASK_RX] = { .taskName = "RX", .subTaskName = 
# 356 "./src/main/fc/tasks.c" 3 4
               ((void *)0)
# 356 "./src/main/fc/tasks.c"
               , .checkFunc = rxUpdateCheck, .taskFunc = taskUpdateRxMain, .desiredPeriodUs = (1000000 / (33)), .staticPriority = TASK_PRIORITY_HIGH },
    [TASK_DISPATCH] = { .taskName = "DISPATCH", .subTaskName = 
# 357 "./src/main/fc/tasks.c" 3 4
                     ((void *)0)
# 357 "./src/main/fc/tasks.c"
                     , .checkFunc = 
# 357 "./src/main/fc/tasks.c" 3 4
                     ((void *)0)
# 357 "./src/main/fc/tasks.c"
                     , .taskFunc = dispatchProcess, .desiredPeriodUs = (1000000 / (1000)), .staticPriority = TASK_PRIORITY_HIGH },


    [TASK_BEEPER] = { .taskName = "BEEPER", .subTaskName = 
# 360 "./src/main/fc/tasks.c" 3 4
                   ((void *)0)
...
# 364 "./src/main/fc/tasks.c" 3 4
                ((void *)0)
# 364 "./src/main/fc/tasks.c"
                , .checkFunc = 
# 364 "./src/main/fc/tasks.c" 3 4
                ((void *)0)
# 364 "./src/main/fc/tasks.c"
    ...
    [TASK_COMPASS] = { .taskName = "COMPASS", .subTaskName = 
...
# 368 "./src/main/fc/tasks.c" 3 4
                    ((void *)0)
# 368 "./src/main/fc/tasks.c"
                    , .taskFunc = taskUpdateMag, .desiredPeriodUs = (1000000 / (10)), .staticPriority = TASK_PRIORITY_LOW },



    [TASK_BARO] = { .taskName = "BARO", .subTaskName = 
# 372 "./src/main/fc/tasks.c" 3 4
                 ((void *)0)
# 372 "./src/main/fc/tasks.c"
                 , .checkFunc = 
# 372 "./src/main/fc/tasks.c" 3 4
                 ((void *)0)
# 372 "./src/main/fc/tasks.c"
                 , .taskFunc = taskUpdateBaro, .desiredPeriodUs = (1000000 / (20)), .staticPriority = TASK_PRIORITY_LOW },



    [TASK_ALTITUDE] = { .taskName = "ALTITUDE", .subTaskName = 
# 376 "./src/main/fc/tasks.c" 3 4
                     ((void *)0)
# 376 "./src/main/fc/tasks.c"
                     , .checkFunc = 
# 376 "./src/main/fc/tasks.c" 3 4
                     ((void *)0)
# 376 "./src/main/fc/tasks.c"
...
# 384 "./src/main/fc/tasks.c" 3 4
                ((void *)0)
# 384 "./src/main/fc/tasks.c"
                , .checkFunc = osdUpdateCheck, .taskFunc = osdUpdate, .desiredPeriodUs = (1000000 / (12)), .staticPriority = TASK_PRIORITY_LOW },



    [TASK_TELEMETRY] = { .taskName = "TELEMETRY", .subTaskName = 
# 388 "./src/main/fc/tasks.c" 3 4
                      ((void *)0)
# 388 "./src/main/fc/tasks.c"
                      , .checkFunc = 
# 388 "./src/main/fc/tasks.c" 3 4
                      ((void *)0)
# 388 "./src/main/fc/tasks.c"
...
# 392 "./src/main/fc/tasks.c" 3 4
                     ((void *)0)
# 392 "./src/main/fc/tasks.c"
                     , .checkFunc = 
# 392 "./src/main/fc/tasks.c" 3 4
                     ((void *)0)
# 392 "./src/main/fc/tasks.c"
...
# 400 "./src/main/fc/tasks.c" 3 4
                       ((void *)0)
# 400 "./src/main/fc/tasks.c"
                       , .checkFunc = 
# 400 "./src/main/fc/tasks.c" 3 4
                       ((void *)0)
# 400 "./src/main/fc/tasks.c"
...
# 404 "./src/main/fc/tasks.c" 3 4
                ((void *)0)
# 404 "./src/main/fc/tasks.c"
                , .checkFunc = 
# 404 "./src/main/fc/tasks.c" 3 4
                ((void *)0)
# 404 "./src/main/fc/tasks.c"
                , .taskFunc = cmsHandler, .desiredPeriodUs = (1000000 / (20)), .staticPriority = TASK_PRIORITY_LOW },



    [TASK_VTXCTRL] = { .taskName = "VTXCTRL", .subTaskName = 
# 408 "./src/main/fc/tasks.c" 3 4
                    ((void *)0)
# 408 "./src/main/fc/tasks.c"
                    , .checkFunc = 
# 408 "./src/main/fc/tasks.c" 3 4
                    ((void *)0)
# 408 "./src/main/fc/tasks.c"
                    , .taskFunc = vtxUpdate, .desiredPeriodUs = (1000000 / (5)), .staticPriority = TASK_PRIORITY_LOWEST },



    [TASK_RCDEVICE] = { .taskName = "RCDEVICE", .subTaskName = 
# 412 "./src/main/fc/tasks.c" 3 4
                     ((void *)0)
# 412 "./src/main/fc/tasks.c"
                     , .checkFunc = 
# 412 "./src/main/fc/tasks.c" 3 4
                     ((void *)0)
# 412 "./src/main/fc/tasks.c"
...
# 416 "./src/main/fc/tasks.c" 3 4
                    ((void *)0)
# 416 "./src/main/fc/tasks.c"
                    , .checkFunc = 
# 416 "./src/main/fc/tasks.c" 3 4
                    ((void *)0)
# 416 "./src/main/fc/tasks.c"
                    , .taskFunc = taskCameraControl, .desiredPeriodUs = (1000000 / (5)), .staticPriority = TASK_PRIORITY_LOW },



    [TASK_ADC_INTERNAL] = { .taskName = "ADCINTERNAL", .subTaskName = 
# 420 "./src/main/fc/tasks.c" 3 4
                         ((void *)0)
# 420 "./src/main/fc/tasks.c"
                         , .checkFunc = 
# 420 "./src/main/fc/tasks.c" 3 4
                         ((void *)0)
# 420 "./src/main/fc/tasks.c"
                         , .taskFunc = adcInternalProcess, .desiredPeriodUs = (1000000 / (1)), .staticPriority = TASK_PRIORITY_LOWEST },



    [TASK_PINIOBOX] = { .taskName = "PINIOBOX", .subTaskName = 
# 424 "./src/main/fc/tasks.c" 3 4
                     ((void *)0)
# 424 "./src/main/fc/tasks.c"
                     , .checkFunc = 
# 424 "./src/main/fc/tasks.c" 3 4
                     ((void *)0)
# 424 "./src/main/fc/tasks.c"
                     , .taskFunc = pinioBoxUpdate, .desiredPeriodUs = (1000000 / (20)), .staticPriority = TASK_PRIORITY_LOWEST },



    [TASK_RANGEFINDER] = { .taskName = "RANGEFINDER", .subTaskName = 
# 428 "./src/main/fc/tasks.c" 3 4
                        ((void *)0)
# 428 "./src/main/fc/tasks.c"
                        , .checkFunc = 
# 428 "./src/main/fc/tasks.c" 3 4
                        ((void *)0)
# 428 "./src/main/fc/tasks.c"
                        , .taskFunc = taskUpdateRangefinder, .desiredPeriodUs = (1000000 / (10)), .staticPriority = TASK_PRIORITY_LOWEST },



    [TASK_SPEED_NEGOTIATION] = { .taskName = "SPEED_NEGOTIATION", .subTaskName = 
# 432 "./src/main/fc/tasks.c" 3 4
                              ((void *)0)
# 432 "./src/main/fc/tasks.c"
                              , .checkFunc = 
# 432 "./src/main/fc/tasks.c" 3 4
                              ((void *)0)
# 432 "./src/main/fc/tasks.c"
                              , .taskFunc = speedNegotiationProcess, .desiredPeriodUs = (1000000 / (100)), .staticPriority = TASK_PRIORITY_LOW },
...
# 453 "./src/main/fc/tasks.c" 3 4
                             1
# 453 "./src/main/fc/tasks.c"
                                 );
...
# 455 "./src/main/fc/tasks.c"
    ...
    const 
# 458 "./src/main/fc/tasks.c" 3 4
         _Bool 
# 458 "./src/main/fc/tasks.c"
    ...
    const 
# 468 "./src/main/fc/tasks.c" 3 4
         _Bool 
# 468 "./src/main/fc/tasks.c"
              useBatteryCurrent = batteryConfig()->currentMeterSource != CURRENT_METER_NONE;
    setTaskEnabled(TASK_BATTERY_CURRENT, useBatteryCurrent);
    const 
# 470 "./src/main/fc/tasks.c" 3 4
         _Bool 
# 470 "./src/main/fc/tasks.c"
              useBatteryAlerts = batteryConfig()->useVBatAlerts || batteryConfig()->useConsumptionAlerts || featureIsEnabled(FEATURE_OSD);
...
# 481 "./src/main/fc/tasks.c" 3 4
                                 1
# 481 "./src/main/fc/tasks.c"
                                     );
        setTaskEnabled(TASK_FILTER, 
# 482 "./src/main/fc/tasks.c" 3 4
                                   1
# 482 "./src/main/fc/tasks.c"
                                       );
...
# 489 "./src/main/fc/tasks.c" 3 4
                                  1
# 489 "./src/main/fc/tasks.c"
                                      );
        rescheduleTask(TASK_ACCEL, (1000000 / (acc.sampleRateHz)));
...
# 501 "./src/main/fc/tasks.c" 3 4
                           1
# 501 "./src/main/fc/tasks.c"
                               );
...
# 506 "./src/main/fc/tasks.c" 3 4
                               1
# 506 "./src/main/fc/tasks.c"
                                   );
...
# 531 "./src/main/fc/tasks.c" 3 4
                                      1
# 531 "./src/main/fc/tasks.c"
                                          );
    ...
    rescheduleTask(TASK_OSD, (1000000 / (osdConfig()->framerate_hz)));
    setTaskEnabled(TASK_OSD, featureIsEnabled(FEATURE_OSD) && osdGetDisplayPort(
# 552 "./src/main/fc/tasks.c" 3 4
                                                                               ((void *)0)
# 552 "./src/main/fc/tasks.c"
                                                                                   ));
...
# 564 "./src/main/fc/tasks.c" 3 4
                                     1
# 564 "./src/main/fc/tasks.c"
                                         );
...
# 573 "./src/main/fc/tasks.c" 3 4
                            1
# 573 "./src/main/fc/tasks.c"
                                );
...
# 581 "./src/main/fc/tasks.c" 3 4
                                1
# 581 "./src/main/fc/tasks.c"
                                    );
...
# 586 "./src/main/fc/tasks.c" 3 4
                                1
# 586 "./src/main/fc/tasks.c"
                                    );
    ...
    const 
# 594 "./src/main/fc/tasks.c" 3 4
         _Bool 
# 594 "./src/main/fc/tasks.c"
              useCRSF = rxRuntimeState.serialrxProvider == SERIALRX_CRSF;
