# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c"
# 42 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c"
...
# 43 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c" 2
# 83 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c"
...
# 118 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c"
...
# 123 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c" 3 4
 ((void *)0)
# 123 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c"
     ,
  
# 124 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c" 3 4
 ((void *)0)
# 124 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c"
     ,
  USBD_MSC_DataIn,
  USBD_MSC_DataOut,
  
# 127 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c" 3 4
 ((void *)0)
# 127 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c"
     ,
  
# 128 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c" 3 4
 ((void *)0)
# 128 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c"
     ,
  
# 129 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c" 3 4
 ((void *)0)
# 129 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c"
     ,
 ...
 uint8_t USBD_MSC_CfgHSDesc[32] __attribute__ ((aligned (4))) =
{
  ...
  0x81U,
  0x02,
  ((uint8_t)(0x200U & 0x00FFU)),
  ((uint8_t)((0x200U & 0xFF00U) >> 8U)),
  0x00,
...
uint8_t USBD_MSC_CfgFSDesc[32] __attribute__ ((aligned (4))) =
{
  ...
  0x81U,
  0x02,
  ((uint8_t)(0x40U & 0x00FFU)),
  ((uint8_t)((0x40U & 0xFF00U) >> 8U)),
  0x00,
 ...
 uint8_t USBD_MSC_OtherSpeedCfgDesc[32] __attribute__ ((aligned (4))) =
{
 ...
 uint8_t USBD_MSC_DeviceQualifierDesc[0x0AU] __attribute__ ((aligned (4))) =
{
  0x0AU,
  0x06U,
  0x00,
...
static __attribute__ ((section(".fastram_bss"), aligned(4))) USBD_MSC_BOT_HandleTypeDef ClassData;
# 297 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c"
uint8_t USBD_MSC_Init (USBD_HandleTypeDef *pdev, uint8_t cfgidx)
{
  ...
  if(pdev->dev_speed == USBD_SPEED_HIGH)
  {
    ...
    USBD_LL_OpenEP(pdev, 0x01U, 0x02U, 0x200U);
    pdev->ep_out[0x01U & 0xFU].is_used = 1U;


    USBD_LL_OpenEP(pdev, 0x81U, 0x02U, 0x200U);
    pdev->ep_in[0x81U & 0xFU].is_used = 1U;
  }
  else
  {

    USBD_LL_OpenEP(pdev, 0x01U, 0x02U, 0x40U);
    pdev->ep_out[0x01U & 0xFU].is_used = 1U;


    USBD_LL_OpenEP(pdev, 0x81U, 0x02U, 0x40U);
    pdev->ep_in[0x81U & 0xFU].is_used = 1U;
  }
...
# 337 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c"
uint8_t USBD_MSC_DeInit (USBD_HandleTypeDef *pdev,
                              uint8_t cfgidx)
{
  ((void)(cfgidx));
  ...
  if(pdev->pMSC_ClassData != 
# 354 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c" 3 4
                            ((void *)0)
# 354 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c"
                                )
  {
    free(pdev->pMSC_ClassData);
    pdev->pMSC_ClassData = 
# 357 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c" 3 4
                           ((void *)0)
# 357 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c"
                               ;
  }
  return USBD_OK;
}
...
# 523 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c"
uint8_t USBD_MSC_DataIn (USBD_HandleTypeDef *pdev,
                              uint8_t epnum)
{
...
# 537 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c"
uint8_t USBD_MSC_DataOut (USBD_HandleTypeDef *pdev,
                               uint8_t epnum)
{
...
{
  if(fops != 
# 599 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c" 3 4
            ((void *)0)
# 599 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc.c"
                )
  {
