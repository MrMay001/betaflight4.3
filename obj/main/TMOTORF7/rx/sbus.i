...
# 108 "./src/main/rx/sbus.c" 3 4
   _Bool 
# 108 "./src/main/rx/sbus.c"
        done;
} sbusFrameData_t;
...
# 136 "./src/main/rx/sbus.c"
                                     ;
            do { if (debugMode == (DEBUG_SBUS)) { debug[(DEBUG_SBUS_FRAME_TIME)] = (sbusFrameTime); } } while (0);
        }
    }
}
...
# 148 "./src/main/rx/sbus.c"
    ...
    do { if (debugMode == (DEBUG_SBUS)) { debug[(DEBUG_SBUS_FRAME_FLAGS)] = (sbusFrameData->frame.frame.channels.flags); } } while (0);
...
# 161 "./src/main/rx/sbus.c"
    sbusInit(const rxConfig_t *rxConfig, rxRuntimeState_t *rxRuntimeState)
{
    ...
    if (rxConfig->sbus_baud_fast) {
        rxRuntimeState->rxRefreshRate = 6000;
        sbusBaudRate = 200000;
    } else {
...
# 190 "./src/main/rx/sbus.c" 3 4
   _Bool 
# 190 "./src/main/rx/sbus.c"
    ...
    return sBusPort != 
# 214 "./src/main/rx/sbus.c" 3 4
                      ((void *)0)
# 214 "./src/main/rx/sbus.c"
                          ;
}
