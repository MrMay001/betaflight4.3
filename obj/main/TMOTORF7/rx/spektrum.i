...
# 60 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 60 "./src/main/rx/spektrum.c"
    srxlEnabled = 
# 60 "./src/main/rx/spektrum.c" 3 4
                  0
# 60 "./src/main/rx/spektrum.c"
...
# 66 "./src/main/rx/spektrum.c"
                                  ;
static 
# 67 "./src/main/rx/spektrum.c" 3 4
      _Bool 
# 67 "./src/main/rx/spektrum.c"
           spekHiRes = 
# 67 "./src/main/rx/spektrum.c" 3 4
                       0
# 67 "./src/main/rx/spektrum.c"
...
# 98 "./src/main/rx/spektrum.c"
            ...
            rcFrameComplete = 
# 101 "./src/main/rx/spektrum.c" 3 4
                             1
# 101 "./src/main/rx/spektrum.c"
                                 ;
        }
    }
}
...
static uint8_t spektrumFrameStatus(rxRuntimeState_t *rxRuntimeState)
{
    ...
    if (rcFrameComplete) {
        rcFrameComplete = 
# 122 "./src/main/rx/spektrum.c" 3 4
                         0
# 122 "./src/main/rx/spektrum.c"
                              ;
        ...
        for (int b = 3; b < spektrumRcDataSize; b += 2) {
            ...
            if (spekChannel < rxRuntimeStatePtr->channelCount && spekChannel < 12) {
...
static float spektrumReadRawRC(const rxRuntimeState_t *rxRuntimeState, uint8_t chan)
{
    ...
    if (spekHiRes) {
        data = 0.5f * (float)spekChannelData[chan] + 988;
    } else {
        data = spekChannelData[chan] + 988;
    }
...
# 194 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 194 "./src/main/rx/spektrum.c"
    spekShouldBind(uint8_t spektrum_sat_bind)
{
    ...
    if (BindPlug) {
        ...
        IOConfigGPIO(BindPlug, ((((uint32_t)0x00000000U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000001U)) << 5)));


        delayMicroseconds(10);
        if (IORead(BindPlug)) {
            return 
# 206 "./src/main/rx/spektrum.c" 3 4
                  0
# 206 "./src/main/rx/spektrum.c"
                       ;
        }
    }
...
void spektrumBind(rxConfig_t *rxConfig)
{
    ...
    if (rxConfig->spektrum_bind_pin_override_ioTag) {
        ...
        int index = (((portConfig->identifier) < 10) ? (portConfig->identifier) : (10 + ((portConfig->identifier) - SERIAL_PORT_SOFTSERIAL1)));
    ...
    IOConfigGPIO(bindIO, ((((uint32_t)0x00000001U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000000U)) << 5)));

    ledSet(1, 
# 269 "./src/main/rx/spektrum.c" 3 4
   1
# 269 "./src/main/rx/spektrum.c"
   );
...
# 272 "./src/main/rx/spektrum.c"
    ...
    delay(60);
    ledSet(1, 
# 276 "./src/main/rx/spektrum.c" 3 4
   0
# 276 "./src/main/rx/spektrum.c"
   );

    for (int i = 0; i < rxConfig->spektrum_sat_bind; i++) {
        ledSet(0, 
# 279 "./src/main/rx/spektrum.c" 3 4
       0
# 279 "./src/main/rx/spektrum.c"
       );
        ledSet(2, 
...
# 282 "./src/main/rx/spektrum.c"
        ...
        ledSet(0, 
# 285 "./src/main/rx/spektrum.c" 3 4
       1
# 285 "./src/main/rx/spektrum.c"
       );
        ledSet(2, 
...
# 286 "./src/main/rx/spektrum.c"
        ...
        IOWrite(bindIO, 
# 288 "./src/main/rx/spektrum.c" 3 4
                       1
# 288 "./src/main/rx/spektrum.c"
                           );
        delayMicroseconds(120);
    ...
    if (rxConfig->spektrum_bind_pin_override_ioTag) {
        delay(50);
        IOConfigGPIO(bindIO, ((((uint32_t)0x00000000U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000000U)) << 5)));
    }
           ...
           spektrumProcessFrame(const rxRuntimeState_t *rxRuntimeState)
{
    ...
    return 
# 325 "./src/main/rx/spektrum.c" 3 4
          1
# 325 "./src/main/rx/spektrum.c"
              ;
}


# 328 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 328 "./src/main/rx/spektrum.c"
    srxlTelemetryBufferEmpty()
{
  if (telemetryBufLen == 0) {
      return 
# 331 "./src/main/rx/spektrum.c" 3 4
            1
# 331 "./src/main/rx/spektrum.c"
                ;
  } else {
      return 
# 333 "./src/main/rx/spektrum.c" 3 4
            0
# 333 "./src/main/rx/spektrum.c"
                 ;
  }
}
...
# 345 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 345 "./src/main/rx/spektrum.c"
    spektrumInit(const rxConfig_t *rxConfig, rxRuntimeState_t *rxRuntimeState)
{
    ...
    if (!portConfig) {
        return 
# 351 "./src/main/rx/spektrum.c" 3 4
              0
# 351 "./src/main/rx/spektrum.c"
                   ;
    }
...
# 356 "./src/main/rx/spektrum.c" 3 4
   _Bool 
# 356 "./src/main/rx/spektrum.c"
...
# 383 "./src/main/rx/spektrum.c"
    ...
    return serialPort != 
# 418 "./src/main/rx/spektrum.c" 3 4
                        ((void *)0)
# 418 "./src/main/rx/spektrum.c"
                            ;
}


# 421 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 421 "./src/main/rx/spektrum.c"
    srxlRxIsActive(void)
{
    return serialPort != 
# 423 "./src/main/rx/spektrum.c" 3 4
                        ((void *)0)
# 423 "./src/main/rx/spektrum.c"
                            ;
}
