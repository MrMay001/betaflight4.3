...
static void jetiExBusDataReceive(uint16_t c, void *data)
{
    ...
    if (cmpTimeUs(now, jetiExBusTimeLast) > 1000) {
        jetiExBusFrameReset();
...
# 247 "./src/main/rx/jetiexbus.c" 3 4
_Bool 
# 247 "./src/main/rx/jetiexbus.c"
    jetiExBusInit(const rxConfig_t *rxConfig, rxRuntimeState_t *rxRuntimeState)
{
    ((void)(rxConfig));
    ...
    if (!portConfig) {
        return 
# 263 "./src/main/rx/jetiexbus.c" 3 4
              0
# 263 "./src/main/rx/jetiexbus.c"
                   ;
    }
...
# 269 "./src/main/rx/jetiexbus.c" 3 4
       ((void *)0)
# 269 "./src/main/rx/jetiexbus.c"
           ,
        125000,
        MODE_RXTX,
        (SERIAL_STOPBITS_1 | SERIAL_PARITY_NO) | (rxConfig->serialrx_inverted ? SERIAL_INVERTED : 0) | SERIAL_BIDIR
        );
    return jetiExBusPort != 
# 274 "./src/main/rx/jetiexbus.c" 3 4
                           ((void *)0)
# 274 "./src/main/rx/jetiexbus.c"
                               ;
}
