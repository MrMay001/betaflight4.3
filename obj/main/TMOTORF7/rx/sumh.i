...
static 
# 55 "./src/main/rx/sumh.c" 3 4
      _Bool 
# 55 "./src/main/rx/sumh.c"
           sumhFrameDone = 
# 55 "./src/main/rx/sumh.c" 3 4
                           0
# 55 "./src/main/rx/sumh.c"
...
static void sumhDataReceive(uint16_t c, void *data)
{
    ...
    if (sumhFramePosition == 21 - 1) {
        ...
        sumhFrameDone = 
# 82 "./src/main/rx/sumh.c" 3 4
                       1
# 82 "./src/main/rx/sumh.c"
                           ;
    } else {
        sumhFramePosition++;
    }
...
static uint8_t sumhFrameStatus(rxRuntimeState_t *rxRuntimeState)
{
    ...
    sumhFrameDone = 
# 98 "./src/main/rx/sumh.c" 3 4
                   0
# 98 "./src/main/rx/sumh.c"
                        ;
...
# 122 "./src/main/rx/sumh.c" 3 4
_Bool 
# 122 "./src/main/rx/sumh.c"
    sumhInit(const rxConfig_t *rxConfig, rxRuntimeState_t *rxRuntimeState)
{
    ((void)(rxConfig));
    ...
    if (!portConfig) {
        return 
# 134 "./src/main/rx/sumh.c" 3 4
              0
# 134 "./src/main/rx/sumh.c"
                   ;
    }


    
# 138 "./src/main/rx/sumh.c" 3 4
   _Bool 
# 138 "./src/main/rx/sumh.c"
...
# 143 "./src/main/rx/sumh.c" 3 4
                                                                                          ((void *)0)
# 143 "./src/main/rx/sumh.c"
    ...
    return sumhPort != 
# 151 "./src/main/rx/sumh.c" 3 4
                      ((void *)0)
# 151 "./src/main/rx/sumh.c"
                          ;
}
