...
# 45 "./src/main/rx/sumd.c" 2
# 72 "./src/main/rx/sumd.c"
static 
# 72 "./src/main/rx/sumd.c" 3 4
      _Bool 
# 72 "./src/main/rx/sumd.c"
           sumdFrameDone = 
# 72 "./src/main/rx/sumd.c" 3 4
...
# 72 "./src/main/rx/sumd.c"
                                ;
static uint16_t sumdChannels[18];
static uint16_t crc;

static uint8_t sumd[(32 * 2 + 5)] = { 0, };
...
static void sumdDataReceive(uint16_t c, void *data)
{
    ...
    if (cmpTimeUs(now, sumdTimeLast) > 4000) {
        sumdIndex = 0;
    }
    sumdTimeLast = now;
    ...
    if (sumdIndex == 0) {
        if (c != 0xA8) {
            ...
            sumdFrameDone = 
# 98 "./src/main/rx/sumd.c" 3 4
                           0
# 98 "./src/main/rx/sumd.c"
                                ;
            crc = 0;
        }
    } else if (sumdIndex == 2) {
    ...
    } else if (sumdIndex == sumdChannelCount * 2 + 3 + 2) {
        lastFrameTimeUs = now;
        sumdIndex = 0;
        sumdFrameDone = 
# 115 "./src/main/rx/sumd.c" 3 4
                       1
# 115 "./src/main/rx/sumd.c"
                           ;
    }
}
...
# 129 "./src/main/rx/sumd.c"
    ...
    if (crc == ((sumd[2 * sumdChannelCount + 3] << 8) |
        ...
        if (frameStatus & RX_FRAME_COMPLETE) {
            const unsigned channelsToProcess = __extension__ ({ __typeof__ (sumdChannelCount) _a = (sumdChannelCount); __typeof__ (18) _b = (18); _a < _b ? _a : _b; });
...
# 170 "./src/main/rx/sumd.c" 3 4
_Bool 
# 170 "./src/main/rx/sumd.c"
    sumdInit(const rxConfig_t *rxConfig, rxRuntimeState_t *rxRuntimeState)
{
    ((void)(rxConfig));

    rxRuntimeState->channelCount = __extension__ ({ __typeof__ (32) _a = (32); __typeof__ (18) _b = (18); _a < _b ? _a : _b; });
    ...
    if (!portConfig) {
        return 
# 183 "./src/main/rx/sumd.c" 3 4
              0
# 183 "./src/main/rx/sumd.c"
                   ;
    }


    
# 187 "./src/main/rx/sumd.c" 3 4
   _Bool 
# 187 "./src/main/rx/sumd.c"
...
# 195 "./src/main/rx/sumd.c"
    ...
    return sumdPort != 
# 207 "./src/main/rx/sumd.c" 3 4
                      ((void *)0)
# 207 "./src/main/rx/sumd.c"
                          ;
}
