...
# 50 "./src/main/rx/fport.c" 2
# 69 "./src/main/rx/fport.c"
enum {
...
static void reportFrameError(uint8_t errorReason) {
    ...
    do { if (debugMode == (DEBUG_FPORT)) { debug[(DEBUG_FPORT_FRAME_ERRORS)] = (frameErrors); } } while (0);
    do { if (debugMode == (DEBUG_FPORT)) { debug[(DEBUG_FPORT_FRAME_LAST_ERROR)] = (errorReason); } } while (0);
}
...
# 195 "./src/main/rx/fport.c"
            ...
            do { if (debugMode == (DEBUG_FPORT)) { debug[(DEBUG_FPORT_FRAME_INTERVAL)] = (currentTimeUs - lastFrameReceivedUs); } } while (0);
...
# 216 "./src/main/rx/fport.c"
                ...
                escapedCharacter = 
# 218 "./src/main/rx/fport.c" 3 4
                                  1
# 218 "./src/main/rx/fport.c"
                                      ;
            ...
            if (framePosition == 2 && val == FPORT_FRAME_TYPE_TELEMETRY_REQUEST) {
                telemetryFrame = 
# 224 "./src/main/rx/fport.c" 3 4
                                1
# 224 "./src/main/rx/fport.c"
                                    ;
            }
...
{
    static 
# 247 "./src/main/rx/fport.c" 3 4
          _Bool 
# 247 "./src/main/rx/fport.c"
               hasTelemetryRequest = 
# 247 "./src/main/rx/fport.c" 3 4
                                     0
# 247 "./src/main/rx/fport.c"
    ...
    static 
# 251 "./src/main/rx/fport.c" 3 4
          _Bool 
# 251 "./src/main/rx/fport.c"
               rxDrivenFrameRate = 
# 251 "./src/main/rx/fport.c" 3 4
                                   0
# 251 "./src/main/rx/fport.c"
                    ...
                    if (frameLength != (sizeof(uint8_t) + sizeof(smartPortPayload_t))) {
                        ...
                        case FPORT_FRAME_ID_DATA:
                            if (!rxDrivenFrameRate) {
                                rxDrivenFrameRate = 
# 298 "./src/main/rx/fport.c" 3 4
                                                   1
# 298 "./src/main/rx/fport.c"
                                                       ;
                            }

                            hasTelemetryRequest = 
# 301 "./src/main/rx/fport.c" 3 4
                                                 1
# 301 "./src/main/rx/fport.c"
                                                     ;
                        ...
                        case FPORT_FRAME_ID_NULL:
                            if (!rxDrivenFrameRate) {
                                if (consecutiveTelemetryFrameCount >= 2 && !(mspPayload && smartPortPayloadContainsMSP(mspPayload))) {
                                    ...
                                    hasTelemetryRequest = 
# 309 "./src/main/rx/fport.c" 3 4
                                                         1
# 309 "./src/main/rx/fport.c"
                                                             ;
    ...
    if ((mspPayload || hasTelemetryRequest) && cmpTimeUs(micros(), lastTelemetryFrameReceivedUs) >= 500) {
        hasTelemetryRequest = 
# 343 "./src/main/rx/fport.c" 3 4
                             0
# 343 "./src/main/rx/fport.c"
                                  ;
...
static 
# 356 "./src/main/rx/fport.c" 3 4
      _Bool 
# 356 "./src/main/rx/fport.c"
           fportProcessFrame(const rxRuntimeState_t *rxRuntimeState)
{
    ((void)(rxRuntimeState));
    ...
    if (cmpTimeUs(currentTimeUs, lastTelemetryFrameReceivedUs) > 2000) {
       clearToSend = 
# 365 "./src/main/rx/fport.c" 3 4
                    0
# 365 "./src/main/rx/fport.c"
                         ;
    }

    if (clearToSend) {
        processSmartPortTelemetry(mspPayload, &clearToSend, 
# 369 "./src/main/rx/fport.c" 3 4
                                                           ((void *)0)
# 369 "./src/main/rx/fport.c"
                                                               );
...
# 374 "./src/main/rx/fport.c"
        ...
        do { if (debugMode == (DEBUG_FPORT)) { debug[(DEBUG_FPORT_TELEMETRY_INTERVAL)] = (currentTimeUs - lastTelemetryFrameSentUs); } } while (0);
        lastTelemetryFrameSentUs = currentTimeUs;
    }

    mspPayload = 
# 381 "./src/main/rx/fport.c" 3 4
                ((void *)0)
# 381 "./src/main/rx/fport.c"
                    ;


    return 
# 384 "./src/main/rx/fport.c" 3 4
          1
# 384 "./src/main/rx/fport.c"
              ;
}


# 387 "./src/main/rx/fport.c" 3 4
_Bool 
# 387 "./src/main/rx/fport.c"
    fportRxInit(const rxConfig_t *rxConfig, rxRuntimeState_t *rxRuntimeState)
{
    static uint16_t sbusChannelData[18];
    rxRuntimeState->channelData = sbusChannelData;
    sbusChannelsInit(rxConfig, rxRuntimeState);

    rxRuntimeState->channelCount = 18;
    ...
    if (!portConfig) {
        return 
# 402 "./src/main/rx/fport.c" 3 4
              0
# 402 "./src/main/rx/fport.c"
                   ;
    }
...
# 408 "./src/main/rx/fport.c" 3 4
       ((void *)0)
# 408 "./src/main/rx/fport.c"
           ,
        115200,
        MODE_RXTX,
    ...
    return fportPort != 
# 424 "./src/main/rx/fport.c" 3 4
                       ((void *)0)
# 424 "./src/main/rx/fport.c"
                           ;
}
