...
static 
# 74 "./src/main/rx/ibus.c" 3 4
      _Bool 
# 74 "./src/main/rx/ibus.c"
           ibusFrameDone = 
# 74 "./src/main/rx/ibus.c" 3 4
                           0
# 74 "./src/main/rx/ibus.c"
                                ;
static uint32_t ibusChannelData[18];

static uint8_t ibus[32] = { 0, };
static timeUs_t lastFrameTimeUs = 0;

static 
# 80 "./src/main/rx/ibus.c" 3 4
      _Bool 
# 80 "./src/main/rx/ibus.c"
...
static void ibusDataReceive(uint16_t c, void *data)
{
    ...
    if (cmpTimeUs(now, ibusTimeLast) > 500) {
        ibusFramePosition = 0;
        rxBytesToIgnore = 0;
    ...
    if (ibusFramePosition == ibusFrameSize - 1) {
        lastFrameTimeUs = now;
        ibusFrameDone = 
# 128 "./src/main/rx/ibus.c" 3 4
                       1
# 128 "./src/main/rx/ibus.c"
                           ;
    } else {
        ibusFramePosition++;
    }
...
static 
# 149 "./src/main/rx/ibus.c" 3 4
      _Bool 
# 149 "./src/main/rx/ibus.c"
           checksumIsOk(void) {
    if (ibusModel == 1 ) {
...
static void updateChannelData(void) {
    ...
    for (i = 14, offset = ibusChannelOffset + 1; i < 18; i++, offset += 6) {
...
static uint8_t ibusFrameStatus(rxRuntimeState_t *rxRuntimeState)
{
    ...
    ibusFrameDone = 
# 180 "./src/main/rx/ibus.c" 3 4
                   0
# 180 "./src/main/rx/ibus.c"
                        ;

    if (checksumIsOk()) {
        if (ibusModel == 1 || ibusSyncByte == (32)) {
            updateChannelData();
    ...
    ibusInit(const rxConfig_t *rxConfig, rxRuntimeState_t *rxRuntimeState)
{
    ...
    if (!portConfig) {
        return 
# 218 "./src/main/rx/ibus.c" 3 4
              0
# 218 "./src/main/rx/ibus.c"
                   ;
    }
...
# 232 "./src/main/rx/ibus.c" 3 4
       ((void *)0)
# 232 "./src/main/rx/ibus.c"
           ,
        115200,
    ...
    return ibusPort != 
# 244 "./src/main/rx/ibus.c" 3 4
                      ((void *)0)
# 244 "./src/main/rx/ibus.c"
                          ;
}
