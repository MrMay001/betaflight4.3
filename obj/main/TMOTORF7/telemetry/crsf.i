...
# 42 "./src/main/io/displayport_crsf.h" 3 4
_Bool 
# 42 "./src/main/io/displayport_crsf.h"
    crsfDisplayPortIsReady(void);
...
# 68 "./src/main/telemetry/crsf.c" 2
...
# 24 "./src/main/telemetry/msp_shared.h" 2
...
# 69 "./src/main/telemetry/crsf.c" 2
...
# 71 "./src/main/telemetry/crsf.c" 2
# 80 "./src/main/telemetry/crsf.c"
static 
# 80 "./src/main/telemetry/crsf.c" 3 4
      _Bool 
# 80 "./src/main/telemetry/crsf.c"
           crsfTelemetryEnabled;
static 
# 81 "./src/main/telemetry/crsf.c" 3 4
      _Bool 
# 81 "./src/main/telemetry/crsf.c"
...
uint32_t getCrsfCachedBaudrate(void)
{
    ...
    for (unsigned i = 0; i < BAUD_COUNT; i++) {
        if (crsfCachedBaudrate == baudRates[i] && baudRates[i] >= 420000) {
...
# 119 "./src/main/telemetry/crsf.c" 3 4
_Bool 
# 119 "./src/main/telemetry/crsf.c"
    checkCrsfCustomizedSpeed(void)
{
    return crsfSpeed.index < BAUD_COUNT ? 
# 121 "./src/main/telemetry/crsf.c" 3 4
                                         1 
# 121 "./src/main/telemetry/crsf.c"
                                              : 
# 121 "./src/main/telemetry/crsf.c" 3 4
                                                0
# 121 "./src/main/telemetry/crsf.c"
...
uint32_t getCrsfDesiredSpeed(void)
{
    return checkCrsfCustomizedSpeed() ? baudRates[crsfSpeed.index] : 420000;
}

void setCrsfDefaultSpeed(void)
{
    crsfSpeed.hasPendingReply = 
# 131 "./src/main/telemetry/crsf.c" 3 4
                               0
# 131 "./src/main/telemetry/crsf.c"
                                    ;
    crsfSpeed.isNewSpeedValid = 
# 132 "./src/main/telemetry/crsf.c" 3 4
                               0
# 132 "./src/main/telemetry/crsf.c"
                                    ;
    crsfSpeed.confirmationTime = 0;
    crsfSpeed.index = BAUD_COUNT;
    isCrsfV3Running = 
# 135 "./src/main/telemetry/crsf.c" 3 4
                     0
# 135 "./src/main/telemetry/crsf.c"
                          ;
    crsfRxUpdateBaudrate(getCrsfDesiredSpeed());
}


# 139 "./src/main/telemetry/crsf.c" 3 4
_Bool 
# 139 "./src/main/telemetry/crsf.c"
    crsfBaudNegotiationInProgress(void)
{
...
# 150 "./src/main/telemetry/crsf.c" 3 4
_Bool 
# 150 "./src/main/telemetry/crsf.c"
    bufferCrsfMspFrame(uint8_t *frameStart, int frameLength)
{
    if (mspRxBuffer.len + 1 + frameLength > 96) {
        return 
# 153 "./src/main/telemetry/crsf.c" 3 4
              0
# 153 "./src/main/telemetry/crsf.c"
                   ;
    } else {
        ...
        *p++ = frameLength;
        ...
        return 
# 159 "./src/main/telemetry/crsf.c" 3 4
              1
# 159 "./src/main/telemetry/crsf.c"
                  ;
    }
}


# 163 "./src/main/telemetry/crsf.c" 3 4
_Bool 
# 163 "./src/main/telemetry/crsf.c"
    handleCrsfMspFrameBuffer(mspResponseFnPtr responseFn)
{
    static 
# 165 "./src/main/telemetry/crsf.c" 3 4
          _Bool 
# 165 "./src/main/telemetry/crsf.c"
               replyPending = 
# 165 "./src/main/telemetry/crsf.c" 3 4
                              0
# 165 "./src/main/telemetry/crsf.c"
    ...
    if (!mspRxBuffer.len) {
        return 
# 173 "./src/main/telemetry/crsf.c" 3 4
              0
# 173 "./src/main/telemetry/crsf.c"
                   ;
    }
    int pos = 0;
    while (
# 176 "./src/main/telemetry/crsf.c" 3 4
          1
# 176 "./src/main/telemetry/crsf.c"
              ) {
        const uint8_t mspFrameLength = mspRxBuffer.bytes[pos];
        if (handleMspFrame(&mspRxBuffer.bytes[1 + pos], mspFrameLength, 
# 178 "./src/main/telemetry/crsf.c" 3 4
                                                                                            ((void *)0)
# 178 "./src/main/telemetry/crsf.c"
                                                                                                )) {
            if (crsfRxIsTelemetryBufEmpty()) {
                replyPending = sendMspReply(CRSF_FRAME_TX_MSP_FRAME_SIZE, responseFn);
            } else {
                replyPending = 
# 182 "./src/main/telemetry/crsf.c" 3 4
                              1
# 182 "./src/main/telemetry/crsf.c"
                                  ;
            }
        }
...
{
    crc8_sbuf_append(dst, &crsfFrame[2], 0xD5);
    sbufSwitchToReader(dst, crsfFrame);

    crsfRxWriteTelemetryData(sbufPtr(dst), sbufBytesRemaining(dst));
}
# 232 "./src/main/telemetry/crsf.c"
void crsfFrameGps(sbuf_t *dst)
{
    ...
    sbufWriteU16BigEndian(dst, (gpsSol.groundSpeed * 36 + 50) / 100);
    sbufWriteU16BigEndian(dst, gpsSol.groundCourse * 10);
    const uint16_t altitude = (constrain(getEstimatedAltitudeCm(), 0 * 100, 5000 * 100) / 100) + 1000;
    sbufWriteU16BigEndian(dst, altitude);
    sbufWriteU8(dst, gpsSol.numSat);
}
# 254 "./src/main/telemetry/crsf.c"
void crsfFrameBatterySensor(sbuf_t *dst)
{
    ...
    if (telemetryConfig()->report_cell_voltage) {
        sbufWriteU16BigEndian(dst, (getBatteryAverageCellVoltage() + 5) / 10);
    } else {
...
static int16_t decidegrees2Radians10000(int16_t angle_decidegree)
{
    ...
    return (int16_t)((3.14159265358979323846f / 180.0f) * 1000.0f * angle_decidegree);
}
...
void crsfFrameFlightMode(sbuf_t *dst)
{
    ...
    if (!(armingFlags & (ARMED)) && featureIsEnabled(FEATURE_GPS) && (!(stateFlags & (GPS_FIX)) || !(stateFlags & (GPS_FIX_HOME)))) {
        flightMode = "WAIT";
    } else
    ...
    if ((flightModeFlags & (FAILSAFE_MODE))) {
        ...
        flightMode = "RTH";
    } else if ((flightModeFlags & (PASSTHRU_MODE))) {
        flightMode = "MANU";
...
# 400 "./src/main/telemetry/crsf.c"
void crsfFrameDeviceInfo(sbuf_t *dst)
{
    char buff[30];
    tfp_sprintf(buff, "%s %s: %s", "Betaflight", "4" "." "3" "." "1", systemConfig()->boardIdentifier);
...
void crsfFrameSpeedNegotiationResponse(sbuf_t *dst, 
                                                        ...
                                                        reply)
{
    ...
    crc8_sbuf_append(dst, &lengthPtr[1], 0xBA);
    *lengthPtr = sbufPtr(dst) - lengthPtr;
}
...
{
    crsfSpeed.hasPendingReply = 
# 451 "./src/main/telemetry/crsf.c" 3 4
                               1
# 451 "./src/main/telemetry/crsf.c"
                                   ;
    crsfSpeed.isNewSpeedValid = 
# 452 "./src/main/telemetry/crsf.c" 3 4
                               0
# 452 "./src/main/telemetry/crsf.c"
                                    ;
}
...
# 458 "./src/main/telemetry/crsf.c" 3 4
       _Bool 
# 458 "./src/main/telemetry/crsf.c"
            found = ((crsfSpeed.index < BAUD_COUNT) && crsfRxUseNegotiatedBaud()) ? 
# 458 "./src/main/telemetry/crsf.c" 3 4
                                                                                    1 
# 458 "./src/main/telemetry/crsf.c"
                                                                                         : 
...
# 458 "./src/main/telemetry/crsf.c"
        ...
        crsfRxSendTelemetryData();
        crsfSpeed.hasPendingReply = 
# 466 "./src/main/telemetry/crsf.c" 3 4
                                   0
# 466 "./src/main/telemetry/crsf.c"
                                        ;
        ...
        if (cmpTimeUs(currentTimeUs, crsfSpeed.confirmationTime) >= 4000) {
            ...
            crsfRxUpdateBaudrate(getCrsfDesiredSpeed());
            crsfSpeed.isNewSpeedValid = 
# 473 "./src/main/telemetry/crsf.c" 3 4
                                       0
# 473 "./src/main/telemetry/crsf.c"
                                            ;
            isCrsfV3Running = 
# 474 "./src/main/telemetry/crsf.c" 3 4
                             1
# 474 "./src/main/telemetry/crsf.c"
                                 ;
        }
...
static void cRleEncodeStream(sbuf_t *source, sbuf_t *dest, uint8_t maxDestLen)
{
    ...
    while (sbufBytesRemaining(source) && (sbufPtr(dest) < destEnd)) {
        ...
        if (runLength > 1) {
            c |= 0x80;
            const uint8_t fullBatches = (runLength / 256);
            const uint8_t remainder = (runLength % 256);
            const uint8_t totalBatches = fullBatches + (remainder ? 1 : 0);
            if (destRemaining >= totalBatches * 2) {
                for (unsigned int i = 1; i <= totalBatches; i++) {
                    const uint8_t batchLength = (i < totalBatches) ? 256 : remainder;
                    sbufWriteU8(dest, c);
...
static 
# 594 "./src/main/telemetry/crsf.c" 3 4
      _Bool 
# 594 "./src/main/telemetry/crsf.c"
           mspReplyPending;
...
{
    mspReplyPending = 
# 599 "./src/main/telemetry/crsf.c" 3 4
                     1
# 599 "./src/main/telemetry/crsf.c"
                         ;
...
static void processCrsf(void)
{
    ...
    if (currentSchedule & (1 << (CRSF_FRAME_HEARTBEAT_INDEX))) {
        crsfInitializeFrame(dst);
        crsfFrameHeartbeat(dst);
        crsfFinalize(dst);
    }
...
{
    deviceInfoReplyPending = 
# 669 "./src/main/telemetry/crsf.c" 3 4
                            1
# 669 "./src/main/telemetry/crsf.c"
                                ;
}
...
void initCrsfTelemetry(void)
{
    ...
    deviceInfoReplyPending = 
# 682 "./src/main/telemetry/crsf.c" 3 4
                            0
# 682 "./src/main/telemetry/crsf.c"
                                 ;

    mspReplyPending = 
# 684 "./src/main/telemetry/crsf.c" 3 4
                     0
# 684 "./src/main/telemetry/crsf.c"
                          ;
    ...
    while (index < (100000 / 20000) && index < CRSF_SCHEDULE_COUNT_MAX) {

        crsfSchedule[index++] = (1 << (CRSF_FRAME_HEARTBEAT_INDEX));
    }
...
# 719 "./src/main/telemetry/crsf.c" 3 4
_Bool 
# 719 "./src/main/telemetry/crsf.c"
    checkCrsfTelemetryState(void)
{
...
void handleCrsfTelemetry(timeUs_t currentTimeUs)
{
    ...
    if (deviceInfoReplyPending) {
        ...
        crsfFinalize(dst);
        deviceInfoReplyPending = 
# 808 "./src/main/telemetry/crsf.c" 3 4
                                0
# 808 "./src/main/telemetry/crsf.c"
                                     ;
        crsfLastCycleTime = currentTimeUs;
        return;
    }
...
# 815 "./src/main/telemetry/crsf.c" 3 4
                                        0
# 815 "./src/main/telemetry/crsf.c"
                                             ;
    ...
    if (crsfDisplayPortIsReady() && crsfDisplayPortScreen()->updated) {
        crsfDisplayPortScreen()->updated = 
# 826 "./src/main/telemetry/crsf.c" 3 4
                                          0
# 826 "./src/main/telemetry/crsf.c"
                                               ;
        ...
        sbuf_t crsfDisplayPortBuf;
        sbuf_t *dst = &crsfDisplayPortBuf;
        displayPortBatchId = (displayPortBatchId + 1) % 0x3F;
        uint8_t i = 0;
