...
# 1 "./src/main/rx/frsky_crc.h" 1
# 24 "./src/main/rx/frsky_crc.h"

# 24 "./src/main/rx/frsky_crc.h" 3 4
_Bool 
# 24 "./src/main/rx/frsky_crc.h"
    frskyCheckSumIsGood(uint8_t *data, uint8_t length);
...
# 76 "./src/main/telemetry/smartport.c" 2
...
# 77 "./src/main/telemetry/smartport.c" 2
...
# 79 "./src/main/telemetry/smartport.c" 2
...
# 83 "./src/main/telemetry/smartport.c" 2
...
# 84 "./src/main/telemetry/smartport.c" 2
...
# 85 "./src/main/telemetry/smartport.c" 2
...
static uint16_t frSkyDataIdTable[20];
# 168 "./src/main/telemetry/smartport.c"
static uint16_t frSkyEscDataIdTable[4];
...
# 186 "./src/main/telemetry/smartport.c" 3 4
                                          ((void *)0)
# 186 "./src/main/telemetry/smartport.c"
                                              ;
...
static 
# 211 "./src/main/telemetry/smartport.c" 3 4
      _Bool 
# 211 "./src/main/telemetry/smartport.c"
...
# 214 "./src/main/telemetry/smartport.c"
                                                         *clearToSend, smartPortReadyToSendFn *readyToSend, 
# 214 "./src/main/telemetry/smartport.c" 3 4
                                                                                                            _Bool 
# 214 "./src/main/telemetry/smartport.c"
                                                                                                                 useChecksum)
{
    ...
    static 
# 218 "./src/main/telemetry/smartport.c" 3 4
          _Bool 
# 218 "./src/main/telemetry/smartport.c"
               skipUntilStart = 
# 218 "./src/main/telemetry/smartport.c" 3 4
                                1
# 218 "./src/main/telemetry/smartport.c"
...
# 219 "./src/main/telemetry/smartport.c"
                                       ;
    static 
# 220 "./src/main/telemetry/smartport.c" 3 4
          _Bool 
# 220 "./src/main/telemetry/smartport.c"
               byteStuffing = 
# 220 "./src/main/telemetry/smartport.c" 3 4
                              0
# 220 "./src/main/telemetry/smartport.c"
...
# 226 "./src/main/telemetry/smartport.c"
                              ;
        skipUntilStart = 
# 227 "./src/main/telemetry/smartport.c" 3 4
                        0
# 227 "./src/main/telemetry/smartport.c"
                             ;

        return 
# 229 "./src/main/telemetry/smartport.c" 3 4
              ((void *)0)
# 229 "./src/main/telemetry/smartport.c"
                  ;
    } else if (skipUntilStart) {
        return 
# 231 "./src/main/telemetry/smartport.c" 3 4
              ((void *)0)
# 231 "./src/main/telemetry/smartport.c"
                  ;
    }

    if (awaitingSensorId) {
        awaitingSensorId = 
# 235 "./src/main/telemetry/smartport.c" 3 4
                          0
# 235 "./src/main/telemetry/smartport.c"
                               ;
...
# 244 "./src/main/telemetry/smartport.c"
        ...
        if (c == FSSP_DLE) {
            byteStuffing = 
# 248 "./src/main/telemetry/smartport.c" 3 4
                          1
# 248 "./src/main/telemetry/smartport.c"
                              ;

            return 
# 250 "./src/main/telemetry/smartport.c" 3 4
                  ((void *)0)
# 250 "./src/main/telemetry/smartport.c"
                      ;
        } else if (byteStuffing) {
            c ^= FSSP_DLE_XOR;
            byteStuffing = 
# 253 "./src/main/telemetry/smartport.c" 3 4
                          0
# 253 "./src/main/telemetry/smartport.c"
                               ;
        }
        ...
        if (smartPortRxBytes < sizeof(smartPortPayload_t)) {
            ...
            if (!useChecksum && (smartPortRxBytes == sizeof(smartPortPayload_t))) {
                skipUntilStart = 
# 261 "./src/main/telemetry/smartport.c" 3 4
                                1
# 261 "./src/main/telemetry/smartport.c"
                                    ;
            ...
            skipUntilStart = 
# 266 "./src/main/telemetry/smartport.c" 3 4
                            1
# 266 "./src/main/telemetry/smartport.c"
                                ;
...
# 294 "./src/main/telemetry/smartport.c" 3 4
_Bool 
# 294 "./src/main/telemetry/smartport.c"
    smartPortPayloadContainsMSP(const smartPortPayload_t *payload)
{
...
void smartPortWriteFrameSerial(const smartPortPayload_t *payload, serialPort_t *port, uint16_t checksum)
{
    ...
    smartPortSendByte(checksum, 
# 306 "./src/main/telemetry/smartport.c" 3 4
                               ((void *)0)
# 306 "./src/main/telemetry/smartport.c"
                                   , port);
}
...
static void initSmartPortSensors(void)
{
    ...
    if (telemetryIsSensorEnabled(SENSOR_TEMPERATURE)) {
        frSkyDataIdTableInfo.table[frSkyDataIdTableInfo.index++] = FSSP_DATAID_T11;
    }
    ...
    if (isAmperageConfigured() && telemetryIsSensorEnabled(SENSOR_CURRENT)) {
        ...
        if (telemetryIsSensorEnabled(SENSOR_CAP_USED)) {
            frSkyDataIdTableInfo.table[frSkyDataIdTableInfo.index++] = FSSP_DATAID_CAP_USED;
        }
    }
    ...
    if (sensors(SENSOR_ACC)) {
        if (telemetryIsSensorEnabled(SENSOR_PITCH)) {
            frSkyDataIdTableInfo.table[frSkyDataIdTableInfo.index++] = FSSP_DATAID_PITCH;
        }
        if (telemetryIsSensorEnabled(SENSOR_ROLL)) {
            frSkyDataIdTableInfo.table[frSkyDataIdTableInfo.index++] = FSSP_DATAID_ROLL;
        }
    ...
    if (telemetryIsSensorEnabled(ESC_SENSOR_VOLTAGE)) {
        frSkyEscDataIdTableInfo.table[frSkyEscDataIdTableInfo.index++] = FSSP_DATAID_VFAS;
    }
    if (telemetryIsSensorEnabled(ESC_SENSOR_CURRENT)) {
        frSkyEscDataIdTableInfo.table[frSkyEscDataIdTableInfo.index++] = FSSP_DATAID_CURRENT;
    }
    if (telemetryIsSensorEnabled(ESC_SENSOR_RPM)) {
        frSkyEscDataIdTableInfo.table[frSkyEscDataIdTableInfo.index++] = FSSP_DATAID_RPM;
    }
    if (telemetryIsSensorEnabled(ESC_SENSOR_TEMPERATURE)) {
        frSkyEscDataIdTableInfo.table[frSkyEscDataIdTableInfo.index++] = FSSP_DATAID_TEMP;
    }
...
# 445 "./src/main/telemetry/smartport.c" 3 4
_Bool 
# 445 "./src/main/telemetry/smartport.c"
    initSmartPortTelemetry(void)
{
    if (telemetryState == TELEMETRY_STATE_UNINITIALIZED) {
        ...
        return 
# 459 "./src/main/telemetry/smartport.c" 3 4
              1
# 459 "./src/main/telemetry/smartport.c"
                  ;
    }

    return 
# 462 "./src/main/telemetry/smartport.c" 3 4
          0
# 462 "./src/main/telemetry/smartport.c"
               ;
}


# 465 "./src/main/telemetry/smartport.c" 3 4
_Bool 
# 465 "./src/main/telemetry/smartport.c"
    initSmartPortTelemetryExternal(smartPortWriteFrameFn *smartPortWriteFrameExternal)
{
    if (telemetryState == TELEMETRY_STATE_UNINITIALIZED) {
        ...
        return 
# 474 "./src/main/telemetry/smartport.c" 3 4
              1
# 474 "./src/main/telemetry/smartport.c"
                  ;
    }

    return 
# 477 "./src/main/telemetry/smartport.c" 3 4
          0
...
static void freeSmartPortTelemetryPort(void)
{
    ...
    smartPortSerialPort = 
# 483 "./src/main/telemetry/smartport.c" 3 4
                         ((void *)0)
# 483 "./src/main/telemetry/smartport.c"
                             ;
}
...
# 491 "./src/main/telemetry/smartport.c" 3 4
                                                                                                  ((void *)0)
# 491 "./src/main/telemetry/smartport.c"
                                                                                                      , 
# 491 "./src/main/telemetry/smartport.c" 3 4
                                                                                                        ((void *)0)
# 491 "./src/main/telemetry/smartport.c"
...
# 498 "./src/main/telemetry/smartport.c" 3 4
       _Bool 
# 498 "./src/main/telemetry/smartport.c"
...
static void smartPortSendMspResponse(uint8_t *data, const uint8_t dataSize) {
    ...
    memcpy(&payload.valueId, data, __extension__ ({ __typeof__ (dataSize) _a = (dataSize); __typeof__ ((sizeof(smartPortPayload_t) - sizeof(uint8_t))) _b = ((sizeof(smartPortPayload_t) - sizeof(uint8_t))); _a < _b ? _a : _b; }));
...
void processSmartPortTelemetry(smartPortPayload_t *payload, volatile 
# 518 "./src/main/telemetry/smartport.c" 3 4
                                                                    _Bool 
# 518 "./src/main/telemetry/smartport.c"
                                                                         *clearToSend, const timeUs_t *requestTimeout)
{
    ...
    if (skipRequests) {
        ...
        smartPortMspReplyPending = handleMspFrame(frameStart, (sizeof(smartPortPayload_t) - sizeof(uint8_t)), &skipRequests);
        ...
        if (skipRequests) {
            *clearToSend = 
# 543 "./src/main/telemetry/smartport.c" 3 4
                          0
# 543 "./src/main/telemetry/smartport.c"
                               ;
        }
    }
...
# 550 "./src/main/telemetry/smartport.c" 3 4
   _Bool 
# 550 "./src/main/telemetry/smartport.c"
        doRun = 
# 550 "./src/main/telemetry/smartport.c" 3 4
                1
# 550 "./src/main/telemetry/smartport.c"
    ...
    while (doRun && *clearToSend && !skipRequests) {
        ...
        if (requestTimeout) {
            if (cmpTimeUs(micros(), *requestTimeout) >= 0) {
                *clearToSend = 
# 555 "./src/main/telemetry/smartport.c" 3 4
                              0
# 555 "./src/main/telemetry/smartport.c"
                                   ;
            ...
            doRun = 
# 560 "./src/main/telemetry/smartport.c" 3 4
                   0
# 560 "./src/main/telemetry/smartport.c"
                        ;
        }
        ...
        if (smartPortMspReplyPending) {
            ...
            *clearToSend = 
# 566 "./src/main/telemetry/smartport.c" 3 4
                          0
# 566 "./src/main/telemetry/smartport.c"
                               ;
        ...
        switch (id) {
            case FSSP_DATAID_VFAS :
                ...
                *clearToSend = 
# 619 "./src/main/telemetry/smartport.c" 3 4
                              0
# 619 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            ...
            case FSSP_DATAID_VFAS8 :
                ...
                if (escData != 
# 631 "./src/main/telemetry/smartport.c" 3 4
                              ((void *)0)
# 631 "./src/main/telemetry/smartport.c"
                                  ) {
                    smartPortSendPackage(id, escData->voltage);
                    *clearToSend = 
# 633 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 633 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
...
# 651 "./src/main/telemetry/smartport.c"
                    ...
                    *clearToSend = 
# 653 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 653 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_RPM :
                ...
                if (escData != 
# 658 "./src/main/telemetry/smartport.c" 3 4
                              ((void *)0)
# 658 "./src/main/telemetry/smartport.c"
                                  ) {
                    smartPortSendPackage(id, calcEscRpm(escData->rpm));
                    *clearToSend = 
# 660 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 660 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            ...
            case FSSP_DATAID_RPM8 :
                ...
                if (escData != 
# 672 "./src/main/telemetry/smartport.c" 3 4
                              ((void *)0)
# 672 "./src/main/telemetry/smartport.c"
                                  ) {
                    smartPortSendPackage(id, calcEscRpm(escData->rpm));
                    *clearToSend = 
# 674 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 674 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_TEMP :
                escData = getEscSensorData(255);
                if (escData != 
# 679 "./src/main/telemetry/smartport.c" 3 4
                              ((void *)0)
# 679 "./src/main/telemetry/smartport.c"
                                  ) {
                    smartPortSendPackage(id, escData->temperature);
                    *clearToSend = 
# 681 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 681 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            ...
            case FSSP_DATAID_TEMP8 :
                ...
                if (escData != 
# 693 "./src/main/telemetry/smartport.c" 3 4
                              ((void *)0)
# 693 "./src/main/telemetry/smartport.c"
                                  ) {
                    smartPortSendPackage(id, escData->temperature);
                    *clearToSend = 
# 695 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 695 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;

            case FSSP_DATAID_ALTITUDE :
                smartPortSendPackage(id, getEstimatedAltitudeCm());
                *clearToSend = 
# 701 "./src/main/telemetry/smartport.c" 3 4
                              0
# 701 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_FUEL :
                {
                    ...
                    *clearToSend = 
# 712 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 712 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
...
# 717 "./src/main/telemetry/smartport.c"
            ...
            case FSSP_DATAID_VARIO :
                ...
                *clearToSend = 
# 722 "./src/main/telemetry/smartport.c" 3 4
                              0
# 722 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            ...
            case FSSP_DATAID_HEADING :
                ...
                *clearToSend = 
# 727 "./src/main/telemetry/smartport.c" 3 4
                              0
# 727 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            ...
            case FSSP_DATAID_PITCH :
                ...
                *clearToSend = 
# 732 "./src/main/telemetry/smartport.c" 3 4
                              0
# 732 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_ROLL :
                smartPortSendPackage(id, attitude.values.roll);
                *clearToSend = 
# 736 "./src/main/telemetry/smartport.c" 3 4
                              0
# 736 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_ACCX :
                smartPortSendPackage(id, lrintf(100 * acc.accADC[X] * acc.dev.acc_1G_rec));
                *clearToSend = 
# 740 "./src/main/telemetry/smartport.c" 3 4
                              0
# 740 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_ACCY :
                smartPortSendPackage(id, lrintf(100 * acc.accADC[Y] * acc.dev.acc_1G_rec));
                *clearToSend = 
# 744 "./src/main/telemetry/smartport.c" 3 4
                              0
# 744 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_ACCZ :
                smartPortSendPackage(id, lrintf(100 * acc.accADC[Z] * acc.dev.acc_1G_rec));
                *clearToSend = 
# 748 "./src/main/telemetry/smartport.c" 3 4
                              0
# 748 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            ...
            case FSSP_DATAID_T1 :
                ...
                *clearToSend = 
# 791 "./src/main/telemetry/smartport.c" 3 4
                              0
# 791 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_T2 :
                ...
                if (sensors(SENSOR_GPS)) {
                    ...
                    smartPortSendPackage(id, ((stateFlags & (GPS_FIX)) ? 1000 : 0) + ((stateFlags & (GPS_FIX_HOME)) ? 2000 : 0) + hdop + gpsSol.numSat);
                    *clearToSend = 
# 799 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 799 "./src/main/telemetry/smartport.c"
                                       ;
...
# 802 "./src/main/telemetry/smartport.c"
                ...
                if (telemetryConfig()->pidValuesAsTelemetry) {
                    ...
                    *clearToSend = 
# 834 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 834 "./src/main/telemetry/smartport.c"
                                       ;
                }
            ...
            case FSSP_DATAID_T11 :
                ...
                *clearToSend = 
# 841 "./src/main/telemetry/smartport.c" 3 4
                              0
# 841 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            ...
            case FSSP_DATAID_SPEED :
                if ((stateFlags & (GPS_FIX))) {
                    ...
                    *clearToSend = 
# 851 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 851 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_LATLONG :
                if ((stateFlags & (GPS_FIX))) {
                    ...
                    smartPortSendPackage(id, tmpui);
                    *clearToSend = 
# 871 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 871 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_HOME_DIST :
                if ((stateFlags & (GPS_FIX))) {
                     ...
                     *clearToSend = 
# 877 "./src/main/telemetry/smartport.c" 3 4
                                   0
# 877 "./src/main/telemetry/smartport.c"
                                        ;
                }
                break;
            case FSSP_DATAID_GPS_ALT :
                if ((stateFlags & (GPS_FIX))) {
                    smartPortSendPackage(id, gpsSol.llh.altCm);
                    *clearToSend = 
# 883 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 883 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;

            case FSSP_DATAID_A4 :
                vfasVoltage = getBatteryAverageCellVoltage();
                smartPortSendPackage(id, vfasVoltage);
                *clearToSend = 
# 890 "./src/main/telemetry/smartport.c" 3 4
                              0
# 890 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            default:
                break;
...
static 
# 899 "./src/main/telemetry/smartport.c" 3 4
      _Bool 
# 899 "./src/main/telemetry/smartport.c"
           serialReadyToSend(void)
{
...
void handleSmartPortTelemetry(void)
{
    const timeUs_t requestTimeout = micros() + 1000;

    if (telemetryState == TELEMETRY_STATE_INITIALIZED_SERIAL && smartPortSerialPort) {
        smartPortPayload_t *payload = 
# 909 "./src/main/telemetry/smartport.c" 3 4
                                     ((void *)0)
# 909 "./src/main/telemetry/smartport.c"
                                         ;
        
# 910 "./src/main/telemetry/smartport.c" 3 4
       _Bool 
# 910 "./src/main/telemetry/smartport.c"
            clearToSend = 
# 910 "./src/main/telemetry/smartport.c" 3 4
                          0
# 910 "./src/main/telemetry/smartport.c"
        ...
        while (serialRxBytesWaiting(smartPortSerialPort) > 0 && !payload) {
            ...
            payload = smartPortDataReceive(c, &clearToSend, serialReadyToSend, 
# 913 "./src/main/telemetry/smartport.c" 3 4
                                                                              1
# 913 "./src/main/telemetry/smartport.c"
                                                                                  );
        }
