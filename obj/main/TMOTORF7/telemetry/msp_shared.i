...
# 33 "./src/main/telemetry/msp_shared.c" 2
...
# 26 "./src/main/msp/msp_serial.h" 2
...
# 40 "./src/main/telemetry/msp_shared.c" 2
...
# 42 "./src/main/telemetry/msp_shared.c" 2
# 81 "./src/main/telemetry/msp_shared.c"
enum {
    MSP_STATUS_SEQUENCE_MASK = 0x0f,
    MSP_STATUS_START_MASK = 0x10,
    MSP_STATUS_VERSION_MASK = 0x60,
    MSP_STATUS_ERROR_MASK = 0x80,
    MSP_STATUS_VERSION_SHIFT = 5,
};
...
enum {
    ...
    MSP_INDEX_SIZE_JUMBO_LO = MSP_INDEX_PAYLOAD_V1,
    MSP_INDEX_SIZE_JUMBO_HI = MSP_INDEX_SIZE_JUMBO_LO + 1,
    MSP_INDEX_PAYLOAD_JUMBO = MSP_INDEX_SIZE_JUMBO_HI + 1,
...
static uint8_t requestBuffer[192];
static uint8_t responseBuffer[320];
static mspPacket_t requestPacket;
static mspPacket_t responsePacket;
static uint8_t lastRequestVersion;
...
void initSharedMsp(void)
{
    ...
    responsePacket.buf.end = (&(responseBuffer)[(sizeof(responseBuffer) / sizeof((responseBuffer)[0]))]);
...
# 152 "./src/main/telemetry/msp_shared.c" 3 4
                                          ((void *)0)
# 152 "./src/main/telemetry/msp_shared.c"
                                              ;
...
# 179 "./src/main/telemetry/msp_shared.c"
    ...
    if (lastRequestVersion > 2) {
        sendMspErrorResponse(TELEMETRY_MSP_VER_MISMATCH, 0);
        return 
# 193 "./src/main/telemetry/msp_shared.c" 3 4
              1
# 193 "./src/main/telemetry/msp_shared.c"
                  ;
    }

    if (status & MSP_STATUS_START_MASK) {
        uint16_t mspPayloadSize;
        if (lastRequestVersion == 1) {
            if (payloadLength < MIN_LENGTH_REQUEST_V1) {
                return 
# 200 "./src/main/telemetry/msp_shared.c" 3 4
                      0
# 200 "./src/main/telemetry/msp_shared.c"
                           ;
            }

            mspPayloadSize = payload[MSP_INDEX_SIZE_V1];
            requestPacket.cmd = payload[MSP_INDEX_ID_V1];
            if (mspPayloadSize == 0xff) {
                if (payloadLength < MIN_LENGTH_REQUEST_JUMBO) {
                    return 
# 207 "./src/main/telemetry/msp_shared.c" 3 4
                          0
# 207 "./src/main/telemetry/msp_shared.c"
                               ;
                }
            ...
            if (payloadLength < MIN_LENGTH_REQUEST_V2) {
                return 
# 216 "./src/main/telemetry/msp_shared.c" 3 4
                      0
# 216 "./src/main/telemetry/msp_shared.c"
                           ;
            }
        ...
        if (mspPayloadSize <= sizeof(requestBuffer)) {
            ...
            return 
# 230 "./src/main/telemetry/msp_shared.c" 3 4
                  1
# 230 "./src/main/telemetry/msp_shared.c"
                      ;
        }
    } else {
        if (!mspStarted) {
            return 
# 234 "./src/main/telemetry/msp_shared.c" 3 4
                  0
# 234 "./src/main/telemetry/msp_shared.c"
                       ;
        } else {
            if (((lastSeq + 1) & MSP_STATUS_SEQUENCE_MASK) != seqNumber) {
                ...
                mspStarted = 0;
                return 
# 239 "./src/main/telemetry/msp_shared.c" 3 4
                      0
# 239 "./src/main/telemetry/msp_shared.c"
                           ;
            }
        }
    ...
    if (payloadExpecting > payloadIncoming) {
        ...
        return 
# 253 "./src/main/telemetry/msp_shared.c" 3 4
              0
# 253 "./src/main/telemetry/msp_shared.c"
                   ;
    } else {
        if (payloadExpecting) {
    ...
    if (requestPacket.cmd == 250 && skipsBeforeResponse) {
    ...
    processMspPacket();
    return 
# 269 "./src/main/telemetry/msp_shared.c" 3 4
          1
# 269 "./src/main/telemetry/msp_shared.c"
              ;
}


# 272 "./src/main/telemetry/msp_shared.c" 3 4
_Bool 
# 272 "./src/main/telemetry/msp_shared.c"
    sendMspReply(const uint8_t payloadSizeMax, mspResponseFnPtr responseFn)
{
    ...
    if (responsePacket.buf.ptr == responseBuffer) {
        ...
        const int size = sbufBytesRemaining(&responsePacket.buf);
        if (lastRequestVersion == 1) {
            if (size >= 0xff) {
            ...
            sbufWriteU8 (payloadBuf, responsePacket.flags);
            sbufWriteU16(payloadBuf, responsePacket.cmd);
            sbufWriteU16(payloadBuf, (uint16_t)size);
        }
    } else {
        sbufWriteU8(payloadBuf, (seq++ & MSP_STATUS_SEQUENCE_MASK) | (lastRequestVersion << MSP_STATUS_VERSION_SHIFT));
    }

    const int inputRemainder = sbufBytesRemaining(&responsePacket.buf);
    const int chunkRemainder = sbufBytesRemaining(payloadBuf);
    ...
    if (inputRemainder >= chunkRemainder) {
        ...
        return 
# 318 "./src/main/telemetry/msp_shared.c" 3 4
              1
# 318 "./src/main/telemetry/msp_shared.c"
                  ;
    }
    ...
    return 
# 326 "./src/main/telemetry/msp_shared.c" 3 4
          0
# 326 "./src/main/telemetry/msp_shared.c"
               ;
}
