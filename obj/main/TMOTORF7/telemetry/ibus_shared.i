...
# 38 "./src/main/telemetry/ibus_shared.c" 2
...
# 55 "./src/main/telemetry/ibus_shared.c" 2
...
# 67 "./src/main/telemetry/ibus_shared.c"
...
# 127 "./src/main/telemetry/ibus_shared.c" 3 4
                                     ((void *)0)
# 127 "./src/main/telemetry/ibus_shared.c"
                                         ;
...
static 
# 296 "./src/main/telemetry/ibus_shared.c" 3 4
      _Bool 
# 296 "./src/main/telemetry/ibus_shared.c"
           setGPS(uint8_t sensorType, ibusTelemetry_s* value)
{
    
# 298 "./src/main/telemetry/ibus_shared.c" 3 4
   _Bool 
# 298 "./src/main/telemetry/ibus_shared.c"
        result = 
# 298 "./src/main/telemetry/ibus_shared.c" 3 4
                 0
# 298 "./src/main/telemetry/ibus_shared.c"
    ...
    for (unsigned i = 0; i < sizeof(GPS_IDS); i++) {
        if (sensorType == GPS_IDS[i]) {
            result = 
# 301 "./src/main/telemetry/ibus_shared.c" 3 4
                    1
# 301 "./src/main/telemetry/ibus_shared.c"
                        ;
            break;
        }
    }
    ...
    if (sensors(SENSOR_GPS)) {
        ...
        if ((stateFlags & (GPS_FIX)) || sensorType == IBUS_SENSOR_TYPE_GPS_STATUS) {
            result = 
# 313 "./src/main/telemetry/ibus_shared.c" 3 4
                    1
# 313 "./src/main/telemetry/ibus_shared.c"
                        ;
            switch (sensorType) {
...
static void setValue(uint8_t* bufferPtr, uint8_t sensorType, uint8_t length)
{
    ...
    switch (sensorType) {
        ...
        case IBUS_SENSOR_TYPE_CLIMB_RATE:
            value.int16 = (int16_t) constrain(getEstimatedVario(), 
# 420 "./src/main/telemetry/ibus_shared.c" 3 4
                                                                  (-0x7fff - 1)
# 420 "./src/main/telemetry/ibus_shared.c"
                                                                          , 0x7fff);
            break;
...
static 
# 447 "./src/main/telemetry/ibus_shared.c" 3 4
      _Bool 
# 447 "./src/main/telemetry/ibus_shared.c"
...
static 
# 465 "./src/main/telemetry/ibus_shared.c" 3 4
      _Bool 
# 465 "./src/main/telemetry/ibus_shared.c"
...
# 513 "./src/main/telemetry/ibus_shared.c" 3 4
_Bool 
# 513 "./src/main/telemetry/ibus_shared.c"
    isChecksumOkIa6b(const uint8_t *ibusPacket, const uint8_t length)
{
