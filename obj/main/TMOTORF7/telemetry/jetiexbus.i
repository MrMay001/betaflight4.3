...
# 88 "./src/main/flight/imu.h"
    isUpright(void);
# 44 "./src/main/telemetry/jetiexbus.c" 2
...
# 50 "./src/main/telemetry/jetiexbus.c" 2
...
# 53 "./src/main/telemetry/jetiexbus.c" 2
...
# 56 "./src/main/telemetry/jetiexbus.c" 2
...
# 57 "./src/main/telemetry/jetiexbus.c" 2
# 68 "./src/main/telemetry/jetiexbus.c"
enum exTelHeader_e {
    EXTEL_HEADER_SYNC = 0,
...
const exBusSensor_t jetiExSensors[] = {
    {"BF D1", "", EX_TYPE_DES, 0 },
    {"Voltage", "V", EX_TYPE_22b, (1 << 5)},
    {"Current", "A", EX_TYPE_22b, (2 << 5)},
    {"Altitude", "m", EX_TYPE_22b, (2 << 5)},
    {"Capacity", "mAh", EX_TYPE_22b, (0 << 5)},
    {"Power", "W", EX_TYPE_22b, (1 << 5)},
    {"Roll angle", "\xB0", EX_TYPE_22b, (1 << 5)},
    {"Pitch angle", "\xB0", EX_TYPE_22b, (1 << 5)},
    {"Heading", "\xB0", EX_TYPE_22b, (1 << 5)},
    {"Vario", "m/s", EX_TYPE_22b, (2 << 5)},
    {"GPS Sats", "", EX_TYPE_22b, (0 << 5)},
    {"GPS Long", "", EX_TYPE_GPS, (0 << 5)},
    {"GPS Lat", "", EX_TYPE_GPS, (0 << 5)},
    {"GPS Speed", "m/s", EX_TYPE_22b, (2 << 5)},
    {"GPS H-Distance", "m", EX_TYPE_22b, (0 << 5)},
    {"GPS H-Direction", "\xB0", EX_TYPE_22b, (1 << 5)},
    {"BF D2", "", EX_TYPE_DES, 0 },
    {"GPS Heading", "\xB0", EX_TYPE_22b, (1 << 5)},
    {"GPS Altitude", "m", EX_TYPE_22b, (2 << 5)},
    {"G-Force X", "", EX_TYPE_22b, (3 << 5)},
    {"G-Force Y", "", EX_TYPE_22b, (3 << 5)},
    {"G-Force Z", "", EX_TYPE_22b, (3 << 5)}
};
...
void enableGpsTelemetry(
# 195 "./src/main/telemetry/jetiexbus.c" 3 4
                       _Bool 
# 195 "./src/main/telemetry/jetiexbus.c"
                            enable)
{
    if (enable) {
...
uint32_t calcGpsDDMMmmm(int32_t value, 
# 289 "./src/main/telemetry/jetiexbus.c" 3 4
                                      _Bool 
# 289 "./src/main/telemetry/jetiexbus.c"
                                           isLong)
{
    uint32_t absValue = __extension__ ({ __typeof__ (value) _x = (value); _x > 0 ? _x : -_x; });
    uint16_t deg16 = absValue / 10000000L;
    uint16_t min16 = (absValue - deg16 * 10000000L) * 6 / 1000;
...
int32_t getSensorValue(uint8_t sensor)
{
    ...
    case EX_GPS_LONG:
        return calcGpsDDMMmmm(gpsSol.llh.lon, 
# 352 "./src/main/telemetry/jetiexbus.c" 3 4
                                             1
# 352 "./src/main/telemetry/jetiexbus.c"
                                                 );
    break;

    case EX_GPS_LAT:
        return calcGpsDDMMmmm(gpsSol.llh.lat, 
# 356 "./src/main/telemetry/jetiexbus.c" 3 4
                                             0
# 356 "./src/main/telemetry/jetiexbus.c"
                                                  );
    break;
...
uint8_t createExTelemetryValueMessage(uint8_t *exMessage, uint8_t item)
{
    ...
    while (item < sensorItemMaxGroup) {
        *p++ = ((item & 0x0F) << 4) | jetiExSensors[item].exDataType;
        ...
        if ((p - &exMessage[EXTEL_HEADER_ID]) + exDataTypeLen[jetiExSensors[item].exDataType] + 1 >= (26 - (1 + 6 + 1))) {
            break;
        }
    }
...
uint8_t sendJetiExBusTelemetry(uint8_t packetID, uint8_t item)
{
    ...
    static 
# 519 "./src/main/telemetry/jetiexbus.c" 3 4
          _Bool 
# 519 "./src/main/telemetry/jetiexbus.c"
               allSensorsActive = 
# 519 "./src/main/telemetry/jetiexbus.c" 3 4
                                  1
# 519 "./src/main/telemetry/jetiexbus.c"
    ...
    if (requestLoop) {
        ...
        if (requestLoop == 0) {
            ...
            if (featureIsEnabled(FEATURE_GPS)) {
                enableGpsTelemetry(
# 538 "./src/main/telemetry/jetiexbus.c" 3 4
                                  0
# 538 "./src/main/telemetry/jetiexbus.c"
                                       );
                allSensorsActive = 
# 539 "./src/main/telemetry/jetiexbus.c" 3 4
                                  0
# 539 "./src/main/telemetry/jetiexbus.c"
                                       ;
            }
        }
    } else {
        ...
        if (!allSensorsActive) {
            if (sensors(SENSOR_GPS)) {
                enableGpsTelemetry(
# 548 "./src/main/telemetry/jetiexbus.c" 3 4
                                  1
# 548 "./src/main/telemetry/jetiexbus.c"
                                      );
                allSensorsActive = 
# 549 "./src/main/telemetry/jetiexbus.c" 3 4
                                  1
# 549 "./src/main/telemetry/jetiexbus.c"
                                      ;
            }
        }
    }
