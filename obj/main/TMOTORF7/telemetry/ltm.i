...
static void ltm_sframe(void)
{
    ...
    ltm_serialise_16(getBatteryVoltage() * 10);
    ltm_serialise_16((uint16_t)constrain(getMAhDrawn(), 0, 
# 187 "./src/main/telemetry/ltm.c" 3 4
                                                          (0xffff)
# 187 "./src/main/telemetry/ltm.c"
                                                                    ));
...
void freeLtmTelemetryPort(void)
{
    ...
    ltmPort = 
# 260 "./src/main/telemetry/ltm.c" 3 4
             ((void *)0)
# 260 "./src/main/telemetry/ltm.c"
                 ;
    ltmEnabled = 
# 261 "./src/main/telemetry/ltm.c" 3 4
                0
# 261 "./src/main/telemetry/ltm.c"
                     ;
}
...
# 279 "./src/main/telemetry/ltm.c" 3 4
                                                                            ((void *)0)
# 279 "./src/main/telemetry/ltm.c"
                                                                                , 
# 279 "./src/main/telemetry/ltm.c" 3 4
                                                                                  ((void *)0)
# 279 "./src/main/telemetry/ltm.c"
    ...
    if (!ltmPort)
        return;
    ltmEnabled = 
# 282 "./src/main/telemetry/ltm.c" 3 4
                1
# 282 "./src/main/telemetry/ltm.c"
                    ;
}
