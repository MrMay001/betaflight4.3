...
static void sendAccel(void)
{
    for (unsigned i = 0; i < 3; i++) {
        frSkyHubWriteFrame(0x24 + i, ((int16_t)(acc.accADC[i] * acc.dev.acc_1G_rec) * 1000));
    }
}
...
# 207 "./src/main/telemetry/frsky_hub.c"
...
static void sendLatLong(int32_t coord[2])
{
    ...
    frSkyHubWriteFrame(0x23, coord[GPS_LATITUDE] < 0 ? 'S' : 'N');
    ...
    frSkyHubWriteFrame(0x22, coord[GPS_LONGITUDE] < 0 ? 'W' : 'E');
}
...
static void sendGpsAltitude(void)
{
    ...
    frSkyHubWriteFrame(0x01, altitudeCm / 100);
    frSkyHubWriteFrame(0x09, altitudeCm % 100);
}
...
static void sendFakeLatLong(void)
{
    ...
    coord[GPS_LATITUDE] = ((0.01f * telemetryConfig()->gpsNoFixLatitude) * 10000000L);
    coord[GPS_LONGITUDE] = ((0.01f * telemetryConfig()->gpsNoFixLongitude) * 10000000L);
...
# 351 "./src/main/telemetry/frsky_hub.c"
...
# 450 "./src/main/telemetry/frsky_hub.c" 3 4
_Bool 
# 450 "./src/main/telemetry/frsky_hub.c"
    initFrSkyHubTelemetry(void)
{
    if (telemetryState == TELEMETRY_STATE_UNINITIALIZED) {
        ...
        return 
# 462 "./src/main/telemetry/frsky_hub.c" 3 4
              1
# 462 "./src/main/telemetry/frsky_hub.c"
                  ;
    }

    return 
# 465 "./src/main/telemetry/frsky_hub.c" 3 4
          0
# 465 "./src/main/telemetry/frsky_hub.c"
               ;
}
    ...
    initFrSkyHubTelemetryExternal(frSkyHubWriteByteFn *frSkyHubWriteByteExternal)
{
    if (telemetryState == TELEMETRY_STATE_UNINITIALIZED) {
        ...
        return 
# 475 "./src/main/telemetry/frsky_hub.c" 3 4
              1
# 475 "./src/main/telemetry/frsky_hub.c"
                  ;
    }

    return 
# 478 "./src/main/telemetry/frsky_hub.c" 3 4
          0
# 478 "./src/main/telemetry/frsky_hub.c"
               ;
}
...
# 490 "./src/main/telemetry/frsky_hub.c" 3 4
                                                                                           ((void *)0)
# 490 "./src/main/telemetry/frsky_hub.c"
                                                                                               , 
# 490 "./src/main/telemetry/frsky_hub.c" 3 4
                                                                                                 ((void *)0)
# 490 "./src/main/telemetry/frsky_hub.c"
...
void checkFrSkyHubTelemetryState(void)
{
    if (telemetryState == TELEMETRY_STATE_INITIALIZED_SERIAL) {
        if (telemetryCheckRxPortShared(portConfig, rxRuntimeState.serialrxProvider)) {
            if (frSkyHubPort == 
# 498 "./src/main/telemetry/frsky_hub.c" 3 4
                               ((void *)0) 
# 498 "./src/main/telemetry/frsky_hub.c"
                                    && telemetrySharedPort != 
# 498 "./src/main/telemetry/frsky_hub.c" 3 4
                                                              ((void *)0)
# 498 "./src/main/telemetry/frsky_hub.c"
...
# 502 "./src/main/telemetry/frsky_hub.c" 3 4
           _Bool 
# 502 "./src/main/telemetry/frsky_hub.c"
...
void processFrSkyHubTelemetry(timeUs_t currentTimeUs)
{
    ...
    if (sensors(SENSOR_BARO | SENSOR_RANGEFINDER) | sensors(SENSOR_GPS)) {
        ...
        if ((cycleNum % 4) == 0 && telemetryIsSensorEnabled(SENSOR_ALTITUDE)) {
            ...
            frSkyHubWriteFrame(0x10, altitudeCm / 100);
            frSkyHubWriteFrame(0x21, altitudeCm % 100);
        }
    }
