# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c"
# 99 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c"
...
# 100 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c" 2
# 120 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c"
static void ADC_MultiModeDMAConvCplt(DMA_HandleTypeDef *hdma);
static void ADC_MultiModeDMAError(DMA_HandleTypeDef *hdma);
static void ADC_MultiModeDMAHalfConvCplt(DMA_HandleTypeDef *hdma);
# 159 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_InjectedStart(ADC_HandleTypeDef* hadc)
{
...
# 248 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_InjectedStart_IT(ADC_HandleTypeDef* hadc)
{
  volatile uint32_t counter = 0;
  uint32_t tmp1 = 0, tmp2 = 0;
...
# 345 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_InjectedStop(ADC_HandleTypeDef* hadc)
{
...
# 399 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_InjectedPollForConversion(ADC_HandleTypeDef* hadc, uint32_t Timeout)
{
...
# 466 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_InjectedStop_IT(ADC_HandleTypeDef* hadc)
{
  HAL_StatusTypeDef tmp_hal_status = HAL_OK;
...
# 528 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c"
uint32_t HAL_ADCEx_InjectedGetValue(ADC_HandleTypeDef* hadc, uint32_t InjectedRank)
{
...
# 579 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_MultiModeStart_DMA(ADC_HandleTypeDef* hadc, uint32_t* pData, uint32_t Length)
{
  volatile uint32_t counter = 0;
  ...
  if((((hadc->Instance->CR2) & ((0x1UL << (0U)))) == ((0x1UL << (0U)))))
  {
    ...
    if (hadc->Init.DMAContinuousRequests != DISABLE)
    {
      ...
      ((ADC_Common_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2300UL))->CCR |= (0x1UL << (13U));
    }
    else
    {
    ...
    HAL_DMA_Start_IT(hadc->DMA_Handle, (uint32_t)&((ADC_Common_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2300UL))->CDR, (uint32_t)pData, Length);
...
# 739 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c"
uint32_t HAL_ADCEx_MultiModeGetValue(ADC_HandleTypeDef* hadc)
{
  ((void)(hadc));


  return ((ADC_Common_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2300UL))->CDR;
}
...
# 770 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_InjectedConfigChannel(ADC_HandleTypeDef* hadc, ADC_InjectionConfTypeDef* sConfigInjected)
{
  ...
  if(sConfigInjected->ExternalTrigInjecConv != ((uint32_t)(0xFUL << (16U)) + 1))
  {
    ((void)0U);
  }
  ...
  if (sConfigInjected->InjectedChannel > ((uint32_t)((0x08UL << (0U)) | (0x01UL << (0U)))))
  {
    ...
    hadc->Instance->SMPR1 &= ~(((0x7UL << (0U))) << (3 * (((uint32_t)((uint16_t)(sConfigInjected->InjectedChannel))) - 10)));
  ...
  else
  {
    ...
    hadc->Instance->SMPR2 &= ~(((0x7UL << (0U))) << (3 * ((uint32_t)((uint16_t)(sConfigInjected->InjectedChannel)))));
  ...
  hadc->Instance->JSQR &= ~(((uint32_t)((uint16_t)((0x1FUL << (0U))))) << (5 * (uint8_t)(((sConfigInjected->InjectedRank) + 3) - (sConfigInjected->InjectedNbrOfConversion))));
  ...
  if ((hadc->Instance == ((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2000UL))) && ((sConfigInjected->InjectedChannel == ((uint32_t)((uint32_t)((0x10UL << (0U)) | (0x02UL << (0U)))) | 0x10000000U)) || (sConfigInjected->InjectedChannel == ((uint32_t)((uint32_t)((0x10UL << (0U)) | (0x01UL << (0U))))))))
  {
...
# 926 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_MultiModeConfigChannel(ADC_HandleTypeDef* hadc, ADC_MultiModeTypeDef* multimode)
{
  ...
  ((ADC_Common_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2300UL))->CCR &= ~((0x1FUL << (0U)));
  ((ADC_Common_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2300UL))->CCR |= multimode->Mode;


  ((ADC_Common_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2300UL))->CCR &= ~((0x3UL << (14U)));
  ((ADC_Common_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2300UL))->CCR |= multimode->DMAAccessMode;


  ((ADC_Common_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2300UL))->CCR &= ~((0xFUL << (8U)));
  ((ADC_Common_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2300UL))->CCR |= multimode->TwoSamplingDelay;
...
# 965 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc_ex.c"
static void ADC_MultiModeDMAConvCplt(DMA_HandleTypeDef *hdma)
{
