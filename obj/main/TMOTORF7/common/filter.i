...
__attribute__((section(".tcm_code"))) __attribute__((optimize("-O2"))) float nullFilterApply(filter_t *filter, float input)
{
    ((void)(filter));
    return input;
}
...
__attribute__((section(".tcm_code"))) __attribute__((optimize("-O2"))) float pt1FilterApply(pt1Filter_t *filter, float input)
{
...
float pt2FilterGain(float f_cut, float dT)
{
    ...
    float RC = 1 / (2 * orderCutoffCorrection * 3.14159265358979323846f * f_cut);
...
__attribute__((section(".tcm_code"))) __attribute__((optimize("-O2"))) float pt2FilterApply(pt2Filter_t *filter, float input)
{
...
__attribute__((section(".tcm_code"))) __attribute__((optimize("-O2"))) float pt3FilterApply(pt3Filter_t *filter, float input)
{
    filter->state1 = filter->state1 + filter->k * (input - filter->state1);
...
__attribute__((section(".tcm_code"))) __attribute__((optimize("-O2"))) float slewFilterApply(slewFilter_t *filter, float input)
{
...
void biquadFilterInitLPF(biquadFilter_t *filter, float filterFreq, uint32_t refreshRate)
{
    biquadFilterInit(filter, filterFreq, refreshRate, 1.0f / sqrtf(2.0f), FILTER_LPF, 1.0f);
}
...
__attribute__((section(".tcm_code"))) __attribute__((optimize("-O2"))) void biquadFilterUpdate(biquadFilter_t *filter, float filterFreq, uint32_t refreshRate, float Q, biquadFilterType_e filterType, float weight)
{
...
__attribute__((section(".tcm_code"))) __attribute__((optimize("-O2"))) void biquadFilterUpdateLPF(biquadFilter_t *filter, float filterFreq, uint32_t refreshRate)
{
    biquadFilterUpdate(filter, filterFreq, refreshRate, 1.0f / sqrtf(2.0f), FILTER_LPF, 1.0f);
}


__attribute__((section(".tcm_code"))) __attribute__((optimize("-O2"))) float biquadFilterApplyDF1(biquadFilter_t *filter, float input)
{
...
__attribute__((section(".tcm_code"))) __attribute__((optimize("-O2"))) float biquadFilterApplyDF1Weighted(biquadFilter_t* filter, float input)
{
...
__attribute__((section(".tcm_code"))) __attribute__((optimize("-O2"))) float biquadFilterApply(biquadFilter_t *filter, float input)
{
...
void laggedMovingAverageInit(laggedMovingAverage_t *filter, uint16_t windowSize, float *buf)
{
    ...
    filter->primed = 
# 277 "./src/main/common/filter.c" 3 4
                    0
# 277 "./src/main/common/filter.c"
                         ;
}

__attribute__((section(".tcm_code"))) __attribute__((optimize("-O2"))) float laggedMovingAverageUpdate(laggedMovingAverage_t *filter, float input)
{
    ...
    if (++filter->movingWindowIndex == filter->windowSize) {
        filter->movingWindowIndex = 0;
        filter->primed = 
# 288 "./src/main/common/filter.c" 3 4
                        1
# 288 "./src/main/common/filter.c"
                            ;
    }
