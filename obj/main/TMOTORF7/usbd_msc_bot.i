# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
# 27 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
...
void MSC_BOT_CplClrFeature (USBD_HandleTypeDef *pdev,
                             uint8_t epnum);
# 28 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c" 2
...
# 29 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c" 2
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_scsi.h" 1
# 30 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c" 2
# 79 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
...
# 102 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
void MSC_BOT_Init (USBD_HandleTypeDef *pdev)
{
  ...
  USBD_LL_FlushEP(pdev, 0x01U);
  USBD_LL_FlushEP(pdev, 0x81U);


  USBD_LL_PrepareReceive (pdev, 0x01U, (uint8_t *)(void *)&hmsc->cbw,
                          31U);
}
...
# 159 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
void MSC_BOT_DataIn (USBD_HandleTypeDef *pdev,
                     uint8_t epnum)
{
  ((void)(epnum));
...
static void MSC_BOT_CBW_Decode (USBD_HandleTypeDef *pdev)
{
  ...
  if ((USBD_LL_GetRxDataSize (pdev ,0x01U) != 31U) ||
      (hmsc->cbw.dSignature != 0x43425355U) ||
        (hmsc->cbw.bLUN > 1U) ||
...
# 293 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
static void MSC_BOT_SendData(USBD_HandleTypeDef *pdev, uint8_t* pbuf,
                              uint16_t len)
{
  USBD_MSC_BOT_HandleTypeDef *hmsc = (USBD_MSC_BOT_HandleTypeDef*)pdev->pMSC_ClassData;

  uint16_t length = (uint16_t)__extension__ ({ __typeof__ (hmsc->cbw.dDataLength) _a = (hmsc->cbw.dDataLength); __typeof__ (len) _b = (len); _a < _b ? _a : _b; });

  hmsc->csw.dDataResidue -= len;
  hmsc->csw.bStatus = 0x00U;
  hmsc->bot_state = 4U;

  USBD_LL_Transmit(pdev, 0x81U, pbuf, length);
}
# 314 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
void MSC_BOT_SendCSW (USBD_HandleTypeDef *pdev,
                              uint8_t CSW_Status)
{
  USBD_MSC_BOT_HandleTypeDef *hmsc = (USBD_MSC_BOT_HandleTypeDef*)pdev->pMSC_ClassData;

  hmsc->csw.dSignature = 0x53425355U;
  hmsc->csw.bStatus = CSW_Status;
  hmsc->bot_state = 0U;

  USBD_LL_Transmit (pdev, 0x81U, (uint8_t *)(void *)&hmsc->csw,
                    13U);
...
# 338 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
static void MSC_BOT_Abort (USBD_HandleTypeDef *pdev)
{
  USBD_MSC_BOT_HandleTypeDef *hmsc = (USBD_MSC_BOT_HandleTypeDef*)pdev->pMSC_ClassData;
  ...
  if ((hmsc->cbw.bmFlags == 0U) &&
      ...
      (hmsc->bot_status == 0U))
  {
    USBD_LL_StallEP(pdev, 0x01U );
  }

  USBD_LL_StallEP(pdev, 0x81U);

  if(hmsc->bot_status == 2U)
  {
    USBD_LL_PrepareReceive (pdev, 0x01U, (uint8_t *)(void *)&hmsc->cbw,
                            31U);
  }
}
# 366 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
void MSC_BOT_CplClrFeature (USBD_HandleTypeDef *pdev, uint8_t epnum)
{
  ...
  else if(((epnum & 0x80U) == 0x80U) && (hmsc->bot_status != 1U))
  {
    MSC_BOT_SendCSW (pdev, 0x01U);
  }
  else
