# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_gpio.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_gpio.c"
# 108 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_gpio.c"
...
# 109 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_gpio.c" 2
# 169 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_gpio.c"
void HAL_GPIO_Init(GPIO_TypeDef *GPIOx, GPIO_InitTypeDef *GPIO_Init)
{
...
# 294 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_gpio.c"
void HAL_GPIO_DeInit(GPIO_TypeDef *GPIOx, uint32_t GPIO_Pin)
{
  uint32_t position;
  uint32_t ioposition = 0x00;
  ...
  for(position = 0; position < ((uint32_t)16U); position++)
  {
    ...
    if(iocurrent == ioposition)
    {
      ...
      tmp = ((SYSCFG_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3800UL))->EXTICR[position >> 2];
      ...
      if(tmp == ((uint32_t)((uint8_t)(((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL))))? 0U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL))))? 1U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL))))? 2U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL))))? 3U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL))))? 4U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1400UL))))? 5U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1800UL))))? 6U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1C00UL))))? 7U : 8U)) << (4 * (position & 0x03))))
      {
        ...
        tmp = ((uint32_t)0x0F) << (4 * (position & 0x03));
        ((SYSCFG_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3800UL))->EXTICR[position >> 2] &= ~tmp;
      ...
      GPIOx->MODER &= ~((0x3UL << (0U)) << (position * 2));


      GPIOx->AFR[position >> 3] &= ~((uint32_t)0xF << ((uint32_t)(position & (uint32_t)0x07) * 4)) ;


      GPIOx->OSPEEDR &= ~((0x3UL << (0U)) << (position * 2));


      GPIOx->OTYPER &= ~(0x00000001U << position) ;


      GPIOx->PUPDR &= ~((0x3UL << (0U)) << (position * 2));
    }
  }
}
# 373 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_gpio.c"
GPIO_PinState HAL_GPIO_ReadPin(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)
{
...
# 407 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_gpio.c"
void HAL_GPIO_WritePin(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin, GPIO_PinState PinState)
{
...
void HAL_GPIO_TogglePin(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)
{
  ...
  {
    GPIOx->BSRR = (uint32_t)GPIO_Pin << ((uint32_t)16U);
  }
  else
  {
    GPIOx->BSRR = GPIO_Pin;
...
# 455 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_gpio.c"
HAL_StatusTypeDef HAL_GPIO_LockPin(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)
{
