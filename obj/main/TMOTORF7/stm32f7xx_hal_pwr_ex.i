# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr_ex.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr_ex.c"
# 25 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr_ex.c"
...
# 26 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr_ex.c" 2
# 135 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr_ex.c"
HAL_StatusTypeDef HAL_PWREx_EnableBkUpReg(void)
{
  ...
  while(((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CSR1 & ((0x1UL << (3U)))) == ((0x1UL << (3U)))) == RESET)
  {
...
HAL_StatusTypeDef HAL_PWREx_DisableBkUpReg(void)
{
  ...
  ((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CSR1 &= (uint32_t)~((uint32_t)(0x1UL << (9U)));
...
void HAL_PWREx_DisableFlashPowerDown(void)
{
  ...
  ((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1 &= (uint32_t)~((uint32_t)(0x1UL << (9U)));
}
...
void HAL_PWREx_DisableMainRegulatorLowVoltage(void)
{
  ...
  ((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1 &= (uint32_t)~((uint32_t)(0x1UL << (11U)));
}
...
void HAL_PWREx_DisableLowRegulatorLowVoltage(void)
{
  ...
  ((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1 &= (uint32_t)~((uint32_t)(0x1UL << (10U)));
}
# 259 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr_ex.c"
HAL_StatusTypeDef HAL_PWREx_EnableOverDrive(void)
{
  uint32_t tickstart = 0;
  ...
  (((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1 |= (uint32_t)(0x1UL << (16U)));


  tickstart = HAL_GetTick();

  while(!((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CSR1 & ((0x1UL << (16U)))) == ((0x1UL << (16U)))))
  {
    if((HAL_GetTick() - tickstart ) > 1000)
    {
      return HAL_TIMEOUT;
  ...
  (((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1 |= (uint32_t)(0x1UL << (17U)));


  tickstart = HAL_GetTick();

  while(!((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CSR1 & ((0x1UL << (17U)))) == ((0x1UL << (17U)))))
  {
    if((HAL_GetTick() - tickstart ) > 1000)
    {
      return HAL_TIMEOUT;
...
# 305 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr_ex.c"
HAL_StatusTypeDef HAL_PWREx_DisableOverDrive(void)
{
  uint32_t tickstart = 0;
...
# 379 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr_ex.c"
HAL_StatusTypeDef HAL_PWREx_EnterUnderDriveSTOPMode(uint32_t Regulator, uint8_t STOPEntry)
{
  uint32_t tempreg = 0;
  uint32_t tickstart = 0;
  ...
  (((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1 |= (uint32_t)(0x3UL << (18U)));


  tickstart = HAL_GetTick();


  while(((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CSR1 & ((0x3UL << (18U)))) == ((0x3UL << (18U)))))
  {
    if((HAL_GetTick() - tickstart ) > 1000)
    {
      return HAL_TIMEOUT;
  ...
  tempreg = ((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1;

  tempreg &= (uint32_t)~((0x1UL << (1U)) | (0x1UL << (0U)) | (0x1UL << (10U)) | (0x1UL << (11U)));


  tempreg |= Regulator;


  ((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1 = tempreg;
...
uint32_t HAL_PWREx_GetVoltageRange(void)
{
  return (((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1 & (0x3UL << (14U)));
}
# 477 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_pwr_ex.c"
HAL_StatusTypeDef HAL_PWREx_ControlVoltageScaling(uint32_t VoltageScaling)
{
  uint32_t tickstart = 0;
  ...
  if((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->CFGR & (0x3UL << (2U))) != 0x00000008U)
  {
    ...
    do { volatile uint32_t tmpreg; (((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1)) = ((((((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1))) & (~((0x3UL << (14U))))) | ((VoltageScaling))))); tmpreg = ((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR1) & ((0x3UL << (14U)))); ((void)(tmpreg)); } while(0);
    ...
    tickstart = HAL_GetTick();
    while((((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CSR1 & ((0x1UL << (14U)))) == ((0x1UL << (14U)))) == RESET))
    {
      if((HAL_GetTick() - tickstart ) > 1000)
      {
        return HAL_TIMEOUT;
