# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
# 83 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
...
# 84 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c" 2
# 141 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_SetTimeStamp(RTC_HandleTypeDef *hrtc, uint32_t TimeStampEdge, uint32_t RTC_TimeStampPin)
{
  uint32_t tmpreg = 0;
  ...
  hrtc->Instance->OR &= (uint32_t)~(0x3UL << (1U));
...
# 201 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_SetTimeStamp_IT(RTC_HandleTypeDef *hrtc, uint32_t TimeStampEdge, uint32_t RTC_TimeStampPin)
{
  uint32_t tmpreg = 0;
  ...
  ((hrtc)->Instance->ISR) = (~(((0x1UL << (11U))) | (0x1UL << (7U)))|((hrtc)->Instance->ISR & (0x1UL << (7U))));

  ((hrtc)->Instance->CR |= ((0x1UL << (11U))));


  ((hrtc)->Instance->CR |= ((0x1UL << (15U))));
...
# 297 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_SetInternalTimeStamp(RTC_HandleTypeDef *hrtc)
{
...
# 364 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_GetTimeStamp(RTC_HandleTypeDef *hrtc, RTC_TimeTypeDef* sTimeStamp, RTC_DateTypeDef* sTimeStampDate, uint32_t Format)
{
...
# 416 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_SetTamper(RTC_HandleTypeDef *hrtc, RTC_TamperTypeDef* sTamper)
{
  uint32_t tmpreg = 0U;
  ...
  {
    sTamper->NoErase = 0;
    if((sTamper->Tamper & (0x1UL << (0U))) != 0U)
    {
      sTamper->NoErase |= (0x1UL << (17U));
    }
    if((sTamper->Tamper & (0x1UL << (3U))) != 0U)
    {
      sTamper->NoErase |= (0x1UL << (20U));
    }
    if((sTamper->Tamper & (0x1UL << (5U))) != 0U)
    {
      sTamper->NoErase |= (0x1UL << (23U));
    }
  }
  ...
  if(sTamper->MaskFlag != ((uint32_t)0x00000000U))
  {
    ...
    if((sTamper->Tamper & (0x1UL << (0U))) != 0U)
    {
      sTamper->MaskFlag |= (0x1UL << (18U));
    }
    if((sTamper->Tamper & (0x1UL << (3U))) != 0U)
    {
      sTamper->MaskFlag |= (0x1UL << (21U));
    }
    if((sTamper->Tamper & (0x1UL << (5U))) != 0U)
    {
      sTamper->MaskFlag |= (0x1UL << (24U));
    }
  }
  ...
  hrtc->Instance->TAMPCR &= (uint32_t)~((uint32_t)sTamper->Tamper | (uint32_t)(sTamper->Tamper << 1) | (uint32_t)(0x1UL << (7U)) |
                                       (uint32_t)(0x7UL << (8U)) | (uint32_t)(0x3UL << (11U)) | (uint32_t)(0x3UL << (13U)) |
                                       (uint32_t)(0x1UL << (15U)) | (uint32_t)(0x1UL << (2U)) | (uint32_t)(0x1UL << (16U)) |
                                       (uint32_t)(0x1UL << (19U)) | (uint32_t)(0x1UL << (22U)) | (uint32_t)(0x1UL << (17U)) |
                                       (uint32_t)(0x1UL << (20U)) | (uint32_t)(0x1UL << (23U)) | (uint32_t)(0x1UL << (18U)) |
                                       (uint32_t)(0x1UL << (21U)) | (uint32_t)(0x1UL << (24U)));
...
# 504 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_SetTamper_IT(RTC_HandleTypeDef *hrtc, RTC_TamperTypeDef* sTamper)
{
  uint32_t tmpreg = 0;
  ...
  {
    sTamper->NoErase = 0;
    if((sTamper->Tamper & (0x1UL << (0U))) != 0)
    {
      sTamper->NoErase |= (0x1UL << (17U));
    }
    if((sTamper->Tamper & (0x1UL << (3U))) != 0)
    {
      sTamper->NoErase |= (0x1UL << (20U));
    }
    if((sTamper->Tamper & (0x1UL << (5U))) != 0)
    {
      sTamper->NoErase |= (0x1UL << (23U));
    }
  }
  ...
  if(sTamper->Tamper == (0x1UL << (0U)))
  {
    ...
    ((hrtc)->Instance->ISR) = (~(((0x1UL << (13U))) | (0x1UL << (7U)))|((hrtc)->Instance->ISR & (0x1UL << (7U))));
  }
  else if(sTamper->Tamper == (0x1UL << (3U)))
  {

    ((hrtc)->Instance->ISR) = (~(((0x1UL << (14U))) | (0x1UL << (7U)))|((hrtc)->Instance->ISR & (0x1UL << (7U))));
  }
  else
  {

    ((hrtc)->Instance->ISR) = (~(((0x1UL << (15U))) | (0x1UL << (7U)))|((hrtc)->Instance->ISR & (0x1UL << (7U))));
  }
...
# 615 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_DeactivateTamper(RTC_HandleTypeDef *hrtc, uint32_t Tamper)
{
  ((void)0U);
  ...
  if ((Tamper & (0x1UL << (0U))) != 0)
  {

    hrtc->Instance->TAMPCR &= (uint32_t)~((0x1UL << (2U)) | (0x1UL << (16U)));
  }
  if ((Tamper & (0x1UL << (3U))) != 0)
  {

    hrtc->Instance->TAMPCR &= (uint32_t)~((0x1UL << (2U)) | (0x1UL << (19U)));
  }
  if ((Tamper & (0x1UL << (5U))) != 0)
  {

    hrtc->Instance->TAMPCR &= (uint32_t)~((0x1UL << (2U)) | (0x1UL << (22U)));
  }
...
void HAL_RTCEx_TamperTimeStampIRQHandler(RTC_HandleTypeDef *hrtc)
{
  if((((((hrtc)->Instance->ISR) & (((0x1UL << (15U)))>> 4)) != RESET) ? SET : RESET))
  {

    if((uint32_t)(hrtc->Instance->CR & (0x1UL << (15U))) != (uint32_t)RESET)
    {
  ...
  if((((((hrtc)->Instance->ISR) & ((0x1UL << (13U)))) != RESET) ? SET : RESET)== SET)
  {

    if((((hrtc->Instance->TAMPCR & (0x1UL << (2U)))) != (uint32_t)RESET) ||
       (((hrtc->Instance->TAMPCR & (0x1UL << (16U)))) != (uint32_t)RESET))
    {
  ...
  if((((((hrtc)->Instance->ISR) & ((0x1UL << (14U)))) != RESET) ? SET : RESET)== SET)
  {

    if((((hrtc->Instance->TAMPCR & (0x1UL << (2U)))) != (uint32_t)RESET) ||
       (((hrtc->Instance->TAMPCR & (0x1UL << (19U)))) != (uint32_t)RESET))
    {
  ...
  if((((((hrtc)->Instance->ISR) & ((0x1UL << (15U)))) != RESET) ? SET : RESET)== SET)
  {

    if((((hrtc->Instance->TAMPCR & (0x1UL << (2U)))) != (uint32_t)RESET) ||
       (((hrtc->Instance->TAMPCR & (0x1UL << (22U)))) != (uint32_t)RESET))
    {
...
# 810 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_PollForTimeStampEvent(RTC_HandleTypeDef *hrtc, uint32_t Timeout)
{
  ...
  while((((((hrtc)->Instance->ISR) & ((0x1UL << (11U)))) != RESET) ? SET : RESET) == RESET)
  {
  ...
  if((((((hrtc)->Instance->ISR) & ((0x1UL << (12U)))) != RESET) ? SET : RESET) != RESET)
  {

    ((hrtc)->Instance->ISR) = (~(((0x1UL << (12U))) | (0x1UL << (7U)))|((hrtc)->Instance->ISR & (0x1UL << (7U))));
...
# 853 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_PollForTamper1Event(RTC_HandleTypeDef *hrtc, uint32_t Timeout)
{
  ...
  while((((((hrtc)->Instance->ISR) & ((0x1UL << (13U)))) != RESET) ? SET : RESET)== RESET)
  {
    if(Timeout != 0xFFFFFFFFU)
    {
...
# 889 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_PollForTamper2Event(RTC_HandleTypeDef *hrtc, uint32_t Timeout)
{
  uint32_t tickstart = 0;
  ...
  while((((((hrtc)->Instance->ISR) & ((0x1UL << (14U)))) != RESET) ? SET : RESET) == RESET)
  {
    if(Timeout != 0xFFFFFFFFU)
    {
      if((Timeout == 0)||((HAL_GetTick() - tickstart ) > Timeout))
...
HAL_StatusTypeDef HAL_RTCEx_PollForTamper3Event(RTC_HandleTypeDef *hrtc, uint32_t Timeout)
{
  ...
  while((((((hrtc)->Instance->ISR) & ((0x1UL << (15U)))) != RESET) ? SET : RESET) == RESET)
  {
    if(Timeout != 0xFFFFFFFFU)
    {
      if((Timeout == 0)||((HAL_GetTick() - tickstart ) > Timeout))
...
# 976 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_SetWakeUpTimer(RTC_HandleTypeDef *hrtc, uint32_t WakeUpCounter, uint32_t WakeUpClock)
{
  uint32_t tickstart = 0;
  ...
  if((hrtc->Instance->CR & (0x1UL << (10U))) != RESET)
  {
    ...
    while((((((hrtc)->Instance->ISR) & ((0x1UL << (2U)))) != RESET) ? SET : RESET) == RESET)
    {
...
# 1049 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_SetWakeUpTimer_IT(RTC_HandleTypeDef *hrtc, uint32_t WakeUpCounter, uint32_t WakeUpClock)
{
  ...
  if((hrtc->Instance->CR & (0x1UL << (10U))) != RESET)
  {
    ...
    count = 1000U * (SystemCoreClock / 32U / 1000U);
    do
    {
      if(count-- == 0U)
      {
    ...
    while((((((hrtc)->Instance->ISR) & ((0x1UL << (2U)))) != RESET) ? SET : RESET) == SET);
  }
  ...
  ((hrtc)->Instance->ISR) = (~(((0x1UL << (10U))) | (0x1UL << (7U)))|((hrtc)->Instance->ISR & (0x1UL << (7U))));


  ((hrtc)->Instance->CR |= ((0x1UL << (14U))));
...
void HAL_RTCEx_WakeUpTimerIRQHandler(RTC_HandleTypeDef *hrtc)
{
  if((((((hrtc)->Instance->ISR) & (((0x1UL << (14U)))>> 4)) != RESET) ? SET : RESET))
  {

    if((uint32_t)(hrtc->Instance->CR & (0x1UL << (14U))) != (uint32_t)RESET)
    {
...
# 1267 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_PollForWakeUpTimerEvent(RTC_HandleTypeDef *hrtc, uint32_t Timeout)
{
  uint32_t tickstart = 0;
  ...
  while((((((hrtc)->Instance->ISR) & ((0x1UL << (10U)))) != RESET) ? SET : RESET) == RESET)
  {
    if(Timeout != 0xFFFFFFFFU)
    {
      if((Timeout == 0)||((HAL_GetTick() - tickstart ) > Timeout))
...
# 1337 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
void HAL_RTCEx_BKUPWrite(RTC_HandleTypeDef *hrtc, uint32_t BackupRegister, uint32_t Data)
{
  uint32_t tmp = 0;
...
# 1360 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
uint32_t HAL_RTCEx_BKUPRead(RTC_HandleTypeDef *hrtc, uint32_t BackupRegister)
{
  uint32_t tmp = 0;
...
# 1394 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_SetSmoothCalib(RTC_HandleTypeDef* hrtc, uint32_t SmoothCalibPeriod, uint32_t SmoothCalibPlusPulses, uint32_t SmouthCalibMinusPulsesValue)
{
  uint32_t tickstart = 0;
...
# 1464 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_SetSynchroShift(RTC_HandleTypeDef* hrtc, uint32_t ShiftAdd1S, uint32_t ShiftSubFS)
{
  uint32_t tickstart = 0;
...
# 1559 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_SetCalibrationOutPut(RTC_HandleTypeDef* hrtc, uint32_t CalibOutput)
{
...
# 1730 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_EnableBypassShadow(RTC_HandleTypeDef* hrtc)
{
...
# 1763 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_DisableBypassShadow(RTC_HandleTypeDef* hrtc)
{
...
# 1813 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
...
# 1830 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_rtc_ex.c"
HAL_StatusTypeDef HAL_RTCEx_PollForAlarmBEvent(RTC_HandleTypeDef *hrtc, uint32_t Timeout)
{
  uint32_t tickstart = 0;
  ...
  while((((((hrtc)->Instance->ISR) & ((0x1UL << (9U)))) != RESET)? SET : RESET) == RESET)
  {
    if(Timeout != 0xFFFFFFFFU)
    {
      if((Timeout == 0)||((HAL_GetTick() - tickstart ) > Timeout))
  ...
  ((hrtc)->Instance->ISR) = (~((((0x1UL << (9U))) | (0x1UL << (7U)))& 0x0000FFFFU)|((hrtc)->Instance->ISR & (0x1UL << (7U))));
