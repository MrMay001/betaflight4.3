# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
# 21 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
...
# 22 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c" 2
# 88 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
USBD_StatusTypeDef USBD_Init(USBD_HandleTypeDef *pdev, USBD_DescriptorsTypeDef *pdesc, uint8_t id)
{

  if(pdev == 
# 91 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c" 3 4
            ((void *)0)
# 91 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
                )
  {
  ...
  if(pdev->pClass != 
# 100 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c" 3 4
                    ((void *)0)
# 100 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
                        )
  {
    pdev->pClass = 
# 102 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c" 3 4
                  ((void *)0)
# 102 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
                      ;
  }


  if(pdesc != 
# 106 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c" 3 4
             ((void *)0)
# 106 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
                 )
  {
    pdev->pDesc = pdesc;
  }
...
# 150 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
USBD_StatusTypeDef USBD_RegisterClass(USBD_HandleTypeDef *pdev, USBD_ClassTypeDef *pclass)
{
...
# 224 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
USBD_StatusTypeDef USBD_SetClassConfig(USBD_HandleTypeDef *pdev, uint8_t cfgidx)
{
  USBD_StatusTypeDef ret = USBD_FAIL;

  if(pdev->pClass != 
# 228 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c" 3 4
                    ((void *)0)
# 228 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
                        )
  {
...
# 247 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
USBD_StatusTypeDef USBD_ClrClassConfig(USBD_HandleTypeDef *pdev, uint8_t cfgidx)
{
...
# 261 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
USBD_StatusTypeDef USBD_LL_SetupStage(USBD_HandleTypeDef *pdev, uint8_t *psetup)
{
...
# 298 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
    ...
    if ( pdev->ep0_state == 0x03U)
    {
      if(pep->rem_length > pep->maxpacket)
      {
        ...
        USBD_CtlContinueRx (pdev,
                            pdata,
                            (uint16_t)__extension__ ({ __typeof__ (pep->rem_length) _a = (pep->rem_length); __typeof__ (pep->maxpacket) _b = (pep->maxpacket); _a < _b ? _a : _b; }));
      }
      else
      {
        if((pdev->pClass->EP0_RxReady != 
# 319 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c" 3 4
                                        ((void *)0)
# 319 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
                                            )&&
...
# 339 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c" 3 4
                                   ((void *)0)
# 339 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
                                       ) &&
          (pdev->dev_state == 0x03U))
  {
...
# 360 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
  ...
  if(epnum == 0U)
  {
    ...
    if ( pdev->ep0_state == 0x02U)
    {
      if(pep->rem_length > pep->maxpacket)
      {
        ...
        USBD_LL_PrepareReceive (pdev, 0U, 
# 378 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c" 3 4
                                         ((void *)0)
# 378 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
                                             , 0U);
      }
      else
      {
...
# 386 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c" 3 4
                                        ((void *)0)
# 386 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
                                            , 0U);
          pdev->ep0_data_len = 0U;


          USBD_LL_PrepareReceive (pdev, 0U, 
# 390 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c" 3 4
                                           ((void *)0)
# 390 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
                                               , 0U);
        }
        else
        {
          if((pdev->pClass->EP0_TxSent != 
# 394 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c" 3 4
                                         ((void *)0)
# 394 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
                                             )&&
             (pdev->dev_state == 0x03U))
          {
...
# 419 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c" 3 4
                                  ((void *)0)
# 419 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
                                      ) &&
          (pdev->dev_state == 0x03U))
  {
...
# 440 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
USBD_StatusTypeDef USBD_LL_Reset(USBD_HandleTypeDef *pdev)
{

  USBD_LL_OpenEP(pdev, 0x00U, 0x00U, 64U);
  pdev->ep_out[0x00U & 0xFU].is_used = 1U;

  pdev->ep_out[0].maxpacket = 64U;


  USBD_LL_OpenEP(pdev, 0x80U, 0x00U, 64U);
...
# 486 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
USBD_StatusTypeDef USBD_LL_Suspend(USBD_HandleTypeDef *pdev)
{
...
# 500 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
USBD_StatusTypeDef USBD_LL_Resume(USBD_HandleTypeDef *pdev)
{
  pdev->dev_state = pdev->dev_old_state;
  return USBD_OK;
}
# 513 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
USBD_StatusTypeDef USBD_LL_SOF(USBD_HandleTypeDef *pdev)
{
  if(pdev->dev_state == 0x03U)
  {
    if(pdev->pClass->SOF != 
# 517 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c" 3 4
                           ((void *)0)
# 517 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
                               )
    {
