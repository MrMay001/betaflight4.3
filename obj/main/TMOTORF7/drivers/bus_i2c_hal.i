# 1 "./src/main/drivers/bus_i2c_hal.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/bus_i2c_hal.c"
# 21 "./src/main/drivers/bus_i2c_hal.c"
# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include/stdbool.h" 1 3 4
# 22 "./src/main/drivers/bus_i2c_hal.c" 2
...
# 23 "./src/main/drivers/bus_i2c_hal.c" 2
...
# 24 "./src/main/drivers/bus_i2c_hal.c" 2
...
# 153 "./src/main/platform.h" 2
# 26 "./src/main/drivers/bus_i2c_hal.c" 2
...
# 30 "./src/main/drivers/bus_i2c_hal.c" 2
...
# 31 "./src/main/drivers/bus_i2c_hal.c" 2
# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 32 "./src/main/drivers/bus_i2c_hal.c" 2
...
# 33 "./src/main/drivers/bus_i2c_hal.c" 2
...
# 34 "./src/main/drivers/bus_i2c_hal.c" 2
...
# 36 "./src/main/drivers/bus_i2c_hal.c" 2
# 1 "./src/main/drivers/bus_i2c_impl.h" 1
# 21 "./src/main/drivers/bus_i2c_impl.h"
       
# 33 "./src/main/drivers/bus_i2c_impl.h"
...
# 76 "./src/main/drivers/bus_i2c_impl.h"
...
# 85 "./src/main/drivers/bus_i2c_impl.h" 3 4
   _Bool 
# 85 "./src/main/drivers/bus_i2c_impl.h"
        pullUp;
    uint16_t clockSpeed;
...
# 37 "./src/main/drivers/bus_i2c_hal.c" 2
# 51 "./src/main/drivers/bus_i2c_hal.c"
...
# 86 "./src/main/drivers/bus_i2c_hal.c"
static volatile uint16_t i2cErrorCount = 0;

static 
# 88 "./src/main/drivers/bus_i2c_hal.c" 3 4
      _Bool 
# 88 "./src/main/drivers/bus_i2c_hal.c"
           i2cHandleHardwareFailure(I2CDevice device)
{
    ...
    return 
# 94 "./src/main/drivers/bus_i2c_hal.c" 3 4
          0
# 94 "./src/main/drivers/bus_i2c_hal.c"
               ;
}
...
# 103 "./src/main/drivers/bus_i2c_hal.c" 3 4
_Bool 
# 103 "./src/main/drivers/bus_i2c_hal.c"
    i2cWrite(I2CDevice device, uint8_t addr_, uint8_t reg_, uint8_t data)
{
    if (device == I2CINVALID || device >= 4) {
        return 
# 106 "./src/main/drivers/bus_i2c_hal.c" 3 4
              0
# 106 "./src/main/drivers/bus_i2c_hal.c"
                   ;
    }
    ...
    if (!pHandle->Instance) {
        return 
# 112 "./src/main/drivers/bus_i2c_hal.c" 3 4
              0
# 112 "./src/main/drivers/bus_i2c_hal.c"
                   ;
    }
    ...
    if (reg_ == 0xFF)
        status = HAL_I2C_Master_Transmit(pHandle ,addr_ << 1, &data, 1, (10000 / 1000));
    else
        status = HAL_I2C_Mem_Write(pHandle ,addr_ << 1, reg_, (0x00000001U), &data, 1, (10000 / 1000));

    if (status != HAL_OK)
        return i2cHandleHardwareFailure(device);

    return 
# 125 "./src/main/drivers/bus_i2c_hal.c" 3 4
          1
# 125 "./src/main/drivers/bus_i2c_hal.c"
              ;
}



# 129 "./src/main/drivers/bus_i2c_hal.c" 3 4
_Bool 
# 129 "./src/main/drivers/bus_i2c_hal.c"
    i2cWriteBuffer(I2CDevice device, uint8_t addr_, uint8_t reg_, uint8_t len_, uint8_t *data)
{
    if (device == I2CINVALID || device >= 4) {
        return 
# 132 "./src/main/drivers/bus_i2c_hal.c" 3 4
              0
# 132 "./src/main/drivers/bus_i2c_hal.c"
                   ;
    }
    ...
    if (!pHandle->Instance) {
        return 
# 138 "./src/main/drivers/bus_i2c_hal.c" 3 4
              0
# 138 "./src/main/drivers/bus_i2c_hal.c"
                   ;
    }

    HAL_StatusTypeDef status;

    status = HAL_I2C_Mem_Write_IT(pHandle ,addr_ << 1, reg_, (0x00000001U),data, len_);

    if (status == HAL_BUSY) {
        return 
# 146 "./src/main/drivers/bus_i2c_hal.c" 3 4
              0
# 146 "./src/main/drivers/bus_i2c_hal.c"
                   ;
    }
    ...
    return 
# 154 "./src/main/drivers/bus_i2c_hal.c" 3 4
          1
# 154 "./src/main/drivers/bus_i2c_hal.c"
              ;
}



# 158 "./src/main/drivers/bus_i2c_hal.c" 3 4
_Bool 
# 158 "./src/main/drivers/bus_i2c_hal.c"
    i2cRead(I2CDevice device, uint8_t addr_, uint8_t reg_, uint8_t len, uint8_t* buf)
{
    if (device == I2CINVALID || device >= 4) {
        return 
# 161 "./src/main/drivers/bus_i2c_hal.c" 3 4
              0
# 161 "./src/main/drivers/bus_i2c_hal.c"
                   ;
    }
    ...
    if (!pHandle->Instance) {
        return 
# 167 "./src/main/drivers/bus_i2c_hal.c" 3 4
              0
# 167 "./src/main/drivers/bus_i2c_hal.c"
                   ;
    }
    ...
    if (reg_ == 0xFF)
        status = HAL_I2C_Master_Receive(pHandle ,addr_ << 1, buf, len, (10000 / 1000));
    else
        status = HAL_I2C_Mem_Read(pHandle, addr_ << 1, reg_, (0x00000001U),buf, len, (10000 / 1000));
    ...
    return 
# 181 "./src/main/drivers/bus_i2c_hal.c" 3 4
          1
# 181 "./src/main/drivers/bus_i2c_hal.c"
              ;
}



# 185 "./src/main/drivers/bus_i2c_hal.c" 3 4
_Bool 
# 185 "./src/main/drivers/bus_i2c_hal.c"
    i2cReadBuffer(I2CDevice device, uint8_t addr_, uint8_t reg_, uint8_t len, uint8_t* buf)
{
    if (device == I2CINVALID || device >= 4) {
        return 
# 188 "./src/main/drivers/bus_i2c_hal.c" 3 4
              0
# 188 "./src/main/drivers/bus_i2c_hal.c"
                   ;
    }
    ...
    if (!pHandle->Instance) {
        return 
# 194 "./src/main/drivers/bus_i2c_hal.c" 3 4
              0
# 194 "./src/main/drivers/bus_i2c_hal.c"
                   ;
    }

    HAL_StatusTypeDef status;

    status = HAL_I2C_Mem_Read_IT(pHandle, addr_ << 1, reg_, (0x00000001U),buf, len);

    if (status == HAL_BUSY) {
        return 
# 202 "./src/main/drivers/bus_i2c_hal.c" 3 4
              0
# 202 "./src/main/drivers/bus_i2c_hal.c"
                   ;
    }
    ...
    return 
# 209 "./src/main/drivers/bus_i2c_hal.c" 3 4
          1
# 209 "./src/main/drivers/bus_i2c_hal.c"
              ;
}


# 212 "./src/main/drivers/bus_i2c_hal.c" 3 4
_Bool 
# 212 "./src/main/drivers/bus_i2c_hal.c"
    i2cBusy(I2CDevice device, 
# 212 "./src/main/drivers/bus_i2c_hal.c" 3 4
                              _Bool 
# 212 "./src/main/drivers/bus_i2c_hal.c"
                                   *error)
{
    ...
    {
        if ((((((pHandle)->Instance->ISR) & ((0x1UL << (15U)))) == ((0x1UL << (15U)))) ? SET : RESET) == SET)
        {
            return 
# 224 "./src/main/drivers/bus_i2c_hal.c" 3 4
                  1
# 224 "./src/main/drivers/bus_i2c_hal.c"
                      ;
        }

        return 
# 227 "./src/main/drivers/bus_i2c_hal.c" 3 4
              0
# 227 "./src/main/drivers/bus_i2c_hal.c"
                   ;
    }

    return 
# 230 "./src/main/drivers/bus_i2c_hal.c" 3 4
          1
# 230 "./src/main/drivers/bus_i2c_hal.c"
              ;
}
