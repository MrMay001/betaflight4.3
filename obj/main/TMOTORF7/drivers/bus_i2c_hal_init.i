# 1 "./src/main/drivers/bus_i2c_hal_init.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/bus_i2c_hal_init.c"
# 21 "./src/main/drivers/bus_i2c_hal_init.c"
# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include/stdbool.h" 1 3 4
# 22 "./src/main/drivers/bus_i2c_hal_init.c" 2
...
# 23 "./src/main/drivers/bus_i2c_hal_init.c" 2
...
# 24 "./src/main/drivers/bus_i2c_hal_init.c" 2
...
# 153 "./src/main/platform.h" 2
# 26 "./src/main/drivers/bus_i2c_hal_init.c" 2
...
# 30 "./src/main/drivers/bus_i2c_hal_init.c" 2
...
# 31 "./src/main/drivers/bus_i2c_hal_init.c" 2
# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 32 "./src/main/drivers/bus_i2c_hal_init.c" 2
...
# 33 "./src/main/drivers/bus_i2c_hal_init.c" 2
...
# 34 "./src/main/drivers/bus_i2c_hal_init.c" 2
...
# 36 "./src/main/drivers/bus_i2c_hal_init.c" 2
...
# 37 "./src/main/drivers/bus_i2c_hal_init.c" 2
# 1 "./src/main/drivers/bus_i2c_timing.h" 1
# 21 "./src/main/drivers/bus_i2c_timing.h"
       

uint32_t i2cClockTIMINGR(uint32_t pclkFreq, int i2cFreqKhz, int dfcoeff);
# 38 "./src/main/drivers/bus_i2c_hal_init.c" 2
# 50 "./src/main/drivers/bus_i2c_hal_init.c"
...
const i2cHardware_t i2cHardware[4] = {
# 71 "./src/main/drivers/bus_i2c_hal_init.c"
    {
        .device = I2CDEV_2,
        .reg = ((I2C_TypeDef *) (0x40000000UL + 0x5800UL)),
        .sclPins = { { ((ioTag_t)((((1) + 1) << 4) | (10))) }, { 0 } },
        .sdaPins = { { ((ioTag_t)((((1) + 1) << 4) | (11))) }, { 0 } },
        .rcc = (((RCC_APB1) << 5) | (16*(((0x1UL << (22U)))>65535L) + (8*((((0x1UL << (22U)))*1L >>16*(((0x1UL << (22U)))>65535L))>255) + (8 - 90/((((((0x1UL << (22U)))*1L >>16*(((0x1UL << (22U)))>65535L)) >>8*((((0x1UL << (22U)))*1L >>16*(((0x1UL << (22U)))>65535L))>255))/4+14)|1) - 2/(((((0x1UL << (22U)))*1L >>16*(((0x1UL << (22U)))>65535L)) >>8*((((0x1UL << (22U)))*1L >>16*(((0x1UL << (22U)))>65535L))>255))/2+1))))),
        .ev_irq = I2C2_EV_IRQn,
        .er_irq = I2C2_ER_IRQn,
    },
# 202 "./src/main/drivers/bus_i2c_hal_init.c"
};

i2cDevice_t i2cDevice[4];
...
void i2cInit(I2CDevice device)
{
    ...
    IOConfigGPIOAF(scl, pDev->pullUp ? ((((uint32_t)0x00000012U)) | ((((uint32_t)0x00000003U)) << 2) | ((((uint32_t)0x00000001U)) << 5)) : ((((uint32_t)0x00000012U)) | ((((uint32_t)0x00000003U)) << 2) | ((((uint32_t)0x00000000U)) << 5)), ((uint8_t)0x04U));
    IOConfigGPIOAF(sda, pDev->pullUp ? ((((uint32_t)0x00000012U)) | ((((uint32_t)0x00000003U)) << 2) | ((((uint32_t)0x00000001U)) << 5)) : ((((uint32_t)0x00000012U)) | ((((uint32_t)0x00000003U)) << 2) | ((((uint32_t)0x00000000U)) << 5)), ((uint8_t)0x04U));
# 244 "./src/main/drivers/bus_i2c_hal_init.c"
...
# 269 "./src/main/drivers/bus_i2c_hal_init.c"
    pHandle->Init.Timing = i2cClockTIMINGR(i2cPclk, pDev->clockSpeed, 0);

    pHandle->Init.OwnAddress1 = 0x0;
    pHandle->Init.AddressingMode = (0x00000001U);
    pHandle->Init.DualAddressMode = (0x00000000U);
    pHandle->Init.OwnAddress2 = 0x0;
    pHandle->Init.GeneralCallMode = (0x00000000U);
    pHandle->Init.NoStretchMode = (0x00000000U);

    HAL_I2C_Init(pHandle);


    HAL_I2CEx_ConfigAnalogFilter(pHandle, 0x00000000U);


    HAL_NVIC_SetPriority(hardware->er_irq, ((((((((0)<<(4-(7-(((uint32_t)0x00000005U)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005U))))))<<4)&0xf0))>>(4-(7-(((uint32_t)0x00000005U)))))>>4), ((((((((0)<<(4-(7-(((uint32_t)0x00000005U)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005U))))))<<4)&0xf0))&(0x0f>>(7-(((uint32_t)0x00000005U)))))>>4));
    HAL_NVIC_EnableIRQ(hardware->er_irq);
    HAL_NVIC_SetPriority(hardware->ev_irq, ((((((((0)<<(4-(7-(((uint32_t)0x00000005U)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005U))))))<<4)&0xf0))>>(4-(7-(((uint32_t)0x00000005U)))))>>4), ((((((((0)<<(4-(7-(((uint32_t)0x00000005U)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005U))))))<<4)&0xf0))&(0x0f>>(7-(((uint32_t)0x00000005U)))))>>4));
...
static void i2cUnstick(IO_t scl, IO_t sda)
{
    ...
    IOConfigGPIO(scl, ((((uint32_t)0x00000011U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000000U)) << 5)));
    IOConfigGPIO(sda, ((((uint32_t)0x00000011U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000000U)) << 5)));
