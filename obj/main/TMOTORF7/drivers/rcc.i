...
# 56 "./src/main/drivers/rcc.c"
    switch (tag) {
    case RCC_AHB1:
        if (NewState == ENABLE) { do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) |= (mask)); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) & (mask)); ((void)(tmpreg)); } while(0); } else { (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR &= ~(mask)); };
        break;

    case RCC_AHB2:
        if (NewState == ENABLE) { do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2ENR) |= (mask)); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2ENR) & (mask)); ((void)(tmpreg)); } while(0); } else { (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2ENR &= ~(mask)); };
        break;


    case RCC_APB1:
        if (NewState == ENABLE) { do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) |= (mask)); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) & (mask)); ((void)(tmpreg)); } while(0); } else { (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR &= ~(mask)); };
        break;


    case RCC_APB2:
        if (NewState == ENABLE) { do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR) |= (mask)); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR) & (mask)); ((void)(tmpreg)); } while(0); } else { (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR &= ~(mask)); };
        break;
# 113 "./src/main/drivers/rcc.c"
    }
# 134 "./src/main/drivers/rcc.c"
}
...
void RCC_ResetCmd(rccPeriphTag_t periphTag, FunctionalState NewState)
{
    int tag = periphTag >> 5;
    uint32_t mask = 1 << (periphTag & 0x1f);
# 154 "./src/main/drivers/rcc.c"
    switch (tag) {
    case RCC_AHB1:
        if (NewState == ENABLE) { (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1RSTR &= ~(mask)); } else { (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1RSTR |= (mask)); };
        break;

    case RCC_AHB2:
        if (NewState == ENABLE) { (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2RSTR &= ~(mask)); } else { (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2RSTR |= (mask)); };
        break;


    case RCC_APB1:
        if (NewState == ENABLE) { (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1RSTR &= ~(mask)); } else { (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1RSTR |= (mask)); };
        break;


    case RCC_APB2:
        if (NewState == ENABLE) { (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2RSTR &= ~(mask)); } else { (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2RSTR |= (mask)); };
        break;
# 211 "./src/main/drivers/rcc.c"
    }
# 234 "./src/main/drivers/rcc.c"
}
