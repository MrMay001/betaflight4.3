...
extern void pgResetFn_cameraControlConfig(cameraControlConfig_t *); cameraControlConfig_t cameraControlConfig_System; cameraControlConfig_t cameraControlConfig_Copy; uint32_t cameraControlConfig_fnv_hash; extern const pgRegistry_t cameraControlConfig_Registry; const pgRegistry_t cameraControlConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 522 | (0 << 12), .length = 1, .size = sizeof(cameraControlConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&cameraControlConfig_System, .fnv_hash = &cameraControlConfig_fnv_hash, .copy = (uint8_t*)&cameraControlConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_cameraControlConfig }, };
...
void cameraControlInit(void)
{
    ...
    if (CAMERA_CONTROL_MODE_HARDWARE_PWM == cameraControlConfig()->mode) {
        ...
        if (!timerHardware) {
            ...
            IOConfigGPIOAF(cameraControlRuntime.io, ((((uint32_t)0x00000002U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000000U)) << 5)), timerHardware->alternateFunction);
