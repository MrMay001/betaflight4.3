# 1 "./src/main/drivers/dshot_bitbang_ll.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/dshot_bitbang_ll.c"
# 21 "./src/main/drivers/dshot_bitbang_ll.c"
...
# 22 "./src/main/drivers/dshot_bitbang_ll.c" 2
...
# 23 "./src/main/drivers/dshot_bitbang_ll.c" 2
...
# 24 "./src/main/drivers/dshot_bitbang_ll.c" 2
...
# 153 "./src/main/platform.h" 2
# 26 "./src/main/drivers/dshot_bitbang_ll.c" 2
...
# 30 "./src/main/drivers/dshot_bitbang_ll.c" 2
...
# 31 "./src/main/drivers/dshot_bitbang_ll.c" 2
...
# 33 "./src/main/drivers/dshot_bitbang_ll.c" 2
...
# 34 "./src/main/drivers/dshot_bitbang_ll.c" 2
...
# 35 "./src/main/drivers/dshot_bitbang_ll.c" 2
...
# 36 "./src/main/drivers/dshot_bitbang_ll.c" 2
...
# 37 "./src/main/drivers/dshot_bitbang_ll.c" 2
...
# 38 "./src/main/drivers/dshot_bitbang_ll.c" 2
...
# 39 "./src/main/drivers/dshot_bitbang_ll.c" 2

# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 41 "./src/main/drivers/dshot_bitbang_ll.c" 2
...
# 79 "./src/main/drivers/pwm_output.h"
    pwmIsSynced(void);
# 42 "./src/main/drivers/dshot_bitbang_ll.c" 2
...
# 43 "./src/main/drivers/dshot_bitbang_ll.c" 2
...
void bbGpioSetup(bbMotor_t *bbMotor)
{
    ...
    bbPort->gpioModeMask |= ((0x3UL << (0U)) << (pinIndex * 2));

    bbPort->gpioModeInput |= ((0x00000000U) << (pinIndex * 2));
    bbPort->gpioModeOutput |= ((0x1UL << (0U)) << (pinIndex * 2));
    ...
    IOConfigGPIO(bbMotor->io, ((((uint32_t)0x00000001U)) | ((((uint32_t)0x00000002U)) << 2) | ((bbPuPdMode) << 5)));
...
void bbTimerChannelInit(bbPort_t *bbPort)
{
    ...
    case 0x00000000U: bbPort->llChannel = (0x1UL << (0U)); break;
    case 0x00000004U: bbPort->llChannel = (0x1UL << (4U)); break;
    case 0x00000008U: bbPort->llChannel = (0x1UL << (8U)); break;
    case 0x0000000CU: bbPort->llChannel = (0x1UL << (12U)); break;
    }

    LL_TIM_OC_InitTypeDef ocInit;
    LL_TIM_OC_StructInit(&ocInit);
    ocInit.OCMode = ((0x0004UL << (4U)) | (0x0002UL << (4U)));
    ocInit.OCIdleState = (0x1UL << (8U));
    ocInit.OCState = (0x1UL << (0U));
    ocInit.OCPolarity = (0x1UL << (1U));
    ...
    if (timhw->tag) {
        ...
        IOConfigGPIOAF(io, ((((uint32_t)0x00000002U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000000U)) << 5)), timhw->alternateFunction);
...
# 148 "./src/main/drivers/dshot_bitbang_ll.c"
}
...
# 166 "./src/main/drivers/dshot_bitbang_ll.c"
}
...
# 202 "./src/main/drivers/dshot_bitbang_ll.c"
...
void bbSwitchToInput(bbPort_t *bbPort)
{
    ...
    for ( uint8_t __basepri_save __attribute__ ((__cleanup__ (__basepriRestoreMem), __unused__)) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((1)<<(4-(7-(((uint32_t)0x00000005U)))))|((1)&(0x0f>>(7-(((uint32_t)0x00000005U))))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
        (((bbPort->gpio->MODER)) = ((((((bbPort->gpio->MODER))) & (~(bbPort->gpioModeMask))) | (bbPort->gpioModeInput))));
    }
...
# 234 "./src/main/drivers/dshot_bitbang_ll.c"
...
void bbDMAPreconfigure(bbPort_t *bbPort, uint8_t direction)
{
    LL_DMA_InitTypeDef *dmainit = (direction == 0) ? &bbPort->outputDmaInit : &bbPort->inputDmaInit;

    LL_DMA_StructInit(dmainit);

    dmainit->Mode = 0x00000000U;



    dmainit->Channel = bbPort->dmaChannel;
    dmainit->FIFOMode = (0x1UL << (2U)) ;


    dmainit->PeriphOrM2MSrcIncMode = 0x00000000U;
    dmainit->MemoryOrM2MDstIncMode = (0x1UL << (10U));

    if (direction == 0) {
        dmainit->Priority = (0x3UL << (16U));
        dmainit->Direction = (0x1UL << (6U));
        dmainit->NbData = bbPort->portOutputCount;
        dmainit->PeriphOrM2MSrcAddress = (uint32_t)&bbPort->gpio->BSRR;
        dmainit->PeriphOrM2MSrcDataSize = (0x2UL << (11U));
        dmainit->MemoryOrM2MDstAddress = (uint32_t)bbPort->portOutputBuffer;
        dmainit->MemoryOrM2MDstDataSize = (0x2UL << (13U));


        LL_EX_DMA_Init((DMA_Stream_TypeDef *)(bbPort->dmaResource), dmainit);
        bbSaveDMARegs(bbPort->dmaResource, &bbPort->dmaRegOutput);

    } else {
        dmainit->Priority = (0x2UL << (16U));
        dmainit->Direction = 0x00000000U;
        dmainit->NbData = bbPort->portInputCount;

        dmainit->PeriphOrM2MSrcAddress = (uint32_t)&bbPort->gpio->IDR;
        dmainit->PeriphOrM2MSrcDataSize = (0x1UL << (11U));
...
void bbTIM_TimeBaseInit(bbPort_t *bbPort, uint16_t period)
{
    ...
    (((bbPort->timhw->tim->CR1)) = ((((((bbPort->timhw->tim->CR1))) & (~((0x1UL << (7U))))) | ((0x1UL << (7U))))));
}
...
void bbDMA_ITConfig(bbPort_t *bbPort)
{
    ...
    LL_EX_DMA_EnableIT_TC((DMA_Stream_TypeDef *)(bbPort->dmaResource));




    ((((DMA_Stream_TypeDef *)(bbPort->dmaResource))->CR) |= ((0x1UL << (4U))|(0x1UL << (2U))));
...
void bbDMA_Cmd(bbPort_t *bbPort, FunctionalState NewState)
{
    ...
    if (NewState == ENABLE) {
        LL_EX_DMA_EnableResource((DMA_Stream_TypeDef *)(bbPort->dmaResource));
    } else {
        LL_EX_DMA_DisableResource((DMA_Stream_TypeDef *)(bbPort->dmaResource));
    }
}

int bbDMA_Count(bbPort_t *bbPort)
{
    return LL_EX_DMA_GetDataLength((DMA_Stream_TypeDef *)(bbPort->dmaResource));
}
