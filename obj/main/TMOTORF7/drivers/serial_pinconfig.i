...
# 34 "./src/main/drivers/serial_pinconfig.c" 2

# 1 "./src/main/pg/pg_ids.h" 1
# 21 "./src/main/pg/pg_ids.h"
       
# 36 "./src/main/drivers/serial_pinconfig.c" 2
# 263 "./src/main/drivers/serial_pinconfig.c"
...
static const serialDefaultPin_t serialDefaultPin[] = {
    ...
    { SERIAL_PORT_USART3, ((ioTag_t)((((2) + 1) << 4) | (11))), ((ioTag_t)((((2) + 1) << 4) | (10))), 0 },


    { SERIAL_PORT_UART4, ((ioTag_t)((((0) + 1) << 4) | (1))), ((ioTag_t)((((0) + 1) << 4) | (0))), 0 },


    { SERIAL_PORT_UART5, ((ioTag_t)((((3) + 1) << 4) | (2))), ((ioTag_t)((((2) + 1) << 4) | (12))), 0 },
# 308 "./src/main/drivers/serial_pinconfig.c"
};

extern void pgResetFn_serialPinConfig(serialPinConfig_t *); serialPinConfig_t serialPinConfig_System; serialPinConfig_t serialPinConfig_Copy; uint32_t serialPinConfig_fnv_hash; extern const pgRegistry_t serialPinConfig_Registry; const pgRegistry_t serialPinConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 509 | (0 << 12), .length = 1, .size = sizeof(serialPinConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&serialPinConfig_System, .fnv_hash = &serialPinConfig_fnv_hash, .copy = (uint8_t*)&serialPinConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_serialPinConfig }, };
...
void pgResetFn_serialPinConfig(serialPinConfig_t *serialPinConfig)
{
    for (size_t index = 0 ; index < (sizeof(serialDefaultPin) / sizeof((serialDefaultPin)[0])) ; index++) {
        ...
        serialPinConfig->ioTagRx[(((defpin->ident) < 10) ? (defpin->ident) : (10 + ((defpin->ident) - SERIAL_PORT_SOFTSERIAL1)))] = defpin->rxIO;
        serialPinConfig->ioTagTx[(((defpin->ident) < 10) ? (defpin->ident) : (10 + ((defpin->ident) - SERIAL_PORT_SOFTSERIAL1)))] = defpin->txIO;
        serialPinConfig->ioTagInverter[(((defpin->ident) < 10) ? (defpin->ident) : (10 + ((defpin->ident) - SERIAL_PORT_SOFTSERIAL1)))] = defpin->inverterIO;
    }
}
