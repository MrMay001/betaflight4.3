...
_Static_assert((sizeof(bmp280_calib_param_t) == (24)), "bmp280_calibration_structure_incorrectly_packed");
...
int32_t bmp280_up = 0;
int32_t bmp280_ut = 0;
static __attribute__ ((section(".fastram_bss"), aligned(4))) uint8_t sensor_data[(6)];

static void bmp280StartUT(baroDev_t *baro);
static 
# 113 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
      _Bool 
# 113 "./src/main/drivers/barometer/barometer_bmp280.c"
           bmp280ReadUT(baroDev_t *baro);
static 
# 114 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
      _Bool 
# 114 "./src/main/drivers/barometer/barometer_bmp280.c"
           bmp280GetUT(baroDev_t *baro);
static void bmp280StartUP(baroDev_t *baro);
static 
# 116 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
      _Bool 
# 116 "./src/main/drivers/barometer/barometer_bmp280.c"
           bmp280ReadUP(baroDev_t *baro);
static 
# 117 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
      _Bool 
# 117 "./src/main/drivers/barometer/barometer_bmp280.c"
           bmp280GetUP(baroDev_t *baro);

static void bmp280Calculate(int32_t *pressure, int32_t *temperature);
...
void bmp280BusInit(const extDevice_t *dev)
{
    ...
    if (dev->bus->busType == BUS_TYPE_SPI) {
        ...
        IOConfigGPIO(dev->busType_u.spi.csnPin, ((((uint32_t)0x00000001U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000000U)) << 5)));
        spiSetClkDivisor(dev, spiCalculateDivider(10000000));
    }
...
# 148 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
_Bool 
# 148 "./src/main/drivers/barometer/barometer_bmp280.c"
    bmp280Detect(baroDev_t *baro)
{
    delay(20);
...
# 153 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
   _Bool 
# 153 "./src/main/drivers/barometer/barometer_bmp280.c"
...
# 160 "./src/main/drivers/barometer/barometer_bmp280.c"
    ...
    busReadRegisterBuffer(dev, (0xD0), &bmp280_chip_id, 1);

    if ((bmp280_chip_id != (0x58)) && (bmp280_chip_id != (0x60))) {
        bmp280BusDeinit(dev);
...
# 170 "./src/main/drivers/barometer/barometer_bmp280.c"
    ...
    busReadRegisterBuffer(dev, (0x88), (uint8_t *)&bmp280_cal, sizeof(bmp280_calib_param_t));


    busWriteRegister(dev, (0xF4), (((0x04)) << 2 | ((0x01)) << 5 | (0x01)));


    baro->combined_read = 
# 182 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
                         1
# 182 "./src/main/drivers/barometer/barometer_bmp280.c"
                             ;
    baro->ut_delay = 0;
    ...
    return 
# 194 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
          1
# 194 "./src/main/drivers/barometer/barometer_bmp280.c"
              ;
}
...
static 
# 203 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
      _Bool 
# 203 "./src/main/drivers/barometer/barometer_bmp280.c"
           bmp280ReadUT(baroDev_t *baro)
{
    ((void)(baro));

    return 
# 207 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
          1
# 207 "./src/main/drivers/barometer/barometer_bmp280.c"
              ;
}
           ...
           bmp280GetUT(baroDev_t *baro)
{
    ...
    return 
# 214 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
          1
# 214 "./src/main/drivers/barometer/barometer_bmp280.c"
              ;
}
...
static void bmp280StartUP(baroDev_t *baro)
{
    ...
    busWriteRegisterStart(&baro->dev, (0xF4), (((0x04)) << 2 | ((0x01)) << 5 | (0x01)));
}

static 
# 224 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
      _Bool 
# 224 "./src/main/drivers/barometer/barometer_bmp280.c"
           bmp280ReadUP(baroDev_t *baro)
{
    if (busBusy(&baro->dev, 
# 226 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
                           ((void *)0)
# 226 "./src/main/drivers/barometer/barometer_bmp280.c"
                               )) {
        return 
# 227 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
              0
# 227 "./src/main/drivers/barometer/barometer_bmp280.c"
                   ;
    }


    busReadRegisterBufferStart(&baro->dev, (0xF7), sensor_data, (6));

    return 
# 233 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
          1
# 233 "./src/main/drivers/barometer/barometer_bmp280.c"
              ;
}

static 
# 236 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
      _Bool 
# 236 "./src/main/drivers/barometer/barometer_bmp280.c"
           bmp280GetUP(baroDev_t *baro)
{
    if (busBusy(&baro->dev, 
# 238 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
                           ((void *)0)
# 238 "./src/main/drivers/barometer/barometer_bmp280.c"
                               )) {
        return 
# 239 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
              0
# 239 "./src/main/drivers/barometer/barometer_bmp280.c"
                   ;
    }
    ...
    return 
# 245 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
          1
# 245 "./src/main/drivers/barometer/barometer_bmp280.c"
              ;
}
