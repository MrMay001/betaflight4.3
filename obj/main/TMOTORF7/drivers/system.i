...
# 37 "./src/main/drivers/system.c" 2
# 48 "./src/main/drivers/system.c"
...
static void indicate(uint8_t count, uint16_t duration)
{
    if (count) {
        ledSet(1, 
# 221 "./src/main/drivers/system.c" 3 4
       1
# 221 "./src/main/drivers/system.c"
       );
        ledSet(0, 
# 222 "./src/main/drivers/system.c" 3 4
       0
# 222 "./src/main/drivers/system.c"
       );
        ...
        while (count--) {
            ...
            ledToggle(0);
            systemBeep(
# 227 "./src/main/drivers/system.c" 3 4
           1
# 227 "./src/main/drivers/system.c"
           );
            delay(duration);
            ...
            ledToggle(0);
            systemBeep(
# 232 "./src/main/drivers/system.c" 3 4
           0
# 232 "./src/main/drivers/system.c"
           );
            delay(duration);
        }
    }
...
# 303 "./src/main/drivers/system.c"
static void unusedPinInit(IO_t io)
{
    if (IOGetOwner(io) == OWNER_FREE) {
        IOConfigGPIO(io, ((((uint32_t)0x00000000U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000001U)) << 5)));
    }
}
