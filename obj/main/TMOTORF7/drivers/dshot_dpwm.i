# 1 "./src/main/drivers/dshot_dpwm.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/dshot_dpwm.c"
# 23 "./src/main/drivers/dshot_dpwm.c"
# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include/stdbool.h" 1 3 4
# 24 "./src/main/drivers/dshot_dpwm.c" 2
...
# 25 "./src/main/drivers/dshot_dpwm.c" 2
...
# 26 "./src/main/drivers/dshot_dpwm.c" 2
...
# 27 "./src/main/drivers/dshot_dpwm.c" 2
...
# 153 "./src/main/platform.h" 2
# 29 "./src/main/drivers/dshot_dpwm.c" 2
...
# 79 "./src/main/drivers/pwm_output.h"
    pwmIsSynced(void);
# 33 "./src/main/drivers/dshot_dpwm.c" 2
...
# 34 "./src/main/drivers/dshot_dpwm.c" 2
...
# 35 "./src/main/drivers/dshot_dpwm.c" 2
...
__attribute__ ((section(".fastram_bss"), aligned(4))) uint32_t dshotDmaBuffer[8][22];


__attribute__ ((section(".fastram_bss"), aligned(4))) uint32_t dshotBurstDmaBuffer[8][18 * 4];



__attribute__ ((section(".fastram_bss"), aligned(4))) 
# 48 "./src/main/drivers/dshot_dpwm.c" 3 4
                   _Bool 
# 48 "./src/main/drivers/dshot_dpwm.c"
                        useBurstDshot = 
# 48 "./src/main/drivers/dshot_dpwm.c" 3 4
                                        0
# 48 "./src/main/drivers/dshot_dpwm.c"
...
__attribute__ ((section(".fastram_bss"), aligned(4))) 
# 51 "./src/main/drivers/dshot_dpwm.c" 3 4
                   _Bool 
# 51 "./src/main/drivers/dshot_dpwm.c"
                        useDshotTelemetry = 
# 51 "./src/main/drivers/dshot_dpwm.c" 3 4
                                            0
# 51 "./src/main/drivers/dshot_dpwm.c"
...
__attribute__((noinline)) uint8_t loadDmaBufferDshot(uint32_t *dmaBuffer, int stride, uint16_t packet)
{
    int i;
    for (i = 0; i < 16; i++) {
...
__attribute__((noinline)) uint8_t loadDmaBufferProshot(uint32_t *dmaBuffer, int stride, uint16_t packet)
{
    int i;
    for (i = 0; i < 4; i++) {
...
static 
# 111 "./src/main/drivers/dshot_dpwm.c" 3 4
      _Bool 
# 111 "./src/main/drivers/dshot_dpwm.c"
           dshotPwmEnableMotors(void)
{
    ...
    return 
# 120 "./src/main/drivers/dshot_dpwm.c" 3 4
          1
# 120 "./src/main/drivers/dshot_dpwm.c"
              ;
}

static 
# 123 "./src/main/drivers/dshot_dpwm.c" 3 4
      _Bool 
# 123 "./src/main/drivers/dshot_dpwm.c"
           dshotPwmIsMotorEnabled(uint8_t index)
{
    return motors[index].enabled;
}

static __attribute__((section(".tcm_code"))) __attribute__((optimize("-O2"))) void dshotWriteInt(uint8_t index, uint16_t value)
{
    pwmWriteDshotInt(index, value);
}

static __attribute__((section(".tcm_code"))) __attribute__((optimize("-O2"))) void dshotWrite(uint8_t index, float value)
{
...
__attribute__ ((section(".fastram_bss"), aligned(4))) motorDevice_t dshotPwmDevice;

motorDevice_t *dshotPwmDevInit(const motorDevConfig_t *motorConfig, uint16_t idlePulse, uint8_t motorCount, 
# 154 "./src/main/drivers/dshot_dpwm.c" 3 4
                                                                                                           _Bool 
# 154 "./src/main/drivers/dshot_dpwm.c"
                                                                                                                useUnsyncedPwm)
{
    ((void)(idlePulse));
    ((void)(useUnsyncedPwm));
    ...
    for (int motorIndex = 0; motorIndex < 8 && motorIndex < motorCount; motorIndex++) {
        ...
        if (timerHardware != 
# 186 "./src/main/drivers/dshot_dpwm.c" 3 4
                            ((void *)0)
# 186 "./src/main/drivers/dshot_dpwm.c"
                                ) {
...
# 195 "./src/main/drivers/dshot_dpwm.c" 3 4
                                            1
# 195 "./src/main/drivers/dshot_dpwm.c"
                                                ;
        ...
        return 
# 206 "./src/main/drivers/dshot_dpwm.c" 3 4
              ((void *)0)
# 206 "./src/main/drivers/dshot_dpwm.c"
                  ;
    }
