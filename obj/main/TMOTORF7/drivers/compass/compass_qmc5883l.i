...
# 77 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
   _Bool 
# 77 "./src/main/drivers/compass/compass_qmc5883l.c"
        ack = 
# 77 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
              1
# 77 "./src/main/drivers/compass/compass_qmc5883l.c"
    ...
    ack = ack && busWriteRegister(dev, 0x09, 0x01 | (0x03 << 2) | (0x00 << 6) | (0x01 << 4));
           ...
           qmc5883lRead(magDev_t *magDev, int16_t *magData)
{
    ...
    switch (state) {
        ...
        case STATE_READ_STATUS:
            busReadRegisterBufferStart(dev, 0x06, &status, sizeof(status));
            state = STATE_WAIT_STATUS;
            return 
# 109 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
                  0
# 109 "./src/main/drivers/compass/compass_qmc5883l.c"
                       ;
        ...
        case STATE_WAIT_STATUS:
            if ((status & 0x04) == 0) {
                state = STATE_READ_STATUS;
                return 
# 114 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
                      0
# 114 "./src/main/drivers/compass/compass_qmc5883l.c"
                           ;
            }

            busReadRegisterBufferStart(dev, 0x00, buf, sizeof(buf));
...
# 119 "./src/main/drivers/compass/compass_qmc5883l.c"
        ...
        case STATE_WAIT_READ:
            ...
            return 
# 129 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
                  1
# 129 "./src/main/drivers/compass/compass_qmc5883l.c"
                      ;
    }

    return 
# 132 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
          0
# 132 "./src/main/drivers/compass/compass_qmc5883l.c"
               ;
}


# 135 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
_Bool 
# 135 "./src/main/drivers/compass/compass_qmc5883l.c"
    qmc5883lDetect(magDev_t *magDev)
{
    ...
    if (dev->bus->busType == BUS_TYPE_I2C && dev->busType_u.i2c.address == 0) {
        dev->busType_u.i2c.address = 0x0D;
    }


    busWriteRegister(dev, 0x0A, 0x80);
    delay(20);
...
# 149 "./src/main/drivers/compass/compass_qmc5883l.c"
        ack = busReadRegisterBuffer(dev, 0x0D, &sig, 1);
    if (ack && sig == 0xFF) {


        ack = busReadRegisterBuffer(dev, 0x09, &sig, 1);
        if (ack && sig != 0x00) {
            return 
# 155 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
                  0
# 155 "./src/main/drivers/compass/compass_qmc5883l.c"
                       ;
        }
        magDev->init = qmc5883lInit;
        magDev->read = qmc5883lRead;
        return 
# 159 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
              1
# 159 "./src/main/drivers/compass/compass_qmc5883l.c"
                  ;
    }
