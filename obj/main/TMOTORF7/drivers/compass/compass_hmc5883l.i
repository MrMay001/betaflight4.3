...
# 162 "./src/main/drivers/compass/compass_hmc5883l.c"
...
# 201 "./src/main/drivers/compass/compass_hmc5883l.c"
static 
# 201 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
      _Bool 
# 201 "./src/main/drivers/compass/compass_hmc5883l.c"
...
# 204 "./src/main/drivers/compass/compass_hmc5883l.c"
    ...
    if (pendingRead) {
        busReadRegisterBufferStart(dev, 0x03, buf, sizeof(buf));

        pendingRead = 
# 211 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
                     0
# 211 "./src/main/drivers/compass/compass_hmc5883l.c"
                          ;
        return 
# 212 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
              0
# 212 "./src/main/drivers/compass/compass_hmc5883l.c"
                   ;
    }
    ...
    pendingRead = 
# 219 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
                 1
# 219 "./src/main/drivers/compass/compass_hmc5883l.c"
                     ;

    return 
# 221 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
          1
# 221 "./src/main/drivers/compass/compass_hmc5883l.c"
              ;
}

static 
# 224 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
      _Bool 
# 224 "./src/main/drivers/compass/compass_hmc5883l.c"
           hmc5883lInit(magDev_t *mag)
{
    ...
    busWriteRegister(dev, 0x00, 0X60 | 0X10 | 0x00);
    busWriteRegister(dev, 0x01, 0X20);
    busWriteRegister(dev, 0x02, 0X00);
...
# 253 "./src/main/drivers/compass/compass_hmc5883l.c"
    if (dev->bus->busType == BUS_TYPE_I2C && dev->busType_u.i2c.address == 0) {
        dev->busType_u.i2c.address = 0x1E;
    }
...
# 258 "./src/main/drivers/compass/compass_hmc5883l.c"
        ack = busReadRegisterBuffer(&mag->dev, 0x0A, &sig, 1);
