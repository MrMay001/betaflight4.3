...
# 69 "./src/main/drivers/exti.c"
static uint32_t triggerLookupTable[] = {

    [BETAFLIGHT_EXTI_TRIGGER_RISING] = ((uint32_t)0x10110000U),
    [BETAFLIGHT_EXTI_TRIGGER_FALLING] = ((uint32_t)0x10210000U),
    [BETAFLIGHT_EXTI_TRIGGER_BOTH] = ((uint32_t)0x10310000U)
...
void EXTIConfig(IO_t io, extiCallbackRec_t *cb, int irqPriority, ioConfig_t config, extiTrigger_t trigger)
{
    ...
    GPIO_InitTypeDef init = {
        .Pin = IO_Pin(io),
        .Mode = ((uint32_t)0x00000000U) | (((config) >> 0) & 0x03) | triggerLookupTable[trigger],
        .Speed = (((config) >> 2) & 0x03),
        .Pull = (((config) >> 5) & 0x03),
    };
    ...
    if (extiGroupPriority[group] > irqPriority) {
        ...
        HAL_NVIC_SetPriority(extiGroupIRQn[group], (((irqPriority)>>(4-(7-(((uint32_t)0x00000005U)))))>>4), (((irqPriority)&(0x0f>>(7-(((uint32_t)0x00000005U)))))>>4));
        HAL_NVIC_EnableIRQ(extiGroupIRQn[group]);
    }
# 182 "./src/main/drivers/exti.c"
}
...
void EXTIRelease(IO_t io)
{
    ...
    extiChannelRec_t *rec = &extiChannelRecs[chIdx];
    rec->handler = 
# 196 "./src/main/drivers/exti.c" 3 4
                  ((void *)0)
# 196 "./src/main/drivers/exti.c"
                      ;
}
...
{
    uint32_t exti_active = ((((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->IMR) & (((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->PR)) & mask;

    (((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->PR) = exti_active;
