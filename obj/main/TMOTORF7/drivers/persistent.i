# 1 "./src/main/drivers/persistent.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/persistent.c"
# 26 "./src/main/drivers/persistent.c"
...
# 27 "./src/main/drivers/persistent.c" 2
...
# 153 "./src/main/platform.h" 2
# 28 "./src/main/drivers/persistent.c" 2
...
# 30 "./src/main/drivers/persistent.c" 2
...
# 31 "./src/main/drivers/persistent.c" 2
...
uint32_t persistentObjectRead(persistentObjectId_e id)
{
    RTC_HandleTypeDef rtcHandle = { .Instance = ((RTC_TypeDef *) (0x40000000UL + 0x2800UL)) };
...
# 61 "./src/main/drivers/persistent.c"
}
...
# 87 "./src/main/drivers/persistent.c"
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) |= ((0x1UL << (10U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) & ((0x1UL << (10U)))); ((void)(tmpreg)); } while(0);
    ...
    do{ (&rtcHandle)->Instance->WPR = 0xFFU; } while(0U);
    do{ (&rtcHandle)->Instance->WPR = 0xCAU; (&rtcHandle)->Instance->WPR = 0x53U; } while(0U);
}
# 123 "./src/main/drivers/persistent.c"
void persistentObjectInit(void)
{
    ...
    wasSoftReset = ((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->CSR & (0x1UL << (28U));
