...
volatile __attribute__ ((section(".fastram_bss"), aligned(4))) uint16_t adcValues[ADC_CHANNEL_COUNT];
...
ADCDevice adcDeviceByInstance(ADC_TypeDef *instance)
{
    if (instance == ((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2000UL))) {
        return ADCDEV_1;
    }


    if (instance == ((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2100UL))) {
        return ADCDEV_2;
    }


    if (instance == ((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2200UL))) {
        return ADCDEV_3;
    }
# 85 "./src/main/drivers/adc.c"
    return ADCINVALID;
}
...
# 111 "./src/main/drivers/adc.c" 3 4
_Bool 
# 111 "./src/main/drivers/adc.c"
    adcVerifyPin(ioTag_t tag, ADCDevice device)
{
    if (!tag) {
        return 
# 114 "./src/main/drivers/adc.c" 3 4
              0
# 114 "./src/main/drivers/adc.c"
                   ;
    }
...
# 125 "./src/main/drivers/adc.c"
    ...
    return 
# 130 "./src/main/drivers/adc.c" 3 4
          0
# 130 "./src/main/drivers/adc.c"
               ;
}
...
uint16_t adcInternalCompensateVref(uint16_t vrefAdcValue)
{
    ...
    return (uint16_t)((uint32_t)(adcVREFINTCAL * ( 3300U)) / vrefAdcValue);
}
...
int16_t adcInternalComputeTemperature(uint16_t tempAdcValue, uint16_t vrefValue)
{
    ...
    return ((((int32_t)((tempAdcValue * vrefValue) / ( 3300U)) - adcTSCAL1) * adcTSSlopeK) + 500) / 1000 + (( int32_t) 30);
}
