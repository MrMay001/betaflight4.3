...
# 49 "/opt/gcc-arm-none-eabi-9-2020-q2-update/arm-none-eabi/include/sys/types.h" 3
...
__attribute__((section(".tcm_code"))) __attribute__((optimize("-O2"))) uint32_t decode_bb( uint16_t buffer[], uint32_t count, uint32_t bit)
{
