...
__attribute__ ((section(".fastram_bss"), aligned(4))) pwmOutputPort_t motors[8];
...
static void pwmOCConfig(TIM_TypeDef *tim, uint8_t channel, uint16_t value, uint8_t output)
{
    ...
    if (Handle == 
# 44 "./src/main/drivers/pwm_output.c" 3 4
                 ((void *)0)
# 44 "./src/main/drivers/pwm_output.c"
    ...
    TIM_OCInitStructure.OCPolarity = (output & TIMER_OUTPUT_INVERTED) ? (0x1UL << (1U)) : 0x00000000U;
    TIM_OCInitStructure.OCNIdleState = (0x1UL << (9U));
    TIM_OCInitStructure.OCNPolarity = (output & TIMER_OUTPUT_INVERTED) ? (0x1UL << (3U)) : 0x00000000U;
...
# 77 "./src/main/drivers/pwm_output.c"
}
...
static __attribute__ ((section(".fastram_bss"), aligned(4))) motorDevice_t motorPwmDevice;
...
# 141 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 141 "./src/main/drivers/pwm_output.c"
    pwmEnableMotors(void)
{
...
# 147 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 147 "./src/main/drivers/pwm_output.c"
    pwmIsMotorEnabled(uint8_t index)
{
...
# 184 "./src/main/drivers/pwm_output.c" 3 4
                                                                                                           _Bool 
# 184 "./src/main/drivers/pwm_output.c"
                                                                                                                useUnsyncedPwm)
{
    ...
    case PWM_TYPE_BRUSHED:
        sMin = 0;
        useUnsyncedPwm = 
# 206 "./src/main/drivers/pwm_output.c" 3 4
                        1
# 206 "./src/main/drivers/pwm_output.c"
                            ;
        idlePulse = 0;
        break;
    case PWM_TYPE_STANDARD:
        ...
        sLen = 1e-3f;
        useUnsyncedPwm = 
# 212 "./src/main/drivers/pwm_output.c" 3 4
                        1
# 212 "./src/main/drivers/pwm_output.c"
                            ;
        idlePulse = 0;
        break;
    }
    ...
    for (int motorIndex = 0; motorIndex < 8 && motorIndex < motorCount; motorIndex++) {
        ...
        const timerHardware_t *timerHardware = timerAllocate(tag, OWNER_MOTOR, (reorderedMotorIndex + 1));

        if (timerHardware == 
# 226 "./src/main/drivers/pwm_output.c" 3 4
                            ((void *)0)
# 226 "./src/main/drivers/pwm_output.c"
                                ) {
            ...
            return 
# 231 "./src/main/drivers/pwm_output.c" 3 4
                  ((void *)0)
# 231 "./src/main/drivers/pwm_output.c"
                      ;
        }

        motors[motorIndex].io = IOGetByTag(tag);
        IOInit(motors[motorIndex].io, OWNER_MOTOR, (reorderedMotorIndex + 1));




        IOConfigGPIOAF(motors[motorIndex].io, ((((uint32_t)0x00000002U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000000U)) << 5)), timerHardware->alternateFunction);
...
# 263 "./src/main/drivers/pwm_output.c" 3 4
       _Bool 
# 263 "./src/main/drivers/pwm_output.c"
            timerAlreadyUsed = 
# 263 "./src/main/drivers/pwm_output.c" 3 4
                               0
# 263 "./src/main/drivers/pwm_output.c"
        ...
        for (int i = 0; i < motorIndex; i++) {
            if (motors[i].channel.tim == motors[motorIndex].channel.tim) {
                timerAlreadyUsed = 
# 266 "./src/main/drivers/pwm_output.c" 3 4
                                  1
# 266 "./src/main/drivers/pwm_output.c"
                                      ;
                break;
            }
        }
...
void servoDevInit(const servoDevConfig_t *servoConfig)
{
    for (uint8_t servoIndex = 0; servoIndex < 8; servoIndex++) {
        ...
        const timerHardware_t *timer = timerAllocate(tag, OWNER_SERVO, (servoIndex + 1));

        if (timer == 
# 307 "./src/main/drivers/pwm_output.c" 3 4
                    ((void *)0)
# 307 "./src/main/drivers/pwm_output.c"
                        ) {
        ...
        IOConfigGPIOAF(servos[servoIndex].io, ((((uint32_t)0x00000002U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000000U)) << 5)), timer->alternateFunction);
...
# 319 "./src/main/drivers/pwm_output.c" 3 4
                                    1
# 319 "./src/main/drivers/pwm_output.c"
                                        ;
    }
}
