...
# 56 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 57 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 58 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
# 1 "./src/main/drivers/accgyro/accgyro_spi_l3gd20.h" 1
# 21 "./src/main/drivers/accgyro/accgyro_spi_l3gd20.h"
       

uint8_t l3gd20Detect(const extDevice_t *dev);

# 24 "./src/main/drivers/accgyro/accgyro_spi_l3gd20.h" 3 4
_Bool 
# 24 "./src/main/drivers/accgyro/accgyro_spi_l3gd20.h"
    l3gd20GyroDetect(gyroDev_t *gyro);
# 59 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 63 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
busStatus_e mpuIntcallback(uint32_t arg)
{
    ...
    gyro->dataReady = 
# 131 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                     1
# 131 "./src/main/drivers/accgyro/accgyro_mpu.c"
                         ;
...
# 164 "./src/main/drivers/accgyro/accgyro_mpu.c"
...
# 179 "./src/main/drivers/accgyro/accgyro_mpu.c"
    ...
    EXTIConfig(mpuIntIO, &gyro->exti, (((((0x0f)<<(4-(7-(((uint32_t)0x00000005U)))))|((0x0f)&(0x0f>>(7-(((uint32_t)0x00000005U))))))<<4)&0xf0), ((((uint32_t)0x00000000U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000000U)) << 5)), BETAFLIGHT_EXTI_TRIGGER_RISING);
    EXTIEnable(mpuIntIO);
}



# 186 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
_Bool 
# 186 "./src/main/drivers/accgyro/accgyro_mpu.c"
    mpuAccRead(accDev_t *acc)
{
    uint8_t data[6];

    const 
# 190 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
         _Bool 
# 190 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ack = busReadRegisterBuffer(&acc->gyro->dev, acc->gyro->accDataReg, data, 6);
    if (!ack) {
        return 
...
# 192 "./src/main/drivers/accgyro/accgyro_mpu.c"
    ...
    return 
# 199 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
          1
# 199 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ;
}
...
# 206 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ack = busReadRegisterBuffer(&gyro->dev, gyro->gyroDataReg, data, 6);
    if (!ack) {
        return 
...
# 220 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
_Bool 
# 220 "./src/main/drivers/accgyro/accgyro_mpu.c"
    mpuAccReadSPI(accDev_t *acc)
{
    ...
    case GYRO_EXTI_NO_INT:
    {
        ...
        busSegment_t segments[] = {
                {.u.buffers = {
# 229 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                              ((void *)0)
# 229 "./src/main/drivers/accgyro/accgyro_mpu.c"
                                  , 
# 229 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                                    ((void *)0)
# 229 "./src/main/drivers/accgyro/accgyro_mpu.c"
...
# 229 "./src/main/drivers/accgyro/accgyro_mpu.c"
                ...
                {.u.link = {
# 230 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                           ((void *)0)
# 230 "./src/main/drivers/accgyro/accgyro_mpu.c"
                               , 
# 230 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                                 ((void *)0)
# 230 "./src/main/drivers/accgyro/accgyro_mpu.c"
...
# 230 "./src/main/drivers/accgyro/accgyro_mpu.c"
    ...
    return 
# 262 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
          1
# 262 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ;
}


# 265 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
_Bool 
# 265 "./src/main/drivers/accgyro/accgyro_mpu.c"
    ...
    case GYRO_EXTI_INIT:
    {
        ...
        if (gyro->detectedEXTI > 1000) {
            if (spiUseDMA(&gyro->dev)) {
                ...
                gyro->segments[0].negateCS = 
# 286 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                                            1
# 286 "./src/main/drivers/accgyro/accgyro_mpu.c"
                                                ;
    ...
    case GYRO_EXTI_NO_INT:
    {
        ...
        busSegment_t segments[] = {
                {.u.buffers = {
# 306 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                              ((void *)0)
# 306 "./src/main/drivers/accgyro/accgyro_mpu.c"
                                  , 
# 306 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                                    ((void *)0)
# 306 "./src/main/drivers/accgyro/accgyro_mpu.c"
...
# 306 "./src/main/drivers/accgyro/accgyro_mpu.c"
                ...
                {.u.link = {
# 307 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                           ((void *)0)
# 307 "./src/main/drivers/accgyro/accgyro_mpu.c"
                               , 
# 307 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                                 ((void *)0)
# 307 "./src/main/drivers/accgyro/accgyro_mpu.c"
...
# 307 "./src/main/drivers/accgyro/accgyro_mpu.c"
    ...
    return 
# 340 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
          1
# 340 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ;
}
...
static gyroSpiDetectFn_t gyroSpiDetectFnTable[] = {
    ...
    mpu6500SpiDetect,
# 376 "./src/main/drivers/accgyro/accgyro_mpu.c"
    
# 376 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
   ((void *)0)

# 377 "./src/main/drivers/accgyro/accgyro_mpu.c"
};

static 
# 379 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
      _Bool 
# 379 "./src/main/drivers/accgyro/accgyro_mpu.c"
           detectSPISensorsAndUpdateDetectionResult(gyroDev_t *gyro, const gyroDeviceConfig_t *config)
{
    if (!config->csnTag || !spiSetBusInstance(&gyro->dev, config->spiBus)) {
        return 
# 382 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
              0
# 382 "./src/main/drivers/accgyro/accgyro_mpu.c"
                   ;
    }

    gyro->dev.busType_u.spi.csnPin = IOGetByTag(config->csnTag);

    IOInit(gyro->dev.busType_u.spi.csnPin, OWNER_GYRO_CS, (config->index + 1));
    IOConfigGPIO(gyro->dev.busType_u.spi.csnPin, ((((uint32_t)0x00000001U)) | ((((uint32_t)0x00000003U)) << 2) | ((((uint32_t)0x00000000U)) << 5)));
    ...
    spiSetClkDivisor(&gyro->dev, spiCalculateDivider(1000000));
    ...
    for (size_t index = 0 ; gyroSpiDetectFnTable[index] ; index++) {
        ...
        if (sensor != MPU_NONE) {
            ...
            return 
# 409 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                  1
# 409 "./src/main/drivers/accgyro/accgyro_mpu.c"
                      ;
        }
    }
    ...
    return 
# 417 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
          0
# 417 "./src/main/drivers/accgyro/accgyro_mpu.c"
               ;
}
...
void mpuPreInit(const struct gyroDeviceConfig_s *config)
{
    ...
    spiPreinitRegister(config->csnTag, ((((uint32_t)0x00000000U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000001U)) << 5)), 1);
...
# 430 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
_Bool 
# 430 "./src/main/drivers/accgyro/accgyro_mpu.c"
    mpuDetect(gyroDev_t *gyro, const gyroDeviceConfig_t *config)
{
    ...
    if (config->busType == BUS_TYPE_NONE) {
        return 
# 439 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
              0
# 439 "./src/main/drivers/accgyro/accgyro_mpu.c"
                   ;
    }
...
# 480 "./src/main/drivers/accgyro/accgyro_mpu.c"
...
{
    gyro->accDataReg = 0x3B;
    gyro->gyroDataReg = 0x43;
...
uint8_t mpuGyroReadRegister(const extDevice_t *dev, uint8_t reg)
{
    uint8_t data;
    const 
# 530 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
         _Bool 
# 530 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ack = busReadRegisterBuffer(dev, reg, &data, 1);
    if (ack) {
        return data;
    } else {
        return 0;
