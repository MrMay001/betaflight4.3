...
void mpu6500GyroInit(gyroDev_t *gyro)
{
    ...
    busWriteRegister(dev, 0x6B, (0x80));
    delay(100);
    busWriteRegister(dev, 0x68, 0x07);
    delay(100);
    busWriteRegister(dev, 0x6B, 0);
    delay(100);
    busWriteRegister(dev, 0x6B, INV_CLK_PLL);
    delay(15);
    busWriteRegister(dev, 0x1B, gyro_range << 3);
    delay(15);
    busWriteRegister(dev, 0x1C, accel_range << 3);
    delay(15);
    busWriteRegister(dev, 0x1A, mpuGyroDLPF(gyro));
    delay(15);
    busWriteRegister(dev, 0x19, gyro->mpuDividerDrops);
    delay(100);
    ...
    busWriteRegister(dev, 0x37, (1 << 4));

    delay(15);


    busWriteRegister(dev, 0x38, (1 << 0));

    delay(15);
}


# 100 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
_Bool 
# 100 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
    mpu6500GyroDetect(gyroDev_t *gyro)
{
    if (gyro->mpuDetectionResult.sensor != MPU_65xx_I2C) {
        return 
# 103 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
              0
# 103 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
                   ;
    }
    ...
    return 
# 111 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
          1
# 111 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
              ;
}
