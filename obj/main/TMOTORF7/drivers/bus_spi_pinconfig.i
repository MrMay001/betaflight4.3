...
# 204 "./src/main/drivers/bus_spi_pinconfig.c"
    {
        .device = SPIDEV_1,
        .reg = ((SPI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3000UL)),
        .sckPins = {
            { ((ioTag_t)((((0) + 1) << 4) | (5))), ((uint8_t)0x05U) },
            { ((ioTag_t)((((1) + 1) << 4) | (3))), ((uint8_t)0x05U) },
        },
        .misoPins = {
            { ((ioTag_t)((((0) + 1) << 4) | (6))), ((uint8_t)0x05U) },
            { ((ioTag_t)((((1) + 1) << 4) | (4))), ((uint8_t)0x05U) },
        },
        .mosiPins = {
            { ((ioTag_t)((((0) + 1) << 4) | (7))), ((uint8_t)0x05U) },
            { ((ioTag_t)((((1) + 1) << 4) | (5))), ((uint8_t)0x05U) },
        },
        .rcc = (((RCC_APB2) << 5) | (16*(((0x1UL << (12U)))>65535L) + (8*((((0x1UL << (12U)))*1L >>16*(((0x1UL << (12U)))>65535L))>255) + (8 - 90/((((((0x1UL << (12U)))*1L >>16*(((0x1UL << (12U)))>65535L)) >>8*((((0x1UL << (12U)))*1L >>16*(((0x1UL << (12U)))>65535L))>255))/4+14)|1) - 2/(((((0x1UL << (12U)))*1L >>16*(((0x1UL << (12U)))>65535L)) >>8*((((0x1UL << (12U)))*1L >>16*(((0x1UL << (12U)))>65535L))>255))/2+1))))),
        .dmaIrqHandler = DMA2_ST3_HANDLER,
    },
    {
        .device = SPIDEV_2,
        .reg = ((SPI_TypeDef *) (0x40000000UL + 0x3800UL)),
        .sckPins = {
            { ((ioTag_t)((((0) + 1) << 4) | (9))), ((uint8_t)0x05U) },
            { ((ioTag_t)((((1) + 1) << 4) | (10))), ((uint8_t)0x05U) },
            { ((ioTag_t)((((1) + 1) << 4) | (13))), ((uint8_t)0x05U) },
            { 0, ((uint8_t)0x05U) },
        },
        .misoPins = {
            { ((ioTag_t)((((1) + 1) << 4) | (14))), ((uint8_t)0x05U) },
            { ((ioTag_t)((((2) + 1) << 4) | (2))), ((uint8_t)0x05U) },
        },
        .mosiPins = {
            { ((ioTag_t)((((1) + 1) << 4) | (15))), ((uint8_t)0x05U) },
            { ((ioTag_t)((((2) + 1) << 4) | (1))), ((uint8_t)0x05U) },
            { ((ioTag_t)((((2) + 1) << 4) | (3))), ((uint8_t)0x05U) },
        },
        .rcc = (((RCC_APB1) << 5) | (16*(((0x1UL << (14U)))>65535L) + (8*((((0x1UL << (14U)))*1L >>16*(((0x1UL << (14U)))>65535L))>255) + (8 - 90/((((((0x1UL << (14U)))*1L >>16*(((0x1UL << (14U)))>65535L)) >>8*((((0x1UL << (14U)))*1L >>16*(((0x1UL << (14U)))>65535L))>255))/4+14)|1) - 2/(((((0x1UL << (14U)))*1L >>16*(((0x1UL << (14U)))>65535L)) >>8*((((0x1UL << (14U)))*1L >>16*(((0x1UL << (14U)))>65535L))>255))/2+1))))),
        .dmaIrqHandler = DMA1_ST4_HANDLER,
    },
    {
        .device = SPIDEV_3,
        .reg = ((SPI_TypeDef *) (0x40000000UL + 0x3C00UL)),
        .sckPins = {
            { ((ioTag_t)((((1) + 1) << 4) | (3))), ((uint8_t)0x06U) },
            { ((ioTag_t)((((2) + 1) << 4) | (10))), ((uint8_t)0x06U) },
        },
        .misoPins = {
            { ((ioTag_t)((((1) + 1) << 4) | (4))), ((uint8_t)0x06U) },
            { ((ioTag_t)((((2) + 1) << 4) | (11))), ((uint8_t)0x06U) },
        },
        .mosiPins = {
            { ((ioTag_t)((((1) + 1) << 4) | (2))), ((uint8_t)0x07U) },
            { ((ioTag_t)((((1) + 1) << 4) | (5))), ((uint8_t)0x06U) },
            { ((ioTag_t)((((2) + 1) << 4) | (12))), ((uint8_t)0x06U) },
            { 0, ((uint8_t)0x05U) },
        },
        .rcc = (((RCC_APB1) << 5) | (16*(((0x1UL << (15U)))>65535L) + (8*((((0x1UL << (15U)))*1L >>16*(((0x1UL << (15U)))>65535L))>255) + (8 - 90/((((((0x1UL << (15U)))*1L >>16*(((0x1UL << (15U)))>65535L)) >>8*((((0x1UL << (15U)))*1L >>16*(((0x1UL << (15U)))>65535L))>255))/4+14)|1) - 2/(((((0x1UL << (15U)))*1L >>16*(((0x1UL << (15U)))>65535L)) >>8*((((0x1UL << (15U)))*1L >>16*(((0x1UL << (15U)))>65535L))>255))/2+1))))),
        .dmaIrqHandler = DMA1_ST7_HANDLER,
    },
    {
        .device = SPIDEV_4,
        .reg = ((SPI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3400UL)),
        .sckPins = {
            { 0, ((uint8_t)0x05U) },
            { 0, ((uint8_t)0x05U) },
        },
        ...
        .rcc = (((RCC_APB2) << 5) | (16*(((0x1UL << (13U)))>65535L) + (8*((((0x1UL << (13U)))*1L >>16*(((0x1UL << (13U)))>65535L))>255) + (8 - 90/((((((0x1UL << (13U)))*1L >>16*(((0x1UL << (13U)))>65535L)) >>8*((((0x1UL << (13U)))*1L >>16*(((0x1UL << (13U)))>65535L))>255))/4+14)|1) - 2/(((((0x1UL << (13U)))*1L >>16*(((0x1UL << (13U)))>65535L)) >>8*((((0x1UL << (13U)))*1L >>16*(((0x1UL << (13U)))>65535L))>255))/2+1))))),
        .dmaIrqHandler = DMA2_ST1_HANDLER,
    },
# 451 "./src/main/drivers/bus_spi_pinconfig.c"
};
...
void spiPinConfigure(const spiPinConfig_t *pConfig)
{
    for (size_t hwindex = 0 ; hwindex < (sizeof(spiHardware) / sizeof((spiHardware)[0])) ; hwindex++) {
        ...
        if (pDev->sck && pDev->miso && pDev->mosi) {
            ...
            pDev->rcc = hw->rcc;
            pDev->leadingEdge = 
# 492 "./src/main/drivers/bus_spi_pinconfig.c" 3 4
                               0
# 492 "./src/main/drivers/bus_spi_pinconfig.c"
                                    ;
