...
# 47 "./src/main/drivers/serial_uart.c" 2
# 73 "./src/main/drivers/serial_uart.c"
__attribute__ ((section(".fastram_bss"), aligned(4))) volatile uint8_t uart1TxBuffer[1280]; __attribute__ ((section(".fastram_bss"), aligned(4))) volatile uint8_t uart1RxBuffer[128]; struct dummy_s;



__attribute__ ((section(".fastram_bss"), aligned(4))) volatile uint8_t uart2TxBuffer[1280]; __attribute__ ((section(".fastram_bss"), aligned(4))) volatile uint8_t uart2RxBuffer[128]; struct dummy_s;



__attribute__ ((section(".fastram_bss"), aligned(4))) volatile uint8_t uart3TxBuffer[1280]; __attribute__ ((section(".fastram_bss"), aligned(4))) volatile uint8_t uart3RxBuffer[128]; struct dummy_s;



__attribute__ ((section(".fastram_bss"), aligned(4))) volatile uint8_t uart4TxBuffer[1280]; __attribute__ ((section(".fastram_bss"), aligned(4))) volatile uint8_t uart4RxBuffer[128]; struct dummy_s;



__attribute__ ((section(".fastram_bss"), aligned(4))) volatile uint8_t uart5TxBuffer[1280]; __attribute__ ((section(".fastram_bss"), aligned(4))) volatile uint8_t uart5RxBuffer[128]; struct dummy_s;
...
serialPort_t *uartOpen(UARTDevice_e device, serialReceiveCallbackPtr rxCallback, void *rxCallbackData, uint32_t baudRate, portMode_e mode, portOptions_e options)
{
    ...
    uartPort->txDMAEmpty = 
# 126 "./src/main/drivers/serial_uart.c" 3 4
                          1
...
static uint32_t uartTotalRxBytesWaiting(const serialPort_t *instance)
{
    ...
    if (uartPort->rxDMAResource) {
        ...
        uint32_t rxDMAHead = ((uartPort->Handle.hdmarx)->Instance->NDTR);
...
static uint32_t uartTotalTxBytesFree(const serialPort_t *instance)
{
    ...
    if (uartPort->txDMAResource) {
        ...
        bytesUsed += ((uartPort->Handle.hdmatx)->Instance->NDTR);
# 220 "./src/main/drivers/serial_uart.c"
...
static 
# 229 "./src/main/drivers/serial_uart.c" 3 4
      _Bool 
# 229 "./src/main/drivers/serial_uart.c"
...
static void uartWrite(serialPort_t *instance, uint8_t ch)
{
...

    {
        ...
        (((((uint8_t)(0x0727U)) >> 5U) == 1U)? ((&uartPort->Handle)->Instance->CR1 |= (1U << ((0x0727U) & 0x001FU))): ((((uint8_t)(0x0727U)) >> 5U) == 2U)? ((&uartPort->Handle)->Instance->CR2 |= (1U << ((0x0727U) & 0x001FU))): ((&uartPort->Handle)->Instance->CR3 |= (1U << ((0x0727U) & 0x001FU))));
...
const struct serialPortVTable uartVTable[] = {
    {
        ...
        .setMode = uartSetMode,
        .setCtrlLineStateCb = 
# 301 "./src/main/drivers/serial_uart.c" 3 4
                             ((void *)0)
# 301 "./src/main/drivers/serial_uart.c"
                                 ,
        .setBaudRateCb = 
...
# 302 "./src/main/drivers/serial_uart.c"
                            ,
        .writeBuf = 
# 303 "./src/main/drivers/serial_uart.c" 3 4
                   ((void *)0)
# 303 "./src/main/drivers/serial_uart.c"
                       ,
        .beginWrite = 
# 304 "./src/main/drivers/serial_uart.c" 3 4
                     ((void *)0)
# 304 "./src/main/drivers/serial_uart.c"
                         ,
        .endWrite = 
# 305 "./src/main/drivers/serial_uart.c" 3 4
                   ((void *)0)
# 305 "./src/main/drivers/serial_uart.c"
                       ,
    }
};
...
void uartConfigureDma(uartDevice_t *uartdev)
{
    ...
    if (serialUartConfig(device)->txDmaopt != (-1)) {
    ...
    if (serialUartConfig(device)->rxDmaopt != (-1)) {
...
# 348 "./src/main/drivers/serial_uart.c"
    if (uartPort->txDMAResource) {
        ...
        if (dmaAllocate(identifier, OWNER_SERIAL_TX, (hardware->device + 1))) {
            ...
            uartPort->txDMAPeripheralBaseAddr = (uint32_t)&((hardware->reg)->TDR);
        }
    }
    ...
    if (uartPort->rxDMAResource) {
        ...
        if (dmaAllocate(identifier, OWNER_SERIAL_RX, (hardware->device + 1))) {
            dmaEnable(identifier);
            uartPort->rxDMAPeripheralBaseAddr = (uint32_t)&((hardware->reg)->RDR);
        }
    }
}
# 375 "./src/main/drivers/serial_uart.c"
