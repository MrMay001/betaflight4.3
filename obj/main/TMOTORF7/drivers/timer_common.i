...
# 26 "./src/main/drivers/timer_common.c" 2
...
const timerHardware_t *timerGetByTagAndIndex(ioTag_t ioTag, unsigned timerIndex)
{
    ...
    if (!ioTag || !timerIndex) {
        return 
# 51 "./src/main/drivers/timer_common.c" 3 4
              ((void *)0)
# 51 "./src/main/drivers/timer_common.c"
                  ;
    }
    ...
    return 
# 64 "./src/main/drivers/timer_common.c" 3 4
          ((void *)0)
# 64 "./src/main/drivers/timer_common.c"
              ;
}
...
const timerHardware_t *timerAllocate(ioTag_t ioTag, resourceOwner_e owner, uint8_t resourceIndex)
{
    if (!ioTag) {
        return 
# 116 "./src/main/drivers/timer_common.c" 3 4
              ((void *)0)
# 116 "./src/main/drivers/timer_common.c"
                  ;
    }
    ...
    for (unsigned i = 0; i < 21; i++) {
        if (timerIOConfig(i)->ioTag == ioTag) {
            ...
            if (timerGetOwner(timer)->owner) {
                return 
# 124 "./src/main/drivers/timer_common.c" 3 4
                      ((void *)0)
# 124 "./src/main/drivers/timer_common.c"
                          ;
            }
    ...
    return 
# 134 "./src/main/drivers/timer_common.c" 3 4
          ((void *)0)
# 134 "./src/main/drivers/timer_common.c"
              ;
}
# 161 "./src/main/drivers/timer_common.c"
ioTag_t timerioTagGetByUsage(timerUsageFlag_e usageFlag, uint8_t index)
{
