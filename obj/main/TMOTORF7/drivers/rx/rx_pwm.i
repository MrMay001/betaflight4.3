...
# 294 "./src/main/drivers/rx/rx_pwm.c"
    ...
    if (pwmInputPort->state == 0) {
        ...
        pwmICConfig(timerHardwarePtr->tim, timerHardwarePtr->channel, (0x1UL << (1U)));
        ...
        pwmICConfig(timerHardwarePtr->tim, timerHardwarePtr->channel, 0x00000000U);
...
void pwmICConfig(TIM_TypeDef *tim, uint8_t channel, uint16_t polarity)
{
    ...
    if (Handle == 
# 328 "./src/main/drivers/rx/rx_pwm.c" 3 4
                 ((void *)0)
# 328 "./src/main/drivers/rx/rx_pwm.c"
                     ) return;
...
# 366 "./src/main/drivers/rx/rx_pwm.c"
void pwmRxInit(const pwmConfig_t *pwmConfig)
{
    ...
    for (int channel = 0; channel < 8; channel++) {
        ...
        const timerHardware_t *timer = timerAllocate(pwmConfig->ioTags[channel], OWNER_PWMINPUT, (channel + 1));
        ...
        IOConfigGPIOAF(io, ((((uint32_t)0x00000002U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000000U)) << 5)), timer->alternateFunction);
        ...
        pwmICConfig(timer->tim, timer->channel, 0x00000000U);
