# 1 "./src/main/drivers/light_ws2811strip_hal.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/light_ws2811strip_hal.c"
# 21 "./src/main/drivers/light_ws2811strip_hal.c"
# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include/stdbool.h" 1 3 4
# 22 "./src/main/drivers/light_ws2811strip_hal.c" 2
...
# 23 "./src/main/drivers/light_ws2811strip_hal.c" 2
...
# 153 "./src/main/platform.h" 2
# 25 "./src/main/drivers/light_ws2811strip_hal.c" 2
...
# 29 "./src/main/drivers/light_ws2811strip_hal.c" 2
...
# 31 "./src/main/drivers/light_ws2811strip_hal.c" 2
...
# 32 "./src/main/drivers/light_ws2811strip_hal.c" 2

# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 34 "./src/main/drivers/light_ws2811strip_hal.c" 2
...
# 35 "./src/main/drivers/light_ws2811strip_hal.c" 2
...
# 36 "./src/main/drivers/light_ws2811strip_hal.c" 2
...
# 39 "./src/main/drivers/light_ws2811strip_hal.c" 2
 ...
 void WS2811_DMA_IRQHandler(dmaChannelDescriptor_t* descriptor)
{
    ...
    ws2811LedDataTransferInProgress = 
# 49 "./src/main/drivers/light_ws2811strip_hal.c" 3 4
                                     0
# 49 "./src/main/drivers/light_ws2811strip_hal.c"
                                          ;
}


# 52 "./src/main/drivers/light_ws2811strip_hal.c" 3 4
_Bool 
# 52 "./src/main/drivers/light_ws2811strip_hal.c"
    ws2811LedStripHardwareInit(ioTag_t ioTag)
{
    if (!ioTag) {
        return 
# 55 "./src/main/drivers/light_ws2811strip_hal.c" 3 4
              0
# 55 "./src/main/drivers/light_ws2811strip_hal.c"
                   ;
    }
    ...
    if (timerHardware == 
# 60 "./src/main/drivers/light_ws2811strip_hal.c" 3 4
                        ((void *)0)
# 60 "./src/main/drivers/light_ws2811strip_hal.c"
                            ) {
        return 
# 61 "./src/main/drivers/light_ws2811strip_hal.c" 3 4
              0
# 61 "./src/main/drivers/light_ws2811strip_hal.c"
                   ;
    }
    ...
    if (dmaSpec == 
# 72 "./src/main/drivers/light_ws2811strip_hal.c" 3 4
                  ((void *)0)
# 72 "./src/main/drivers/light_ws2811strip_hal.c"
                      ) {
        return 
# 73 "./src/main/drivers/light_ws2811strip_hal.c" 3 4
              0
# 73 "./src/main/drivers/light_ws2811strip_hal.c"
                   ;
    }
    ...
    if (dmaRef == 
# 83 "./src/main/drivers/light_ws2811strip_hal.c" 3 4
                 ((void *)0) 
# 83 "./src/main/drivers/light_ws2811strip_hal.c"
                      || !dmaAllocate(dmaGetIdentifier(dmaRef), OWNER_LED_STRIP, 0)) {
        return 
# 84 "./src/main/drivers/light_ws2811strip_hal.c" 3 4
              0
# 84 "./src/main/drivers/light_ws2811strip_hal.c"
                   ;
    }
    ...
    TimHandle.Init.ClockDivision = 0x00000000U;
    TimHandle.Init.CounterMode = 0x00000000U;
    if (HAL_TIM_PWM_Init(&TimHandle) != HAL_OK) {

        return 
# 101 "./src/main/drivers/light_ws2811strip_hal.c" 3 4
              0
# 101 "./src/main/drivers/light_ws2811strip_hal.c"
                   ;
    }
    ...
    IOConfigGPIOAF(ws2811IO, ((((uint32_t)0x00000002U)) | ((((uint32_t)0x00000003U)) << 2) | ((((uint32_t)0x00000002U)) << 5)), timerHardware->alternateFunction);

    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) |= ((0x1UL << (21U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) & ((0x1UL << (21U)))); ((void)(tmpreg)); } while(0);
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) |= ((0x1UL << (22U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) & ((0x1UL << (22U)))); ((void)(tmpreg)); } while(0);
    ...
    hdma_tim.Init.Direction = (0x1UL << (6U));
    hdma_tim.Init.PeriphInc = 0x00000000U;
    hdma_tim.Init.MemInc = (0x1UL << (10U));
    hdma_tim.Init.PeriphDataAlignment = (0x2UL << (11U));
    hdma_tim.Init.MemDataAlignment = (0x2UL << (13U));
    hdma_tim.Init.Mode = 0x00000000U;
    hdma_tim.Init.Priority = (0x2UL << (16U));

    hdma_tim.Init.FIFOMode = 0x00000000U;
    hdma_tim.Init.FIFOThreshold = (0x3UL << (0U));
    hdma_tim.Init.MemBurst = 0x00000000U;
    hdma_tim.Init.PeriphBurst = 0x00000000U;



    hdma_tim.Instance = (DMA_Stream_TypeDef *)dmaRef;

    uint16_t dmaIndex = timerDmaIndex(timerChannel);


    do{ (&TimHandle)->hdma[dmaIndex] = &(hdma_tim); (hdma_tim).Parent = (&TimHandle); } while(0);

    dmaEnable(dmaGetIdentifier(dmaRef));
    dmaSetHandler(dmaGetIdentifier(dmaRef), WS2811_DMA_IRQHandler, (((((1)<<(4-(7-(((uint32_t)0x00000005U)))))|((2)&(0x0f>>(7-(((uint32_t)0x00000005U))))))<<4)&0xf0), dmaIndex);


    if (HAL_DMA_Init(TimHandle.hdma[dmaIndex]) != HAL_OK) {

        return 
# 147 "./src/main/drivers/light_ws2811strip_hal.c" 3 4
              0
# 147 "./src/main/drivers/light_ws2811strip_hal.c"
                   ;
    }
    ...
    TIM_OCInitStructure.OCMode = ((0x0004UL << (4U)) | (0x0002UL << (4U)));
    TIM_OCInitStructure.OCIdleState = 0x00000000U;
    TIM_OCInitStructure.OCPolarity = (timerHardware->output & TIMER_OUTPUT_INVERTED) ? (0x1UL << (1U)) : 0x00000000U;
    TIM_OCInitStructure.OCNIdleState = 0x00000000U;
    TIM_OCInitStructure.OCNPolarity = (timerHardware->output & TIMER_OUTPUT_INVERTED) ? (0x1UL << (3U)) : 0x00000000U;
    TIM_OCInitStructure.Pulse = 0;
    TIM_OCInitStructure.OCFastMode = 0x00000000U;
    if (HAL_TIM_PWM_ConfigChannel(&TimHandle, &TIM_OCInitStructure, timerChannel) != HAL_OK) {

        return 
# 162 "./src/main/drivers/light_ws2811strip_hal.c" 3 4
              0
# 162 "./src/main/drivers/light_ws2811strip_hal.c"
                   ;
    }
    if (timerHardware->output & TIMER_OUTPUT_N_CHANNEL) {
        if (HAL_TIMEx_PWMN_Start(&TimHandle, timerChannel) != HAL_OK) {
            ...
            return 
# 167 "./src/main/drivers/light_ws2811strip_hal.c" 3 4
                  0
# 167 "./src/main/drivers/light_ws2811strip_hal.c"
                       ;
        }
    } else {
        if (HAL_TIM_PWM_Start(&TimHandle, timerChannel) != HAL_OK) {
            ...
            return 
# 172 "./src/main/drivers/light_ws2811strip_hal.c" 3 4
                  0
# 172 "./src/main/drivers/light_ws2811strip_hal.c"
                       ;
        }
    }

    return 
# 176 "./src/main/drivers/light_ws2811strip_hal.c" 3 4
          1
# 176 "./src/main/drivers/light_ws2811strip_hal.c"
              ;
}

void ws2811LedStripDMAEnable(void)
{
    if (DMA_SetCurrDataCounter(&TimHandle, timerChannel, ledStripDMABuffer, (32 * 32 + 42)) != HAL_OK) {

        ws2811LedDataTransferInProgress = 
# 183 "./src/main/drivers/light_ws2811strip_hal.c" 3 4
                                         0
# 183 "./src/main/drivers/light_ws2811strip_hal.c"
                                              ;
        return;
    }
