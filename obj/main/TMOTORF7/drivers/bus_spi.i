...
# 37 "./src/main/drivers/bus_spi_impl.h"
...
typedef struct spiHardware_s {
    SPIDevice device;
    SPI_TypeDef *reg;
    spiPinDef_t sckPins[4];
    spiPinDef_t misoPins[4];
    spiPinDef_t mosiPins[4];
...
# 78 "./src/main/drivers/bus_spi_impl.h" 3 4
   _Bool 
# 78 "./src/main/drivers/bus_spi_impl.h"
        leadingEdge;
...
extern spiDevice_t spiDevice[4];

void spiInitDevice(SPIDevice device);
void spiInternalInitStream(const extDevice_t *dev, 
# 87 "./src/main/drivers/bus_spi_impl.h" 3 4
                                                  _Bool 
# 87 "./src/main/drivers/bus_spi_impl.h"
                                                       preInit);
...
# 36 "./src/main/drivers/bus_spi.c" 2
...
# 38 "./src/main/drivers/bus_spi.c" 2
...
# 39 "./src/main/drivers/bus_spi.c" 2
# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 40 "./src/main/drivers/bus_spi.c" 2
...
# 41 "./src/main/drivers/bus_spi.c" 2



static uint8_t spiRegisteredDeviceCount = 0;

spiDevice_t spiDevice[4];
busDevice_t spiBusDevice[4];

SPIDevice spiDeviceByInstance(SPI_TypeDef *instance)
{

    if (instance == ((SPI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3000UL))) {
        return SPIDEV_1;
    }



    if (instance == ((SPI_TypeDef *) (0x40000000UL + 0x3800UL))) {
        return SPIDEV_2;
    }



    if (instance == ((SPI_TypeDef *) (0x40000000UL + 0x3C00UL))) {
        return SPIDEV_3;
    }
...
SPI_TypeDef *spiInstanceByDevice(SPIDevice device)
{
    if (device == SPIINVALID || device >= 4) {
        return 
# 93 "./src/main/drivers/bus_spi.c" 3 4
              ((void *)0)
# 93 "./src/main/drivers/bus_spi.c"
                  ;
    }
...
# 99 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 99 "./src/main/drivers/bus_spi.c"
    spiInit(SPIDevice device)
{
    switch (device) {
    case SPIINVALID:
...
# 103 "./src/main/drivers/bus_spi.c"
    ...
    case SPIDEV_1:
        ...
        return 
# 108 "./src/main/drivers/bus_spi.c" 3 4
              1
# 108 "./src/main/drivers/bus_spi.c"
                  ;
...
# 124 "./src/main/drivers/bus_spi.c"
    ...
    return 
# 153 "./src/main/drivers/bus_spi.c" 3 4
          0
# 153 "./src/main/drivers/bus_spi.c"
               ;
}



# 157 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 157 "./src/main/drivers/bus_spi.c"
    spiIsBusy(const extDevice_t *dev)
{
    return (dev->bus->curSegment != (busSegment_t *)0x0);
}
...
void spiWait(const extDevice_t *dev)
{
    ...
    while (dev->bus->curSegment != (busSegment_t *)0x0);
}
...
void spiReadWriteBuf(const extDevice_t *dev, uint8_t *txData, uint8_t *rxData, int len)
{
    ...
    busSegment_t segments[] = {
            {.u.buffers = {txData, rxData}, len, 
# 174 "./src/main/drivers/bus_spi.c" 3 4
                                                1
# 174 "./src/main/drivers/bus_spi.c"
                                                    , 
# 174 "./src/main/drivers/bus_spi.c" 3 4
                                                      ((void *)0)
# 174 "./src/main/drivers/bus_spi.c"
            ...
            {.u.link = {
# 175 "./src/main/drivers/bus_spi.c" 3 4
                       ((void *)0)
# 175 "./src/main/drivers/bus_spi.c"
                           , 
# 175 "./src/main/drivers/bus_spi.c" 3 4
                             ((void *)0)
# 175 "./src/main/drivers/bus_spi.c"
...
# 184 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 184 "./src/main/drivers/bus_spi.c"
    spiReadWriteBufRB(const extDevice_t *dev, uint8_t *txData, uint8_t *rxData, int length)
{

    if (spiIsBusy(dev)) {
        return 
# 188 "./src/main/drivers/bus_spi.c" 3 4
              0
# 188 "./src/main/drivers/bus_spi.c"
                   ;
    }
    ...
    return 
# 193 "./src/main/drivers/bus_spi.c" 3 4
          1
# 193 "./src/main/drivers/bus_spi.c"
              ;
}
...
uint8_t spiReadWrite(const extDevice_t *dev, uint8_t data)
{
    ...
    busSegment_t segments[] = {
            {.u.buffers = {&data, &retval}, sizeof(data), 
# 203 "./src/main/drivers/bus_spi.c" 3 4
                                                         1
# 203 "./src/main/drivers/bus_spi.c"
                                                             , 
# 203 "./src/main/drivers/bus_spi.c" 3 4
                                                               ((void *)0)
# 203 "./src/main/drivers/bus_spi.c"
...
# 221 "./src/main/drivers/bus_spi.c"
            ...
            {.u.buffers = {&data, &retval}, sizeof(data), 
# 222 "./src/main/drivers/bus_spi.c" 3 4
                                                         1
# 222 "./src/main/drivers/bus_spi.c"
                                                             , 
# 222 "./src/main/drivers/bus_spi.c" 3 4
                                                               ((void *)0)
# 222 "./src/main/drivers/bus_spi.c"
            ...
            {.u.link = {
# 223 "./src/main/drivers/bus_spi.c" 3 4
                       ((void *)0)
# 223 "./src/main/drivers/bus_spi.c"
                           , 
# 223 "./src/main/drivers/bus_spi.c" 3 4
                             ((void *)0)
# 223 "./src/main/drivers/bus_spi.c"
...
void spiWriteReg(const extDevice_t *dev, uint8_t reg, uint8_t data)
{
    ...
    busSegment_t segments[] = {
            {.u.buffers = {&reg, 
# 252 "./src/main/drivers/bus_spi.c" 3 4
                                ((void *)0)
...
# 252 "./src/main/drivers/bus_spi.c"
            ...
            {.u.buffers = {&data, 
# 253 "./src/main/drivers/bus_spi.c" 3 4
                                 ((void *)0)
# 253 "./src/main/drivers/bus_spi.c"
                                     }, sizeof(data), 
# 253 "./src/main/drivers/bus_spi.c" 3 4
                                                      1
# 253 "./src/main/drivers/bus_spi.c"
...
# 263 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 263 "./src/main/drivers/bus_spi.c"
    spiWriteRegRB(const extDevice_t *dev, uint8_t reg, uint8_t data)
{

    if (spiIsBusy(dev)) {
        return 
# 267 "./src/main/drivers/bus_spi.c" 3 4
              0
# 267 "./src/main/drivers/bus_spi.c"
                   ;
    }
    ...
    return 
# 272 "./src/main/drivers/bus_spi.c" 3 4
          1
# 272 "./src/main/drivers/bus_spi.c"
              ;
}
...
# 280 "./src/main/drivers/bus_spi.c"
            ...
            {.u.buffers = {
# 281 "./src/main/drivers/bus_spi.c" 3 4
                          ((void *)0)
# 281 "./src/main/drivers/bus_spi.c"
                              , data}, length, 
# 281 "./src/main/drivers/bus_spi.c" 3 4
                                               1
# 281 "./src/main/drivers/bus_spi.c"
...
# 281 "./src/main/drivers/bus_spi.c"
            ...
            {.u.link = {
# 282 "./src/main/drivers/bus_spi.c" 3 4
                       ((void *)0)
# 282 "./src/main/drivers/bus_spi.c"
                           , 
# 282 "./src/main/drivers/bus_spi.c" 3 4
                             ((void *)0)
# 282 "./src/main/drivers/bus_spi.c"
...
# 291 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 291 "./src/main/drivers/bus_spi.c"
    spiReadRegBufRB(const extDevice_t *dev, uint8_t reg, uint8_t *data, uint8_t length)
{

    if (spiIsBusy(dev)) {
        return 
# 295 "./src/main/drivers/bus_spi.c" 3 4
              0
# 295 "./src/main/drivers/bus_spi.c"
                   ;
    }
    ...
    return 
# 300 "./src/main/drivers/bus_spi.c" 3 4
          1
# 300 "./src/main/drivers/bus_spi.c"
              ;
}



# 304 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 304 "./src/main/drivers/bus_spi.c"
    spiReadRegMskBufRB(const extDevice_t *dev, uint8_t reg, uint8_t *data, uint8_t length)
{
...
void spiWriteRegBuf(const extDevice_t *dev, uint8_t reg, uint8_t *data, uint32_t length)
{
    ...
    busSegment_t segments[] = {
            {.u.buffers = {&reg, 
# 314 "./src/main/drivers/bus_spi.c" 3 4
                                ((void *)0)
# 314 "./src/main/drivers/bus_spi.c"
                                    }, sizeof(reg), 
# 314 "./src/main/drivers/bus_spi.c" 3 4
                                                    0
# 314 "./src/main/drivers/bus_spi.c"
...
# 315 "./src/main/drivers/bus_spi.c"
            ...
            {.u.link = {
# 316 "./src/main/drivers/bus_spi.c" 3 4
                       ((void *)0)
...
uint8_t spiReadReg(const extDevice_t *dev, uint8_t reg)
{
    ...
    busSegment_t segments[] = {
            {.u.buffers = {&reg, 
# 330 "./src/main/drivers/bus_spi.c" 3 4
                                ((void *)0)
# 330 "./src/main/drivers/bus_spi.c"
                                    }, sizeof(reg), 
# 330 "./src/main/drivers/bus_spi.c" 3 4
                                                    0
# 330 "./src/main/drivers/bus_spi.c"
...
# 330 "./src/main/drivers/bus_spi.c"
            ...
            {.u.buffers = {
# 331 "./src/main/drivers/bus_spi.c" 3 4
                          ((void *)0)
# 331 "./src/main/drivers/bus_spi.c"
                              , &data}, sizeof(data), 
# 331 "./src/main/drivers/bus_spi.c" 3 4
                                                      1
# 331 "./src/main/drivers/bus_spi.c"
...
# 331 "./src/main/drivers/bus_spi.c"
            ...
            {.u.link = {
# 332 "./src/main/drivers/bus_spi.c" 3 4
                       ((void *)0)
# 332 "./src/main/drivers/bus_spi.c"
                           , 
# 332 "./src/main/drivers/bus_spi.c" 3 4
                             ((void *)0)
# 332 "./src/main/drivers/bus_spi.c"
...
static void spiIrqHandler(const extDevice_t *dev)
{
    ...
    if (bus->curSegment->callback) {
        ...
        case BUS_BUSY:
            ...
            spiInternalInitStream(dev, 
# 392 "./src/main/drivers/bus_spi.c" 3 4
                                      1
# 392 "./src/main/drivers/bus_spi.c"
                                          );
            break;

        case BUS_ABORT:
            bus->curSegment = (busSegment_t *)0x0;
            return;
    ...
    if (nextSegment->len == 0) {
        ...
        if (nextSegment->u.link.dev) {
            ...
            nextSegment->u.link.dev = 
# 422 "./src/main/drivers/bus_spi.c" 3 4
                                     ((void *)0)
# 422 "./src/main/drivers/bus_spi.c"
                                         ;
...
# 430 "./src/main/drivers/bus_spi.c" 3 4
       _Bool 
# 430 "./src/main/drivers/bus_spi.c"
            negateCS = bus->curSegment->negateCS;
        ...
        if (bus->initSegment) {
            spiInternalInitStream(dev, 
# 436 "./src/main/drivers/bus_spi.c" 3 4
                                      0
# 436 "./src/main/drivers/bus_spi.c"
                                           );
            bus->initSegment = 
# 437 "./src/main/drivers/bus_spi.c" 3 4
                              0
# 437 "./src/main/drivers/bus_spi.c"
                                   ;
        }
        ...
        spiInternalInitStream(dev, 
# 449 "./src/main/drivers/bus_spi.c" 3 4
                                  1
# 449 "./src/main/drivers/bus_spi.c"
                                      );
    }
}
...
static void spiRxIrqHandler(dmaChannelDescriptor_t* descriptor)
{
    ...
    if (bus->curSegment->u.buffers.rxData) {
        ...
        SCB_InvalidateDCache_by_Addr(
            (uint32_t *)((uint32_t)bus->curSegment->u.buffers.rxData & ~(32 - 1)),
            (((uint32_t)bus->curSegment->u.buffers.rxData & (32 - 1)) +
              bus->curSegment->len - 1 + 32) & ~(32 - 1));
    }
...
# 513 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 513 "./src/main/drivers/bus_spi.c"
    spiSetBusInstance(extDevice_t *dev, uint32_t device)
{
    if ((device == 0) || (device > 4)) {
        return 
# 516 "./src/main/drivers/bus_spi.c" 3 4
              0
# 516 "./src/main/drivers/bus_spi.c"
                   ;
    }

    dev->bus = &spiBusDevice[((device) - 1)];


    dev->useDMA = 
# 522 "./src/main/drivers/bus_spi.c" 3 4
                 1
# 522 "./src/main/drivers/bus_spi.c"
                     ;
    ...
    if (dev->bus->busType == BUS_TYPE_SPI) {
        ...
        dev->bus->deviceCount++;
        return 
# 527 "./src/main/drivers/bus_spi.c" 3 4
              1
# 527 "./src/main/drivers/bus_spi.c"
                  ;
    }

    busDevice_t *bus = dev->bus;

    bus->busType_u.spi.instance = spiInstanceByDevice(((device) - 1));

    if (bus->busType_u.spi.instance == 
# 534 "./src/main/drivers/bus_spi.c" 3 4
                                      ((void *)0)
# 534 "./src/main/drivers/bus_spi.c"
                                          ) {
        return 
# 535 "./src/main/drivers/bus_spi.c" 3 4
              0
# 535 "./src/main/drivers/bus_spi.c"
                   ;
    }

    bus->busType = BUS_TYPE_SPI;
    bus->useDMA = 
# 539 "./src/main/drivers/bus_spi.c" 3 4
                 0
# 539 "./src/main/drivers/bus_spi.c"
                      ;
    bus->deviceCount = 1;
    ...
    return 
# 544 "./src/main/drivers/bus_spi.c" 3 4
          1
# 544 "./src/main/drivers/bus_spi.c"
              ;
}
...
{
    uint32_t device;
# 559 "./src/main/drivers/bus_spi.c"
    for (device = 0; device < 4; device++) {
        ...
        for (uint8_t opt = txDmaoptMin; opt <= txDmaoptMax; opt++) {
            ...
            if (dmaTxChannelSpec) {
                ...
                bus->dmaTx->stream = ((((dmaTxIdentifier)-1) % 8));
        ...
        for (uint8_t opt = rxDmaoptMin; opt <= rxDmaoptMax; opt++) {
            ...
            if (dmaRxChannelSpec) {
                ...
                bus->dmaRx->stream = ((((dmaRxIdentifier)-1) % 8));
        ...
        if (dmaTxIdentifier && dmaRxIdentifier) {
            ...
            dmaSetHandler(dmaRxIdentifier, spiRxIrqHandler, (((((0)<<(4-(7-(((uint32_t)0x00000005U)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005U))))))<<4)&0xf0), 0);

            bus->useDMA = 
# 650 "./src/main/drivers/bus_spi.c" 3 4
                         1
# 650 "./src/main/drivers/bus_spi.c"
                             ;

        } else if (dmaTxIdentifier) {

            bus->dmaTx = dmaGetDescriptorByIdentifier(dmaTxIdentifier);
            bus->dmaRx = (dmaChannelDescriptor_t *)
# 655 "./src/main/drivers/bus_spi.c" 3 4
                                                  ((void *)0)
# 655 "./src/main/drivers/bus_spi.c"
                                                      ;
            ...
            dmaSetHandler(dmaTxIdentifier, spiTxIrqHandler, (((((0)<<(4-(7-(((uint32_t)0x00000005U)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005U))))))<<4)&0xf0), 0);

            bus->useDMA = 
# 664 "./src/main/drivers/bus_spi.c" 3 4
                         1
# 664 "./src/main/drivers/bus_spi.c"
                             ;

        } else {

            bus->dmaRx = (dmaChannelDescriptor_t *)
# 668 "./src/main/drivers/bus_spi.c" 3 4
                                                  ((void *)0)
# 668 "./src/main/drivers/bus_spi.c"
                                                      ;
            bus->dmaTx = (dmaChannelDescriptor_t *)
# 669 "./src/main/drivers/bus_spi.c" 3 4
                                                  ((void *)0)
# 669 "./src/main/drivers/bus_spi.c"
                                                      ;
        }
    }
}
...
void spiSetClkPhasePolarity(const extDevice_t *dev, 
# 680 "./src/main/drivers/bus_spi.c" 3 4
                                                   _Bool 
# 680 "./src/main/drivers/bus_spi.c"
                                                        leadingEdge)
{
...
void spiDmaEnable(const extDevice_t *dev, 
# 686 "./src/main/drivers/bus_spi.c" 3 4
                                         _Bool 
# 686 "./src/main/drivers/bus_spi.c"
                                              enable)
{
...
# 691 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 691 "./src/main/drivers/bus_spi.c"
    spiUseDMA(const extDevice_t *dev)
{
...
# 697 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 697 "./src/main/drivers/bus_spi.c"
    spiUseMOSI_DMA(const extDevice_t *dev)
{
...
void spiSequence(const extDevice_t *dev, busSegment_t *segments)
{
    ...
    for ( uint8_t __basepri_save __attribute__ ((__cleanup__ (__basepriRestoreMem), __unused__)) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((0)<<(4-(7-(((uint32_t)0x00000005U)))))|((1)&(0x0f>>(7-(((uint32_t)0x00000005U))))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
        if (spiIsBusy(dev)) {
            ...
            if (endCmpSegment) {
                while (
# 737 "./src/main/drivers/bus_spi.c" 3 4
                      1
# 737 "./src/main/drivers/bus_spi.c"
                          ) {
                    ...
                    if (endCmpSegment->u.link.dev == 
# 749 "./src/main/drivers/bus_spi.c" 3 4
                                                    ((void *)0)
# 749 "./src/main/drivers/bus_spi.c"
                                                        ) {
