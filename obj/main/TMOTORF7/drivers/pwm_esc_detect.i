...
# 34 "./src/main/drivers/pwm_esc_detect.c" 2
...
# 36 "./src/main/drivers/pwm_esc_detect.c" 2
...
void detectBrushedESC(ioTag_t motorIoTag)
{
    ...
    IOConfigGPIO(motorDetectPin, ((((uint32_t)0x00000000U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000001U)) << 5)));
