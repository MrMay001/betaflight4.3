# 1 "./src/main/drivers/bus_spi_ll.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/bus_spi_ll.c"
# 21 "./src/main/drivers/bus_spi_ll.c"
# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include/stdbool.h" 1 3 4
# 22 "./src/main/drivers/bus_spi_ll.c" 2
...
# 23 "./src/main/drivers/bus_spi_ll.c" 2
...
# 24 "./src/main/drivers/bus_spi_ll.c" 2
...
# 153 "./src/main/platform.h" 2
# 26 "./src/main/drivers/bus_spi_ll.c" 2
...
# 31 "./src/main/drivers/bus_spi_ll.c" 2
...
# 33 "./src/main/drivers/bus_spi_ll.c" 2
...
# 34 "./src/main/drivers/bus_spi_ll.c" 2
...
# 35 "./src/main/drivers/bus_spi_ll.c" 2
...
# 37 "./src/main/drivers/bus_spi_ll.c" 2
...
# 38 "./src/main/drivers/bus_spi_ll.c" 2
# 82 "./src/main/drivers/bus_spi_ll.c"
static LL_SPI_InitTypeDef defaultInit =
{
    .TransferDirection = 0x00000000U,
    .Mode = ((0x1UL << (2U)) | (0x1UL << (8U))),
    .DataWidth = ((0x4UL << (8U)) | (0x2UL << (8U)) | (0x1UL << (8U))),
    .NSS = ((0x1UL << (9U))),
    .BaudRate = ((0x2UL << (3U))),
    .BitOrder = 0x00000000U,
    .CRCCalculation = 0x00000000U,
    .ClockPolarity = ((0x1UL << (1U))),
    .ClockPhase = ((0x1UL << (0U))),
};
...
static uint32_t spiDivisorToBRbits(SPI_TypeDef *instance, uint16_t divisor)
{
    ...
    if (instance == ((SPI_TypeDef *) (0x40000000UL + 0x3800UL)) || instance == ((SPI_TypeDef *) (0x40000000UL + 0x3C00UL))) {
        divisor /= 2;
    }
...
# 124 "./src/main/drivers/bus_spi_ll.c"
    return (ffs(divisor) - 2) << (3U);
...
void spiInitDevice(SPIDevice device)
{
    ...
    IOConfigGPIOAF(IOGetByTag(spi->miso), ((((uint32_t)0x00000002U)) | ((((uint32_t)0x00000003U)) << 2) | ((((uint32_t)0x00000001U)) << 5)), spi->misoAF);
    IOConfigGPIOAF(IOGetByTag(spi->mosi), ((((uint32_t)0x00000002U)) | ((((uint32_t)0x00000003U)) << 2) | ((((uint32_t)0x00000000U)) << 5)), spi->mosiAF);
    IOConfigGPIOAF(IOGetByTag(spi->sck), ((((uint32_t)0x00000002U)) | ((((uint32_t)0x00000003U)) << 2) | ((((uint32_t)0x00000001U)) << 5)), spi->sckAF);

    LL_SPI_Disable(spi->dev);
    LL_SPI_DeInit(spi->dev);
# 158 "./src/main/drivers/bus_spi_ll.c"
    LL_SPI_SetRxFIFOThreshold(spi->dev, (0x1UL << (12U)));
...
void spiInternalResetDescriptors(busDevice_t *bus)
{
    ...
    initTx->Mode = 0x00000000U;
    initTx->Direction = (0x1UL << (6U));



    initTx->PeriphOrM2MSrcAddress = (uint32_t)&bus->busType_u.spi.instance->DR;

    initTx->Priority = 0x00000000U;
    initTx->PeriphOrM2MSrcIncMode = 0x00000000U;
    initTx->PeriphOrM2MSrcDataSize = 0x00000000U;
    initTx->MemoryOrM2MDstDataSize = 0x00000000U;
    ...
    if (bus->dmaRx) {
        ...
        initRx->Mode = 0x00000000U;
        initRx->Direction = 0x00000000U;



        initRx->PeriphOrM2MSrcAddress = (uint32_t)&bus->busType_u.spi.instance->DR;

        initRx->Priority = 0x00000000U;
        initRx->PeriphOrM2MSrcIncMode = 0x00000000U;
        initRx->PeriphOrM2MSrcDataSize = 0x00000000U;
    }
}
...
void spiInternalResetStream(dmaChannelDescriptor_t *descriptor)
{
    ...
    if (descriptor->flagsShift > 31) descriptor->dma->HIFCR = (((uint32_t)0x00000010) | ((uint32_t)0x00000008) | ((uint32_t)0x00000020) << (descriptor->flagsShift - 32)); else descriptor->dma->LIFCR = (((uint32_t)0x00000010) | ((uint32_t)0x00000008) | ((uint32_t)0x00000020) << descriptor->flagsShift);
}


static 
# 225 "./src/main/drivers/bus_spi_ll.c" 3 4
      _Bool 
# 225 "./src/main/drivers/bus_spi_ll.c"
           spiInternalReadWriteBufPolled(SPI_TypeDef *instance, const uint8_t *txData, uint8_t *rxData, int len)
{
# 248 "./src/main/drivers/bus_spi_ll.c"
    ((instance->CR2) &= ~((0x1UL << (12U))));
    while (len > 1) {
    ...
    return 
# 284 "./src/main/drivers/bus_spi_ll.c" 3 4
          1
# 284 "./src/main/drivers/bus_spi_ll.c"
              ;
}

void spiInternalInitStream(const extDevice_t *dev, 
# 287 "./src/main/drivers/bus_spi_ll.c" 3 4
                                                  _Bool 
# 287 "./src/main/drivers/bus_spi_ll.c"
                                                       preInit)
{
    static __attribute__ ((section(".fastram_data"), aligned(4))) uint8_t dummyTxByte = 0xff;
    static __attribute__ ((section(".fastram_data"), aligned(4))) uint8_t dummyRxByte;
    ...
    if (txData) {
        ...
        if (!(((uint32_t)txData & 0xffff0000) == 0x20000000)) {


            SCB_CleanDCache_by_Addr(
                    (uint32_t *)((uint32_t)txData & ~(32 - 1)),
                    (((uint32_t)txData & (32 - 1)) + len - 1 + 32) & ~(32 - 1));
        }

        initTx->MemoryOrM2MDstAddress = (uint32_t)txData;
        initTx->MemoryOrM2MDstIncMode = (0x1UL << (10U));
    } else {
        initTx->MemoryOrM2MDstAddress = (uint32_t)&dummyTxByte;
        initTx->MemoryOrM2MDstIncMode = 0x00000000U;
    }
    initTx->NbData = len;
    ...
    if (dev->bus->dmaRx) {
        ...
        if (rxData) {
# 348 "./src/main/drivers/bus_spi_ll.c"
            if (!(((uint32_t)rxData & 0xffff0000) == 0x20000000)) {

                SCB_CleanInvalidateDCache_by_Addr(
                        (uint32_t *)((uint32_t)rxData & ~(32 - 1)),
                        (((uint32_t)rxData & (32 - 1)) + len - 1 + 32) & ~(32 - 1));
            }

        initRx->MemoryOrM2MDstAddress = (uint32_t)rxData;
        initRx->MemoryOrM2MDstIncMode = (0x1UL << (10U));
    } else {
        initRx->MemoryOrM2MDstAddress = (uint32_t)&dummyRxByte;
        initRx->MemoryOrM2MDstIncMode = 0x00000000U;
    }
    initRx->NbData = len;
...
void spiInternalStartDMA(const extDevice_t *dev)
{
    ...
    if (dmaRx) {
        ...
        if (dmaTx->flagsShift > 31) dmaTx->dma->HIFCR = (((uint32_t)0x00000010) | ((uint32_t)0x00000008) | ((uint32_t)0x00000020) << (dmaTx->flagsShift - 32)); else dmaTx->dma->LIFCR = (((uint32_t)0x00000010) | ((uint32_t)0x00000008) | ((uint32_t)0x00000020) << dmaTx->flagsShift);
        if (dmaRx->flagsShift > 31) dmaRx->dma->HIFCR = (((uint32_t)0x00000010) | ((uint32_t)0x00000008) | ((uint32_t)0x00000020) << (dmaRx->flagsShift - 32)); else dmaRx->dma->LIFCR = (((uint32_t)0x00000010) | ((uint32_t)0x00000008) | ((uint32_t)0x00000020) << dmaRx->flagsShift);
# 406 "./src/main/drivers/bus_spi_ll.c"
...
# 439 "./src/main/drivers/bus_spi_ll.c"
        LL_DMA_EnableStream(dmaTx->dma, dmaTx->stream);
        LL_DMA_EnableStream(dmaRx->dma, dmaRx->stream);

        ((dev->bus->busType_u.spi.instance->CR2) |= ((0x1UL << (1U)) | (0x1UL << (0U))));
        ...
        LL_DMA_Init(dmaTx->dma, dmaTx->stream, bus->initTx);
# 471 "./src/main/drivers/bus_spi_ll.c"
        LL_DMA_EnableStream(dmaTx->dma, dmaTx->stream);

        ((dev->bus->busType_u.spi.instance->CR2) |= ((0x1UL << (1U))));
    }
...
# 538 "./src/main/drivers/bus_spi_ll.c" 3 4
   _Bool 
# 538 "./src/main/drivers/bus_spi_ll.c"
        dmaSafe = dev->useDMA;
    uint32_t xferLen = 0;
    uint32_t segmentCount = 0;

    bus->initSegment = 
# 542 "./src/main/drivers/bus_spi_ll.c" 3 4
                      1
# 542 "./src/main/drivers/bus_spi_ll.c"
                          ;
    ...
    if (dev->busType_u.spi.leadingEdge != bus->busType_u.spi.leadingEdge) {
        if (dev->busType_u.spi.leadingEdge) {
            IOConfigGPIOAF(IOGetByTag(spi->sck), ((((uint32_t)0x00000002U)) | ((((uint32_t)0x00000003U)) << 2) | ((((uint32_t)0x00000002U)) << 5)), spi->sckAF);
            LL_SPI_SetClockPhase(instance, 0x00000000U);
            LL_SPI_SetClockPolarity(instance, 0x00000000U);
        }
        else {
            IOConfigGPIOAF(IOGetByTag(spi->sck), ((((uint32_t)0x00000002U)) | ((((uint32_t)0x00000003U)) << 2) | ((((uint32_t)0x00000001U)) << 5)), spi->sckAF);
            LL_SPI_SetClockPhase(instance, ((0x1UL << (0U))));
            LL_SPI_SetClockPolarity(instance, ((0x1UL << (1U))));
        }
...
# 584 "./src/main/drivers/bus_spi_ll.c"
    for (busSegment_t *checkSegment = (busSegment_t *)bus->curSegment; checkSegment->len; checkSegment++) {

        if ((checkSegment->u.buffers.rxData) && (bus->dmaRx == (dmaChannelDescriptor_t *)
# 586 "./src/main/drivers/bus_spi_ll.c" 3 4
                                                                                        ((void *)0)
# 586 "./src/main/drivers/bus_spi_ll.c"
                                                                                            )) {
            dmaSafe = 
# 587 "./src/main/drivers/bus_spi_ll.c" 3 4
                     0
# 587 "./src/main/drivers/bus_spi_ll.c"
                          ;
            break;
        }
# 607 "./src/main/drivers/bus_spi_ll.c"
        if ((checkSegment->u.buffers.rxData) &&

            (!(((uint32_t)checkSegment->u.buffers.rxData & 0xffff0000) == 0x20000000) &&
            (((uint32_t)checkSegment->u.buffers.rxData & (32 - 1)) || (checkSegment->len & (32 - 1))))) {
            dmaSafe = 
# 611 "./src/main/drivers/bus_spi_ll.c" 3 4
                     0
# 611 "./src/main/drivers/bus_spi_ll.c"
                          ;
            break;
        }
# 630 "./src/main/drivers/bus_spi_ll.c"
        segmentCount++;
...
# 638 "./src/main/drivers/bus_spi_ll.c" 3 4
                                  0
# 638 "./src/main/drivers/bus_spi_ll.c"
                                       );
        ...
        busSegment_t *lastSegment = 
# 646 "./src/main/drivers/bus_spi_ll.c" 3 4
                                   ((void *)0)
# 646 "./src/main/drivers/bus_spi_ll.c"
                                       ;
        
# 647 "./src/main/drivers/bus_spi_ll.c" 3 4
       _Bool 
# 647 "./src/main/drivers/bus_spi_ll.c"
            segmentComplete;
        ...
        while (bus->curSegment->len) {
            ...
            segmentComplete = 
# 667 "./src/main/drivers/bus_spi_ll.c" 3 4
                             1
# 667 "./src/main/drivers/bus_spi_ll.c"
                                 ;
            if (bus->curSegment->callback) {
                ...
                case BUS_BUSY:
                    ...
                    segmentComplete = 
# 672 "./src/main/drivers/bus_spi_ll.c" 3 4
                                     0
# 672 "./src/main/drivers/bus_spi_ll.c"
                                          ;
                    break;
                ...
                case BUS_ABORT:
                    ...
                    segmentComplete = 
# 677 "./src/main/drivers/bus_spi_ll.c" 3 4
                                     0
# 677 "./src/main/drivers/bus_spi_ll.c"
                                          ;
                    return;
        ...
        if (bus->curSegment->u.link.dev) {
            ...
            endSegment->u.link.dev = 
# 703 "./src/main/drivers/bus_spi_ll.c" 3 4
                                    ((void *)0)
# 703 "./src/main/drivers/bus_spi_ll.c"
                                        ;
