# 1 "./src/main/drivers/serial_uart_hal.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/serial_uart_hal.c"
# 27 "./src/main/drivers/serial_uart_hal.c"
# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include/stdbool.h" 1 3 4
# 28 "./src/main/drivers/serial_uart_hal.c" 2
...
# 29 "./src/main/drivers/serial_uart_hal.c" 2
...
# 30 "./src/main/drivers/serial_uart_hal.c" 2
...
# 153 "./src/main/platform.h" 2
# 32 "./src/main/drivers/serial_uart_hal.c" 2
...
# 36 "./src/main/drivers/serial_uart_hal.c" 2
...
# 37 "./src/main/drivers/serial_uart_hal.c" 2
...
# 40 "./src/main/drivers/serial_uart_hal.c" 2
# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 41 "./src/main/drivers/serial_uart_hal.c" 2
...
# 27 "./src/main/drivers/inverter.h"
                                               on);
# 42 "./src/main/drivers/serial_uart_hal.c" 2
...
# 43 "./src/main/drivers/serial_uart_hal.c" 2
...
# 44 "./src/main/drivers/serial_uart_hal.c" 2
...
# 47 "./src/main/drivers/serial_uart_hal.c" 2
...
# 48 "./src/main/drivers/serial_uart_hal.c" 2

static void usartConfigurePinInversion(uartPort_t *uartPort) {
    
# 50 "./src/main/drivers/serial_uart_hal.c" 3 4
   _Bool 
# 50 "./src/main/drivers/serial_uart_hal.c"
    ...
    if (inverted)
    {
        ...
        {
            uartPort->Handle.AdvancedInit.AdvFeatureInit |= 0x00000002U;
            uartPort->Handle.AdvancedInit.RxPinLevelInvert = (0x1UL << (16U));
        }
        if (uartPort->port.mode & MODE_TX)
        {
            uartPort->Handle.AdvancedInit.AdvFeatureInit |= 0x00000001U;
            uartPort->Handle.AdvancedInit.TxPinLevelInvert = (0x1UL << (17U));
        }
    }
}
...
static uartDevice_t *uartFindDevice(uartPort_t *uartPort)
{
    ...
    return 
# 76 "./src/main/drivers/serial_uart_hal.c" 3 4
          ((void *)0)
# 76 "./src/main/drivers/serial_uart_hal.c"
              ;
}
...
static void uartConfigurePinSwap(uartPort_t *uartPort)
{
    ...
    if (!uartDevice) {
        return 
# 84 "./src/main/drivers/serial_uart_hal.c" 3 4
              ((void *)0)
# 84 "./src/main/drivers/serial_uart_hal.c"
                  ;
    }

    if (uartDevice->pinSwap) {
        uartDevice->port.Handle.AdvancedInit.AdvFeatureInit |= 0x00000008U;
        uartDevice->port.Handle.AdvancedInit.Swap = (0x1UL << (15U));
    }
}
...
void uartReconfigure(uartPort_t *uartPort)
{
    ...
    uartPort->Handle.Init.WordLength = (uartPort->port.options & SERIAL_PARITY_EVEN) ? (0x00001UL << (12U)) : 0x00000000U;
    uartPort->Handle.Init.StopBits = (uartPort->port.options & SERIAL_STOPBITS_2) ? (0x2UL << (12U)) : 0x00000000U;
    uartPort->Handle.Init.Parity = (uartPort->port.options & SERIAL_PARITY_EVEN) ? (0x1UL << (10U)) : 0x00000000U;
    uartPort->Handle.Init.HwFlowCtl = 0x00000000U;
    uartPort->Handle.Init.OneBitSampling = 0x00000000U;
    ...
    if (uartPort->port.mode & MODE_RX)
        uartPort->Handle.Init.Mode |= (0x1UL << (2U));
    if (uartPort->port.mode & MODE_TX)
        uartPort->Handle.Init.Mode |= (0x1UL << (3U));
    ...
    if (uartPort->port.mode & MODE_RX)
    {
        ...
        {
            uartPort->rxDMAHandle.Instance = (DMA_Stream_TypeDef *)uartPort->rxDMAResource;

            uartPort->rxDMAHandle.Init.Channel = uartPort->rxDMAChannel;



            uartPort->rxDMAHandle.Init.Direction = 0x00000000U;
            uartPort->rxDMAHandle.Init.PeriphInc = 0x00000000U;
            uartPort->rxDMAHandle.Init.MemInc = (0x1UL << (10U));
            uartPort->rxDMAHandle.Init.PeriphDataAlignment = 0x00000000U;
            uartPort->rxDMAHandle.Init.MemDataAlignment = 0x00000000U;
            uartPort->rxDMAHandle.Init.Mode = (0x1UL << (8U));

            uartPort->rxDMAHandle.Init.FIFOMode = 0x00000000U;
            uartPort->rxDMAHandle.Init.FIFOThreshold = 0x00000000U;
            uartPort->rxDMAHandle.Init.PeriphBurst = 0x00000000U;
            uartPort->rxDMAHandle.Init.MemBurst = 0x00000000U;

            uartPort->rxDMAHandle.Init.Priority = (0x1UL << (16U));


            HAL_DMA_DeInit(&uartPort->rxDMAHandle);
            HAL_DMA_Init(&uartPort->rxDMAHandle);

            do{ (&uartPort->Handle)->hdmarx = &(uartPort->rxDMAHandle); (uartPort->rxDMAHandle).Parent = (&uartPort->Handle); } while(0);
...

        {
            ...
            ((uartPort->USARTx->CR1) |= ((0x1UL << (8U))));


            ((uartPort->USARTx->CR3) |= ((0x1UL << (0U))));


            ((uartPort->USARTx->CR1) |= ((0x1UL << (5U))));


            ((uartPort->USARTx->CR1) |= ((0x1UL << (4U))));
        }
    }
    ...
    if (uartPort->port.mode & MODE_TX) {
        ...
        if (uartPort->txDMAResource) {
            uartPort->txDMAHandle.Instance = (DMA_Stream_TypeDef *)uartPort->txDMAResource;

            uartPort->txDMAHandle.Init.Channel = uartPort->txDMAChannel;



            uartPort->txDMAHandle.Init.Direction = (0x1UL << (6U));
            uartPort->txDMAHandle.Init.PeriphInc = 0x00000000U;
            uartPort->txDMAHandle.Init.MemInc = (0x1UL << (10U));
            uartPort->txDMAHandle.Init.PeriphDataAlignment = 0x00000000U;
            uartPort->txDMAHandle.Init.MemDataAlignment = 0x00000000U;
            uartPort->txDMAHandle.Init.Mode = 0x00000000U;


            uartPort->txDMAHandle.Init.FIFOMode = 0x00000000U;
            uartPort->txDMAHandle.Init.FIFOThreshold = 0x00000000U;
            uartPort->txDMAHandle.Init.PeriphBurst = 0x00000000U;
            uartPort->txDMAHandle.Init.MemBurst = 0x00000000U;

            uartPort->txDMAHandle.Init.Priority = (0x1UL << (16U));
            ...
            do{ (&uartPort->Handle)->hdmatx = &(uartPort->txDMAHandle); (uartPort->txDMAHandle).Parent = (&uartPort->Handle); } while(0);

            ((&uartPort->txDMAHandle)->Instance->NDTR = (uint16_t)(0));
        } else

        {


            ((uartPort->USARTx->CR1) |= ((0x1UL << (7U))));
        }
    }
    return;
}
...
void uartTryStartTxDMA(uartPort_t *s)
{
    for ( uint8_t __basepri_save __attribute__ ((__cleanup__ (__basepriRestoreMem), __unused__)) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((1)<<(4-(7-(((uint32_t)0x00000005U)))))|((1)&(0x0f>>(7-(((uint32_t)0x00000005U))))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
        if ((((DMA_Stream_TypeDef *)(s->txDMAResource))->CR & (0x1UL << (0U)))) {

            return;
        }

        HAL_UART_StateTypeDef state = HAL_UART_GetState(&s->Handle);
        if ((state & 0x00000021U) == 0x00000021U) {
        ...
        if (s->port.txBufferHead == s->port.txBufferTail) {
            ...
            s->txDMAEmpty = 
# 255 "./src/main/drivers/serial_uart_hal.c" 3 4
                           1
# 255 "./src/main/drivers/serial_uart_hal.c"
                               ;
            return;
        }
        ...
        s->txDMAEmpty = 
# 269 "./src/main/drivers/serial_uart_hal.c" 3 4
                       0
# 269 "./src/main/drivers/serial_uart_hal.c"
                            ;
...
# 301 "./src/main/drivers/serial_uart_hal.c"
}
 ...
 void uartIrqHandler(uartPort_t *s)
{
    ...
    if ((((((huart)->Instance->ISR & (1U << ((0x0525U)>> 8U))) != RESET) ? SET : RESET) != RESET)) {
    ...
    if ((((((huart)->Instance->ISR & (1U << ((0x0028U)>> 8U))) != RESET) ? SET : RESET) != RESET)) {
        ((huart)->Instance->ICR = (uint32_t)((0x1UL << (0U))));
    }


    if ((((((huart)->Instance->ISR & (1U << ((0x0100U)>> 8U))) != RESET) ? SET : RESET) != RESET)) {
        ((huart)->Instance->ICR = (uint32_t)((0x1UL << (1U))));
    }


    if ((((((huart)->Instance->ISR & (1U << ((0x0200U)>> 8U))) != RESET) ? SET : RESET) != RESET)) {
        ((huart)->Instance->ICR = (uint32_t)((0x1UL << (2U))));
    }


    if ((((((huart)->Instance->ISR & (1U << ((0x0300U)>> 8U))) != RESET) ? SET : RESET) != RESET)) {
        ((huart)->Instance->ICR = (uint32_t)((0x1UL << (3U))));
    }
    ...
    if (
        ...
        (((((huart)->Instance->ISR & (1U << ((0x0727U)>> 8U))) != RESET) ? SET : RESET) != RESET)) {
    ...
    if ((((((huart)->Instance->ISR & (1U << ((0x0626U)>> 8U))) != RESET) ? SET : RESET) != RESET)) {
    ...
    if (((((huart)->Instance->ISR & (1U << ((0x0424U)>> 8U))) != RESET) ? SET : RESET)) {
