...
# 1 "./src/main/drivers/flash_w25n01g.h" 1
# 23 "./src/main/drivers/flash_w25n01g.h"
...
# 28 "./src/main/drivers/flash_w25n01g.h" 3 4
_Bool 
# 28 "./src/main/drivers/flash_w25n01g.h"
    w25n01g_detect(flashDevice_t *fdevice, uint32_t chipID);
# 35 "./src/main/drivers/flash.c" 2
# 1 "./src/main/drivers/flash_w25q128fv.h" 1

       
# 36 "./src/main/drivers/flash.c" 2
...
# 130 "./src/main/drivers/flash.c"
void flashPreInit(const flashConfig_t *flashConfig)
{
    spiPreinitRegister(flashConfig->csTag, ((((uint32_t)0x00000000U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000001U)) << 5)), 1);
}

static 
# 135 "./src/main/drivers/flash.c" 3 4
      _Bool 
# 135 "./src/main/drivers/flash.c"
           flashSpiInit(const flashConfig_t *flashConfig)
{
    ...
    if (flashConfig->csTag) {
        ...
        return 
# 143 "./src/main/drivers/flash.c" 3 4
              0
# 143 "./src/main/drivers/flash.c"
                   ;
    }

    if (!IOIsFreeOrPreinit(dev->busType_u.spi.csnPin)) {
        return 
# 147 "./src/main/drivers/flash.c" 3 4
              0
# 147 "./src/main/drivers/flash.c"
                   ;
    }

    if (!spiSetBusInstance(dev, flashConfig->spiDevice)) {
        return 
# 151 "./src/main/drivers/flash.c" 3 4
              0
# 151 "./src/main/drivers/flash.c"
                   ;
    }
    ...
    spiReadRegBuf(dev, 0x9F, readIdResponse, sizeof(readIdResponse));
    ...
    if (m25p16_detect(&flashDevice, chipID)) {
        return 
# 182 "./src/main/drivers/flash.c" 3 4
              1
# 182 "./src/main/drivers/flash.c"
                  ;
    }
# 193 "./src/main/drivers/flash.c"
    chipID = (readIdResponse[1] << 16) | (readIdResponse[2] << 8) | (readIdResponse[3]);
# 207 "./src/main/drivers/flash.c"
    spiPreinitByTag(flashConfig->csTag);

    return 
# 209 "./src/main/drivers/flash.c" 3 4
          0
# 209 "./src/main/drivers/flash.c"
               ;
}



# 213 "./src/main/drivers/flash.c" 3 4
_Bool 
# 213 "./src/main/drivers/flash.c"
    flashDeviceInit(const flashConfig_t *flashConfig)
{

    
# 216 "./src/main/drivers/flash.c" 3 4
   _Bool 
# 216 "./src/main/drivers/flash.c"
        useSpi = (((flashConfig->spiDevice) - 1) != SPIINVALID);

    if (useSpi) {
        return flashSpiInit(flashConfig);
    }
# 230 "./src/main/drivers/flash.c"
    return 
# 230 "./src/main/drivers/flash.c" 3 4
          0
# 230 "./src/main/drivers/flash.c"
               ;
}
...
# 233 "./src/main/drivers/flash.c" 3 4
_Bool 
# 233 "./src/main/drivers/flash.c"
    flashIsReady(void)
{
...
# 238 "./src/main/drivers/flash.c" 3 4
_Bool 
# 238 "./src/main/drivers/flash.c"
    flashWaitForReady(void)
{
...
void flashEraseSector(uint32_t address)
{
    flashDevice.callback = 
# 245 "./src/main/drivers/flash.c" 3 4
                          ((void *)0)
# 245 "./src/main/drivers/flash.c"
                              ;
...
{
    flashDevice.callback = 
# 251 "./src/main/drivers/flash.c" 3 4
                          ((void *)0)
# 251 "./src/main/drivers/flash.c"
                              ;
...
{
    flashDevice.callback = 
# 296 "./src/main/drivers/flash.c" 3 4
                          ((void *)0)
# 296 "./src/main/drivers/flash.c"
                              ;
...
static void flashConfigurePartitions(void)
{
    ...
    flashSector_t endSector = flashGeometry->sectors - 1;
...
flashPartition_t *flashPartitionFindByType(uint8_t type)
{
    ...
    return 
# 395 "./src/main/drivers/flash.c" 3 4
          ((void *)0)
# 395 "./src/main/drivers/flash.c"
              ;
}
...
const flashPartition_t *flashPartitionFindByIndex(uint8_t index)
{
    if (index >= flashPartitions) {
        return 
# 401 "./src/main/drivers/flash.c" 3 4
              ((void *)0)
# 401 "./src/main/drivers/flash.c"
                  ;
    }
...
const char *flashPartitionGetTypeName(flashPartitionType_e type)
{
    if (type < (sizeof(flashPartitionNames) / sizeof((flashPartitionNames)[0]))) {
        return flashPartitionNames[type];
    }

    return 
# 439 "./src/main/drivers/flash.c" 3 4
          ((void *)0)
# 439 "./src/main/drivers/flash.c"
              ;
}


# 442 "./src/main/drivers/flash.c" 3 4
_Bool 
# 442 "./src/main/drivers/flash.c"
    flashInit(const flashConfig_t *flashConfig)
{
...
# 447 "./src/main/drivers/flash.c" 3 4
   _Bool 
# 447 "./src/main/drivers/flash.c"
        haveFlash = flashDeviceInit(flashConfig);
