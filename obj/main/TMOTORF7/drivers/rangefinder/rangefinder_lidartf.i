        ...
        case TF_FRAME_STATE_WAIT_CKSUM:
            {
                ...
                if (c == cksum) {
                    ...
                    do { if (debugMode == (DEBUG_LIDAR_TF)) { debug[(0)] = (distance); } } while (0);
                    do { if (debugMode == (DEBUG_LIDAR_TF)) { debug[(1)] = (strength); } } while (0);
                    do { if (debugMode == (DEBUG_LIDAR_TF)) { debug[(2)] = (tfFrame[4]); } } while (0);
                    do { if (debugMode == (DEBUG_LIDAR_TF)) { debug[(3)] = (tfFrame[5]); } } while (0);
