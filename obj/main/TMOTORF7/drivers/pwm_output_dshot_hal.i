# 1 "./src/main/drivers/pwm_output_dshot_hal.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/pwm_output_dshot_hal.c"
# 21 "./src/main/drivers/pwm_output_dshot_hal.c"
# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include/stdbool.h" 1 3 4
# 22 "./src/main/drivers/pwm_output_dshot_hal.c" 2
...
# 23 "./src/main/drivers/pwm_output_dshot_hal.c" 2
...
# 24 "./src/main/drivers/pwm_output_dshot_hal.c" 2
...
# 153 "./src/main/platform.h" 2
# 26 "./src/main/drivers/pwm_output_dshot_hal.c" 2
...
# 30 "./src/main/drivers/pwm_output_dshot_hal.c" 2
...
# 32 "./src/main/drivers/pwm_output_dshot_hal.c" 2
...
# 34 "./src/main/drivers/pwm_output_dshot_hal.c" 2
...
# 35 "./src/main/drivers/pwm_output_dshot_hal.c" 2
...
# 36 "./src/main/drivers/pwm_output_dshot_hal.c" 2
...
# 37 "./src/main/drivers/pwm_output_dshot_hal.c" 2
...
# 38 "./src/main/drivers/pwm_output_dshot_hal.c" 2

# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 40 "./src/main/drivers/pwm_output_dshot_hal.c" 2
...
# 79 "./src/main/drivers/pwm_output.h"
    pwmIsSynced(void);
# 42 "./src/main/drivers/pwm_output_dshot_hal.c" 2
...
# 62 "./src/main/drivers/pwm_output_dshot_shared.h"
    pwmStartDshotMotorUpdate(void);
# 43 "./src/main/drivers/pwm_output_dshot_hal.c" 2
...
# 44 "./src/main/drivers/pwm_output_dshot_hal.c" 2
...
# 45 "./src/main/drivers/pwm_output_dshot_hal.c" 2
...
# 47 "./src/main/drivers/pwm_output_dshot_hal.c" 2
...
)
{
    ...
    LL_EX_DMA_DeInit((DMA_Stream_TypeDef *)(motor->dmaRef));


    motor->isInput = 
# 81 "./src/main/drivers/pwm_output_dshot_hal.c" 3 4
                    0
# 81 "./src/main/drivers/pwm_output_dshot_hal.c"
                         ;
    ...
    motor->dmaInitStruct.Direction = (0x1UL << (6U));

    LL_EX_DMA_Init((DMA_Stream_TypeDef *)(motor->dmaRef), pDmaInit);
    LL_EX_DMA_EnableIT_TC((DMA_Stream_TypeDef *)(motor->dmaRef));
}


__attribute__((section(".tcm_code"))) __attribute__((optimize("-O2"))) static void pwmDshotSetDirectionInput(
    motorDmaOutput_t * const motor
)
{
    LL_DMA_InitTypeDef* pDmaInit = &motor->dmaInitStruct;
    ...
    motor->isInput = 
# 105 "./src/main/drivers/pwm_output_dshot_hal.c" 3 4
                    1
# 105 "./src/main/drivers/pwm_output_dshot_hal.c"
                        ;
    if (!inputStampUs) {
        inputStampUs = micros();
    }
...
# 121 "./src/main/drivers/pwm_output_dshot_hal.c"
    LL_TIM_IC_Init(timer, motor->llChannel, &motor->icInitStruct);
# 133 "./src/main/drivers/pwm_output_dshot_hal.c"
    motor->dmaInitStruct.Direction = 0x00000000U;
    LL_EX_DMA_Init((DMA_Stream_TypeDef *)(motor->dmaRef), pDmaInit);
}



__attribute__((section(".tcm_code"))) __attribute__((optimize("-O2"))) void pwmCompleteDshotMotorUpdate(void)
{
    ...
    for (int i = 0; i < dmaMotorTimerCount; i++) {
        ...
        if (useBurstDshot) {
            LL_EX_DMA_SetDataLength((DMA_Stream_TypeDef *)(dmaMotorTimers[i].dmaBurstRef), dmaMotorTimers[i].dmaBurstLength);
            LL_EX_DMA_EnableResource((DMA_Stream_TypeDef *)(dmaMotorTimers[i].dmaBurstRef));


            LL_TIM_ConfigDMABurst(dmaMotorTimers[i].timer, ((0x08UL << (0U)) | (0x04UL << (0U)) | (0x01UL << (0U))), ((0x02UL << (8U)) | (0x01UL << (8U))));
...
__attribute__((section(".tcm_code"))) __attribute__((optimize("-O2"))) static void motor_DMA_IRQHandler(dmaChannelDescriptor_t* descriptor)
{
    if ((descriptor->flagsShift > 31 ? descriptor->dma->HISR & (((uint32_t)0x00000020) << (descriptor->flagsShift - 32)): descriptor->dma->LISR & (((uint32_t)0x00000020) << descriptor->flagsShift))) {
        ...
        if (!motor->isInput) {
            ...
            if (useBurstDshot) {
                LL_EX_DMA_DisableResource((DMA_Stream_TypeDef *)(motor->timerHardware->dmaTimUPRef));
                LL_TIM_DisableDMAReq_UPDATE(motor->timerHardware->tim);
            } else

            {
                LL_EX_DMA_DisableResource((DMA_Stream_TypeDef *)(motor->dmaRef));
            ...
            if (useDshotTelemetry) {
                ...
                LL_EX_DMA_SetDataLength((DMA_Stream_TypeDef *)(motor->dmaRef), 22);
                LL_EX_DMA_EnableResource((DMA_Stream_TypeDef *)(motor->dmaRef));
...
# 204 "./src/main/drivers/pwm_output_dshot_hal.c" 3 4
_Bool 
# 204 "./src/main/drivers/pwm_output_dshot_hal.c"
    pwmDshotMotorHardwareConfig(const timerHardware_t *timerHardware, uint8_t motorIndex, uint8_t reorderedMotorIndex, motorPwmProtocolTypes_e pwmProtocolType, uint8_t output)
{
# 216 "./src/main/drivers/pwm_output_dshot_hal.c"
    dmaResource_t *dmaRef = 
# 216 "./src/main/drivers/pwm_output_dshot_hal.c" 3 4
                           ((void *)0)
# 216 "./src/main/drivers/pwm_output_dshot_hal.c"
                               ;
    ...
    if (dmaSpec != 
# 221 "./src/main/drivers/pwm_output_dshot_hal.c" 3 4
                  ((void *)0)
# 221 "./src/main/drivers/pwm_output_dshot_hal.c"
                      ) {
        dmaRef = dmaSpec->ref;
    ...
    if (dmaRef == 
# 237 "./src/main/drivers/pwm_output_dshot_hal.c" 3 4
                 ((void *)0)
# 237 "./src/main/drivers/pwm_output_dshot_hal.c"
                     ) {
        return 
# 238 "./src/main/drivers/pwm_output_dshot_hal.c" 3 4
              0
# 238 "./src/main/drivers/pwm_output_dshot_hal.c"
                   ;
    }
...
# 243 "./src/main/drivers/pwm_output_dshot_hal.c" 3 4
   _Bool 
# 243 "./src/main/drivers/pwm_output_dshot_hal.c"
        dmaIsConfigured = 
# 243 "./src/main/drivers/pwm_output_dshot_hal.c" 3 4
                          0
# 243 "./src/main/drivers/pwm_output_dshot_hal.c"
    ...
    if (useBurstDshot) {
        ...
        if (owner->owner == OWNER_TIMUP && owner->resourceIndex == timerGetTIMNumber(timerHardware->tim)) {
            dmaIsConfigured = 
# 248 "./src/main/drivers/pwm_output_dshot_hal.c" 3 4
                             1
# 248 "./src/main/drivers/pwm_output_dshot_hal.c"
                                 ;
        } else if (!dmaAllocate(dmaIdentifier, OWNER_TIMUP, timerGetTIMNumber(timerHardware->tim))) {
            return 
# 250 "./src/main/drivers/pwm_output_dshot_hal.c" 3 4
                  0
# 250 "./src/main/drivers/pwm_output_dshot_hal.c"
                       ;
        }
    } else

    {
        if (!dmaAllocate(dmaIdentifier, OWNER_MOTOR, (reorderedMotorIndex + 1))) {
            return 
# 256 "./src/main/drivers/pwm_output_dshot_hal.c" 3 4
                  0
# 256 "./src/main/drivers/pwm_output_dshot_hal.c"
                       ;
        }
    }
    ...
    const 
# 266 "./src/main/drivers/pwm_output_dshot_hal.c" 3 4
         _Bool 
# 266 "./src/main/drivers/pwm_output_dshot_hal.c"
    ...
    uint8_t pupMode = (output & TIMER_OUTPUT_INVERTED) ? ((uint32_t)0x00000002U) : ((uint32_t)0x00000001U);
    ...
    motor->iocfg = ((((uint32_t)0x00000002U)) | ((((uint32_t)0x00000003U)) << 2) | ((pupMode) << 5));
    ...
    if (configureTimer) {
        ...
        init.Autoreload = (pwmProtocolType == PWM_TYPE_PROSHOT1000 ? (24 * 4) : 20) - 1;
        init.ClockDivision = 0x00000000U;
        init.RepetitionCounter = 0;
        init.CounterMode = 0x00000000U;
        LL_TIM_Init(timer, &init);
    }

    LL_TIM_OC_StructInit(&motor->ocInitStruct);
    motor->ocInitStruct.OCMode = ((0x0004UL << (4U)) | (0x0002UL << (4U)));
    if (output & TIMER_OUTPUT_N_CHANNEL) {
        motor->ocInitStruct.OCNState = (0x1UL << (0U));
        motor->ocInitStruct.OCNIdleState = 0x00000000U;
        motor->ocInitStruct.OCNPolarity = (output & TIMER_OUTPUT_INVERTED) ? (0x1UL << (1U)) : 0x00000000U;
    } else {
        motor->ocInitStruct.OCState = (0x1UL << (0U));
        motor->ocInitStruct.OCIdleState = (0x1UL << (8U));
        motor->ocInitStruct.OCPolarity = (output & TIMER_OUTPUT_INVERTED) ? (0x1UL << (1U)) : 0x00000000U;
    }
    motor->ocInitStruct.CompareValue = 0;


    LL_TIM_IC_StructInit(&motor->icInitStruct);
    motor->icInitStruct.ICPolarity = ((0x1UL << (1U)) | (0x1UL << (3U)));
    motor->icInitStruct.ICPrescaler = 0x00000000U;
    motor->icInitStruct.ICFilter = 2;


    uint32_t channel = 0;
    switch (timerHardware->channel) {
    case 0x00000000U: channel = (0x1UL << (0U)); break;
    case 0x00000004U: channel = (0x1UL << (4U)); break;
    case 0x00000008U: channel = (0x1UL << (8U)); break;
    case 0x0000000CU: channel = (0x1UL << (12U)); break;
    }
    ...
    if (!dmaIsConfigured) {
        LL_EX_DMA_DisableResource((DMA_Stream_TypeDef *)(dmaRef));
        LL_EX_DMA_DeInit((DMA_Stream_TypeDef *)(dmaRef));

        dmaEnable(dmaIdentifier);
    }

    LL_DMA_StructInit(&motor->dmaInitStruct);
    ...
    if (useBurstDshot) {
        ...
        motor->dmaInitStruct.Channel = dmaChannel;

        motor->dmaInitStruct.MemoryOrM2MDstAddress = (uint32_t)motor->timer->dmaBurstBuffer;

        motor->dmaInitStruct.FIFOThreshold = (0x3UL << (0U));

        motor->dmaInitStruct.PeriphOrM2MSrcAddress = (uint32_t)&timerHardware->tim->DMAR;
    } else

    {
        ...
        motor->dmaInitStruct.MemoryOrM2MDstAddress = (uint32_t)motor->dmaBuffer;

        motor->dmaInitStruct.FIFOThreshold = 0x00000000U;

        motor->dmaInitStruct.PeriphOrM2MSrcAddress = (uint32_t)timerChCCR(timerHardware);
    }

    motor->dmaInitStruct.Direction = (0x1UL << (6U));

    motor->dmaInitStruct.FIFOMode = (0x1UL << (2U));
    motor->dmaInitStruct.MemBurst = 0x00000000U;
    motor->dmaInitStruct.PeriphBurst = 0x00000000U;

    motor->dmaInitStruct.NbData = pwmProtocolType == PWM_TYPE_PROSHOT1000 ? 6 : 18;
    motor->dmaInitStruct.PeriphOrM2MSrcIncMode = 0x00000000U;
    motor->dmaInitStruct.MemoryOrM2MDstIncMode = (0x1UL << (10U));
    motor->dmaInitStruct.PeriphOrM2MSrcDataSize = (0x2UL << (11U));
    motor->dmaInitStruct.MemoryOrM2MDstDataSize = (0x2UL << (13U));
    motor->dmaInitStruct.Mode = 0x00000000U;
    motor->dmaInitStruct.Priority = (0x2UL << (16U));

    if (!dmaIsConfigured) {
        LL_EX_DMA_Init((DMA_Stream_TypeDef *)(dmaRef), &motor->dmaInitStruct);
        LL_EX_DMA_EnableIT_TC((DMA_Stream_TypeDef *)(dmaRef));
    }
    ...
    if (useBurstDshot) {
        if (!dmaIsConfigured) {
            dmaSetHandler(dmaIdentifier, motor_DMA_IRQHandler, (((((2)<<(4-(7-(((uint32_t)0x00000005U)))))|((1)&(0x0f>>(7-(((uint32_t)0x00000005U))))))<<4)&0xf0), motor->index);
        }
    } else
    ...
    LL_TIM_OC_Init(timer, channel, &motor->ocInitStruct);
    ...
    motor->configured = 
# 452 "./src/main/drivers/pwm_output_dshot_hal.c" 3 4
                       1
# 452 "./src/main/drivers/pwm_output_dshot_hal.c"
                           ;

    return 
# 454 "./src/main/drivers/pwm_output_dshot_hal.c" 3 4
          1
# 454 "./src/main/drivers/pwm_output_dshot_hal.c"
              ;
}
