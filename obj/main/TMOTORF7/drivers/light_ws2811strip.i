...
# 47 "./src/main/drivers/light_ws2811strip.c" 2
...
# 49 "./src/main/drivers/light_ws2811strip.c" 2
# 63 "./src/main/drivers/light_ws2811strip.c"
__attribute__ ((section(".fastram_bss"), aligned(4))) uint32_t ledStripDMABuffer[(32 * 32 + 42)];
...
static 
# 72 "./src/main/drivers/light_ws2811strip.c" 3 4
      _Bool 
# 72 "./src/main/drivers/light_ws2811strip.c"
           ws2811Initialised = 
# 72 "./src/main/drivers/light_ws2811strip.c" 3 4
                               0
# 72 "./src/main/drivers/light_ws2811strip.c"
                                    ;
volatile 
# 73 "./src/main/drivers/light_ws2811strip.c" 3 4
        _Bool 
# 73 "./src/main/drivers/light_ws2811strip.c"
             ws2811LedDataTransferInProgress = 
# 73 "./src/main/drivers/light_ws2811strip.c" 3 4
                                               0
# 73 "./src/main/drivers/light_ws2811strip.c"
...
static 
# 75 "./src/main/drivers/light_ws2811strip.c" 3 4
      _Bool 
# 75 "./src/main/drivers/light_ws2811strip.c"
           needsFullRefresh = 
# 75 "./src/main/drivers/light_ws2811strip.c" 3 4
                              1
# 75 "./src/main/drivers/light_ws2811strip.c"
...
void setUsedLedCount(unsigned ledCount)
{
    usedLedCount = (ledCount < 32) ? ledCount : 32;



    needsFullRefresh = 
# 124 "./src/main/drivers/light_ws2811strip.c" 3 4
                      1
# 124 "./src/main/drivers/light_ws2811strip.c"
                          ;
}
...
void ws2811LedStripEnable(void)
{
    if (!ws2811Initialised) {
        ...
        ws2811Initialised = 
# 146 "./src/main/drivers/light_ws2811strip.c" 3 4
                           1
# 146 "./src/main/drivers/light_ws2811strip.c"
                               ;
    }
}


# 150 "./src/main/drivers/light_ws2811strip.c" 3 4
_Bool 
# 150 "./src/main/drivers/light_ws2811strip.c"
    isWS2811LedStripReady(void)
{
    return ws2811Initialised && !ws2811LedDataTransferInProgress;
}

static void updateLEDDMABuffer(ledStripFormatRGB_e ledFormat, rgbColor24bpp_t *color, unsigned ledIndex)
{
    ...
    switch (ledFormat) {
        ...
        case LED_GRBW:
        {
            ...
            uint8_t white = __extension__ ({ __typeof__ (__extension__ ({ __typeof__ (color->rgb.r) _a = (color->rgb.r); __typeof__ (color->rgb.g) _b = (color->rgb.g); _a < _b ? _a : _b; })) _a = (__extension__ ({ __typeof__ (color->rgb.r) _a = (color->rgb.r); __typeof__ (color->rgb.g) _b = (color->rgb.g); _a < _b ? _a : _b; })); __typeof__ (color->rgb.b) _b = (color->rgb.b); _a < _b ? _a : _b; });
...
void ws2811UpdateStrip(ledStripFormatRGB_e ledFormat, uint8_t brightness)
{
    ...
    const unsigned ledUpdateCount = needsFullRefresh ? 32 : usedLedCount;
    ...
    needsFullRefresh = 
# 215 "./src/main/drivers/light_ws2811strip.c" 3 4
                      0
# 215 "./src/main/drivers/light_ws2811strip.c"
                           ;
    ...
    ws2811LedDataTransferInProgress = 
# 221 "./src/main/drivers/light_ws2811strip.c" 3 4
                                     1
# 221 "./src/main/drivers/light_ws2811strip.c"
                                         ;
