...
# 35 "./src/main/drivers/vtx_common.c" 2


static vtxDevice_t *vtxDevice = 
# 37 "./src/main/drivers/vtx_common.c" 3 4
                               ((void *)0)
# 37 "./src/main/drivers/vtx_common.c"
                                   ;
...
# 63 "./src/main/drivers/vtx_common.c" 3 4
_Bool 
# 63 "./src/main/drivers/vtx_common.c"
    vtxCommonDeviceIsReady(const vtxDevice_t *vtxDevice)
{
    ...
    return 
# 69 "./src/main/drivers/vtx_common.c" 3 4
          0
# 69 "./src/main/drivers/vtx_common.c"
               ;
}
...
# 115 "./src/main/drivers/vtx_common.c" 3 4
_Bool 
# 115 "./src/main/drivers/vtx_common.c"
    vtxCommonGetBandAndChannel(const vtxDevice_t *vtxDevice, uint8_t *pBand, uint8_t *pChannel)
{
...
# 117 "./src/main/drivers/vtx_common.c"
        result = vtxDevice->vTable->getBandAndChannel(vtxDevice, pBand, pChannel);
...
# 222 "./src/main/drivers/vtx_common.c" 3 4
_Bool 
# 222 "./src/main/drivers/vtx_common.c"
    vtxCommonLookupPowerValue(const vtxDevice_t *vtxDevice, int index, uint16_t *pPowerValue)
{
    if (vtxDevice && index > 0 && index <= vtxTablePowerLevels) {
        *pPowerValue = vtxTablePowerValues[index - 1];
        return 
# 226 "./src/main/drivers/vtx_common.c" 3 4
              1
# 226 "./src/main/drivers/vtx_common.c"
                  ;
    } else {
        return 
# 228 "./src/main/drivers/vtx_common.c" 3 4
              0
# 228 "./src/main/drivers/vtx_common.c"
                   ;
    }
}
...
{
    const 
# 234 "./src/main/drivers/vtx_common.c" 3 4
         _Bool 
# 234 "./src/main/drivers/vtx_common.c"
              customDeviceStatusAvailable = vtxDevice && vtxDevice->vTable->serializeCustomDeviceStatus;
...
void vtxCommonSerializeDeviceStatus(const vtxDevice_t *vtxDevice, sbuf_t *dst)
{
    if (vtxDevice) {
        ...
        const 
# 262 "./src/main/drivers/vtx_common.c" 3 4
             _Bool 
# 262 "./src/main/drivers/vtx_common.c"
                  deviceReady = vtxCommonDeviceIsReady(vtxDevice);

        uint8_t band = 0;
        uint8_t channel = 0;
        const 
# 266 "./src/main/drivers/vtx_common.c" 3 4
             _Bool 
# 266 "./src/main/drivers/vtx_common.c"
                  bandAndChannelAvailable = vtxCommonGetBandAndChannel(vtxDevice, &band, &channel);

        uint8_t powerIndex = 0;
        const 
# 269 "./src/main/drivers/vtx_common.c" 3 4
             _Bool 
# 269 "./src/main/drivers/vtx_common.c"
                  powerIndexAvailable = vtxCommonGetPowerIndex(vtxDevice, &powerIndex);

        uint16_t frequency = 0;
        const 
# 272 "./src/main/drivers/vtx_common.c" 3 4
             _Bool 
# 272 "./src/main/drivers/vtx_common.c"
                  frequencyAvailable = vtxCommonGetFrequency(vtxDevice, &frequency);

        unsigned vtxStatus = 0;
        const 
# 275 "./src/main/drivers/vtx_common.c" 3 4
             _Bool 
# 275 "./src/main/drivers/vtx_common.c"
                  vtxStatusAvailable = vtxCommonGetStatus(vtxDevice, &vtxStatus);
