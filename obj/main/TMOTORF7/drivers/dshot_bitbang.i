# 1 "./src/main/drivers/dshot_bitbang.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/dshot_bitbang.c"
# 21 "./src/main/drivers/dshot_bitbang.c"
...
# 22 "./src/main/drivers/dshot_bitbang.c" 2
...
# 23 "./src/main/drivers/dshot_bitbang.c" 2
...
# 24 "./src/main/drivers/dshot_bitbang.c" 2
...
# 153 "./src/main/platform.h" 2
# 26 "./src/main/drivers/dshot_bitbang.c" 2
...
# 30 "./src/main/drivers/dshot_bitbang.c" 2
...
# 31 "./src/main/drivers/dshot_bitbang.c" 2
...
# 33 "./src/main/drivers/dshot_bitbang.c" 2
...
# 34 "./src/main/drivers/dshot_bitbang.c" 2
...
# 35 "./src/main/drivers/dshot_bitbang.c" 2
...
# 36 "./src/main/drivers/dshot_bitbang.c" 2
...
# 37 "./src/main/drivers/dshot_bitbang.c" 2

# 1 "./src/main/drivers/dshot_bitbang_impl.h" 1
# 21 "./src/main/drivers/dshot_bitbang_impl.h"
...
# 25 "./src/main/drivers/dshot_bitbang_impl.h" 2
# 88 "./src/main/drivers/dshot_bitbang_impl.h"
typedef struct dmaRegCache_s {
    ...
    uint32_t PAR;
    uint32_t M0AR;
# 103 "./src/main/drivers/dshot_bitbang_impl.h"
} dmaRegCache_t;
...
# 169 "./src/main/drivers/dshot_bitbang_impl.h" 3 4
   _Bool 
# 169 "./src/main/drivers/dshot_bitbang_impl.h"
        inputActive;
...
# 189 "./src/main/drivers/dshot_bitbang_impl.h" 3 4
   _Bool 
# 189 "./src/main/drivers/dshot_bitbang_impl.h"
        configured;
    
# 190 "./src/main/drivers/dshot_bitbang_impl.h" 3 4
   _Bool 
# 190 "./src/main/drivers/dshot_bitbang_impl.h"
        enabled;
} bbMotor_t;


extern __attribute__ ((section(".fastram_bss"), aligned(4))) bbPacer_t bbPacers[4];
extern __attribute__ ((section(".fastram_bss"), aligned(4))) int usedMotorPacers;

extern __attribute__ ((section(".fastram_bss"), aligned(4))) bbPort_t bbPorts[4];
extern __attribute__ ((section(".fastram_bss"), aligned(4))) int usedMotorPorts;

extern __attribute__ ((section(".fastram_bss"), aligned(4))) bbMotor_t bbMotors[8];
...
extern uint32_t bbOutputBuffer[(((16 / 1) * 3) + 3) * 4];
# 233 "./src/main/drivers/dshot_bitbang_impl.h"
extern uint16_t bbInputBuffer[140 * 4];
...
# 39 "./src/main/drivers/dshot_bitbang.c" 2
...
# 40 "./src/main/drivers/dshot_bitbang.c" 2

# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 42 "./src/main/drivers/dshot_bitbang.c" 2
...
# 79 "./src/main/drivers/pwm_output.h"
    pwmIsSynced(void);
# 43 "./src/main/drivers/dshot_bitbang.c" 2
...
# 44 "./src/main/drivers/dshot_bitbang.c" 2
...
# 45 "./src/main/drivers/dshot_bitbang.c" 2
...
# 46 "./src/main/drivers/dshot_bitbang.c" 2




__attribute__ ((section(".fastram_bss"), aligned(4))) bbPacer_t bbPacers[4];
__attribute__ ((section(".fastram_bss"), aligned(4))) int usedMotorPacers = 0;

__attribute__ ((section(".fastram_bss"), aligned(4))) bbPort_t bbPorts[4];
__attribute__ ((section(".fastram_bss"), aligned(4))) int usedMotorPorts;

__attribute__ ((section(".fastram_bss"), aligned(4))) bbMotor_t bbMotors[8];

static __attribute__ ((section(".fastram_bss"), aligned(4))) int motorCount;
dshotBitbangStatus_e bbStatus;
# 84 "./src/main/drivers/dshot_bitbang.c"
__attribute__ ((section(".fastram_bss"), aligned(4))) uint32_t bbOutputBuffer[(((16 / 1) * 3) + 3) * 4];
__attribute__ ((section(".fastram_bss"), aligned(4))) uint16_t bbInputBuffer[140 * 4];

uint8_t bbPuPdMode;
__attribute__ ((section(".fastram_bss"), aligned(4))) timeUs_t dshotFrameUs;


const timerHardware_t bbTimerHardware[] = {


    { ((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x0400UL)), 0, 0x00000000U, TIM_USE_NONE, (TIMER_OUTPUT_NONE | 0), ((uint8_t)0x03U) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x040UL)), 0x0E000000U , (dmaResource_t *)((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x028UL)), 0x0E000000U, DMA2_ST1_HANDLER },
    { ((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x0400UL)), 0, 0x00000004U, TIM_USE_NONE, (TIMER_OUTPUT_NONE | 0), ((uint8_t)0x03U) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x058UL)), 0x0E000000U , (dmaResource_t *)((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x028UL)), 0x0E000000U, DMA2_ST1_HANDLER },
    { ((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x0400UL)), 0, 0x00000008U, TIM_USE_NONE, (TIMER_OUTPUT_NONE | 0), ((uint8_t)0x03U) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x070UL)), 0x0E000000U , (dmaResource_t *)((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x028UL)), 0x0E000000U, DMA2_ST1_HANDLER },
    { ((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x0400UL)), 0, 0x0000000CU, TIM_USE_NONE, (TIMER_OUTPUT_NONE | 0), ((uint8_t)0x03U) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x0B8UL)), 0x0E000000U , (dmaResource_t *)((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x028UL)), 0x0E000000U, DMA2_ST1_HANDLER },

    { ((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x0000UL)), 0, 0x00000000U, TIM_USE_NONE, (TIMER_OUTPUT_NONE | 0), ((uint8_t)0x01U) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x028UL)), 0x0C000000U , (dmaResource_t *)((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x088UL)), 0x0C000000U, DMA2_ST5_HANDLER },
    { ((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x0000UL)), 0, 0x00000000U, TIM_USE_NONE, (TIMER_OUTPUT_NONE | 0), ((uint8_t)0x01U) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x058UL)), 0x0C000000U , (dmaResource_t *)((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x088UL)), 0x0C000000U, DMA2_ST5_HANDLER },
    { ((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x0000UL)), 0, 0x00000004U, TIM_USE_NONE, (TIMER_OUTPUT_NONE | 0), ((uint8_t)0x01U) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x040UL)), 0x0C000000U , (dmaResource_t *)((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x088UL)), 0x0C000000U, DMA2_ST5_HANDLER },
    { ((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x0000UL)), 0, 0x00000008U, TIM_USE_NONE, (TIMER_OUTPUT_NONE | 0), ((uint8_t)0x01U) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x0A0UL)), 0x0C000000U , (dmaResource_t *)((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x088UL)), 0x0C000000U, DMA2_ST5_HANDLER },
    { ((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x0000UL)), 0, 0x0000000CU, TIM_USE_NONE, (TIMER_OUTPUT_NONE | 0), ((uint8_t)0x01U) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x070UL)), 0x0C000000U , (dmaResource_t *)((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x088UL)), 0x0C000000U, DMA2_ST5_HANDLER },
# 126 "./src/main/drivers/dshot_bitbang.c"
};

static __attribute__ ((section(".fastram_bss"), aligned(4))) motorDevice_t bbDevice;
static __attribute__ ((section(".fastram_bss"), aligned(4))) timeUs_t lastSendUs;

static motorPwmProtocolTypes_e motorPwmProtocol;



static void bbOutputDataInit(uint32_t *buffer, uint16_t portMask, 
# 135 "./src/main/drivers/dshot_bitbang.c" 3 4
                                                                 _Bool 
# 135 "./src/main/drivers/dshot_bitbang.c"
                                                                      inverted)
{
    uint32_t resetMask;
    uint32_t setMask;
    ...
    for (symbol_index = 0; symbol_index < 16; symbol_index++) {
        buffer[symbol_index * 3 + 0] |= setMask ;
        buffer[symbol_index * 3 + 1] = 0;
        buffer[symbol_index * 3 + 2] |= resetMask;
    }
# 165 "./src/main/drivers/dshot_bitbang.c"
    int hold_bit_index = 16 * 3;
    buffer[hold_bit_index + 0] |= resetMask;
    buffer[hold_bit_index + 1] = 0;
    buffer[hold_bit_index + 2] = 0;
}

static void bbOutputDataSet(uint32_t *buffer, int pinNumber, uint16_t value, 
# 171 "./src/main/drivers/dshot_bitbang.c" 3 4
                                                                            _Bool 
# 171 "./src/main/drivers/dshot_bitbang.c"
                                                                                 inverted)
{
    uint32_t middleBit;
...
static bbPacer_t *bbFindMotorPacer(TIM_TypeDef *tim)
{
    for (int i = 0; i < 4; i++) {
        ...
        if (bbPacer->tim == 
# 205 "./src/main/drivers/dshot_bitbang.c" 3 4
                           ((void *)0)
# 205 "./src/main/drivers/dshot_bitbang.c"
                               ) {
            bbPacer->tim = tim;
            ++usedMotorPacers;
            return bbPacer;
    ...
    return 
# 216 "./src/main/drivers/dshot_bitbang.c" 3 4
          ((void *)0)
# 216 "./src/main/drivers/dshot_bitbang.c"
              ;
}
...
static bbPort_t *bbFindMotorPort(int portIndex)
{
    ...
    return 
# 228 "./src/main/drivers/dshot_bitbang.c" 3 4
          ((void *)0)
# 228 "./src/main/drivers/dshot_bitbang.c"
              ;
}
...
static bbPort_t *bbAllocateMotorPort(int portIndex)
{
    if (usedMotorPorts >= 4) {
        ...
        return 
# 235 "./src/main/drivers/dshot_bitbang.c" 3 4
              ((void *)0)
# 235 "./src/main/drivers/dshot_bitbang.c"
                  ;
    }
    ...
    if (!bbPort->timhw) {
        ...
        return 
# 243 "./src/main/drivers/dshot_bitbang.c" 3 4
              ((void *)0)
# 243 "./src/main/drivers/dshot_bitbang.c"
                  ;
    }
...
const timerHardware_t *dshotBitbangTimerGetAllocatedByNumberAndChannel(int8_t timerNumber, uint16_t timerChannel)
{
    ...
    return 
# 264 "./src/main/drivers/dshot_bitbang.c" 3 4
          ((void *)0)
# 264 "./src/main/drivers/dshot_bitbang.c"
              ;
}
...
static void bbSetupDma(bbPort_t *bbPort)
{
    ...
    dmaSetHandler(dmaIdentifier, bbDMAIrqHandler, (((((2)<<(4-(7-(((uint32_t)0x00000005U)))))|((1)&(0x0f>>(7-(((uint32_t)0x00000005U))))))<<4)&0xf0), (uint32_t)bbPort);
...
{
    for (int bbPortIndex = 0; bbPortIndex < 4; bbPortIndex++) {
        for (unsigned timerIndex = 0; timerIndex < (sizeof(bbTimerHardware) / sizeof((bbTimerHardware)[0])); timerIndex++) {
...
# 359 "./src/main/drivers/dshot_bitbang.c" 3 4
           _Bool 
# 359 "./src/main/drivers/dshot_bitbang.c"
                timerConflict = 
# 359 "./src/main/drivers/dshot_bitbang.c" 3 4
                                0
# 359 "./src/main/drivers/dshot_bitbang.c"
            ...
            for (int channel = 0; channel < 4; channel++) {
                const timerHardware_t *timer = timerGetAllocatedByNumberAndChannel(timNumber, ((uint16_t)(channel) << 2));
                const resourceOwner_e timerOwner = timerGetOwner(timer)->owner;
                if (timerOwner != OWNER_FREE && timerOwner != OWNER_DSHOT_BITBANG) {
                    timerConflict = 
# 364 "./src/main/drivers/dshot_bitbang.c" 3 4
                                   1
# 364 "./src/main/drivers/dshot_bitbang.c"
                                       ;
                    break;
                }
            }
            ...
            for (int index = 0; index < bbPortIndex; index++) {
                ...
                if (timerGetTIMNumber(t->tim) == timNumber && timer->channel == t->channel) {
                    timerConflict = 
# 372 "./src/main/drivers/dshot_bitbang.c" 3 4
                                   1
# 372 "./src/main/drivers/dshot_bitbang.c"
                                       ;
                    break;
                }
            }
...
static void bbTimebaseSetup(bbPort_t *bbPort, motorPwmProtocolTypes_e dshotProtocolType)
{
    ...
    uint32_t inputFreq = outputFreq * 5 * 2 * 3 / 24;
...
static 
# 416 "./src/main/drivers/dshot_bitbang.c" 3 4
      _Bool 
# 416 "./src/main/drivers/dshot_bitbang.c"
           bbMotorConfig(IO_t io, uint8_t motorIndex, motorPwmProtocolTypes_e pwmProtocolType, uint8_t output)
{
    ...
    if (!bbPort) {
        ...
        if (!bbPort || !dmaAllocate(dmaGetIdentifier(bbPort->dmaResource), bbPort->owner.owner, bbPort->owner.resourceIndex)) {
            ...
            return 
# 447 "./src/main/drivers/dshot_bitbang.c" 3 4
                  0
# 447 "./src/main/drivers/dshot_bitbang.c"
                       ;
        }

        bbPort->gpio = IO_GPIO(io);

        bbPort->portOutputCount = (((16 / 1) * 3) + 3);
        bbPort->portOutputBuffer = &bbOutputBuffer[(bbPort - bbPorts) * (((16 / 1) * 3) + 3)];

        bbPort->portInputCount = 140;
        bbPort->portInputBuffer = &bbInputBuffer[(bbPort - bbPorts) * 140];
        ...
        bbSetupDma(bbPort);
        bbDMAPreconfigure(bbPort, 0);
        bbDMAPreconfigure(bbPort, 1);
    ...
    if (useDshotTelemetry) {
        bbOutputDataInit(bbPort->portOutputBuffer, (1 << pinIndex), 
# 482 "./src/main/drivers/dshot_bitbang.c" 3 4
                                                                   1
# 482 "./src/main/drivers/dshot_bitbang.c"
                                                                                         );
    } else

    {
        bbOutputDataInit(bbPort->portOutputBuffer, (1 << pinIndex), 
# 486 "./src/main/drivers/dshot_bitbang.c" 3 4
                                                                   0
# 486 "./src/main/drivers/dshot_bitbang.c"
                                                                                            );
    }

    bbSwitchToOutput(bbPort);

    bbMotors[motorIndex].configured = 
# 491 "./src/main/drivers/dshot_bitbang.c" 3 4
                                     1
# 491 "./src/main/drivers/dshot_bitbang.c"
                                         ;

    return 
# 493 "./src/main/drivers/dshot_bitbang.c" 3 4
          1
# 493 "./src/main/drivers/dshot_bitbang.c"
              ;
}

static 
# 496 "./src/main/drivers/dshot_bitbang.c" 3 4
      _Bool 
# 496 "./src/main/drivers/dshot_bitbang.c"
           bbUpdateStart(void)
{
    ...
    if (useDshotTelemetry) {
        ...
        if (cmpTimeUs(currentUs, lastSendUs) < (timeDelta_t)(40 + 2 * dshotFrameUs)) {
            return 
# 506 "./src/main/drivers/dshot_bitbang.c" 3 4
                  0
# 506 "./src/main/drivers/dshot_bitbang.c"
                       ;
        }

        for (int motorIndex = 0; motorIndex < 8 && motorIndex < motorCount; motorIndex++) {
# 530 "./src/main/drivers/dshot_bitbang.c"
            ...
            if (value != 0xffff) {
                ...
                dshotTelemetryState.motorState[motorIndex].telemetryActive = 
# 542 "./src/main/drivers/dshot_bitbang.c" 3 4
                                                                            1
# 542 "./src/main/drivers/dshot_bitbang.c"
                                                                                ;
                if (motorIndex < 4) {
                    do { if (debugMode == (DEBUG_DSHOT_RPM_TELEMETRY)) { debug[(motorIndex)] = (value); } } while (0);
                }
            } else {
                dshotTelemetryState.invalidPacketCount++;
            }

            updateDshotTelemetryQuality(&dshotTelemetryQuality[motorIndex], value != 0xffff, currentTimeMs);
    ...
    return 
# 560 "./src/main/drivers/dshot_bitbang.c" 3 4
          1
# 560 "./src/main/drivers/dshot_bitbang.c"
              ;
}
...
# 574 "./src/main/drivers/dshot_bitbang.c" 3 4
                                             0
# 574 "./src/main/drivers/dshot_bitbang.c"
                                                  ;
...
# 580 "./src/main/drivers/dshot_bitbang.c" 3 4
                                                       1
# 580 "./src/main/drivers/dshot_bitbang.c"
                                                           ;
        }
    }
    ...
    if (useDshotTelemetry) {
        bbOutputDataSet(bbPort->portOutputBuffer, bbmotor->pinIndex, packet, 
# 592 "./src/main/drivers/dshot_bitbang.c" 3 4
                                                                            1
# 592 "./src/main/drivers/dshot_bitbang.c"
                                                                                                  );
    } else

    {
        bbOutputDataSet(bbPort->portOutputBuffer, bbmotor->pinIndex, packet, 
# 596 "./src/main/drivers/dshot_bitbang.c" 3 4
                                                                            0
# 596 "./src/main/drivers/dshot_bitbang.c"
                                                                                                     );
    }
}
...
# 630 "./src/main/drivers/dshot_bitbang.c"
    for (int i = 0; i < usedMotorPorts; i++) {
        ...
        if (useDshotTelemetry) {
            if (bbPort->direction == 1) {
                bbPort->inputActive = 
# 636 "./src/main/drivers/dshot_bitbang.c" 3 4
                                     0
# 636 "./src/main/drivers/dshot_bitbang.c"
                                          ;
                bbSwitchToOutput(bbPort);
            }
        } else
...
static 
# 658 "./src/main/drivers/dshot_bitbang.c" 3 4
      _Bool 
# 658 "./src/main/drivers/dshot_bitbang.c"
           bbEnableMotors(void)
{
    ...
    return 
# 665 "./src/main/drivers/dshot_bitbang.c" 3 4
          1
# 665 "./src/main/drivers/dshot_bitbang.c"
              ;
}
...
static 
# 678 "./src/main/drivers/dshot_bitbang.c" 3 4
      _Bool 
# 678 "./src/main/drivers/dshot_bitbang.c"
           bbIsMotorEnabled(uint8_t index)
{
...
static void bbPostInit()
{
    ...
    for (int motorIndex = 0; motorIndex < 8 && motorIndex < motorCount; motorIndex++) {
        ...
        if (!bbMotorConfig(bbMotors[motorIndex].io, motorIndex, motorPwmProtocol, bbMotors[motorIndex].output)) {
            return 
# 690 "./src/main/drivers/dshot_bitbang.c" 3 4
                  ((void *)0)
# 690 "./src/main/drivers/dshot_bitbang.c"
                      ;
        }


        bbMotors[motorIndex].enabled = 
# 694 "./src/main/drivers/dshot_bitbang.c" 3 4
                                      1
# 694 "./src/main/drivers/dshot_bitbang.c"
                                          ;



        motors[motorIndex].enabled = 
# 698 "./src/main/drivers/dshot_bitbang.c" 3 4
                                    1
# 698 "./src/main/drivers/dshot_bitbang.c"
                                        ;
    }
}
...
motorDevice_t *dshotBitbangDevInit(const motorDevConfig_t *motorConfig, uint8_t count)
{
    ...
    for (int motorIndex = 0; motorIndex < 8 && motorIndex < motorCount; motorIndex++) {
        ...
        bbPuPdMode = (output & TIMER_OUTPUT_INVERTED) ? ((uint32_t)0x00000002U) : ((uint32_t)0x00000001U);
        ...
        if (!IOIsFreeOrPreinit(io)) {
            ...
            return 
# 757 "./src/main/drivers/dshot_bitbang.c" 3 4
                  ((void *)0)
# 757 "./src/main/drivers/dshot_bitbang.c"
                      ;
        }
        ...
        bbMotors[motorIndex].iocfg = ((((uint32_t)0x00000001U)) | ((((uint32_t)0x00000000U)) << 2) | ((bbPuPdMode) << 5));
