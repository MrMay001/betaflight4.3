...
# 31 "./src/main/drivers/bus_spi_config.c" 2
...
# 33 "./src/main/drivers/bus_spi_config.c" 2
...
# 34 "./src/main/drivers/bus_spi_config.c" 2
...
# 26 "./src/main/drivers/rx/rx_spi.h" 2
...
# 28 "./src/main/drivers/rx/rx_spi.h" 2
...
# 29 "./src/main/drivers/rx/rx_spi.h" 2
...
# 36 "./src/main/drivers/rx/rx_spi.h" 3 4
_Bool 
# 36 "./src/main/drivers/rx/rx_spi.h"
...
void rxSpiDmaEnable(
# 40 "./src/main/drivers/rx/rx_spi.h" 3 4
                   _Bool 
# 40 "./src/main/drivers/rx/rx_spi.h"
                        enable);
...
# 49 "./src/main/drivers/rx/rx_spi.h" 3 4
_Bool 
# 49 "./src/main/drivers/rx/rx_spi.h"
    rxSpiExtiConfigured(void);

# 50 "./src/main/drivers/rx/rx_spi.h" 3 4
_Bool 
# 50 "./src/main/drivers/rx/rx_spi.h"
    rxSpiGetExtiState(void);

# 51 "./src/main/drivers/rx/rx_spi.h" 3 4
_Bool 
# 51 "./src/main/drivers/rx/rx_spi.h"
    rxSpiPollExti(void);
void rxSpiResetExti(void);
timeUs_t rxSpiGetLastExtiTimeUs(void);
void rxSpiTransferCommandMulti(uint8_t *data, uint8_t length);

# 55 "./src/main/drivers/rx/rx_spi.h" 3 4
_Bool 
# 55 "./src/main/drivers/rx/rx_spi.h"
    rxSpiIsBusy(void);
# 35 "./src/main/drivers/bus_spi_config.c" 2
...
# 36 "./src/main/drivers/bus_spi_config.c" 2
...
# 39 "./src/main/drivers/bus_spi_config.c" 2
...
# 40 "./src/main/drivers/bus_spi_config.c" 2
...
# 45 "./src/main/drivers/bus_spi_config.c" 3 4
   _Bool 
# 45 "./src/main/drivers/bus_spi_config.c"
        init;
} spiPreinit_t;

static spiPreinit_t spiPreinitArray[16];
static int spiPreinitCount = 0;

void spiPreinitRegister(ioTag_t iotag, uint8_t iocfg, 
# 51 "./src/main/drivers/bus_spi_config.c" 3 4
                                                     _Bool 
# 51 "./src/main/drivers/bus_spi_config.c"
                                                          init)
{
    if (!iotag) {
        return;
...
static void spiPreinitPin(spiPreinit_t *preinit, int index)
{
    ...
    IOInit(io, OWNER_PREINIT, (index + 1));
...
{
# 91 "./src/main/drivers/bus_spi_config.c"
