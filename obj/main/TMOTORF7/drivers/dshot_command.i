# 1 "./src/main/drivers/dshot_command.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/dshot_command.c"
# 21 "./src/main/drivers/dshot_command.c"
# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include/stdbool.h" 1 3 4
# 22 "./src/main/drivers/dshot_command.c" 2
...
# 23 "./src/main/drivers/dshot_command.c" 2
...
static __attribute__((section(".tcm_code"))) __attribute__((optimize("-O2"))) uint32_t dshotCommandCyclesFromTime(timeUs_t delayUs)
{
...
# 268 "./src/main/drivers/dshot_command.c" 3 4
                  _Bool 
# 268 "./src/main/drivers/dshot_command.c"
                       dshotCommandOutputIsEnabled(uint8_t motorCount)
{
    ((void)(motorCount));
    ...
    case DSHOT_COMMAND_STATE_STARTDELAY:
        if (command->nextCommandCycleDelay) {
            ...
            return 
# 284 "./src/main/drivers/dshot_command.c" 3 4
                  0
# 284 "./src/main/drivers/dshot_command.c"
                       ;
        }
        command->state = DSHOT_COMMAND_STATE_ACTIVE;
    ...
    case DSHOT_COMMAND_STATE_ACTIVE:
        if (command->nextCommandCycleDelay) {
            --command->nextCommandCycleDelay;
            return 
# 293 "./src/main/drivers/dshot_command.c" 3 4
                  0
# 293 "./src/main/drivers/dshot_command.c"
                       ;
        }
    ...
    case DSHOT_COMMAND_STATE_POSTDELAY:
        if (command->nextCommandCycleDelay) {
            --command->nextCommandCycleDelay;
            return 
# 313 "./src/main/drivers/dshot_command.c" 3 4
                  0
# 313 "./src/main/drivers/dshot_command.c"
                       ;
        }
        if (dshotCommandQueueUpdate()) {
            ...
            return 
# 318 "./src/main/drivers/dshot_command.c" 3 4
                  0
# 318 "./src/main/drivers/dshot_command.c"
                       ;
        }
    }

    return 
# 322 "./src/main/drivers/dshot_command.c" 3 4
          1
# 322 "./src/main/drivers/dshot_command.c"
              ;
}
