...
# 31 "./src/main/drivers/mco.c" 2
# 64 "./src/main/drivers/mco.c"
void mcoConfigure(MCODevice_e device, const mcoConfig_t *config)
{
    if (!config->enabled) {
        return;
    ...
    case MCODEV_2:
        io = IOGetByTag(((ioTag_t)((((2) + 1) << 4) | (9))));
        IOInit(io, OWNER_MCO, 2);

        HAL_RCC_MCOConfig(((uint32_t)0x00000001U), (0x1UL << (30U)), ((uint32_t)(0x2UL << (24U)) | (0x4UL << (24U))));
        IOConfigGPIOAF(io, ((((uint32_t)0x00000002U)) | ((((uint32_t)0x00000003U)) << 2) | ((((uint32_t)0x00000000U)) << 5)), ((uint8_t)0x00U));
