...
static void pwmWriteBeeper(
# 42 "./src/main/drivers/sound_beeper.c" 3 4
                          _Bool 
# 42 "./src/main/drivers/sound_beeper.c"
                               on)
{
    if (!beeperPwm.io) {
        return;
    ...
    if (on) {
        *beeperPwm.channel.ccr = (((1) * 1000000) / freqBeep) / 2;
        beeperPwm.enabled = 
# 50 "./src/main/drivers/sound_beeper.c" 3 4
                           1
# 50 "./src/main/drivers/sound_beeper.c"
                               ;
    } else {
        *beeperPwm.channel.ccr = 0;
        beeperPwm.enabled = 
# 53 "./src/main/drivers/sound_beeper.c" 3 4
                           0
# 53 "./src/main/drivers/sound_beeper.c"
                                ;
    }
}
...
static void beeperPwmInit(const ioTag_t tag, uint16_t frequency)
{
    ...
    if (beeperIO && timer) {
        ...
        IOConfigGPIOAF(beeperPwm.io, ((((uint32_t)0x00000002U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000000U)) << 5)), timer->alternateFunction);
        ...
        *beeperPwm.channel.ccr = 0;
        beeperPwm.enabled = 
# 79 "./src/main/drivers/sound_beeper.c" 3 4
                           0
# 79 "./src/main/drivers/sound_beeper.c"
                                ;
    }
}
...
void systemBeep(
# 85 "./src/main/drivers/sound_beeper.c" 3 4
               _Bool 
# 85 "./src/main/drivers/sound_beeper.c"
                    onoff)
{
...
void beeperInit(const beeperDevConfig_t *config)
{
    ...
    if (beeperFrequency == 0) {
        ...
        if (beeperIO) {
            ...
            IOConfigGPIO(beeperIO, config->isOpenDrain ? ((((uint32_t)0x00000011U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000000U)) << 5)) : ((((uint32_t)0x00000001U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000000U)) << 5)));
        }
        systemBeep(
# 126 "./src/main/drivers/sound_beeper.c" 3 4
                  0
# 126 "./src/main/drivers/sound_beeper.c"
                       );
    }
