...
# 52 "./src/main/drivers/flash_impl.h" 3 4
   _Bool 
# 52 "./src/main/drivers/flash_impl.h"
        isLargeFlash;



    
# 56 "./src/main/drivers/flash_impl.h" 3 4
   _Bool 
# 56 "./src/main/drivers/flash_impl.h"
        couldBeBusy;
    uint32_t timeoutAt;
    flashDeviceIO_t io;
...
# 64 "./src/main/drivers/flash_impl.h" 3 4
   _Bool 
# 64 "./src/main/drivers/flash_impl.h"
        (*isReady)(flashDevice_t *fdevice);
    
# 65 "./src/main/drivers/flash_impl.h" 3 4
   _Bool 
# 65 "./src/main/drivers/flash_impl.h"
        (*waitForReady)(flashDevice_t *fdevice);
...
# 56 "./src/main/drivers/flash_m25p16.c"
...
_Static_assert((256 < 2048), "M25P16_PAGESIZE_too_small");

const flashVTable_t m25p16_vTable;

static uint8_t m25p16_readStatus(flashDevice_t *fdevice)
{
    static __attribute__ ((section(".fastram_data"), aligned(4))) uint8_t readStatus[2] = { 0x05, 0 };
    static __attribute__ ((section(".fastram_data"), aligned(4))) uint8_t readyStatus[2];
...
static 
# 141 "./src/main/drivers/flash_m25p16.c" 3 4
      _Bool 
# 141 "./src/main/drivers/flash_m25p16.c"
           m25p16_isReady(flashDevice_t *fdevice)
{

    if (fdevice->io.handle.dev->bus->useDMA && spiIsBusy(fdevice->io.handle.dev)) {
        return 
# 145 "./src/main/drivers/flash_m25p16.c" 3 4
              0
# 145 "./src/main/drivers/flash_m25p16.c"
                   ;
    }
    ...
    if (!fdevice->couldBeBusy) {
        return 
# 150 "./src/main/drivers/flash_m25p16.c" 3 4
              1
# 150 "./src/main/drivers/flash_m25p16.c"
                  ;
    }


    fdevice->couldBeBusy = ((m25p16_readStatus(fdevice) & 0x01) != 0);

    return !fdevice->couldBeBusy;
}

static 
# 159 "./src/main/drivers/flash_m25p16.c" 3 4
      _Bool 
# 159 "./src/main/drivers/flash_m25p16.c"
           m25p16_waitForReady(flashDevice_t *fdevice)
{
    while (!m25p16_isReady(fdevice));

    return 
# 163 "./src/main/drivers/flash_m25p16.c" 3 4
          1
# 163 "./src/main/drivers/flash_m25p16.c"
              ;
}
...
# 171 "./src/main/drivers/flash_m25p16.c" 3 4
_Bool 
# 171 "./src/main/drivers/flash_m25p16.c"
    m25p16_detect(flashDevice_t *fdevice, uint32_t chipID)
{
    ...
    if (m25p16FlashConfig[index].jedecID == 0) {
        ...
        return 
# 192 "./src/main/drivers/flash_m25p16.c" 3 4
              0
# 192 "./src/main/drivers/flash_m25p16.c"
                   ;
    }
...
# 204 "./src/main/drivers/flash_m25p16.c" 3 4
                               1
# 204 "./src/main/drivers/flash_m25p16.c"
                                   ;


        uint8_t modeSet[] = { 0xB7 };

        spiReadWriteBuf(fdevice->io.handle.dev, modeSet, 
# 209 "./src/main/drivers/flash_m25p16.c" 3 4
                                                        ((void *)0)
# 209 "./src/main/drivers/flash_m25p16.c"
                                                            , sizeof(modeSet));
    }
...
# 212 "./src/main/drivers/flash_m25p16.c"
    ...
    return 
# 214 "./src/main/drivers/flash_m25p16.c" 3 4
          1
# 214 "./src/main/drivers/flash_m25p16.c"
              ;
}
...
busStatus_e m25p16_callbackWriteEnable(uint32_t arg)
{
    ...
    fdevice->couldBeBusy = 
# 234 "./src/main/drivers/flash_m25p16.c" 3 4
                          1
# 234 "./src/main/drivers/flash_m25p16.c"
                              ;
...
{
    static __attribute__ ((section(".fastram_data"), aligned(4))) uint8_t sectorErase[5] = { 0xD8 };
    static __attribute__ ((section(".fastram_data"), aligned(4))) uint8_t readStatus[2] = { 0x05, 0 };
    static __attribute__ ((section(".fastram_data"), aligned(4))) uint8_t readyStatus[2];
    static __attribute__ ((section(".fastram_data"), aligned(4))) uint8_t writeEnable[] = { 0x06 };

    busSegment_t segments[] = {
            {.u.buffers = {readStatus, readyStatus}, sizeof(readStatus), 
# 286 "./src/main/drivers/flash_m25p16.c" 3 4
                                                                        1
# 286 "./src/main/drivers/flash_m25p16.c"
                                                                            , m25p16_callbackReady},
            {.u.buffers = {writeEnable, 
# 287 "./src/main/drivers/flash_m25p16.c" 3 4
                                       ((void *)0)
# 287 "./src/main/drivers/flash_m25p16.c"
                                           }, sizeof(writeEnable), 
# 287 "./src/main/drivers/flash_m25p16.c" 3 4
                                                                   1
# 287 "./src/main/drivers/flash_m25p16.c"
                                                                       , m25p16_callbackWriteEnable},
            {.u.buffers = {sectorErase, 
# 288 "./src/main/drivers/flash_m25p16.c" 3 4
                                       ((void *)0)
# 288 "./src/main/drivers/flash_m25p16.c"
...
# 288 "./src/main/drivers/flash_m25p16.c"
            ...
            {.u.link = {
# 289 "./src/main/drivers/flash_m25p16.c" 3 4
                       ((void *)0)
# 289 "./src/main/drivers/flash_m25p16.c"
                           , 
# 289 "./src/main/drivers/flash_m25p16.c" 3 4
                             ((void *)0)
# 289 "./src/main/drivers/flash_m25p16.c"
...
static void m25p16_eraseCompletely(flashDevice_t *fdevice)
{
    ...
    static __attribute__ ((section(".fastram_data"), aligned(4))) uint8_t readyStatus[2];
    static __attribute__ ((section(".fastram_data"), aligned(4))) uint8_t writeEnable[] = { 0x06 };
    static __attribute__ ((section(".fastram_data"), aligned(4))) uint8_t bulkErase[] = { 0xC7 };

    busSegment_t segments[] = {
            {.u.buffers = {readStatus, readyStatus}, sizeof(readStatus), 
# 311 "./src/main/drivers/flash_m25p16.c" 3 4
                                                                        1
# 311 "./src/main/drivers/flash_m25p16.c"
                                                                            , m25p16_callbackReady},
            {.u.buffers = {writeEnable, 
# 312 "./src/main/drivers/flash_m25p16.c" 3 4
                                       ((void *)0)
# 312 "./src/main/drivers/flash_m25p16.c"
                                           }, sizeof(writeEnable), 
# 312 "./src/main/drivers/flash_m25p16.c" 3 4
                                                                   1
# 312 "./src/main/drivers/flash_m25p16.c"
                                                                       , m25p16_callbackWriteEnable},
            {.u.buffers = {bulkErase, 
# 313 "./src/main/drivers/flash_m25p16.c" 3 4
                                     ((void *)0)
# 313 "./src/main/drivers/flash_m25p16.c"
                                         }, sizeof(bulkErase), 
# 313 "./src/main/drivers/flash_m25p16.c" 3 4
                                                               1
# 313 "./src/main/drivers/flash_m25p16.c"
...
# 313 "./src/main/drivers/flash_m25p16.c"
            ...
            {.u.link = {
# 314 "./src/main/drivers/flash_m25p16.c" 3 4
                       ((void *)0)
...
static uint32_t m25p16_pageProgramContinue(flashDevice_t *fdevice, uint8_t const **buffers, uint32_t *bufferSizes, uint32_t bufferCount)
{
    ...
    static __attribute__ ((section(".fastram_data"), aligned(4))) uint8_t readyStatus[2];
    static __attribute__ ((section(".fastram_data"), aligned(4))) uint8_t writeEnable[] = { 0x06 };
    static __attribute__ ((section(".fastram_data"), aligned(4))) uint8_t pageProgram[5] = { 0x02 };

    static busSegment_t segments[] = {
            {.u.buffers = {readStatus, readyStatus}, sizeof(readStatus), 
# 339 "./src/main/drivers/flash_m25p16.c" 3 4
                                                                        1
# 339 "./src/main/drivers/flash_m25p16.c"
                                                                            , m25p16_callbackReady},
            {.u.buffers = {writeEnable, 
# 340 "./src/main/drivers/flash_m25p16.c" 3 4
                                       ((void *)0)
# 340 "./src/main/drivers/flash_m25p16.c"
                                           }, sizeof(writeEnable), 
# 340 "./src/main/drivers/flash_m25p16.c" 3 4
                                                                   1
# 340 "./src/main/drivers/flash_m25p16.c"
                                                                       , m25p16_callbackWriteEnable},
            {.u.buffers = {pageProgram, 
# 341 "./src/main/drivers/flash_m25p16.c" 3 4
                                       ((void *)0)
# 341 "./src/main/drivers/flash_m25p16.c"
                                           }, 0, 
# 341 "./src/main/drivers/flash_m25p16.c" 3 4
                                                 0
# 341 "./src/main/drivers/flash_m25p16.c"
...
# 341 "./src/main/drivers/flash_m25p16.c"
            ...
            {.u.link = {
# 342 "./src/main/drivers/flash_m25p16.c" 3 4
                       ((void *)0)
# 342 "./src/main/drivers/flash_m25p16.c"
                           , 
# 342 "./src/main/drivers/flash_m25p16.c" 3 4
                             ((void *)0)
# 342 "./src/main/drivers/flash_m25p16.c"
...
# 342 "./src/main/drivers/flash_m25p16.c"
            ...
            {.u.link = {
# 343 "./src/main/drivers/flash_m25p16.c" 3 4
                       ((void *)0)
# 343 "./src/main/drivers/flash_m25p16.c"
                           , 
# 343 "./src/main/drivers/flash_m25p16.c" 3 4
                             ((void *)0)
# 343 "./src/main/drivers/flash_m25p16.c"
...
# 343 "./src/main/drivers/flash_m25p16.c"
            ...
            {.u.link = {
# 344 "./src/main/drivers/flash_m25p16.c" 3 4
                       ((void *)0)
# 344 "./src/main/drivers/flash_m25p16.c"
                           , 
# 344 "./src/main/drivers/flash_m25p16.c" 3 4
                             ((void *)0)
# 344 "./src/main/drivers/flash_m25p16.c"
...
# 344 "./src/main/drivers/flash_m25p16.c"
    ...
    if (bufferCount == 1) {
        segments[DATA1].negateCS = 
# 360 "./src/main/drivers/flash_m25p16.c" 3 4
                                  1
# 360 "./src/main/drivers/flash_m25p16.c"
                                      ;
        segments[DATA1].callback = m25p16_callbackWriteComplete;

        segments[DATA2].u.buffers.txData = (uint8_t *)
# 363 "./src/main/drivers/flash_m25p16.c" 3 4
                                                     ((void *)0)
# 363 "./src/main/drivers/flash_m25p16.c"
                                                         ;
        segments[DATA2].len = 0;
    } else if (bufferCount == 2) {
        segments[DATA1].negateCS = 
# 366 "./src/main/drivers/flash_m25p16.c" 3 4
                                  0
# 366 "./src/main/drivers/flash_m25p16.c"
                                       ;
        segments[DATA1].callback = 
# 367 "./src/main/drivers/flash_m25p16.c" 3 4
                                  ((void *)0)
# 367 "./src/main/drivers/flash_m25p16.c"
                                      ;
        segments[DATA2].u.buffers.txData = (uint8_t *)buffers[1];
        segments[DATA2].len = bufferSizes[1];
        fdevice->callbackArg += bufferSizes[1];
        segments[DATA2].negateCS = 
# 371 "./src/main/drivers/flash_m25p16.c" 3 4
                                  1
# 371 "./src/main/drivers/flash_m25p16.c"
                                      ;
    ...
    if (fdevice->callback == 
# 379 "./src/main/drivers/flash_m25p16.c" 3 4
                            ((void *)0)
# 379 "./src/main/drivers/flash_m25p16.c"
                                ) {
...
# 407 "./src/main/drivers/flash_m25p16.c"
...
static int m25p16_readBytes(flashDevice_t *fdevice, uint32_t address, uint8_t *buffer, uint32_t length)
{
    static __attribute__ ((section(".fastram_data"), aligned(4))) uint8_t readStatus[2] = { 0x05, 0 };
    static __attribute__ ((section(".fastram_data"), aligned(4))) uint8_t readyStatus[2];
    static __attribute__ ((section(".fastram_data"), aligned(4))) uint8_t readBytes[5] = { 0x03 };
    ...
    busSegment_t segments[] = {
            {.u.buffers = {readStatus, readyStatus}, sizeof(readStatus), 
# 432 "./src/main/drivers/flash_m25p16.c" 3 4
                                                                        1
# 432 "./src/main/drivers/flash_m25p16.c"
                                                                            , m25p16_callbackReady},
            {.u.buffers = {readBytes, 
# 433 "./src/main/drivers/flash_m25p16.c" 3 4
                                     ((void *)0)
# 433 "./src/main/drivers/flash_m25p16.c"
                                         }, fdevice->isLargeFlash ? 5 : 4, 
# 433 "./src/main/drivers/flash_m25p16.c" 3 4
                                                                           0
# 433 "./src/main/drivers/flash_m25p16.c"
...
# 433 "./src/main/drivers/flash_m25p16.c"
            ...
            {.u.buffers = {
# 434 "./src/main/drivers/flash_m25p16.c" 3 4
                          ((void *)0)
# 434 "./src/main/drivers/flash_m25p16.c"
                              , buffer}, length, 
# 434 "./src/main/drivers/flash_m25p16.c" 3 4
                                                 1
# 434 "./src/main/drivers/flash_m25p16.c"
...
# 434 "./src/main/drivers/flash_m25p16.c"
            ...
            {.u.link = {
# 435 "./src/main/drivers/flash_m25p16.c" 3 4
                       ((void *)0)
# 435 "./src/main/drivers/flash_m25p16.c"
                           , 
# 435 "./src/main/drivers/flash_m25p16.c" 3 4
                             ((void *)0)
# 435 "./src/main/drivers/flash_m25p16.c"
