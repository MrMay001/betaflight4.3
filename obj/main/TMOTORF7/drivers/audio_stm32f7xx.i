# 1 "./src/main/drivers/audio_stm32f7xx.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/audio_stm32f7xx.c"
# 21 "./src/main/drivers/audio_stm32f7xx.c"
# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include/stdbool.h" 1 3 4
# 22 "./src/main/drivers/audio_stm32f7xx.c" 2
...
# 23 "./src/main/drivers/audio_stm32f7xx.c" 2
...
# 24 "./src/main/drivers/audio_stm32f7xx.c" 2
...
# 153 "./src/main/platform.h" 2
# 26 "./src/main/drivers/audio_stm32f7xx.c" 2
...
# 28 "./src/main/drivers/audio_stm32f7xx.c" 2
...
# 30 "./src/main/drivers/audio_stm32f7xx.c" 2
...
void audioSetupIO(void)
{
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) |= ((0x1UL << (29U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) & ((0x1UL << (29U)))); ((void)(tmpreg)); } while(0);
    ...
    hdac.Instance = ((DAC_TypeDef *) (0x40000000UL + 0x7400UL));
    HAL_DAC_Init(&hdac);
...
void audioGenerateWhiteNoise(void)
{
    ...
    handle.Instance = ((TIM_TypeDef *) (0x40000000UL + 0x1000UL));
    ...
    sMasterConfig.MasterSlaveMode = (0x1UL << (7U));
    sMasterConfig.MasterOutputTrigger = (0x2UL << (4U));
    HAL_TIMEx_MasterConfigSynchronization(&handle, &sMasterConfig);

    HAL_TIM_Base_Start(&handle);

    sConfig.DAC_Trigger = ((uint32_t)(0x1UL << (2U)));
    sConfig.DAC_OutputBuffer = ((uint32_t)0x00000000U);
    HAL_DAC_ConfigChannel(&hdac, &sConfig, ((uint32_t)0x00000000U));

    HAL_DACEx_NoiseWaveGenerate(&hdac, ((uint32_t)0x00000000U), ((uint32_t)(0x8UL << (8U)) | (0x2UL << (8U))));
    HAL_DAC_SetValue(&hdac, ((uint32_t)0x00000000U), ((uint32_t)0x00000004U), 0xcd00);

    HAL_DAC_Start(&hdac, ((uint32_t)0x00000000U));
}
...
void audioPlayTone(uint8_t tone)
{
    handle.Init.Period = 64 + (__extension__ ({ __typeof__ (0) _a = (0); __typeof__ (__extension__ ({ __typeof__ (tone) _a = (tone); __typeof__ ((64 - 1)) _b = ((64 - 1)); _a < _b ? _a : _b; })) _b = (__extension__ ({ __typeof__ (tone) _a = (tone); __typeof__ ((64 - 1)) _b = ((64 - 1)); _a < _b ? _a : _b; })); _a > _b ? _a : _b; }) * 8);
    TIM_Base_SetConfig(handle.Instance, &handle.Init);
}

void audioSilence(void)
{
    HAL_DAC_Stop(&hdac, ((uint32_t)0x00000000U));
