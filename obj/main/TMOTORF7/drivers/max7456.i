...
# 26 "./src/main/drivers/max7456.h" 2
...
# 49 "./src/main/drivers/max7456.h" 3 4
                                                                                                                   _Bool 
# 49 "./src/main/drivers/max7456.h"
                                                                                                                        cpuOverclock);
void max7456Invert(
...
# 52 "./src/main/drivers/max7456.h" 3 4
_Bool 
# 52 "./src/main/drivers/max7456.h"
...
# 54 "./src/main/drivers/max7456.h" 3 4
_Bool 
# 54 "./src/main/drivers/max7456.h"
       max7456WriteNvm(uint8_t char_address, const uint8_t *font_data);
...
# 60 "./src/main/drivers/max7456.h" 3 4
_Bool 
# 60 "./src/main/drivers/max7456.h"
       max7456DmaInProgress(void);

# 61 "./src/main/drivers/max7456.h" 3 4
_Bool 
# 61 "./src/main/drivers/max7456.h"
       max7456BuffersSynced(void);

# 62 "./src/main/drivers/max7456.h" 3 4
_Bool 
# 62 "./src/main/drivers/max7456.h"
       max7456LayerSupported(displayPortLayer_e layer);

# 63 "./src/main/drivers/max7456.h" 3 4
_Bool 
# 63 "./src/main/drivers/max7456.h"
       max7456LayerSelect(displayPortLayer_e layer);

# 64 "./src/main/drivers/max7456.h" 3 4
_Bool 
# 64 "./src/main/drivers/max7456.h"
       max7456LayerCopy(displayPortLayer_e destLayer, displayPortLayer_e sourceLayer);

# 65 "./src/main/drivers/max7456.h" 3 4
_Bool 
# 65 "./src/main/drivers/max7456.h"
       max7456IsDeviceDetected(void);
...
# 185 "./src/main/drivers/max7456.c"
typedef struct max7456Layer_s {
    uint8_t buffer[480];
} max7456Layer_t;

static max7456Layer_t displayLayers[(DISPLAYPORT_LAYER_BACKGROUND + 1)];
...
static 
# 195 "./src/main/drivers/max7456.c" 3 4
      _Bool 
# 195 "./src/main/drivers/max7456.c"
           max7456DeviceDetected = 
# 195 "./src/main/drivers/max7456.c" 3 4
                                   0
# 195 "./src/main/drivers/max7456.c"
                                        ;
...
# 213 "./src/main/drivers/max7456.c"
static __attribute__ ((section(".fastram_data"), aligned(4))) uint8_t spiBuf[250];
...
static 
# 222 "./src/main/drivers/max7456.c" 3 4
      _Bool 
# 222 "./src/main/drivers/max7456.c"
           fontIsLoading = 
# 222 "./src/main/drivers/max7456.c" 3 4
                                 0
# 222 "./src/main/drivers/max7456.c"
...
static uint8_t previousBlackWhiteRegister = 255;
static uint8_t previousInvertRegister = 255;
...
{
    uint8_t backgroundGray = 0x04;
    uint8_t vm1Register = 0x04 | 0x03;
    ...
    spiWriteReg(dev, 0x01, vm1Register);
}
...
{
    memset(getLayerBuffer(layer), 0x20, 480);
}
...
void max7456ReInit(void)
{
    ...
    previousBlackWhiteRegister = 255;
    max7456Brightness(0, 2);



    spiWriteReg(dev, 0x00, videoSignalReg);
    spiWriteReg(dev, 0x02, hosRegValue);
    spiWriteReg(dev, 0x03, vosRegValue);
...
{
    spiPreinitRegister(max7456Config->csTag, max7456Config->preInitOPU ? ((((uint32_t)0x00000001U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000000U)) << 5)) : ((((uint32_t)0x00000000U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000001U)) << 5)), 1);
}
...
# 341 "./src/main/drivers/max7456.c" 3 4
                                                                                                      _Bool 
# 341 "./src/main/drivers/max7456.c"
                                                                                                           cpuOverclock)
{
    max7456DeviceDetected = 
# 343 "./src/main/drivers/max7456.c" 3 4
                           0
# 343 "./src/main/drivers/max7456.c"
                                ;
    deviceBackgroundType = DISPLAY_BACKGROUND_TRANSPARENT;


    for (unsigned i = 0; i < (DISPLAYPORT_LAYER_BACKGROUND + 1); i++) {
        max7456ClearLayer(i);
    }
    ...
    IOConfigGPIO(dev->busType_u.spi.csnPin, ((((uint32_t)0x00000001U)) | ((((uint32_t)0x00000003U)) << 2) | ((((uint32_t)0x00000000U)) << 5)));
    ...
    spiSetClkDivisor(dev, spiCalculateDivider(5000000));


    spiWrite(dev, 0xff);

    uint8_t osdm = spiReadRegMsk(dev, 0x0c);

    if (osdm != 0x1B) {
        IOConfigGPIO(dev->busType_u.spi.csnPin, ((((uint32_t)0x00000000U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000001U)) << 5)));
        return MAX7456_INIT_NOT_FOUND;
    }


    max7456DeviceDetected = 
# 385 "./src/main/drivers/max7456.c" 3 4
                           1
# 385 "./src/main/drivers/max7456.c"
                               ;
    IOInit(dev->busType_u.spi.csnPin, OWNER_OSD_CS, 0);
    ...
    spiWriteReg(dev, 0x0a, (1 << 6));

    if (spiReadRegMsk(dev, 0x0a) & (1 << 6)) {
        max7456DeviceType = 1;
    } else {
        max7456DeviceType = 0;
    }
    ...
    case 0:
        max7456SpiClockDiv = spiCalculateDivider(10000000 / 2);
        break;

    case 1:
    default:
        max7456SpiClockDiv = spiCalculateDivider(10000000);
        break;
    ...
    do { if (debugMode == (DEBUG_MAX7456_SPICLOCK)) { debug[(0)] = (cpuOverclock); } } while (0);
    do { if (debugMode == (DEBUG_MAX7456_SPICLOCK)) { debug[(1)] = (max7456DeviceType); } } while (0);
    do { if (debugMode == (DEBUG_MAX7456_SPICLOCK)) { debug[(2)] = (max7456SpiClockDiv); } } while (0);
    do { if (debugMode == (DEBUG_MAX7456_SPICLOCK)) { debug[(3)] = (spiCalculateClock(max7456SpiClockDiv) / 10000); } } while (0);
    ...
    spiWriteReg(dev, 0x00, 0x02);


    delayMicroseconds(200);


    while ((spiReadRegMsk(dev, 0x00) & 0x02) != 0x00);
...
void max7456Invert(
# 450 "./src/main/drivers/max7456.c" 3 4
                  _Bool 
# 450 "./src/main/drivers/max7456.c"
                       invert)
{
    if (invert) {
    ...
    if (displayMemoryModeReg != previousInvertRegister) {
        ...
        spiWriteReg(dev, 0x04, displayMemoryModeReg);
    }
}
...
void max7456Brightness(uint8_t black, uint8_t white)
{
    ...
    if (reg != previousBlackWhiteRegister) {
        ...
        static __attribute__ ((section(".fastram_data"), aligned(4))) uint8_t buf[32];
        for (int i = 0x10, j = 0; i <= 0x1f; i++) {
            buf[j++] = i;
            buf[j++] = reg;
        }
        spiReadWriteBuf(dev, buf, 
# 484 "./src/main/drivers/max7456.c" 3 4
                                 ((void *)0)
# 484 "./src/main/drivers/max7456.c"
                                     , sizeof(buf));
    }
}
...
void max7456Write(uint8_t x, uint8_t y, const char *buff)
{
    if (y < 16) {
        uint8_t *buffer = getActiveLayerBuffer();
        for (int i = 0; buff[i] && x + i < 30; i++) {
            buffer[y * 30 + x + i] = buff[i];
        }
    }
}


# 511 "./src/main/drivers/max7456.c" 3 4
_Bool 
# 511 "./src/main/drivers/max7456.c"
    max7456LayerSupported(displayPortLayer_e layer)
{
    if (layer == DISPLAYPORT_LAYER_FOREGROUND || layer == DISPLAYPORT_LAYER_BACKGROUND) {
        return 
# 514 "./src/main/drivers/max7456.c" 3 4
              1
# 514 "./src/main/drivers/max7456.c"
                  ;
    } else {
        return 
# 516 "./src/main/drivers/max7456.c" 3 4
              0
# 516 "./src/main/drivers/max7456.c"
                   ;
    }
}
    ...
    max7456LayerSelect(displayPortLayer_e layer)
{
    if (max7456LayerSupported(layer)) {
        activeLayer = layer;
        return 
# 524 "./src/main/drivers/max7456.c" 3 4
              1
# 524 "./src/main/drivers/max7456.c"
                  ;
    } else {
        return 
# 526 "./src/main/drivers/max7456.c" 3 4
              0
# 526 "./src/main/drivers/max7456.c"
                   ;
    }
}


# 530 "./src/main/drivers/max7456.c" 3 4
_Bool 
# 530 "./src/main/drivers/max7456.c"
    max7456LayerCopy(displayPortLayer_e destLayer, displayPortLayer_e sourceLayer)
{
    if ((sourceLayer != destLayer) && max7456LayerSupported(sourceLayer) && max7456LayerSupported(destLayer)) {
        memcpy(getLayerBuffer(destLayer), getLayerBuffer(sourceLayer), 480);
        return 
...
# 540 "./src/main/drivers/max7456.c" 3 4
_Bool 
# 540 "./src/main/drivers/max7456.c"
    max7456DmaInProgress(void)
{
...
# 545 "./src/main/drivers/max7456.c" 3 4
_Bool 
# 545 "./src/main/drivers/max7456.c"
    max7456BuffersSynced(void)
{
    for (int i = 0; i < maxScreenSize; i++) {
        if (displayLayers[DISPLAYPORT_LAYER_FOREGROUND].buffer[i] != shadowBuffer[i]) {
            return 
# 549 "./src/main/drivers/max7456.c" 3 4
                  0
# 549 "./src/main/drivers/max7456.c"
                       ;
        }
    }
    return 
# 552 "./src/main/drivers/max7456.c" 3 4
          1
# 552 "./src/main/drivers/max7456.c"
              ;
}


# 555 "./src/main/drivers/max7456.c" 3 4
_Bool 
# 555 "./src/main/drivers/max7456.c"
    max7456ReInitIfRequired(
# 555 "./src/main/drivers/max7456.c" 3 4
                            _Bool 
# 555 "./src/main/drivers/max7456.c"
                                 forceStallCheck)
{
    ...
    static timeMs_t lastStallCheckMs = 1000 / 2;

    const timeMs_t nowMs = millis();

    
# 564 "./src/main/drivers/max7456.c" 3 4
   _Bool 
# 564 "./src/main/drivers/max7456.c"
        stalled = 
# 564 "./src/main/drivers/max7456.c" 3 4
                  0
# 564 "./src/main/drivers/max7456.c"
                       ;
    if (forceStallCheck || (lastStallCheckMs + 1000 < nowMs)) {
        lastStallCheckMs = nowMs;


        spiWrite(dev, 0xff);

        stalled = (spiReadRegMsk(dev, 0x00) != videoSignalReg);
    }
    ...
    if (stalled) {
        ...
        const uint8_t videoSense = spiReadRegMsk(dev, 0xA0);

        do { if (debugMode == (DEBUG_MAX7456_SIGNAL)) { debug[(0)] = (videoSignalReg & 0x40); } } while (0);
        do { if (debugMode == (DEBUG_MAX7456_SIGNAL)) { debug[(1)] = (videoSense & 0x7); } } while (0);
        do { if (debugMode == (DEBUG_MAX7456_SIGNAL)) { debug[(3)] = (max7456GetRowsCount()); } } while (0);
              ...
              || ((!((videoSense) & 0x04) && !((videoSense) & 0x01)) && (((videoSignalReg) & 0x40) == 0x40))) {
                if (videoDetectTimeMs) {
                    if (millis() - videoDetectTimeMs > 100) {
                        max7456ReInit();
                        do { if (debugMode == (DEBUG_MAX7456_SIGNAL)) { debug[(2)] = (++reInitCount); } } while (0);
                    }
                } else {
...
# 614 "./src/main/drivers/max7456.c" 3 4
_Bool 
# 614 "./src/main/drivers/max7456.c"
    max7456DrawScreen(void)
{
    ...
    static busSegment_t segments[] = {
            {.u.link = {
# 619 "./src/main/drivers/max7456.c" 3 4
                       ((void *)0)
# 619 "./src/main/drivers/max7456.c"
                           , 
# 619 "./src/main/drivers/max7456.c" 3 4
                             ((void *)0)
# 619 "./src/main/drivers/max7456.c"
...
# 619 "./src/main/drivers/max7456.c"
            ...
            {.u.link = {
# 620 "./src/main/drivers/max7456.c" 3 4
                       ((void *)0)
# 620 "./src/main/drivers/max7456.c"
                           , 
# 620 "./src/main/drivers/max7456.c" 3 4
                             ((void *)0)
# 620 "./src/main/drivers/max7456.c"
...
# 628 "./src/main/drivers/max7456.c" 3 4
       _Bool 
# 628 "./src/main/drivers/max7456.c"
            setAddress = 
# 628 "./src/main/drivers/max7456.c" 3 4
                         1
# 628 "./src/main/drivers/max7456.c"
...
# 629 "./src/main/drivers/max7456.c" 3 4
       _Bool 
# 629 "./src/main/drivers/max7456.c"
            autoInc = 
# 629 "./src/main/drivers/max7456.c" 3 4
                      0
# 629 "./src/main/drivers/max7456.c"
        ...
        maxSpiBufStartIndex = spiUseMOSI_DMA(dev) ? 250 : 12;
        maxEncodeTime = spiUseMOSI_DMA(dev) ? 20 : 10;


        if (spiIsBusy(dev)) {

            return 
# 638 "./src/main/drivers/max7456.c" 3 4
                  1
# 638 "./src/main/drivers/max7456.c"
                      ;
        }
            ...
            if (buffer[pos] != shadowBuffer[pos]) {
                ...
                if (setAddress || !autoInc) {
                    if (buffer[pos + 1] != shadowBuffer[pos + 1]) {
                        ...
                        spiBuf[spiBufIndex++] = 0x04;
                        spiBuf[spiBufIndex++] = displayMemoryModeReg | 0x01;
                        autoInc = 
# 658 "./src/main/drivers/max7456.c" 3 4
                                 1
# 658 "./src/main/drivers/max7456.c"
                                     ;
                    } else {
                        ...
                        autoInc = 
# 663 "./src/main/drivers/max7456.c" 3 4
                                 0
# 663 "./src/main/drivers/max7456.c"
                                      ;
                    }

                    spiBuf[spiBufIndex++] = 0x05;
                    spiBuf[spiBufIndex++] = pos >> 8;
                    spiBuf[spiBufIndex++] = 0x06;
...
# 671 "./src/main/drivers/max7456.c"
                ...
                if (!setAddress) {
                    setAddress = 
# 680 "./src/main/drivers/max7456.c" 3 4
                                1
# 680 "./src/main/drivers/max7456.c"
                                    ;
                    if (autoInc) {
                        spiBuf[spiBufIndex++] = 0x07;
                        spiBuf[spiBufIndex++] = 0xff;
                    }
                }
            }
...
{
    max7456ReInitIfRequired(
# 720 "./src/main/drivers/max7456.c" 3 4
                           1
# 720 "./src/main/drivers/max7456.c"
                               );
    while (max7456DrawScreen());
}


# 724 "./src/main/drivers/max7456.c" 3 4
_Bool 
# 724 "./src/main/drivers/max7456.c"
    max7456WriteNvm(uint8_t char_address, const uint8_t *font_data)
{
    if (!max7456DeviceDetected) {
        return 
# 727 "./src/main/drivers/max7456.c" 3 4
              0
# 727 "./src/main/drivers/max7456.c"
                   ;
    }
    ...
    fontIsLoading = 
# 734 "./src/main/drivers/max7456.c" 3 4
                   1
# 734 "./src/main/drivers/max7456.c"
                       ;
    spiWriteReg(dev, 0x00, 0);

    spiWriteReg(dev, 0x09, char_address);

    for (int x = 0; x < 54; x++) {
        spiWriteReg(dev, 0x0a, x);
        spiWriteReg(dev, 0x0b, font_data[x]);
    ...
    spiWriteReg(dev, 0x08, 0xA0);



    while ((spiReadRegMsk(dev, 0xA0) & 0x20) != 0x00);
...
void max7456HardwareReset(void)
{
# 780 "./src/main/drivers/max7456.c"
    delay(50);

}


# 784 "./src/main/drivers/max7456.c" 3 4
_Bool 
# 784 "./src/main/drivers/max7456.c"
    max7456IsDeviceDetected(void)
{
