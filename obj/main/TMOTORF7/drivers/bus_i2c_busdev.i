...
# 34 "./src/main/drivers/bus_i2c_busdev.c" 3 4
_Bool 
# 34 "./src/main/drivers/bus_i2c_busdev.c"
...
# 39 "./src/main/drivers/bus_i2c_busdev.c" 3 4
_Bool 
# 39 "./src/main/drivers/bus_i2c_busdev.c"
...
# 49 "./src/main/drivers/bus_i2c_busdev.c" 3 4
_Bool 
# 49 "./src/main/drivers/bus_i2c_busdev.c"
...
# 61 "./src/main/drivers/bus_i2c_busdev.c" 3 4
_Bool 
# 61 "./src/main/drivers/bus_i2c_busdev.c"
...
# 66 "./src/main/drivers/bus_i2c_busdev.c" 3 4
_Bool 
# 66 "./src/main/drivers/bus_i2c_busdev.c"
...
# 71 "./src/main/drivers/bus_i2c_busdev.c" 3 4
_Bool 
# 71 "./src/main/drivers/bus_i2c_busdev.c"
    i2cBusSetInstance(extDevice_t *dev, uint32_t device)
{

    static busDevice_t i2cBus[4];

    if ((device < 1) || (device > 4)) {
        return 
# 77 "./src/main/drivers/bus_i2c_busdev.c" 3 4
              0
# 77 "./src/main/drivers/bus_i2c_busdev.c"
                   ;
    }

    dev->bus = &i2cBus[((device) - 1)];
    dev->bus->busType = BUS_TYPE_I2C;
    dev->bus->busType_u.i2c.device = ((device) - 1);

    return 
# 84 "./src/main/drivers/bus_i2c_busdev.c" 3 4
          1
# 84 "./src/main/drivers/bus_i2c_busdev.c"
              ;
}
