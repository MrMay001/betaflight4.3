# 1 "./src/main/drivers/usb_msc_common.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/usb_msc_common.c"
# 26 "./src/main/drivers/usb_msc_common.c"
...
# 29 "./src/main/drivers/usb_msc_common.c" 2
...
# 153 "./src/main/platform.h" 2
# 31 "./src/main/drivers/usb_msc_common.c" 2
...
# 35 "./src/main/drivers/usb_msc_common.c" 2
...
# 39 "./src/main/drivers/usb_msc_common.c" 2
...
# 67 "./src/main/drivers/light_led.h"
                         state);
# 40 "./src/main/drivers/usb_msc_common.c" 2
# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 41 "./src/main/drivers/usb_msc_common.c" 2
...
# 42 "./src/main/drivers/usb_msc_common.c" 2
...
# 43 "./src/main/drivers/usb_msc_common.c" 2
...
# 44 "./src/main/drivers/usb_msc_common.c" 2
...
# 45 "./src/main/drivers/usb_msc_common.c" 2
...
# 47 "./src/main/drivers/usb_msc_common.c" 2
...
# 49 "./src/main/drivers/usb_msc_common.c" 2
...
void mscInit(void)
{
    if (usbDevConfig()->mscButtonPin) {
        ...
        if (usbDevConfig()->mscButtonUsePullup) {
            IOConfigGPIO(mscButton, ((((uint32_t)0x00000000U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000001U)) << 5)));
        } else {
            IOConfigGPIO(mscButton, ((((uint32_t)0x00000000U)) | ((((uint32_t)0x00000000U)) << 2) | ((((uint32_t)0x00000002U)) << 5)));
        }
    }
}


# 69 "./src/main/drivers/usb_msc_common.c" 3 4
_Bool 
# 69 "./src/main/drivers/usb_msc_common.c"
    mscCheckBootAndReset(void)
{
    static 
# 71 "./src/main/drivers/usb_msc_common.c" 3 4
          _Bool 
# 71 "./src/main/drivers/usb_msc_common.c"
               firstCheck = 
# 71 "./src/main/drivers/usb_msc_common.c" 3 4
                            1
# 71 "./src/main/drivers/usb_msc_common.c"
                                ;
    static 
# 72 "./src/main/drivers/usb_msc_common.c" 3 4
          _Bool 
# 72 "./src/main/drivers/usb_msc_common.c"
               mscMode;

    if (firstCheck) {

        const uint32_t bootModeRequest = persistentObjectRead(PERSISTENT_OBJECT_RESET_REASON);
        if (bootModeRequest == 3) {
            mscMode = 
# 78 "./src/main/drivers/usb_msc_common.c" 3 4
                     1
# 78 "./src/main/drivers/usb_msc_common.c"
                         ;


            persistentObjectWrite(PERSISTENT_OBJECT_RESET_REASON, 0);
            firstCheck = 
# 82 "./src/main/drivers/usb_msc_common.c" 3 4
                        0
# 82 "./src/main/drivers/usb_msc_common.c"
                             ;
        }
    }
...
void mscActivityLed(void)
{
    ...
    if (nowMs - lastActiveTimeMs > 50) {
        ledSet(0, 
# 100 "./src/main/drivers/usb_msc_common.c" 3 4
       0
# 100 "./src/main/drivers/usb_msc_common.c"
       );
        nextToggleMs = 0;
    } else if (nowMs > nextToggleMs) {
        ledToggle(0);
        nextToggleMs = nowMs + 50;
    }
}


# 108 "./src/main/drivers/usb_msc_common.c" 3 4
_Bool 
# 108 "./src/main/drivers/usb_msc_common.c"
    mscCheckButton(void)
{
    
# 110 "./src/main/drivers/usb_msc_common.c" 3 4
   _Bool 
# 110 "./src/main/drivers/usb_msc_common.c"
        result = 
# 110 "./src/main/drivers/usb_msc_common.c" 3 4
                 0
# 110 "./src/main/drivers/usb_msc_common.c"
...
void mscWaitForButton(void)
{
    ...
    delay(20);
    while (
# 128 "./src/main/drivers/usb_msc_common.c" 3 4
          1
# 128 "./src/main/drivers/usb_msc_common.c"
              ) {
        asm("NOP");
        if (mscCheckButton()) {
            systemResetFromMsc();
...
void systemResetToMsc(int timezoneOffsetMinutes)
{
    persistentObjectWrite(PERSISTENT_OBJECT_RESET_REASON, 3);
