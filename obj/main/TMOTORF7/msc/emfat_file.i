# 1 "./src/main/msc/emfat_file.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/msc/emfat_file.c"
# 25 "./src/main/msc/emfat_file.c"
...
# 153 "./src/main/platform.h" 2
# 26 "./src/main/msc/emfat_file.c" 2
...
# 30 "./src/main/msc/emfat_file.c" 2
...
# 31 "./src/main/msc/emfat_file.c" 2
...
# 32 "./src/main/msc/emfat_file.c" 2
...
# 35 "./src/main/msc/emfat_file.c" 2
...
# 67 "./src/main/drivers/light_led.h"
                         state);
# 36 "./src/main/msc/emfat_file.c" 2
...
# 37 "./src/main/msc/emfat_file.c" 2
...
# 38 "./src/main/msc/emfat_file.c" 2
...
# 40 "./src/main/msc/emfat_file.c" 2
...
# 54 "./src/main/vcp_hal/usbd_conf.h"
...
# 44 "./src/main/msc/emfat_file.c" 2
# 249 "./src/main/msc/emfat_file.c"
...
static const emfat_entry_t entriesPredefined[] =
{
    ...
    { "", 
# 259 "./src/main/msc/emfat_file.c" 3 4
                     1
# 259 "./src/main/msc/emfat_file.c"
                         , 0, 0, 0, 0, 0, 0, { ((((((2018)-1980) << 9) | ((1) << 5) | (1)) << 16) | (((13) << 11) | ((0) << 5) | (0 >> 1))), ((((((2018)-1980) << 9) | ((1) << 5) | (1)) << 16) | (((13) << 11) | ((0) << 5) | (0 >> 1))), ((((((2018)-1980) << 9) | ((1) << 5) | (1)) << 16) | (((13) << 11) | ((0) << 5) | (0 >> 1))) }, 
# 259 "./src/main/msc/emfat_file.c" 3 4
                                                                                                                ((void *)0)
# 259 "./src/main/msc/emfat_file.c"
                                                                                                                    , 
...
# 259 "./src/main/msc/emfat_file.c"
                                                                                                                                       , { 0 } },
# 269 "./src/main/msc/emfat_file.c"
    { "BTFL" "_ALL.BBL", 0, 0, 1, 0, 0, 0, 0, { ((((((2018)-1980) << 9) | ((1) << 5) | (1)) << 16) | (((13) << 11) | ((0) << 5) | (0 >> 1))), ((((((2018)-1980) << 9) | ((1) << 5) | (1)) << 16) | (((13) << 11) | ((0) << 5) | (0 >> 1))), ((((((2018)-1980) << 9) | ((1) << 5) | (1)) << 16) | (((13) << 11) | ((0) << 5) | (0 >> 1))) }, bblog_read_proc, 
# 269 "./src/main/msc/emfat_file.c" 3 4
                                                                                                                                                      ((void *)0)
# 269 "./src/main/msc/emfat_file.c"
                                                                                                                                                          , { 0 } },
    { "PADDING.TXT", 0, 0x02, 1, 0, 0, 0, 0, { ((((((2018)-1980) << 9) | ((1) << 5) | (1)) << 16) | (((13) << 11) | ((0) << 5) | (0 >> 1))), ((((((2018)-1980) << 9) | ((1) << 5) | (1)) << 16) | (((13) << 11) | ((0) << 5) | (0 >> 1))), ((((((2018)-1980) << 9) | ((1) << 5) | (1)) << 16) | (((13) << 11) | ((0) << 5) | (0 >> 1))) }, 
# 270 "./src/main/msc/emfat_file.c" 3 4
                                                                                                                ((void *)0)
# 270 "./src/main/msc/emfat_file.c"
                                                                                                                    , 
# 270 "./src/main/msc/emfat_file.c" 3 4
                                                                                                                                   ((void *)0)
# 270 "./src/main/msc/emfat_file.c"
...
static emfat_entry_t entries[((1 + 0 + 0 + 0) + 100 + 2)];

emfat_t emfat;
static uint32_t cmaTime = ((((((2018)-1980) << 9) | ((1) << 5) | (1)) << 16) | (((13) << 11) | ((0) << 5) | (0 >> 1)));
...
{
    static char logNames[100][8+1+3];

    tfp_sprintf(logNames[number], "BTFL" "_%03d.BBL", number + 1);
...
static int emfat_find_log(emfat_entry_t *entry, int maxCount, int flashfsUsedSpace)
{
    ...
    for ( ; currOffset < flashfsUsedSpace ; currOffset += 2048) {

        mscSetActive();
        mscActivityLed();

        flashfsReadAbs(currOffset, buffer, 32);
        ...
        while (
# 353 "./src/main/msc/emfat_file.c" 3 4
              1
# 353 "./src/main/msc/emfat_file.c"
                  ) {
            if (buffer[buffOffset++] == timeHeader[timeHeaderMatched]) {

                if (++timeHeaderMatched == lenTimeHeader) {

                    flashfsReadAbs(hdrOffset + buffOffset, buffer, 32);
                    ...
                    int sec = strtoul(++nextToken, 
# 367 "./src/main/msc/emfat_file.c" 3 4
                                                  ((void *)0)
# 367 "./src/main/msc/emfat_file.c"
                                                      , 10);


                    if (year) {
                        entry->cma_time[0] = ((((((year)-1980) << 9) | ((month) << 5) | (day)) << 16) | (((hour) << 11) | ((min) << 5) | (sec >> 1)));
                    }
            ...
            if (buffOffset == 32) {
                ...
                flashfsReadAbs(hdrOffset, buffer, 32);
                buffOffset = 0;
            }
        }
...
void emfat_init_files(void)
{
    ...
    flashfsInit();
    ledSet(0, 
# 436 "./src/main/msc/emfat_file.c" 3 4
   0
# 436 "./src/main/msc/emfat_file.c"
   );

    flashfsUsedSpace = flashfsIdentifyStartOfFreeSpace();


    const int logCount = emfat_find_log(&entries[(1 + 0 + 0 + 0)], 100, flashfsUsedSpace);
    ...
    if (logCount > 0) {
        ...
        entries[entryIndex] = entriesPredefined[(1 + 0 + 0 + 0)];
    ...
    if (flashfsUsedSpace * 2 < 256 * 1024 * 1024) {
        entries[entryIndex] = entriesPredefined[(1 + 0 + 0 + 0) + 1];
        entry = &entries[entryIndex];

        entry->curr_size = (256 * 1024 * 1024) - (flashfsUsedSpace * 2);
        entry->max_size = entry->curr_size;
    ...
    ledSet(0, 
# 470 "./src/main/msc/emfat_file.c" 3 4
   0
# 470 "./src/main/msc/emfat_file.c"
   );
}
