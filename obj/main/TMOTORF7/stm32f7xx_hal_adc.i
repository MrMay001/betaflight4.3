# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
# 257 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
...
# 258 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c" 2
# 278 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
static void ADC_Init(ADC_HandleTypeDef* hadc);
static void ADC_DMAConvCplt(DMA_HandleTypeDef *hdma);
static void ADC_DMAError(DMA_HandleTypeDef *hdma);
static void ADC_DMAHalfConvCplt(DMA_HandleTypeDef *hdma);
# 321 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
HAL_StatusTypeDef HAL_ADC_Init(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc == 
# 326 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c" 3 4
            ((void *)0)
# 326 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
                )
  {
    return HAL_ERROR;
  }
  ...
  if(hadc->Init.ExternalTrigConv != ((uint32_t)(0xFUL << (24U)) + 1))
  {
    ((void)0U);
  }
  ...
  {
# 367 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
  ...
  if ((((hadc->State) & (((uint32_t)0x00000010U))) == 0U))
  {
...
HAL_StatusTypeDef HAL_ADC_DeInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc == 
# 420 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c" 3 4
            ((void *)0)
# 420 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
                )
  {
    return HAL_ERROR;
  }
  ...
  {
# 449 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
...
# 729 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
HAL_StatusTypeDef HAL_ADC_Start(ADC_HandleTypeDef* hadc)
{
  ...
  if((((hadc->Instance->CR2) & ((0x1UL << (0U)))) == ((0x1UL << (0U)))))
  {
    ...
    if ((((hadc->State) & (((uint32_t)0x00001000U))) == (((uint32_t)0x00001000U))))
    {
    ...
    if((((((ADC_Common_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2300UL))->CCR) & ((0x1FUL << (0U)))) == 0U))
    {
    ...
    else
    {
      ...
      if( (((((ADC_Common_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2300UL))->CCR) & ((0x10UL << (0U)))) == 0U) )
      {

        if((hadc->Instance == ((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2200UL))) && ((hadc->Instance->CR2 & (0x3UL << (28U))) == RESET))
        {
...
# 842 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
HAL_StatusTypeDef HAL_ADC_Stop(ADC_HandleTypeDef* hadc)
{
...
# 885 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
HAL_StatusTypeDef HAL_ADC_PollForConversion(ADC_HandleTypeDef* hadc, uint32_t Timeout)
{
      ...
      (((hadc->Instance->CR2) & ((0x1UL << (10U)))) == 0U) ) )
  {
    ...
    if ((((hadc->State) & (((uint32_t)0x00001000U))) == 0U))
    {
...
# 970 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
HAL_StatusTypeDef HAL_ADC_PollForEvent(ADC_HandleTypeDef* hadc, uint32_t EventType, uint32_t Timeout)
{
  uint32_t tickstart = 0;
...
# 1032 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
HAL_StatusTypeDef HAL_ADC_Start_IT(ADC_HandleTypeDef* hadc)
{
  volatile uint32_t counter = 0;
...
# 1147 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
HAL_StatusTypeDef HAL_ADC_Stop_IT(ADC_HandleTypeDef* hadc)
{
...
void HAL_ADC_IRQHandler(ADC_HandleTypeDef* hadc)
{
  ...
  if(tmp1 && tmp2)
  {
       ...
       (hadc->Init.ContinuousConvMode == DISABLE))))
    {
      ...
      if ((((hadc->State) & (((uint32_t)0x00000100U))) == 0U))
      {
        ((hadc->State) |= (((uint32_t)0x00000001U)));
      }
    }
...
# 1346 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
HAL_StatusTypeDef HAL_ADC_Start_DMA(ADC_HandleTypeDef* hadc, uint32_t* pData, uint32_t Length)
{
  volatile uint32_t counter = 0;
...
# 1585 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
...
# 1623 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
HAL_StatusTypeDef HAL_ADC_ConfigChannel(ADC_HandleTypeDef* hadc, ADC_ChannelConfTypeDef* sConfig)
{
  volatile uint32_t counter = 0;
 ...
 if (sConfig->Channel > ((uint32_t)((0x08UL << (0U)) | (0x01UL << (0U)))))
 {
  ...
  hadc->Instance->SMPR1 &= ~(((0x7UL << (0U))) << (3 * (((uint32_t)((uint16_t)(sConfig->Channel))) - 10)));

  if (sConfig->Channel == ((uint32_t)((uint32_t)((0x10UL << (0U)) | (0x02UL << (0U)))) | 0x10000000U))
  {

   hadc->Instance->SMPR1 |= ((sConfig->SamplingTime) << (3 * (((uint32_t)((uint16_t)(((uint32_t)((0x10UL << (0U)) | (0x02UL << (0U))))))) - 10)));
  }
   else
   {
  ...
  else
  {
    ...
    hadc->Instance->SMPR2 &= ~(((0x7UL << (0U))) << (3 * ((uint32_t)((uint16_t)(sConfig->Channel)))));
  ...
  if (sConfig->Rank < 7)
  {
    ...
    hadc->Instance->SQR3 &= ~(((uint32_t)((uint16_t)((0x1FUL << (0U))))) << (5 * ((sConfig->Rank) - 1)));
  ...
  else if (sConfig->Rank < 13)
  {
    ...
    hadc->Instance->SQR2 &= ~(((uint32_t)((uint16_t)((0x1FUL << (0U))))) << (5 * ((sConfig->Rank) - 7)));
  ...
  else
  {
    ...
    hadc->Instance->SQR1 &= ~(((uint32_t)((uint16_t)((0x1FUL << (0U))))) << (5 * ((sConfig->Rank) - 13)));
  ...
  if ((hadc->Instance == ((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2000UL))) && (sConfig->Channel == ((uint32_t)((uint32_t)((0x10UL << (0U)) | (0x02UL << (0U)))))))
  {
    ...
    ((ADC_Common_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2300UL))->CCR |= (0x1UL << (22U));
  }


  if ((hadc->Instance == ((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2000UL))) && ((sConfig->Channel == ((uint32_t)((uint32_t)((0x10UL << (0U)) | (0x02UL << (0U)))) | 0x10000000U)) || (sConfig->Channel == ((uint32_t)((uint32_t)((0x10UL << (0U)) | (0x01UL << (0U))))))))
  {

    ((ADC_Common_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2300UL))->CCR |= (0x1UL << (23U));
...
# 1737 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
HAL_StatusTypeDef HAL_ADC_AnalogWDGConfig(ADC_HandleTypeDef* hadc, ADC_AnalogWDGConfTypeDef* AnalogWDGConfig)
{
  ...
  ((void)0U);
  ((void)0U);
# 1755 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
  do{ if((hadc)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hadc)->Lock = HAL_LOCKED; } }while (0U);
...
# 1819 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
uint32_t HAL_ADC_GetState(ADC_HandleTypeDef* hadc)
{
...
# 1857 "./lib/main/STM32F7/Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_adc.c"
static void ADC_Init(ADC_HandleTypeDef* hadc)
{


  ((ADC_Common_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2300UL))->CCR &= ~((0x3UL << (16U)));
  ((ADC_Common_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2300UL))->CCR |= hadc->Init.ClockPrescaler;
  ...
  hadc->Instance->CR2 |= (((uint32_t)hadc->Init.ContinuousConvMode) << 1);
  ...
  hadc->Instance->CR2 |= (((uint32_t)hadc->Init.DMAContinuousRequests) << 9);
...
static void ADC_DMAConvCplt(DMA_HandleTypeDef *hdma)
{
  ...
  if ((((hadc->State) & (((uint32_t)0x00000010U) | ((uint32_t)0x00000040U))) == 0U))
  {
  ...
  {
    if ((hadc->State & ((uint32_t)0x00000010U)) != 0UL)
    {
