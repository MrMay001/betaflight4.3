...
# 59 "./src/main/osd/osd.c" 2
# 1 "./src/main/drivers/osd_symbols.h" 1
# 22 "./src/main/drivers/osd_symbols.h"
       
# 60 "./src/main/osd/osd.c" 2
...
# 211 "./src/main/io/gps.h"
                        state);
# 80 "./src/main/osd/osd.c" 2

# 1 "./src/main/osd/osd.h" 1
# 21 "./src/main/osd/osd.h"
       
# 30 "./src/main/osd/osd.h"
...
# 83 "./src/main/rx/crsf.h"
    crsfRxIsTelemetryBufEmpty(void);

struct rxConfig_s;
struct rxRuntimeState_s;

# 87 "./src/main/rx/crsf.h" 3 4
_Bool 
# 87 "./src/main/rx/crsf.h"
    crsfRxInit(const struct rxConfig_s *initialRxConfig, struct rxRuntimeState_s *rxRuntimeState);
void crsfRxUpdateBaudrate(uint32_t baudrate);

# 89 "./src/main/rx/crsf.h" 3 4
_Bool 
# 89 "./src/main/rx/crsf.h"
    crsfRxUseNegotiatedBaud(void);

# 90 "./src/main/rx/crsf.h" 3 4
_Bool 
# 90 "./src/main/rx/crsf.h"
    crsfRxIsActive(void);
# 91 "./src/main/osd/osd.c" 2
...
# 25 "./src/main/scheduler/scheduler.h" 2
...
static 
# 128 "./src/main/osd/osd.c" 3 4
      _Bool 
# 128 "./src/main/osd/osd.c"
           showVisualBeeper = 
# 128 "./src/main/osd/osd.c" 3 4
                              0
# 128 "./src/main/osd/osd.c"
...
static 
# 140 "./src/main/osd/osd.c" 3 4
      _Bool 
# 140 "./src/main/osd/osd.c"
           osdIsReady;

static 
# 142 "./src/main/osd/osd.c" 3 4
      _Bool 
# 142 "./src/main/osd/osd.c"
...
static 
# 144 "./src/main/osd/osd.c" 3 4
      _Bool 
# 144 "./src/main/osd/osd.c"
...
extern void pgResetFn_osdConfig(osdConfig_t *); osdConfig_t osdConfig_System; osdConfig_t osdConfig_Copy; uint32_t osdConfig_fnv_hash; extern const pgRegistry_t osdConfig_Registry; const pgRegistry_t osdConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 501 | (9 << 12), .length = 1, .size = sizeof(osdConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&osdConfig_System, .fnv_hash = &osdConfig_fnv_hash, .copy = (uint8_t*)&osdConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_osdConfig }, };

extern void pgResetFn_osdElementConfig(osdElementConfig_t *); osdElementConfig_t osdElementConfig_System; osdElementConfig_t osdElementConfig_Copy; uint32_t osdElementConfig_fnv_hash; extern const pgRegistry_t osdElementConfig_Registry; const pgRegistry_t osdElementConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 2045 | (0 << 12), .length = 1, .size = sizeof(osdElementConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&osdElementConfig_System, .fnv_hash = &osdElementConfig_fnv_hash, .copy = (uint8_t*)&osdElementConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_osdElementConfig }, };
# 166 "./src/main/osd/osd.c"
...
# 212 "./src/main/osd/osd.c"
int osdPrintFloat(char *buffer, char leadingSymbol, float value, char *formatString, unsigned decimalPlaces, 
# 212 "./src/main/osd/osd.c" 3 4
                                                                                                            _Bool 
# 212 "./src/main/osd/osd.c"
                                                                                                                 round, char trailingSymbol)
{
    ...
    value *= multiplier;
    const int scaledValueAbs = __extension__ ({ __typeof__ (round ? lrintf(value) : value) _x = (round ? lrintf(value) : value); _x > 0 ? _x : -_x; });
    const int integerPart = scaledValueAbs / multiplier;
    const int fractionalPart = scaledValueAbs % multiplier;

    if (leadingSymbol != 0x00) {
    ...
    if (decimalPlaces) {
        tfp_sprintf((char *)&mask, ".%%0%uu", decimalPlaces);
        pos += tfp_sprintf(buffer + pos, mask, fractionalPart);
    }

    if (trailingSymbol != 0x00) {
...
void osdStatSetState(uint8_t statIndex, 
# 247 "./src/main/osd/osd.c" 3 4
                                       _Bool 
# 247 "./src/main/osd/osd.c"
                                            enabled)
{
    if (enabled) {
...
# 256 "./src/main/osd/osd.c" 3 4
_Bool 
# 256 "./src/main/osd/osd.c"
    osdStatGetState(uint8_t statIndex)
{
...
void osdWarnSetState(uint8_t warningIndex, 
# 261 "./src/main/osd/osd.c" 3 4
                                          _Bool 
# 261 "./src/main/osd/osd.c"
                                               enabled)
{
    if (enabled) {
...
# 270 "./src/main/osd/osd.c" 3 4
_Bool 
# 270 "./src/main/osd/osd.c"
    osdWarnGetState(uint8_t warningIndex)
{
...
const uint16_t osdTimerDefault[OSD_TIMER_COUNT] = {
        ((OSD_TIMER_SRC_ON & 0x0F) | ((OSD_TIMER_PREC_SECOND & 0x0F) << 4) | ((10 & 0xFF ) << 8)),
        ((OSD_TIMER_SRC_TOTAL_ARMED & 0x0F) | ((OSD_TIMER_PREC_SECOND & 0x0F) << 4) | ((10 & 0xFF ) << 8))
};
...
# 327 "./src/main/osd/osd.c" 3 4
                                       1
# 327 "./src/main/osd/osd.c"
                                           );
    osdStatSetState(OSD_STAT_MIN_BATTERY, 
# 328 "./src/main/osd/osd.c" 3 4
                                         1
# 328 "./src/main/osd/osd.c"
                                             );
    osdStatSetState(OSD_STAT_MIN_RSSI, 
# 329 "./src/main/osd/osd.c" 3 4
                                      1
# 329 "./src/main/osd/osd.c"
                                          );
    osdStatSetState(OSD_STAT_MAX_CURRENT, 
# 330 "./src/main/osd/osd.c" 3 4
                                         1
# 330 "./src/main/osd/osd.c"
                                             );
    osdStatSetState(OSD_STAT_USED_MAH, 
# 331 "./src/main/osd/osd.c" 3 4
                                      1
# 331 "./src/main/osd/osd.c"
                                          );
    osdStatSetState(OSD_STAT_BLACKBOX, 
# 332 "./src/main/osd/osd.c" 3 4
                                      1
# 332 "./src/main/osd/osd.c"
                                          );
    osdStatSetState(OSD_STAT_BLACKBOX_NUMBER, 
# 333 "./src/main/osd/osd.c" 3 4
                                             1
# 333 "./src/main/osd/osd.c"
                                                 );
    osdStatSetState(OSD_STAT_TIMER_2, 
# 334 "./src/main/osd/osd.c" 3 4
                                     1
# 334 "./src/main/osd/osd.c"
                                         );
    ...
    for (int i=0; i < OSD_WARNING_COUNT; i++) {
        osdWarnSetState(i, 
# 340 "./src/main/osd/osd.c" 3 4
                          1
# 340 "./src/main/osd/osd.c"
                              );
    }

    osdWarnSetState(OSD_WARNING_RSSI, 
# 343 "./src/main/osd/osd.c" 3 4
                                     0
# 343 "./src/main/osd/osd.c"
                                          );
    osdWarnSetState(OSD_WARNING_LINK_QUALITY, 
# 344 "./src/main/osd/osd.c" 3 4
                                             0
# 344 "./src/main/osd/osd.c"
                                                  );
    osdWarnSetState(OSD_WARNING_RSSI_DBM, 
# 345 "./src/main/osd/osd.c" 3 4
                                         0
# 345 "./src/main/osd/osd.c"
                                              );

    osdWarnSetState(OSD_WARNING_OVER_CAP, 
# 347 "./src/main/osd/osd.c" 3 4
                                         0
# 347 "./src/main/osd/osd.c"
                                              );
...
# 358 "./src/main/osd/osd.c" 3 4
                               (-0x7f - 1)
# 358 "./src/main/osd/osd.c"
                                                 ;
    ...
    osdConfig->ahInvert = 
# 367 "./src/main/osd/osd.c" 3 4
                         0
# 367 "./src/main/osd/osd.c"
                              ;
    for (int i=0; i < 3; i++) {
        osdConfig->profile[i][0] = '\0';
    }
    osdConfig->rssi_dbm_alarm = -60;
    osdConfig->gps_sats_show_hdop = 
# 372 "./src/main/osd/osd.c" 3 4
                                   0
# 372 "./src/main/osd/osd.c"
                                        ;
    ...
    osdConfig->logo_on_arming_duration = 5;

    osdConfig->camera_frame_width = 24;
    osdConfig->camera_frame_height = 11;

    osdConfig->stat_show_cell_value = 
# 387 "./src/main/osd/osd.c" 3 4
                                     0
# 387 "./src/main/osd/osd.c"
                                          ;
    osdConfig->framerate_hz = 12;
...
void pgResetFn_osdElementConfig(osdElementConfig_t *osdElementConfig)
{
    ...
    for (int i = 0; i < OSD_ITEM_COUNT; i++) {
        osdElementConfig->item_pos[i] = ((10 & ((1 << 5) - 1)) | ((7 & ((1 << 5) - 1)) << 5));
    }
    ...
    osdElementConfig->item_pos[OSD_CROSSHAIRS] = ((13 & ((1 << 5) - 1)) | ((6 & ((1 << 5) - 1)) << 5));
    osdElementConfig->item_pos[OSD_ARTIFICIAL_HORIZON] = ((14 & ((1 << 5) - 1)) | ((2 & ((1 << 5) - 1)) << 5));
    osdElementConfig->item_pos[OSD_HORIZON_SIDEBARS] = ((14 & ((1 << 5) - 1)) | ((6 & ((1 << 5) - 1)) << 5));
    osdElementConfig->item_pos[OSD_CAMERA_FRAME] = ((3 & ((1 << 5) - 1)) | ((1 & ((1 << 5) - 1)) << 5));
    osdElementConfig->item_pos[OSD_UP_DOWN_REFERENCE] = ((13 & ((1 << 5) - 1)) | ((6 & ((1 << 5) - 1)) << 5));
}
...
static void osdCompleteInitialization(void)
{
    ...
    tfp_sprintf(string_buffer, "V%s", "4" "." "3" "." "1");
    ...
    osdIsReady = 
# 464 "./src/main/osd/osd.c" 3 4
                1
# 464 "./src/main/osd/osd.c"
                    ;
}
...
# 609 "./src/main/osd/osd.c" 3 4
   _Bool 
# 609 "./src/main/osd/osd.c"
        storageDeviceIsWorking = isBlackboxDeviceWorking();
    uint32_t storageUsed = 0;
    uint32_t storageTotal = 0;

    switch (blackboxConfig()->device) {
# 624 "./src/main/osd/osd.c"
    case BLACKBOX_DEVICE_FLASH:
        if (storageDeviceIsWorking) {
            ...
            storageTotal = (((flashPartition->endSector + 1 - flashPartition->startSector) * flashGeometry->sectorSize) / 1024);
...
static 
# 659 "./src/main/osd/osd.c" 3 4
      _Bool 
# 659 "./src/main/osd/osd.c"
           isSomeStatEnabled(void)
{
    return (osdConfig()->enabled_stats != 0);
}
# 671 "./src/main/osd/osd.c"
static 
# 671 "./src/main/osd/osd.c" 3 4
      _Bool 
# 671 "./src/main/osd/osd.c"
           osdDisplayStat(int statistic, uint8_t displayRow)
{
    char buff[32];
...
# 677 "./src/main/osd/osd.c" 3 4
       _Bool 
# 677 "./src/main/osd/osd.c"
            success = 
# 677 "./src/main/osd/osd.c" 3 4
                      0
# 677 "./src/main/osd/osd.c"
        ...
        return 
# 686 "./src/main/osd/osd.c" 3 4
              1
# 686 "./src/main/osd/osd.c"
                  ;
    }

    case OSD_STAT_TIMER_1:
        osdFormatTimer(buff, 
# 690 "./src/main/osd/osd.c" 3 4
                            0
# 690 "./src/main/osd/osd.c"
...
# 690 "./src/main/osd/osd.c"
        ...
        osdDisplayStatisticLabel(displayRow, osdTimerSourceNames[(osdConfig()->timers[OSD_TIMER_1] & 0x0F)], buff);
        return 
# 692 "./src/main/osd/osd.c" 3 4
              1
# 692 "./src/main/osd/osd.c"
                  ;

    case OSD_STAT_TIMER_2:
        osdFormatTimer(buff, 
# 695 "./src/main/osd/osd.c" 3 4
                            0
# 695 "./src/main/osd/osd.c"
...
# 695 "./src/main/osd/osd.c"
        ...
        osdDisplayStatisticLabel(displayRow, osdTimerSourceNames[(osdConfig()->timers[OSD_TIMER_2] & 0x0F)], buff);
        return 
# 697 "./src/main/osd/osd.c" 3 4
              1
# 697 "./src/main/osd/osd.c"
                  ;

    case OSD_STAT_MAX_ALTITUDE: {
        osdPrintFloat(buff, 0x00, osdGetMetersToSelectedUnit(stats.max_altitude) / 100.0f, "", 1, 
# 700 "./src/main/osd/osd.c" 3 4
                                                                                                     1
# 700 "./src/main/osd/osd.c"
                                                                                                         , osdGetMetersToSelectedUnitSymbol());
        osdDisplayStatisticLabel(displayRow, "MAX ALTITUDE", buff);
        return 
# 702 "./src/main/osd/osd.c" 3 4
              1
...
# 747 "./src/main/osd/osd.c"
    ...
    case OSD_STAT_MIN_RSSI:
        ...
        return 
# 755 "./src/main/osd/osd.c" 3 4
              1
# 755 "./src/main/osd/osd.c"
                  ;

    case OSD_STAT_MAX_CURRENT:
        if (batteryConfig()->currentMeterSource != CURRENT_METER_NONE) {
            tfp_sprintf(buff, "%d%c", stats.max_current, 0x9A);
            osdDisplayStatisticLabel(displayRow, "MAX CURRENT", buff);
            return 
# 761 "./src/main/osd/osd.c" 3 4
                  1
# 761 "./src/main/osd/osd.c"
                      ;
        }
        break;
    ...
    case OSD_STAT_USED_MAH:
        if (batteryConfig()->currentMeterSource != CURRENT_METER_NONE) {
            ...
            return 
# 769 "./src/main/osd/osd.c" 3 4
                  1
# 769 "./src/main/osd/osd.c"
                      ;
        }
        break;
    ...
    case OSD_STAT_BLACKBOX:
        if (blackboxConfig()->device && blackboxConfig()->device != BLACKBOX_DEVICE_SERIAL) {
            ...
            return 
# 778 "./src/main/osd/osd.c" 3 4
                  1
# 778 "./src/main/osd/osd.c"
                      ;
        }
        break;
    ...
    case OSD_STAT_BLACKBOX_NUMBER:
        {
            ...
            if (logNumber >= 0) {
                ...
                return 
# 788 "./src/main/osd/osd.c" 3 4
                      1
# 788 "./src/main/osd/osd.c"
                          ;
            }
        }
        break;
    ...
    case OSD_STAT_MAX_G_FORCE:
        if (sensors(SENSOR_ACC)) {
            osdPrintFloat(buff, 0x00, stats.max_g_force, "", 1, 
# 797 "./src/main/osd/osd.c" 3 4
                                                                   1
# 797 "./src/main/osd/osd.c"
                                                                       , 'G');
            osdDisplayStatisticLabel(displayRow, "MAX G-FORCE", buff);
            return 
# 799 "./src/main/osd/osd.c" 3 4
                  1
# 799 "./src/main/osd/osd.c"
                      ;
        }
        break;
...
# 823 "./src/main/osd/osd.c"
    ...
    case OSD_STAT_MAX_FFT:
        if (isDynNotchActive()) {
            ...
            return 
# 836 "./src/main/osd/osd.c" 3 4
                  1
# 836 "./src/main/osd/osd.c"
                      ;
        }
        break;
...
static 
# 898 "./src/main/osd/osd.c" 3 4
      _Bool 
# 898 "./src/main/osd/osd.c"
           osdRenderStatsContinue(void)
{
    if (osdStatsRenderingState.row == 0) {

        
# 902 "./src/main/osd/osd.c" 3 4
       _Bool 
# 902 "./src/main/osd/osd.c"
            displayLabel = 
# 902 "./src/main/osd/osd.c" 3 4
                           0
# 902 "./src/main/osd/osd.c"
        ...
        if (osdStatsRenderingState.rowCount > 0) {
            ...
            int displayRows = __extension__ ({ __typeof__ (osdStatsRenderingState.rowCount) _a = (osdStatsRenderingState.rowCount); __typeof__ (availableRows) _b = (availableRows); _a < _b ? _a : _b; });
            if (osdStatsRenderingState.rowCount < availableRows) {
                displayLabel = 
# 909 "./src/main/osd/osd.c" 3 4
                              1
# 909 "./src/main/osd/osd.c"
                                  ;
                displayRows++;
            }
            osdStatsRenderingState.row = (availableRows - displayRows) / 2;
        }

        if (displayLabel) {
            displayWrite(osdDisplayPort, 2, osdStatsRenderingState.row++, DISPLAYPORT_ATTR_NONE, "  --- STATS ---");
            return 
# 917 "./src/main/osd/osd.c" 3 4
                  0
# 917 "./src/main/osd/osd.c"
                       ;
        }
    }
...
# 922 "./src/main/osd/osd.c" 3 4
   _Bool 
# 922 "./src/main/osd/osd.c"
        renderedStat = 
# 922 "./src/main/osd/osd.c" 3 4
                       0
# 922 "./src/main/osd/osd.c"
    ...
    while (osdStatsRenderingState.index < OSD_STAT_COUNT) {
        ...
        if (osdStatGetState(osdStatsDisplayOrder[index])) {
            if (osdDisplayStat(osdStatsDisplayOrder[index], osdStatsRenderingState.row)) {
                ...
                renderedStat = 
# 934 "./src/main/osd/osd.c" 3 4
                              1
# 934 "./src/main/osd/osd.c"
                                  ;
                break;
            }
        }
...
# 940 "./src/main/osd/osd.c" 3 4
   _Bool 
# 940 "./src/main/osd/osd.c"
        moreSpaceAvailable = osdStatsRenderingState.row < osdDisplayPort->rows;

    if (renderedStat && moreSpaceAvailable) {
        return 
# 943 "./src/main/osd/osd.c" 3 4
              0
# 943 "./src/main/osd/osd.c"
                   ;
    }
    ...
    return 
# 950 "./src/main/osd/osd.c" 3 4
          1
# 950 "./src/main/osd/osd.c"
              ;
}


static 
# 954 "./src/main/osd/osd.c" 3 4
      _Bool 
# 954 "./src/main/osd/osd.c"
           osdRefreshStats(void)
{
    
# 956 "./src/main/osd/osd.c" 3 4
   _Bool 
# 956 "./src/main/osd/osd.c"
        completed = 
# 956 "./src/main/osd/osd.c" 3 4
                    0
# 956 "./src/main/osd/osd.c"
...
# 982 "./src/main/osd/osd.c" 3 4
           _Bool 
# 982 "./src/main/osd/osd.c"
                count_phase_complete = osdRenderStatsContinue();
...
static timeDelta_t osdShowArmed(void)
{
    ...
    if ((osdConfig()->logo_on_arming == OSD_LOGO_ARMING_ON) || ((osdConfig()->logo_on_arming == OSD_LOGO_ARMING_FIRST) && !(armingFlags & (WAS_EVER_ARMED)))) {
        osdDrawLogo(3, 1);
...
static 
# 1028 "./src/main/osd/osd.c" 3 4
      _Bool 
# 1028 "./src/main/osd/osd.c"
           osdStatsVisible = 
# 1028 "./src/main/osd/osd.c" 3 4
                             0
# 1028 "./src/main/osd/osd.c"
                                  ;
static 
# 1029 "./src/main/osd/osd.c" 3 4
      _Bool 
# 1029 "./src/main/osd/osd.c"
           osdStatsEnabled = 
# 1029 "./src/main/osd/osd.c" 3 4
                             0
# 1029 "./src/main/osd/osd.c"
...
static 
# 1031 "./src/main/osd/osd.c" 3 4
                  _Bool 
# 1031 "./src/main/osd/osd.c"
                       osdProcessStats1(timeUs_t currentTimeUs)
{
    static timeUs_t lastTimeUs = 0;
    static timeUs_t osdStatsRefreshTimeUs;

    
# 1036 "./src/main/osd/osd.c" 3 4
   _Bool 
# 1036 "./src/main/osd/osd.c"
        refreshStatsRequired = 
# 1036 "./src/main/osd/osd.c" 3 4
                               0
# 1036 "./src/main/osd/osd.c"
                                    ;
    ...
    if (armState != (armingFlags & (ARMED))) {
        if ((armingFlags & (ARMED))) {
            osdStatsEnabled = 
# 1041 "./src/main/osd/osd.c" 3 4
                             0
# 1041 "./src/main/osd/osd.c"
                                  ;
            osdStatsVisible = 
# 1042 "./src/main/osd/osd.c" 3 4
                             0
# 1042 "./src/main/osd/osd.c"
                                  ;
            osdResetStats();
            ...
            osdStatsEnabled = 
# 1050 "./src/main/osd/osd.c" 3 4
                             1
# 1050 "./src/main/osd/osd.c"
                                 ;
    ...
    if ((armingFlags & (ARMED))) {
        ...
        if (displayIsGrabbed(osdDisplayPort)) {
            osdStatsEnabled = 
# 1066 "./src/main/osd/osd.c" 3 4
                             0
# 1066 "./src/main/osd/osd.c"
                                  ;
            resumeRefreshAt = 0;
            stats.armed_time = 0;
        } else {
            if (IS_RC_MODE_ACTIVE(BOXOSD) && osdStatsVisible) {
                osdStatsVisible = 
# 1071 "./src/main/osd/osd.c" 3 4
                                 0
# 1071 "./src/main/osd/osd.c"
                                      ;
                displayClearScreen(osdDisplayPort, DISPLAY_CLEAR_NONE);
            } else if (!IS_RC_MODE_ACTIVE(BOXOSD)) {
                if (!osdStatsVisible) {
                    osdStatsVisible = 
# 1075 "./src/main/osd/osd.c" 3 4
                                     1
# 1075 "./src/main/osd/osd.c"
                                         ;
...
void osdProcessStats2(timeUs_t currentTimeUs)
{
    ...
    if (resumeRefreshAt) {
        if (cmp32(currentTimeUs, resumeRefreshAt) < 0) {
            ...
            if (!(armingFlags & (ARMED)) &&
                ((rcData[THROTTLE] > 1750) || (rcData[PITCH] > 1750) || IS_RC_MODE_ACTIVE(BOXFLIPOVERAFTERCRASH))) {
            ...
            resumeRefreshAt = 0;
            osdStatsEnabled = 
# 1105 "./src/main/osd/osd.c" 3 4
                             0
# 1105 "./src/main/osd/osd.c"
                                  ;
            stats.armed_time = 0;
        }
...
# 1156 "./src/main/osd/osd.c" 3 4
_Bool 
# 1156 "./src/main/osd/osd.c"
    osdUpdateCheck(timeUs_t currentTimeUs, timeDelta_t currentDeltaTimeUs)
{
    ...
    if (osdState == OSD_STATE_IDLE) {
        ...
        if (cmpTimeUs(currentTimeUs, osdUpdateDueUs) > 0) {
            ...
            if (osdUpdateDueUs) {
                osdUpdateDueUs += (1000000 / osdConfig()->framerate_hz);
            } else {
                osdUpdateDueUs = currentTimeUs + (1000000 / osdConfig()->framerate_hz);
            }
        }
    }
...
void osdUpdate(timeUs_t currentTimeUs)
{
    ...
    static uint16_t osdElementGroupTargetFractionUs[OSD_ITEM_COUNT] = { 0 };
    static uint16_t osdElementGroupDurationFractionUs[OSD_ITEM_COUNT] = { 0 };
    static uint8_t osdElementGroup;
    static 
# 1187 "./src/main/osd/osd.c" 3 4
          _Bool 
# 1187 "./src/main/osd/osd.c"
               firstPass = 
# 1187 "./src/main/osd/osd.c" 3 4
                           1
# 1187 "./src/main/osd/osd.c"
...
# 1198 "./src/main/osd/osd.c" 3 4
                                              0
# 1198 "./src/main/osd/osd.c"
                                                   )) {
...
# 1234 "./src/main/osd/osd.c" 3 4
           _Bool 
# 1234 "./src/main/osd/osd.c"
                refreshStatsRequired = osdProcessStats1(currentTimeUs);
...
# 1245 "./src/main/osd/osd.c" 3 4
           _Bool 
# 1245 "./src/main/osd/osd.c"
                completed = osdRefreshStats();
            if (completed) {
                osdState = OSD_STATE_PROCESS_STATS2;
            }
            break;
    ...
    case OSD_STATE_UPDATE_CANVAS:
        ...
        static 
# 1299 "./src/main/osd/osd.c" 3 4
              _Bool 
# 1299 "./src/main/osd/osd.c"
                   lastGpsSensorState;


        const 
# 1302 "./src/main/osd/osd.c" 3 4
             _Bool 
# 1302 "./src/main/osd/osd.c"
    ...
    case OSD_STATE_GROUP_ELEMENTS:
        {
            ...
            for (elementGroup = 0; elementGroup < OSD_ITEM_COUNT; elementGroup++) {
                if (osdElementGroupDurationFractionUs[elementGroup] > (30 << 8)) {
            ...
            for (uint8_t curElement = 0; curElement < activeElements; curElement++) {
                if ((osdElementGroupTargetFractionUs[elementGroup] == 0) ||
                    (osdElementGroupTargetFractionUs[elementGroup] + (osdElementDurationUs[curElement]) <= (30 << 8)) ||
                    (elementGroup == (OSD_ITEM_COUNT - 1))) {
                    ...
                    if (osdElementGroupMemberships[curElement] != elementGroup) {
                        osdElementGroupDurationFractionUs[elementGroup] = osdElementGroupTargetFractionUs[elementGroup] + (2 << 8);
                    }
...
# 1362 "./src/main/osd/osd.c" 3 4
           _Bool 
# 1362 "./src/main/osd/osd.c"
                moreElements = 
# 1362 "./src/main/osd/osd.c" 3 4
                               1
# 1362 "./src/main/osd/osd.c"
            ...
            do {
                ...
                if (executeTimeUs > (osdElementDurationUs[osdCurrentElement] >> 8)) {
                    osdElementDurationUs[osdCurrentElement] = executeTimeUs << 8;
    ...
    case OSD_STATE_TRANSFER:
        ...
        firstPass = 
# 1418 "./src/main/osd/osd.c" 3 4
                   0
# 1418 "./src/main/osd/osd.c"
                        ;
        osdState = OSD_STATE_IDLE;
    ...
    if (!schedulerGetIgnoreTaskExecTime()) {
        ...
        if (!firstPass) {
            if (osdCurrentState == OSD_STATE_UPDATE_ELEMENTS) {
                if (executeTimeUs > (osdElementGroupDurationFractionUs[osdCurrentElementGroup] >> 8)) {
                    osdElementGroupDurationFractionUs[osdCurrentElementGroup] = executeTimeUs << 8;
            ...
            if (executeTimeUs > (osdStateDurationFractionUs[osdCurrentState] >> 8)) {
                osdStateDurationFractionUs[osdCurrentState] = executeTimeUs << 8;
    ...
    if (osdState == OSD_STATE_UPDATE_ELEMENTS) {
        schedulerSetNextStateTime((osdElementGroupDurationFractionUs[osdElementGroup] >> 8) + 2);
    } else {
        if (osdState == OSD_STATE_IDLE) {
            schedulerSetNextStateTime((osdStateDurationFractionUs[OSD_STATE_CHECK] >> 8) + 1);
        } else {
            schedulerSetNextStateTime((osdStateDurationFractionUs[osdState] >> 8) + 1);
        }
    }
}

void osdSuppressStats(
# 1465 "./src/main/osd/osd.c" 3 4
                     _Bool 
# 1465 "./src/main/osd/osd.c"
                          flag)
{
...
# 1471 "./src/main/osd/osd.c" 3 4
_Bool 
# 1471 "./src/main/osd/osd.c"
    osdElementVisible(uint16_t value)
{
    return (
# 1473 "./src/main/osd/osd.c" 3 4
           _Bool
# 1473 "./src/main/osd/osd.c"
               )((((value & (((1 << 3) - 1) << 11)) >> 11) & osdProfile) != 0);
}



# 1477 "./src/main/osd/osd.c" 3 4
_Bool 
# 1477 "./src/main/osd/osd.c"
    osdGetVisualBeeperState(void)
{
...
void osdSetVisualBeeperState(
# 1482 "./src/main/osd/osd.c" 3 4
                            _Bool 
# 1482 "./src/main/osd/osd.c"
                                 state)
{
...
static 
# 1495 "./src/main/osd/osd.c" 3 4
      _Bool 
# 1495 "./src/main/osd/osd.c"
           osdStatsNeedAccelerometer(void)
{
...
# 1501 "./src/main/osd/osd.c" 3 4
_Bool 
# 1501 "./src/main/osd/osd.c"
    osdNeedsAccelerometer(void)
{
