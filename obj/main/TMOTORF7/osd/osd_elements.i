# 1 "./src/main/osd/osd_elements.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/osd/osd_elements.c"
# 101 "./src/main/osd/osd_elements.c"
# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include/stdbool.h" 1 3 4
# 102 "./src/main/osd/osd_elements.c" 2
...
# 103 "./src/main/osd/osd_elements.c" 2
...
# 104 "./src/main/osd/osd_elements.c" 2
...
# 105 "./src/main/osd/osd_elements.c" 2
...
int toupper (int __c);
int isblank (int __c);
# 106 "./src/main/osd/osd_elements.c" 2
...
# 107 "./src/main/osd/osd_elements.c" 2
...
# 153 "./src/main/platform.h" 2
# 109 "./src/main/osd/osd_elements.c" 2
...
# 113 "./src/main/osd/osd_elements.c" 2
...
# 114 "./src/main/osd/osd_elements.c" 2
...
# 117 "./src/main/osd/osd_elements.c" 2
...
# 119 "./src/main/osd/osd_elements.c" 2
...
# 120 "./src/main/osd/osd_elements.c" 2
...
# 121 "./src/main/osd/osd_elements.c" 2
...
# 122 "./src/main/osd/osd_elements.c" 2
...
# 125 "./src/main/osd/osd_elements.c" 2
...
# 127 "./src/main/osd/osd_elements.c" 2
...
# 128 "./src/main/osd/osd_elements.c" 2
...
# 130 "./src/main/osd/osd_elements.c" 2
...
# 133 "./src/main/osd/osd_elements.c" 2
...
# 134 "./src/main/osd/osd_elements.c" 2
...
# 136 "./src/main/osd/osd_elements.c" 2
...
# 137 "./src/main/osd/osd_elements.c" 2
...
# 138 "./src/main/osd/osd_elements.c" 2
...
# 139 "./src/main/osd/osd_elements.c" 2
...
void mwDisarm(void);
# 140 "./src/main/osd/osd_elements.c" 2
...
# 142 "./src/main/osd/osd_elements.c" 2
...
# 143 "./src/main/osd/osd_elements.c" 2
...
# 88 "./src/main/flight/imu.h"
    isUpright(void);
# 144 "./src/main/osd/osd_elements.c" 2
...
# 145 "./src/main/osd/osd_elements.c" 2
...
# 146 "./src/main/osd/osd_elements.c" 2
...
# 211 "./src/main/io/gps.h"
                        state);
# 148 "./src/main/osd/osd_elements.c" 2
...
# 149 "./src/main/osd/osd_elements.c" 2
...
# 151 "./src/main/osd/osd_elements.c" 2
...
# 152 "./src/main/osd/osd_elements.c" 2
...
# 153 "./src/main/osd/osd_elements.c" 2
...
# 156 "./src/main/osd/osd_elements.c" 2
...
# 158 "./src/main/osd/osd_elements.c" 2
...
# 160 "./src/main/osd/osd_elements.c" 2
...
# 25 "./src/main/drivers/barometer/barometer.h" 2
...
# 161 "./src/main/osd/osd_elements.c" 2
...
# 162 "./src/main/osd/osd_elements.c" 2
...
# 164 "./src/main/osd/osd_elements.c" 2
# 184 "./src/main/osd/osd_elements.c"
...
static 
# 223 "./src/main/osd/osd_elements.c" 3 4
      _Bool 
# 223 "./src/main/osd/osd_elements.c"
...
static 
# 227 "./src/main/osd/osd_elements.c" 3 4
      _Bool 
# 227 "./src/main/osd/osd_elements.c"
           blinkState = 
# 227 "./src/main/osd/osd_elements.c" 3 4
                        1
# 227 "./src/main/osd/osd_elements.c"
...
{
    if ((blinkBits[(element->item) / 32] & (1 << ((element->item) % 32)))) {
        attr |= 0x80;
    }
...
static void renderOsdEscRpmOrFreq(getEscRpmOrFreqFnPtr escFnPtr, osdElementParms_t *element)
{
    ...
    element->drawElement = 
# 289 "./src/main/osd/osd_elements.c" 3 4
                          0
# 289 "./src/main/osd/osd_elements.c"
                               ;
}
...
static void osdFormatAltitudeString(char * buff, int32_t altitudeCm, osdElementType_e variantType)
{
    ...
    osdPrintFloat(buff, 0x7F, osdGetMetersToSelectedUnit(altitudeCm) / 100.0f, "", decimalPlaces, 
# 319 "./src/main/osd/osd_elements.c" 3 4
                                                                                                         1
# 319 "./src/main/osd/osd_elements.c"
                                                                                                             , unitSymbol);
}
...
{
    int32_t gpsValue = 0;
    const char leadingSymbol = (coordinateType == GPS_LONGITUDE) ? 0x98 : 0x89;

    if ((stateFlags & (GPS_FIX_EVER))) {
        gpsValue = (coordinateType == GPS_LONGITUDE) ? gpsSol.llh.lon : gpsSol.llh.lat;
    }

    const int degreesPart = __extension__ ({ __typeof__ (gpsValue) _x = (gpsValue); _x > 0 ? _x : -_x; }) / 10000000L;
    int fractionalPart = __extension__ ({ __typeof__ (gpsValue) _x = (gpsValue); _x > 0 ? _x : -_x; }) % 10000000L;

    switch (variantType) {
# 356 "./src/main/osd/osd_elements.c"
    case OSD_ELEMENT_TYPE_3:
        {
            char trailingSymbol;
            *buff++ = leadingSymbol;

            const int minutes = fractionalPart * 60 / 10000000L;
            const int fractionalMinutes = fractionalPart * 60 % 10000000L;
            const int seconds = fractionalMinutes * 60 / 10000000L;
            const int tenthSeconds = (fractionalMinutes * 60 % 10000000L) * 10 / 10000000L;
            ...
            tfp_sprintf(buff, "%u%c%02u%c%02u.%u%c%c", degreesPart, 0x08, minutes, 0x27, seconds, tenthSeconds, 0x22, trailingSymbol);
            break;
        }
...
void osdFormatDistanceString(char *ptr, int distance, char leadingSymbol)
{
    ...
    case UNIT_IMPERIAL:
        unitTransition = 5280;
        unitSymbol = 0x0F;
        unitSymbolExtended = 0x7E;
        break;
    default:
        unitTransition = 1000;
        unitSymbol = 0x0C;
        unitSymbolExtended = 0x7D;
        break;
    }
    ...
    osdPrintFloat(ptr, leadingSymbol, displayDistance, "", decimalPlaces, 
# 427 "./src/main/osd/osd_elements.c" 3 4
                                                                         0
# 427 "./src/main/osd/osd_elements.c"
                                                                              , displaySymbol);
}
...
# 436 "./src/main/osd/osd_elements.c" 3 4
_Bool 
# 436 "./src/main/osd/osd_elements.c"
    osdFormatRtcDateTime(char *buffer)
{
    dateTime_t dateTime;
    if (!rtcGetDateTime(&dateTime)) {
        ...
        return 
# 442 "./src/main/osd/osd_elements.c" 3 4
              0
# 442 "./src/main/osd/osd_elements.c"
                   ;
    }
    ...
    return 
# 447 "./src/main/osd/osd_elements.c" 3 4
          1
# 447 "./src/main/osd/osd_elements.c"
              ;
}
...
static char osdGetTimerSymbol(osd_timer_source_e src)
{
    ...
    case OSD_TIMER_SRC_ON_OR_ARMED:
        return (armingFlags & (ARMED)) ? 0x9C : 0x9B;
    default:
        return ' ';
    }
}
...
static timeUs_t osdGetTimerValue(osd_timer_source_e src)
{
    ...
    case OSD_TIMER_SRC_ON_OR_ARMED:
        return (armingFlags & (ARMED)) ? osdFlyTime : micros();
    default:
        return 0;
    }
}
...
void osdFormatTimer(char *buff, 
# 510 "./src/main/osd/osd_elements.c" 3 4
                               _Bool 
# 510 "./src/main/osd/osd_elements.c"
                                    showSymbol, 
# 510 "./src/main/osd/osd_elements.c" 3 4
                                                _Bool 
# 510 "./src/main/osd/osd_elements.c"
...
# 655 "./src/main/osd/osd_elements.c" 3 4
   _Bool 
# 655 "./src/main/osd/osd_elements.c"
        haveBaro = 
# 655 "./src/main/osd/osd_elements.c" 3 4
                   0
# 655 "./src/main/osd/osd_elements.c"
...
# 656 "./src/main/osd/osd_elements.c" 3 4
   _Bool 
# 656 "./src/main/osd/osd_elements.c"
        haveGps = 
# 656 "./src/main/osd/osd_elements.c" 3 4
                  0
# 656 "./src/main/osd/osd_elements.c"
...
static void osdElementAngleRollPitch(osdElementParms_t *element)
{
    ...
    osdPrintFloat(element->buff, (element->item == OSD_PITCH_ANGLE) ? 0x15 : 0x14, fabsf(angle), ((angle < 0) ? "-%02u" : " %02u"), 1, 
# 676 "./src/main/osd/osd_elements.c" 3 4
                                                                                                                                               1
# 676 "./src/main/osd/osd_elements.c"
                                                                                                                                                   , 0x00);
}
...
static void osdElementArtificialHorizon(osdElementParms_t *element)
{
    ...
    for (int x = -4; x <= 4; x++) {
        ...
        if (y >= 0 && y <= 81) {
            osdDisplayWriteChar(element, element->elemPosX + x, element->elemPosY + (y / 9), DISPLAYPORT_ATTR_NONE, (0x80 + (y % 9)));
        }
    }

    element->drawElement = 
# 711 "./src/main/osd/osd_elements.c" 3 4
                          0
# 711 "./src/main/osd/osd_elements.c"
                               ;
}
...
static void osdElementUpDownReference(osdElementParms_t *element)
{
    ...
    const float earthUpinBodyFrame[3] = {-rMat[2][0], -rMat[2][1], -rMat[2][2]};

    if (__extension__ ({ __typeof__ (earthUpinBodyFrame[2]) _x = (earthUpinBodyFrame[2]); _x > 0 ? _x : -_x; }) < 0.422618261740699f && __extension__ ({ __typeof__ (earthUpinBodyFrame[1]) _x = (earthUpinBodyFrame[1]); _x > 0 ? _x : -_x; }) < 0.422618261740699f) {
        float thetaB;
        float psiB;
        char *symbol[2] = {"U", "D"};
        int direction;
        ...
        if(attitude.values.pitch>0.0){
            thetaB = -earthUpinBodyFrame[2];
            psiB = -earthUpinBodyFrame[1];
            direction = DOWN;
        } else {
            thetaB = earthUpinBodyFrame[2];
            psiB = earthUpinBodyFrame[1];
        ...
        int posX = element->elemPosX + lrintf(scaleRangef(psiB, -3.14159265358979323846f / 4, 3.14159265358979323846f / 4, -14, 14));
        int posY = element->elemPosY + lrintf(scaleRangef(thetaB, -3.14159265358979323846f / 4, 3.14159265358979323846f / 4, -8, 8));

        osdDisplayWrite(element, posX, posY, DISPLAYPORT_ATTR_NONE, symbol[direction]);
    }
    element->drawElement = 
# 739 "./src/main/osd/osd_elements.c" 3 4
                          0
# 739 "./src/main/osd/osd_elements.c"
                               ;
}
...
static void osdElementAverageCellVoltage(osdElementParms_t *element)
{
    ...
    osdPrintFloat(element->buff, osdGetBatterySymbol(cellV), cellV / 100.0f, "", 2, 
# 746 "./src/main/osd/osd_elements.c" 3 4
                                                                                   0
# 746 "./src/main/osd/osd_elements.c"
                                                                                        , 0x06);
}

static void osdElementCompassBar(osdElementParms_t *element)
{
    memcpy(element->buff, compassBar + osdGetHeadingIntoDiscreteDirections(((attitude.values.yaw) / 10), 16), 9);
    element->buff[9] = 0;
}
...
{
    tfp_sprintf(element->buff, "C%c%3d%c", 0x7A, osdConvertTemperatureToSelectedUnit(getCoreTemperatureCelsius()), osdGetTemperatureSymbolForSelectedUnit());
}
...
static void osdBackgroundCameraFrame(osdElementParms_t *element)
{
    ...
    const uint8_t width = constrain(osdConfig()->camera_frame_width, 2, 30);
    const uint8_t height = constrain(osdConfig()->camera_frame_height, 2, 16);

    element->buff[0] = 0x0B;
    for (int i = 1; i < (width - 1); i++) {
        element->buff[i] = 0x17;
    }
    element->buff[width - 1] = 0x0B;
    element->buff[width] = 0;

    osdDisplayWrite(element, xpos, ypos, DISPLAYPORT_ATTR_NONE, element->buff);
    for (int i = 1; i < (height - 1); i++) {
        osdDisplayWriteChar(element, xpos, ypos + i, DISPLAYPORT_ATTR_NONE, 0x16);
        osdDisplayWriteChar(element, xpos + width - 1, ypos + i, DISPLAYPORT_ATTR_NONE, 0x16);
    }
    osdDisplayWrite(element, xpos, ypos + height - 1, DISPLAYPORT_ATTR_NONE, element->buff);

    element->drawElement = 
# 783 "./src/main/osd/osd_elements.c" 3 4
                          0
# 783 "./src/main/osd/osd_elements.c"
                               ;
}
...
static void osdElementCrashFlipArrow(osdElementParms_t *element)
{
    ...
    if ((isFlipOverAfterCrashActive() || (!(armingFlags & (ARMED)) && !isUpright())) && !((imuConfig()->small_angle < 180 && isUpright()) || (rollAngle == 0 && pitchAngle == 0))) {
        if (abs(pitchAngle) < 2 * abs(rollAngle) && abs(rollAngle) < 2 * abs(pitchAngle)) {
            if (pitchAngle > 0) {
                if (rollAngle > 0) {
                    element->buff[0] = 0x6C + 2;
                } else {
                    element->buff[0] = 0x64 - 2;
                }
            } else {
                if (rollAngle > 0) {
                    element->buff[0] = 0x6C - 2;
...
static void osdElementCurrentDraw(osdElementParms_t *element)
{
    ...
    osdPrintFloat(element->buff, 0x00, amperage, "%3u", 2, 
# 858 "./src/main/osd/osd_elements.c" 3 4
                                                              0
# 858 "./src/main/osd/osd_elements.c"
                                                                   , 0x9A);
}
...
{
    osdPrintFloat(element->buff, 0x00, osdGForce, "", 1, 
# 1007 "./src/main/osd/osd_elements.c" 3 4
                                                            1
# 1007 "./src/main/osd/osd_elements.c"
                                                                , 'G');
}
...
static void osdElementGpsCoordinate(osdElementParms_t *element)
{
    ...
    if ((stateFlags & (GPS_FIX_EVER)) && !(stateFlags & (GPS_FIX))) {
        (blinkBits[(element->item) / 32] |= (1 << ((element->item) % 32)));
    } else {
        (blinkBits[(element->item) / 32] &= ~(1 << ((element->item) % 32)));
    }
}
...
{
    if (!gpsIsHealthy()) {
        tfp_sprintf(element->buff, "%c%cNC", 0x1E, 0x1F);
    } else {
...
# 1071 "./src/main/osd/osd_elements.c" 3 4
                                                                                     1
# 1071 "./src/main/osd/osd_elements.c"
                                                                                         , 0x00);
        }
    }
}
...
static void osdElementGpsSpeed(osdElementParms_t *element)
{
    if ((stateFlags & (GPS_FIX))) {
        ...
        tfp_sprintf(element->buff, "%c%c%c", 0x70, 0x2D, osdGetSpeedToSelectedUnitSymbol());
    }
}
...
static void osdElementEfficiency(osdElementParms_t *element)
{
    ...
    if (sensors(SENSOR_GPS) && (armingFlags & (ARMED)) && (stateFlags & (GPS_FIX)) && gpsSol.groundSpeed >= 100) {
        ...
        const float mAmperage = (float)getAmperage() * 10.f;
...
static void osdBackgroundHorizonSidebars(osdElementParms_t *element)
{
    ...
    for (int y = -hudheight; y <= hudheight; y++) {
        osdDisplayWriteChar(element, element->elemPosX - hudwidth, element->elemPosY + y, DISPLAYPORT_ATTR_NONE, 0x13);
        osdDisplayWriteChar(element, element->elemPosX + hudwidth, element->elemPosY + y, DISPLAYPORT_ATTR_NONE, 0x13);
    }


    osdDisplayWriteChar(element, element->elemPosX - hudwidth + 1, element->elemPosY, DISPLAYPORT_ATTR_NONE, 0x03);
    osdDisplayWriteChar(element, element->elemPosX + hudwidth - 1, element->elemPosY, DISPLAYPORT_ATTR_NONE, 0x02);

    element->drawElement = 
# 1117 "./src/main/osd/osd_elements.c" 3 4
                          0
# 1117 "./src/main/osd/osd_elements.c"
                               ;
}
...
static void osdElementTxUplinkPower(osdElementParms_t *element)
{
    ...
    if (osdUplinkTxPowerMw < 1000) {
        tfp_sprintf(element->buff, "%c%3dMW", 0x01, osdUplinkTxPowerMw);
    } else {
        osdPrintFloat(element->buff, 0x01, osdUplinkTxPowerMw / 1000.0f, "", 1, 
# 1148 "./src/main/osd/osd_elements.c" 3 4
                                                                                   0
# 1148 "./src/main/osd/osd_elements.c"
                                                                                        , 'W');
    }
}
...
static void osdElementLogStatus(osdElementParms_t *element)
{
    if (IS_RC_MODE_ACTIVE(BOXBLACKBOX)) {
        if (!isBlackboxDeviceWorking()) {
            tfp_sprintf(element->buff, "%c!", 0x10);
        } else if (isBlackboxDeviceFull()) {
            tfp_sprintf(element->buff, "%c>", 0x10);
        } else {
            int32_t logNumber = blackboxGetLogNumber();
            if (logNumber >= 0) {
                tfp_sprintf(element->buff, "%c%d", 0x10, logNumber);
            } else {
                tfp_sprintf(element->buff, "%c", 0x10);
            }
        }
...
{
    tfp_sprintf(element->buff, "%4d%c", getMAhDrawn(), 0x07);
}
    ...
    case OSD_ELEMENT_TYPE_4:
        {
            ...
            tfp_sprintf(element->buff, "%c%d%%", 0x07, displayPercent);
            break;
        }
    ...
    default:
        {
            ...
            if (batteryConfig()->batteryCapacity) {
                ...
                remainingCapacityBars = ceilf((batteryRemaining / (batteryConfig()->batteryCapacity / 11)));
            }


            element->buff[0] = 0x8A;
            for (int i = 1; i <= 11; i++) {
                element->buff[i] = i <= remainingCapacityBars ? 0x8B : 0x8D;
            }
            element->buff[11 + 1] = 0x8F;
            if (remainingCapacityBars > 0 && remainingCapacityBars < 11) {
                element->buff[1 + remainingCapacityBars] = 0x8E;
            }
            element->buff[11 +2] = '\0';
            break;
        }
...
# 1240 "./src/main/osd/osd_elements.c" 3 4
                                                                                                                        1
# 1240 "./src/main/osd/osd_elements.c"
                                                                                                                            , 0x06);
}
...
static void osdElementMotorDiagnostics(osdElementParms_t *element)
{
    int i = 0;
    const 
# 1246 "./src/main/osd/osd_elements.c" 3 4
         _Bool 
# 1246 "./src/main/osd/osd_elements.c"
              motorsRunning = areMotorsRunning();
...
# 1272 "./src/main/osd/osd_elements.c" 3 4
   _Bool 
# 1272 "./src/main/osd/osd_elements.c"
        haveBaro = 
# 1272 "./src/main/osd/osd_elements.c" 3 4
                   0
# 1272 "./src/main/osd/osd_elements.c"
...
# 1273 "./src/main/osd/osd_elements.c" 3 4
   _Bool 
# 1273 "./src/main/osd/osd_elements.c"
        haveGps = 
# 1273 "./src/main/osd/osd_elements.c" 3 4
                  0
# 1273 "./src/main/osd/osd_elements.c"
...
# 1283 "./src/main/osd/osd_elements.c" 3 4
                                                                                  1
# 1283 "./src/main/osd/osd_elements.c"
...
static void osdElementRcChannels(osdElementParms_t *element)
{
    ...
    for (int i = 0; i < 4; i++) {
        if (osdConfig()->rcChannels[i] >= 0) {
            ...
            int data = scaleRange(rcData[osdConfig()->rcChannels[i]], 1000, 2000, -1000, 1000);
    ...
    element->drawElement = 
# 1334 "./src/main/osd/osd_elements.c" 3 4
                          0
# 1334 "./src/main/osd/osd_elements.c"
                               ;
}
...
static void osdElementRssi(osdElementParms_t *element)
{
    ...
    tfp_sprintf(element->buff, "%c%2d", 0x01, osdRssi);
}
...
static void osdBackgroundStickOverlay(osdElementParms_t *element)
{
    ...
    element->drawElement = 
# 1395 "./src/main/osd/osd_elements.c" 3 4
                          0
# 1395 "./src/main/osd/osd_elements.c"
                               ;
}
...
static void osdElementStickOverlay(osdElementParms_t *element)
{
    ...
    element->drawElement = 
# 1420 "./src/main/osd/osd_elements.c" 3 4
                          0
# 1420 "./src/main/osd/osd_elements.c"
                               ;
}
...
{
    osdFormatTimer(element->buff, 
# 1431 "./src/main/osd/osd_elements.c" 3 4
                                 1
# 1431 "./src/main/osd/osd_elements.c"
                                     , 
# 1431 "./src/main/osd/osd_elements.c" 3 4
                                       1
# 1431 "./src/main/osd/osd_elements.c"
...
# 1470 "./src/main/osd/osd_elements.c" 3 4
   _Bool 
# 1470 "./src/main/osd/osd_elements.c"
        elementBlinking = 
# 1470 "./src/main/osd/osd_elements.c" 3 4
                          0
# 1470 "./src/main/osd/osd_elements.c"
...
const osdElementDrawFn osdElementDrawFunction[OSD_ITEM_COUNT] = {
    [OSD_CAMERA_FRAME] = 
# 1566 "./src/main/osd/osd_elements.c" 3 4
                                   ((void *)0)
# 1566 "./src/main/osd/osd_elements.c"
                                       ,
    ...
    [OSD_HORIZON_SIDEBARS] = 
# 1574 "./src/main/osd/osd_elements.c" 3 4
                                   ((void *)0)
# 1574 "./src/main/osd/osd_elements.c"
                                       ,
    [OSD_ITEM_TIMER_1] = osdElementTimer,
    [OSD_ITEM_TIMER_2] = osdElementTimer,
    [OSD_FLYMODE] = osdElementFlymode,
    [OSD_CRAFT_NAME] = 
# 1578 "./src/main/osd/osd_elements.c" 3 4
                                   ((void *)0)
# 1578 "./src/main/osd/osd_elements.c"
                                       ,
    ...
    [OSD_DISPLAY_NAME] = 
# 1657 "./src/main/osd/osd_elements.c" 3 4
                                   ((void *)0)
# 1657 "./src/main/osd/osd_elements.c"
                                       ,
...
static void osdDrawSingleElement(displayPort_t *osdDisplayPort, uint8_t item)
{
    ...
    if (!osdDisplayPort->useDeviceBlink && ((blinkBits[(item) / 32] & (1 << ((item) % 32))) && blinkState)) {
        return;
    }

    uint8_t elemPosX = (osdElementConfig()->item_pos[item] & ((1 << 5) - 1));
    uint8_t elemPosY = ((osdElementConfig()->item_pos[item] >> 5) & ((1 << 5) - 1));
    char buff[32] = "";
    ...
    element.type = ((osdElementConfig()->item_pos[item] & 0xC000) >> 14);
    element.buff = (char *)&buff;
    element.osdDisplayPort = osdDisplayPort;
    element.drawElement = 
# 1771 "./src/main/osd/osd_elements.c" 3 4
                         1
# 1771 "./src/main/osd/osd_elements.c"
                             ;
...
static void osdDrawSingleElementBackground(displayPort_t *osdDisplayPort, uint8_t item)
{
    ...
    element.osdDisplayPort = osdDisplayPort;
    element.drawElement = 
# 1799 "./src/main/osd/osd_elements.c" 3 4
                         1
# 1799 "./src/main/osd/osd_elements.c"
                             ;
...
# 1821 "./src/main/osd/osd_elements.c" 3 4
_Bool 
# 1821 "./src/main/osd/osd_elements.c"
    osdDrawNextActiveElement(displayPort_t *osdDisplayPort, timeUs_t currentTimeUs)
{
    ((void)(currentTimeUs));
    
# 1824 "./src/main/osd/osd_elements.c" 3 4
   _Bool 
# 1824 "./src/main/osd/osd_elements.c"
        retval = 
# 1824 "./src/main/osd/osd_elements.c" 3 4
                 1
# 1824 "./src/main/osd/osd_elements.c"
    ...
    if (activeElement >= activeOsdElementCount) {
        return 
# 1827 "./src/main/osd/osd_elements.c" 3 4
              0
# 1827 "./src/main/osd/osd_elements.c"
                   ;
    }
    ...
    if (++activeElement >= activeOsdElementCount) {
        activeElement = 0;
        retval = 
# 1840 "./src/main/osd/osd_elements.c" 3 4
                0
# 1840 "./src/main/osd/osd_elements.c"
                     ;
    }
...
void osdElementsInit(
# 1858 "./src/main/osd/osd_elements.c" 3 4
                    _Bool 
# 1858 "./src/main/osd/osd_elements.c"
                         backgroundLayerFlag)
{
    backgroundLayerSupported = backgroundLayerFlag;
    activeOsdElementCount = 0;
    pt1FilterInit(&batteryEfficiencyFilt, pt1FilterGain(0.5f, 1.0f / osdConfig()->framerate_hz));
}
...
void osdSyncBlink() {
    ...
    if (++blinkCount == ((osdConfig()->framerate_hz / 2) / 2)) {
        blinkCount = 0;
...
void osdUpdateAlarms(void)
{
    ...
    if ((alt >= osdConfig()->alt_alarm) && (armingFlags & (ARMED))) {
...
# 1963 "./src/main/osd/osd_elements.c" 3 4
                                          (-0x7f - 1) 
# 1963 "./src/main/osd/osd_elements.c"
...
static 
# 1973 "./src/main/osd/osd_elements.c" 3 4
      _Bool 
# 1973 "./src/main/osd/osd_elements.c"
           osdElementIsActive(osd_items_e element)
{
    for (unsigned i = 0; i < activeOsdElementCount; i++) {
        if (activeOsdElementArray[i] == element) {
            return 
# 1977 "./src/main/osd/osd_elements.c" 3 4
                  1
# 1977 "./src/main/osd/osd_elements.c"
                      ;
        }
    }
    return 
# 1980 "./src/main/osd/osd_elements.c" 3 4
          0
# 1980 "./src/main/osd/osd_elements.c"
               ;
}



# 1984 "./src/main/osd/osd_elements.c" 3 4
_Bool 
# 1984 "./src/main/osd/osd_elements.c"
    osdElementsNeedAccelerometer(void)
{
