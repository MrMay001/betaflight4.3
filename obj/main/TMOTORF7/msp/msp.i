...
# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include-fixed/limits.h" 1 3 4
# 34 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include-fixed/limits.h" 3 4
# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include-fixed/syslimits.h" 1 3 4
...
# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include-fixed/limits.h" 1 3 4
# 194 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include-fixed/limits.h" 3 4
# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/arm-none-eabi/include/limits.h" 1 3 4





# 1 "/opt/gcc-arm-none-eabi-9-2020-q2-update/arm-none-eabi/include/sys/syslimits.h" 1 3 4
# 7 "/opt/gcc-arm-none-eabi-9-2020-q2-update/arm-none-eabi/include/limits.h" 2 3 4
# 195 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include-fixed/limits.h" 2 3 4
# 8 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include-fixed/syslimits.h" 2 3 4
# 35 "/opt/gcc-arm-none-eabi-9-2020-q2-update/lib/gcc/arm-none-eabi/9.3.1/include-fixed/limits.h" 2 3 4
...
# 64 "./src/main/msp/msp.c" 2
# 1 "./src/main/drivers/osd.h" 1
# 21 "./src/main/drivers/osd.h"
       
# 43 "./src/main/drivers/osd.h"
typedef enum {
    VIDEO_SYSTEM_AUTO = 0,
    VIDEO_SYSTEM_PAL,
    VIDEO_SYSTEM_NTSC
...
typedef struct gpsRescue_s {
    ...
    uint8_t minSats;
    uint16_t minRescueDth;
    uint8_t sanityChecks;
    uint8_t allowArmingWithoutFix;
    uint8_t useMag;
    uint16_t targetLandingAltitudeM;
    uint16_t targetLandingDistanceM;
    uint8_t altitudeMode;
    uint16_t ascendRate;
    uint16_t descendRate;
    uint16_t rescueAltitudeBufferM;
} gpsRescueConfig_t;
...
# 57 "./src/main/flight/gps_rescue.h" 3 4
_Bool 
# 57 "./src/main/flight/gps_rescue.h"
    gpsRescueIsConfigured(void);

# 58 "./src/main/flight/gps_rescue.h" 3 4
_Bool 
# 58 "./src/main/flight/gps_rescue.h"
    gpsRescueIsAvailable(void);

# 59 "./src/main/flight/gps_rescue.h" 3 4
_Bool 
# 59 "./src/main/flight/gps_rescue.h"
    gpsRescueIsDisabled(void);

# 60 "./src/main/flight/gps_rescue.h" 3 4
_Bool 
# 60 "./src/main/flight/gps_rescue.h"
    gpsRescueDisableMag(void);
# 87 "./src/main/msp/msp.c" 2
...
# 89 "./src/main/msp/msp.c" 2

# 1 "./src/main/flight/pid_init.h" 1
# 21 "./src/main/flight/pid_init.h"
...
# 52 "./src/main/io/serial_4way.h" 3 4
_Bool 
# 52 "./src/main/io/serial_4way.h"
    isMcuConnected(void);
uint8_t esc4wayInit(void);
struct serialPort_s;
void esc4wayProcess(struct serialPort_s *mspPort);
void esc4wayRelease(void);
# 103 "./src/main/msp/msp.c" 2
# 1 "./src/main/io/servos.h" 1
# 21 "./src/main/io/servos.h"
       
# 104 "./src/main/msp/msp.c" 2
...
# 110 "./src/main/msp/msp.c" 2
# 1 "./src/main/msp/msp_protocol.h" 1
# 56 "./src/main/msp/msp_protocol.h"
       
# 111 "./src/main/msp/msp.c" 2
# 1 "./src/main/msp/msp_protocol_v2_betaflight.h" 1
# 112 "./src/main/msp/msp.c" 2
# 1 "./src/main/msp/msp_protocol_v2_common.h" 1
# 113 "./src/main/msp/msp.c" 2
...
# 28 "./src/main/msp/msp_serial.h" 2
...
# 117 "./src/main/msp/msp_serial.h" 3 4
   _Bool 
# 117 "./src/main/msp/msp_serial.h"
        sharedWithTelemetry;
...
# 122 "./src/main/msp/msp_serial.h" 3 4
_Bool 
# 122 "./src/main/msp/msp_serial.h"
...
# 116 "./src/main/msp/msp.c" 2
# 1 "./src/main/osd/osd_elements.h" 1
# 21 "./src/main/osd/osd_elements.h"
...
# 41 "./src/main/osd/osd_elements.h" 3 4
   _Bool 
# 41 "./src/main/osd/osd_elements.h"
        drawElement;
    uint8_t attr;
} osdElementParms_t;
...
# 49 "./src/main/osd/osd_elements.h" 3 4
_Bool 
# 49 "./src/main/osd/osd_elements.h"
    osdFormatRtcDateTime(char *buffer);
void osdFormatTime(char * buff, osd_timer_precision_e precision, timeUs_t time);
void osdFormatTimer(char *buff, 
# 51 "./src/main/osd/osd_elements.h" 3 4
                               _Bool 
# 51 "./src/main/osd/osd_elements.h"
                                    showSymbol, 
# 51 "./src/main/osd/osd_elements.h" 3 4
                                                _Bool 
# 51 "./src/main/osd/osd_elements.h"
...
# 60 "./src/main/osd/osd_elements.h" 3 4
_Bool 
# 60 "./src/main/osd/osd_elements.h"
    osdDrawNextActiveElement(displayPort_t *osdDisplayPort, timeUs_t currentTimeUs);
void osdDrawActiveElementsBackground(displayPort_t *osdDisplayPort);
void osdElementsInit(
# 62 "./src/main/osd/osd_elements.h" 3 4
                    _Bool 
# 62 "./src/main/osd/osd_elements.h"
                         backgroundLayerFlag);
void osdSyncBlink();
void osdResetAlarms(void);
void osdUpdateAlarms(void);

# 66 "./src/main/osd/osd_elements.h" 3 4
_Bool 
# 66 "./src/main/osd/osd_elements.h"
    osdElementsNeedAccelerometer(void);
# 117 "./src/main/msp/msp.c" 2
# 1 "./src/main/osd/osd_warnings.h" 1
# 21 "./src/main/osd/osd_warnings.h"
...
_Static_assert(((12 + 1) <= 32), "osd_warnings_size_exceeds_buffer_size");

void renderOsdWarning(char *warningText, 
# 30 "./src/main/osd/osd_warnings.h" 3 4
                                        _Bool 
# 30 "./src/main/osd/osd_warnings.h"
                                             *blinking, uint8_t *displayAttr);
# 118 "./src/main/msp/msp.c" 2
...
# 37 "./src/main/telemetry/msp_shared.h" 3 4
_Bool 
# 37 "./src/main/telemetry/msp_shared.h"
    handleMspFrame(uint8_t *const payload, uint8_t const payloadLength, uint8_t *const skipsBeforeResponse);



# 40 "./src/main/telemetry/msp_shared.h" 3 4
_Bool 
# 40 "./src/main/telemetry/msp_shared.h"
    sendMspReply(const uint8_t payloadSize_max, mspResponseFnPtr responseFn);
# 147 "./src/main/msp/msp.c" 2
...
# 148 "./src/main/msp/msp.c" 2
# 156 "./src/main/msp/msp.c"
...
static 
# 209 "./src/main/msp/msp.c" 3 4
      _Bool 
# 209 "./src/main/msp/msp.c"
           vtxTableNeedsInit = 
# 209 "./src/main/msp/msp.c" 3 4
                               0
# 209 "./src/main/msp/msp.c"
...
static 
# 231 "./src/main/msp/msp.c" 3 4
      _Bool 
# 231 "./src/main/msp/msp.c"
           mspIsMspArmingEnabled(void)
{
...
# 248 "./src/main/msp/msp.c"
static serialPort_t *mspFindPassthroughSerialPort(void)
{
    serialPortUsage_t *portUsage = 
# 250 "./src/main/msp/msp.c" 3 4
                                  ((void *)0)
# 250 "./src/main/msp/msp.c"
                                      ;
    ...
    return portUsage ? portUsage->serialPort : 
# 267 "./src/main/msp/msp.c" 3 4
                                              ((void *)0)
# 267 "./src/main/msp/msp.c"
                                                  ;
}
...
static void mspSerialPassthroughFn(serialPort_t *serialPort)
{
    ...
    if (passthroughPort && serialPort) {
        serialPassthrough(passthroughPort, serialPort, 
# 274 "./src/main/msp/msp.c" 3 4
                                                      ((void *)0)
# 274 "./src/main/msp/msp.c"
                                                          , 
# 274 "./src/main/msp/msp.c" 3 4
                                                            ((void *)0)
# 274 "./src/main/msp/msp.c"
...
static void mspRebootFn(serialPort_t *serialPort)
{
    ...
    while (
# 386 "./src/main/msp/msp.c" 3 4
          1
# 386 "./src/main/msp/msp.c"
              ) ;
}
...
void mspReboot(dispatchEntry_t* self)
{
    ...
    mspRebootFn(
# 399 "./src/main/msp/msp.c" 3 4
               ((void *)0)
# 399 "./src/main/msp/msp.c"
                   );
}
...
{
    mspReboot, 0, 
# 404 "./src/main/msp/msp.c" 3 4
                 ((void *)0)
# 404 "./src/main/msp/msp.c"
                     , 
# 404 "./src/main/msp/msp.c" 3 4
                       0

# 405 "./src/main/msp/msp.c"
};
...
void writeReadEeprom(dispatchEntry_t* self)
{
    ...
    if (vtxTableNeedsInit) {
        vtxTableNeedsInit = 
# 420 "./src/main/msp/msp.c" 3 4
                           0
# 420 "./src/main/msp/msp.c"
                                ;
        vtxTableInit();
    }
...
{
    writeReadEeprom, 0, 
# 428 "./src/main/msp/msp.c" 3 4
                       ((void *)0)
# 428 "./src/main/msp/msp.c"
                           , 
# 428 "./src/main/msp/msp.c" 3 4
                             0

# 429 "./src/main/msp/msp.c"
};
...
static void serializeDataflashSummaryReply(sbuf_t *dst)
{
    ...
    if (flashfsIsSupported()) {
        ...
        sbufWriteU8(dst, flags);
        sbufWriteU32(dst, (flashPartition->endSector + 1 - flashPartition->startSector));
...
# 517 "./src/main/msp/msp.c" 3 4
                                                                                           _Bool 
# 517 "./src/main/msp/msp.c"
                                                                                                useLegacyFormat, 
# 517 "./src/main/msp/msp.c" 3 4
                                                                                                                 _Bool 
# 517 "./src/main/msp/msp.c"
                                                                                                                      allowCompression)
{
    _Static_assert((16 >= 16), "MSP_PORT_DATAFLASH_INFO_SIZE_invalid");
...
static 
# 615 "./src/main/msp/msp.c" 3 4
      _Bool 
# 615 "./src/main/msp/msp.c"
           mspCommonProcessOutCommand(int16_t cmdMSP, sbuf_t *dst, mspPostProcessFnPtr *mspPostProcessFn)
{
    ...
    case 4:
    {
        ...
        sbufWriteU8(dst, 2);
# 659 "./src/main/msp/msp.c"
        uint8_t targetCapabilities = 0;

        targetCapabilities |= (1 << (0));
# 679 "./src/main/msp/msp.c"
        if (getRxBindSupported()) {
            targetCapabilities |= (1 << (6));
        }
        ...
        sbufWriteU16(dst, gyro.sampleRateHz);
        ...
        if (!accHasBeenCalibrated()) {
            configurationProblems |= (1 << (0));
        }


        if (!checkMotorProtocolEnabled(&motorConfig()->dev, 
# 734 "./src/main/msp/msp.c" 3 4
                                                           ((void *)0)
# 734 "./src/main/msp/msp.c"
                                                               )) {
            configurationProblems |= (1 << (1));
        }
    ...
    case 160:
        sbufWriteU32(dst, (*(uint32_t*)0x1FF07A10UL));
        sbufWriteU32(dst, (*(uint32_t*)(0x1FF07A10UL + 4)));
        sbufWriteU32(dst, (*(uint32_t*)(0x1FF07A10UL + 8)));
        break;
    ...
    case 56:
        {
            ...
            _Static_assert((VOLTAGE_SENSOR_ADC_VBAT == 0), "VOLTAGE_SENSOR_ADC_VBAT_incorrect");
            sbufWriteU8(dst, 1);
...
# 954 "./src/main/msp/msp.c" 3 4
       _Bool 
# 954 "./src/main/msp/msp.c"
...
# 987 "./src/main/msp/msp.c"
    ...
    default:
        return 
# 1051 "./src/main/msp/msp.c" 3 4
              0
# 1051 "./src/main/msp/msp.c"
                   ;
    }
    return 
# 1053 "./src/main/msp/msp.c" 3 4
          1
# 1053 "./src/main/msp/msp.c"
              ;
}

static 
# 1056 "./src/main/msp/msp.c" 3 4
      _Bool 
# 1056 "./src/main/msp/msp.c"
           mspProcessOutCommand(int16_t cmdMSP, sbuf_t *dst)
{
    
# 1058 "./src/main/msp/msp.c" 3 4
   _Bool 
# 1058 "./src/main/msp/msp.c"
        unsupportedCommand = 
# 1058 "./src/main/msp/msp.c" 3 4
                             0
# 1058 "./src/main/msp/msp.c"
    ...
    case 101:
        {
            ...
            sbufWriteU16(dst, constrain(getAverageSystemLoadPercent(), 0, 100));
            if (cmdMSP == 150) {
                sbufWriteU8(dst, 3);
            ...
            sbufWriteU8(dst, ((32*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0) + (16*(((ARMING_DISABLED_ARM_SWITCH)*1L >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0) >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0))>65535L) + (8*((((ARMING_DISABLED_ARM_SWITCH)*1L >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0) >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0))*1L >>16*(((ARMING_DISABLED_ARM_SWITCH)*1L >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0) >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0))>65535L))>255) + (8 - 90/((((((ARMING_DISABLED_ARM_SWITCH)*1L >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0) >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0))*1L >>16*(((ARMING_DISABLED_ARM_SWITCH)*1L >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0) >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0))>65535L)) >>8*((((ARMING_DISABLED_ARM_SWITCH)*1L >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0) >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0))*1L >>16*(((ARMING_DISABLED_ARM_SWITCH)*1L >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0) >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0))>65535L))>255))/4+14)|1) - 2/(((((ARMING_DISABLED_ARM_SWITCH)*1L >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0) >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0))*1L >>16*(((ARMING_DISABLED_ARM_SWITCH)*1L >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0) >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0))>65535L)) >>8*((((ARMING_DISABLED_ARM_SWITCH)*1L >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0) >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0))*1L >>16*(((ARMING_DISABLED_ARM_SWITCH)*1L >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0) >>16*((ARMING_DISABLED_ARM_SWITCH)/2L>>31 > 0))>65535L))>255))/2+1))))) + 1));
    ...
    case 104:
        for (unsigned i = 0; i < 8; i++) {
            ...
            if (!motorIsEnabled() || i >= 8 || !motorIsMotorEnabled(i)) {
                sbufWriteU16(dst, 0);
                continue;
            }
...
# 1205 "./src/main/msp/msp.c" 3 4
           _Bool 
# 1205 "./src/main/msp/msp.c"
                rpmDataAvailable = 
# 1205 "./src/main/msp/msp.c" 3 4
                                   0
# 1205 "./src/main/msp/msp.c"
            ...
            if (motorConfig()->dev.useDshotTelemetry) {
                ...
                rpmDataAvailable = 
# 1210 "./src/main/msp/msp.c" 3 4
                                  1
# 1210 "./src/main/msp/msp.c"
                                      ;
                invalidPct = 10000;
            ...
            if (featureIsEnabled(FEATURE_ESC_SENSOR)) {
                ...
                if (!rpmDataAvailable) {
                    ...
                    rpmDataAvailable = 
# 1225 "./src/main/msp/msp.c" 3 4
                                      1
# 1225 "./src/main/msp/msp.c"
                                          ;
                }
...
# 1265 "./src/main/msp/msp.c" 3 4
           _Bool 
# 1265 "./src/main/msp/msp.c"
                isBlinking;
            uint8_t displayAttr;
    ...
    case 134:
        if (featureIsEnabled(FEATURE_ESC_SENSOR)) {
            ...
            unsupportedCommand = 
# 1440 "./src/main/msp/msp.c" 3 4
                                1
# 1440 "./src/main/msp/msp.c"
                                    ;
        }
...
# 1462 "./src/main/msp/msp.c" 3 4
                                                                        (0xffff)
# 1462 "./src/main/msp/msp.c"
                                                                                  ));
...
# 1964 "./src/main/msp/msp.c"
    ...
    default:
        unsupportedCommand = 
# 2063 "./src/main/msp/msp.c" 3 4
                            1
# 2063 "./src/main/msp/msp.c"
                                ;
    }
...
static mspResult_e mspFcProcessOutCommandWithArg(mspDescriptor_t srcDesc, int16_t cmdMSP, sbuf_t *src, sbuf_t *dst, mspPostProcessFnPtr *mspPostProcessFn)
{
    ...
    case 68:
        ...
        if (featureIsEnabled(FEATURE_RX_SPI) && srcDesc == getMspTelemetryDescriptor()) {
            dispatchAdd(&mspRebootEntry, 1000000);
        } else
    ...
    case 230:
        {
            ...
            int bytesRemaining = sbufBytesRemaining(dst) - 1;
            ...
            while (sbufBytesRemaining(src) && bytesRemaining > 0) {
                ...
                packetIn.cmd = newMSP;
                mspFcProcessCommand(srcDesc, &packetIn, &packetOut, 
# 2264 "./src/main/msp/msp.c" 3 4
                                                                   ((void *)0)
# 2264 "./src/main/msp/msp.c"
                                                                       );
            ...
            for (int i = 0; i < maxMSPs; i++) {
                ...
                sbufWriteU8(&packetOut.buf, 0);
                packetIn.cmd = sbufReadU8(src);
                mspFcProcessCommand(srcDesc, &packetIn, &packetOut, 
# 2278 "./src/main/msp/msp.c" 3 4
                                                                   ((void *)0)
# 2278 "./src/main/msp/msp.c"
                                                                       );
...
# 2365 "./src/main/msp/msp.c" 3 4
           _Bool 
# 2365 "./src/main/msp/msp.c"
                result = 
# 2365 "./src/main/msp/msp.c" 3 4
                         1
# 2365 "./src/main/msp/msp.c"
...
# 2422 "./src/main/msp/msp.c" 3 4
           _Bool 
# 2422 "./src/main/msp/msp.c"
                success = 
# 2422 "./src/main/msp/msp.c" 3 4
                          0
# 2422 "./src/main/msp/msp.c"
            ...
            if (!(armingFlags & (ARMED))) {
                ...
                success = resetEEPROM(
# 2427 "./src/main/msp/msp.c" 3 4
                                     0
# 2427 "./src/main/msp/msp.c"
                                          );
...
# 2453 "./src/main/msp/msp.c" 3 4
   _Bool 
# 2453 "./src/main/msp/msp.c"
        allowCompression = 
# 2453 "./src/main/msp/msp.c" 3 4
                           0
# 2453 "./src/main/msp/msp.c"
...
# 2454 "./src/main/msp/msp.c" 3 4
   _Bool 
# 2454 "./src/main/msp/msp.c"
        useLegacyFormat;
    if (dataSize >= sizeof(uint32_t) + sizeof(uint16_t)) {
        ...
        useLegacyFormat = 
# 2460 "./src/main/msp/msp.c" 3 4
                         0
# 2460 "./src/main/msp/msp.c"
                              ;
    } else {
        readLength = 128;
        useLegacyFormat = 
# 2463 "./src/main/msp/msp.c" 3 4
                         1
# 2463 "./src/main/msp/msp.c"
                             ;
    }
...
static mspResult_e mspProcessInCommand(mspDescriptor_t srcDesc, int16_t cmdMSP, sbuf_t *src)
{
    ...
    case 204:
        if (sbufBytesRemaining(src) >= 10) {
            ...
            value = sbufReadU8(src);
            currentControlRateProfile->tpa_rate = __extension__ ({ __typeof__ (value) _a = (value); __typeof__ (100) _b = (100); _a < _b ? _a : _b; });
...
# 3071 "./src/main/msp/msp.c"
    ...
    case 250:
        ...
        if (featureIsEnabled(FEATURE_RX_SPI) && srcDesc == getMspTelemetryDescriptor()) {
            dispatchAdd(&writeReadEepromEntry, 1000000);
        } else

        {
            writeReadEeprom(
# 3134 "./src/main/msp/msp.c" 3 4
                           ((void *)0)
# 3134 "./src/main/msp/msp.c"
                               );
        }
    ...
    case 89:
        {
            ...
            if (sbufBytesRemaining(src) >= 2) {
                ...
                if (vtxType != VTXDEV_UNKNOWN) {
                    ...
                    if ((
# 3193 "./src/main/msp/msp.c" 3 4
                        _Bool
# 3193 "./src/main/msp/msp.c"
    ...
    case 227:
        {
            ...
            const 
# 3276 "./src/main/msp/msp.c" 3 4
                 _Bool 
# 3276 "./src/main/msp/msp.c"
                      isFactoryBand = (
# 3276 "./src/main/msp/msp.c" 3 4
                                       _Bool
# 3276 "./src/main/msp/msp.c"
            ...
            if (band > 0 && band <= vtxTableConfig()->bands) {
                ...
                vtxTableNeedsInit = 
# 3300 "./src/main/msp/msp.c" 3 4
                                   1
# 3300 "./src/main/msp/msp.c"
                                       ;
            } else {
                return MSP_RESULT_ERROR;
            }
    ...
    case 228:
        {
            ...
            if (powerLevel > 0 && powerLevel <= vtxTableConfig()->powerLevels) {
                ...
                vtxTableNeedsInit = 
# 3324 "./src/main/msp/msp.c" 3 4
                                   1
# 3324 "./src/main/msp/msp.c"
                                       ;
            } else {
                return MSP_RESULT_ERROR;
            }
    ...
    case 0x3003:
        {
            const 
# 3351 "./src/main/msp/msp.c" 3 4
                 _Bool 
# 3351 "./src/main/msp/msp.c"
...
# 3417 "./src/main/msp/msp.c" 3 4
                                              0
# 3417 "./src/main/msp/msp.c"
                                                   );
    ...
    case 45:
        ...
        if (sbufBytesRemaining(src) >= 1) {
            ...
            configRebootUpdateCheckU8(&rxConfigMutable()->rc_smoothing_auto_factor_rpy, constrain(sbufReadU8(src), 0, 250));
...
# 4011 "./src/main/msp/msp.c" 3 4
                                                             ((void *)0)
# 4011 "./src/main/msp/msp.c"
                                                                 );
            if (!osdDisplayPort) {
                return MSP_RESULT_ERROR;
            }
