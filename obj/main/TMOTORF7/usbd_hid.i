# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
# 47 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Inc/usbd_hid.h" 1
# 29 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Inc/usbd_hid.h"
...
# 30 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Inc/usbd_hid.h" 2
...
# 48 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c" 2
# 1 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ctlreq.h" 1
# 49 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c" 2
# 93 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
...
# 119 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
...
# 124 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c" 3 4
 ((void *)0)
# 124 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
     ,
  
# 125 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c" 3 4
 ((void *)0)
# 125 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
     ,
  USBD_HID_DataIn,
  
# 127 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c" 3 4
 ((void *)0)
# 127 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
     ,
  
# 128 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c" 3 4
 ((void *)0)
# 128 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
     ,
  
# 129 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c" 3 4
 ((void *)0)
# 129 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
     ,
  
# 130 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c" 3 4
 ((void *)0)
# 130 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
     ,
 ...
 static uint8_t USBD_HID_CfgFSDesc[34U] __attribute__ ((aligned (4))) =
{
  0x09,
  0x02U,
  34U,
 ...
 static uint8_t USBD_HID_CfgHSDesc[34U] __attribute__ ((aligned (4))) =
{
  0x09,
  0x02U,
  34U,
 ...
 static uint8_t USBD_HID_OtherSpeedCfgDesc[34U] __attribute__ ((aligned (4))) =
{
  0x09,
  0x02U,
  34U,
 ...
 static uint8_t USBD_HID_Desc[9U] __attribute__ ((aligned (4))) =
{
 ...
 static uint8_t USBD_HID_DeviceQualifierDesc[0x0AU] __attribute__ ((aligned (4))) =
{
  0x0AU,
  0x06U,
  0x00,
 ...
 static uint8_t HID_MOUSE_ReportDesc[54U] __attribute__ ((aligned (4))) =
{
        0x05, 0x01,
        0x09, 0x05,
        0xa1, 0x01,
...
# 365 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
static uint8_t USBD_HID_Init (USBD_HandleTypeDef *pdev, uint8_t cfgidx)
{
  ((void)(cfgidx));


  USBD_LL_OpenEP(pdev, 0x83U, 0x03U, 0x08U);
  pdev->ep_in[0x83U & 0xFU].is_used = 1U;

  pdev->pHID_ClassData = malloc(sizeof (USBD_HID_HandleTypeDef));

  if (pdev->pHID_ClassData == 
# 375 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c" 3 4
                             ((void *)0)
# 375 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
                                 )
  {
    return USBD_FAIL;
  }
...
# 392 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
static uint8_t USBD_HID_DeInit (USBD_HandleTypeDef *pdev,
                                 uint8_t cfgidx)
{
  ((void)(cfgidx));
  ...
  if(pdev->pHID_ClassData != 
# 402 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c" 3 4
                            ((void *)0)
# 402 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
                                )
  {
    free(pdev->pHID_ClassData);
    pdev->pHID_ClassData = 
# 405 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c" 3 4
                          ((void *)0)
# 405 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
                              ;
  }

  return USBD_OK;
}
# 418 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
static uint8_t USBD_HID_Setup (USBD_HandleTypeDef *pdev,
                                USBD_SetupReqTypedef *req)
{
  ...
  uint16_t len = 0U;
  uint8_t *pbuf = 
# 423 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c" 3 4
                 ((void *)0)
# 423 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
                     ;
  ...
  case 0x00U:
    ...
    case 0x06U:
      ...
      {
        len = __extension__ ({ __typeof__ (54U) _a = (54U); __typeof__ (req->wLength) _b = (req->wLength); _a < _b ? _a : _b; });
        pbuf = HID_MOUSE_ReportDesc;
      }
      else if(req->wValue >> 8 == 0x21U)
      {
        pbuf = USBD_HID_Desc;
        len = __extension__ ({ __typeof__ (9U) _a = (9U); __typeof__ (req->wLength) _b = (req->wLength); _a < _b ? _a : _b; });
      }
      else
      {
        USBD_CtlError (pdev, req);
...
# 536 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
uint8_t USBD_HID_SendReport (USBD_HandleTypeDef *pdev,
                                 uint8_t *report,
                                 uint16_t len)
{
...
# 591 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
static uint8_t *USBD_HID_GetFSCfgDesc (uint16_t *length)
{
  *length = sizeof (USBD_HID_CfgFSDesc);
  return USBD_HID_CfgFSDesc;
}
# 604 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
static uint8_t *USBD_HID_GetHSCfgDesc (uint16_t *length)
{
  *length = sizeof (USBD_HID_CfgHSDesc);
  return USBD_HID_CfgHSDesc;
}
# 617 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
static uint8_t *USBD_HID_GetOtherSpeedCfgDesc (uint16_t *length)
{
  *length = sizeof (USBD_HID_OtherSpeedCfgDesc);
  return USBD_HID_OtherSpeedCfgDesc;
}
# 630 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
...
# 648 "./lib/main/STM32F7/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Src/usbd_hid.c"
static uint8_t *USBD_HID_GetDeviceQualifierDesc (uint16_t *length)
{
